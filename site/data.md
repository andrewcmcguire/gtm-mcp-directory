...
> The whole GTM MCP Directory as JSON: 336 entries, 200 official MCP servers, 849 job tags, every source URL. Free, no key, no signup. Baked 2026-09-07.
...
|---|---|---|
| [data/directory.json](data/directory.json) | 5,182,577 | Every entry with every field, the 15 category blocks, the closed 56 job vocabulary with its per job counts, the duplicate groups, and the counts block the whole site renders from. |
...
- **Reconciled against tools_recount.py Network calls during the build 0 Content sha256**: 2af6b4f072f57f090746f147...
