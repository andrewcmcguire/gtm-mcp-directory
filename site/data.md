...
> The whole GTM MCP Directory as JSON: 293 entries, 156 official MCP servers, 849 job tags, every source URL. Free, no key, no signup. Baked 2026-09-07.
...
|---|---|---|
| [data/directory.json](data/directory.json) | 2,029,348 | Every entry with every field, the 15 category blocks, the closed 56 job vocabulary with its per job counts, the duplicate groups, and the counts block the whole site renders from. |
| [data/build_report.json](data/build_report.json) | 55,685 | The counting authority's report: per file reconciliation, field coverage, every place this build is thin, and the 49 entries the tagging pass flagged for human review. |
...
- **Reconciled against tools_recount.py Network calls during the build 0 Content sha256**: 50067b26b98e696e4e535614...
