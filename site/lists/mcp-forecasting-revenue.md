...
> 3 of the 17 forecasting & revenue tools in The GTM MCP Directory have an MCP server: 3 official and 0 community. The server URL, auth model and access gate for each. Counted 2026-08-25.
