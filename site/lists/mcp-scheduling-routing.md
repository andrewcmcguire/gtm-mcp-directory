...
> 9 of the 19 scheduling & routing tools in The GTM MCP Directory have an MCP server: 5 official and 4 community. The server URL, auth model and access gate for each. Counted 2026-09-20.
