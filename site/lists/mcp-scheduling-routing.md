# Scheduling & Routing tools with MCP servers: 7 of 15, counted

> 7 of the 15 scheduling & routing tools in The GTM MCP Directory have an MCP server: 5 official and 2 community. The server URL, auth model and access gate for each. Counted 2026-09-12.
