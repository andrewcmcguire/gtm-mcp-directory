...
> How the 165 GTM tools with an MCP server authenticate. OAuth, API key, both, or not recorded, with the verbatim auth field on every row. Counted 2026-08-25.
...
- [OAuth or an API key](auth-either.md)**45** of 165 servers
- [Third party platform auth](auth-third-party.md)**4** of 165 servers
- [Auth not recorded](auth-unrecorded.md)**26** of 165 servers
...
- [OAuth or an API key](auth-either.md) - 45 of 165 servers. Both paths are documented. Usually OAuth for a hosted server and a key for the self hosted or legacy endpoint.
...
- [Auth not recorded](auth-unrecorded.md) - 26 of 165 servers. The mcp_auth field on the entry is blank, or says unknown. Published as blank rather than guessed.
