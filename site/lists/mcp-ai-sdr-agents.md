...
> 10 of the 23 ai sdrs tools in The GTM MCP Directory have an MCP server: 7 official and 3 community. The server URL, auth model and access gate for each. Counted 2026-09-07.
