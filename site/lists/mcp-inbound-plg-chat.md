# Inbound & PLG Chat tools with MCP servers: 13 of 40, counted

> 13 of the 40 inbound & plg chat tools in The GTM MCP Directory have an MCP server: 11 official and 2 community. The server URL, auth model and access gate for each. Counted 2026-09-12.
...
front.com | [Official MCP](../mcp/official.md) | [https://mcp.frontapp.com/mcp](https://mcp.frontapp.com/mcp) +1 more | OAuth
...
helpscout.com | [Official MCP](../mcp/official.md) | [https://mcp.helpscout.net/mcp](https://mcp.helpscout.net/mcp) +1 more | OAuth
