# Inbound & PLG Chat tools with MCP servers: 13 of 43, counted

> 13 of the 43 inbound & plg chat tools in The GTM MCP Directory have an MCP server: 11 official and 2 community. The server URL, auth model and access gate for each. Counted 2026-09-12.
