...
> 9 of the 14 proposals & deals tools in The GTM MCP Directory have an MCP server: 7 official and 2 community. The server URL, auth model and access gate for each. Counted 2026-09-04.
