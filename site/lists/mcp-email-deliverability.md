# Email Deliverability tools with MCP servers: 4 of 15, counted

> 4 of the 15 email deliverability tools in The GTM MCP Directory have an MCP server: 4 official and 0 community. The server URL, auth model and access gate for each. Counted 2026-09-12.
