...
> 7 of the 62 enablement & coaching tools in The GTM MCP Directory have an MCP server: 2 official and 5 community. The server URL, auth model and access gate for each. Counted 2026-09-18.
