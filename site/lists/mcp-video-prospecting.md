...
> 9 of the 14 video prospecting tools in The GTM MCP Directory have an MCP server: 3 official and 6 community. The server URL, auth model and access gate for each. Counted 2026-08-25.
