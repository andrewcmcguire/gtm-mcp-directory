...
quoted from [https://www.chatbase.co/docs/cli/overview](https://www.chatbase.co/docs/cli/overview) on 2026-09-26, via npx
...
- [npm: chatbase 0.8.0](https://www.npmjs.com/package/chatbase)
