# Say Ur Intent MCP: MCP server status, API access gate and what it does

> Local-first MCP toolkit for Sui DeFi intents: turn a natural-language ask into verified on-chain evidence and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/stelis-dev/say-ur-intent](https://github.com/stelis-dev/say-ur-intent) · entry id 05-say-ur-intent-mcp · source 05-signals-intent-abm.md line 1702
...
https://github.com/stelis-dev/say-ur-intent

- [https://github.com/stelis-dev/say-ur-intent](https://github.com/stelis-dev/say-ur-intent)
