# OneSignal: MCP server status, API access gate and what it does

> The world's leader for mobile push notifications, web push, SMS, email and in-app messaging. Trusted by 2... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [onesignal.com](https://onesignal.com) · entry id 02-onesignal · source 02-engagement-outbound.md line 1937
...
No GitHub organisation could be tied to onesignal.com with evidence on 2026-09-15.
...
- [https://onesignal.com/llms.txt](https://onesignal.com/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://onesignal.com, https://onesignal.com/llms.txt, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://onesignal.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from signals-intent-abm to engagement-outbound.

**Provenance**

- **Entry id**: 02-onesignal
