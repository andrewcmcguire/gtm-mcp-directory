# Sendblue: MCP server status, API access gate and what it does

> Send iMessage, SMS, and RCS from your CRM or via REST API. 2-3x higher response rates than SMS. No A2P... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [sendblue.com](https://sendblue.com) · entry id 02-sendblue · source 02-engagement-outbound.md line 741

**What it does**
Send iMessage, SMS, and RCS from your CRM or via REST API. 2-3x higher response rates than SMS. No A2P registration. SOC 2 certified. Used by 20,000+ businesses.
...
quoted from [https://www.sendblue.com/api](https://www.sendblue.com/api) on 2026-09-17, via npm
...
[https://www.sendblue.com/api](https://www.sendblue.com/api)
...
No GitHub organisation could be tied to sendblue.com with evidence on 2026-09-15.
...
- [https://www.sendblue.com](https://www.sendblue.com)
- [https://www.sendblue.com/api](https://www.sendblue.com/api)
- [https://www.sendblue.com/llms.txt](https://www.sendblue.com/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://www.sendblue.com, https://www.sendblue.com/api, https://www.sendblue.com/llms.txt, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
API mentioned on https://www.sendblue.com/api; pricing/gate not inferred from presence alone. API mentioned on https://www.sendblue.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to engagement-outbound.

**Provenance**

- **Entry id**: 02-sendblue
