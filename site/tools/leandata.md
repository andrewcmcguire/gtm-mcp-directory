...
> GTM lead-routing/orchestration platform for Salesforce-centric revenue teams - routes leads, signals, and... MCP unknown, Enterprise only. Checked 2026-08-24.
...
https://leandata.com, https://leandata.com/platform/pricing/, https://docs.leandata.com

**Notes, verbatim from the file**
LeanData's own homepage references a "BookIt MCP (Model Context Protocol server)" tied to a "Q2 2026 release," but no dedicated MCP docs page, repo, or endpoint could be located - docs.leandata.com search returned nothing and leandata.com/platform/bookit/ 404'd. This is a real, sourced mention of an MCP claim without a verifiable URL, so per this directory's law (an MCP claim requires a URL) it is recorded as mcp_status: unknown rather than official - worth a manual re-check once LeanData's Q2 2026 release material is more discoverable.
