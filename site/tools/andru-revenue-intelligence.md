# Andru Revenue Intelligence: MCP server status, API access gate and what it does

> Revenue intelligence for SaaS founders: ICP scoring, persona profiling, competitive positioning. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [andru.ai](https://andru.ai) · entry id 12-andru-revenue-intelligence · source 12-forecasting-revenue.md line 644
...
https://github.com/geter-andru/mcp-server-andru-intelligence.git

- [https://github.com/geter-andru/mcp-server-andru-intelligence.git](https://github.com/geter-andru/mcp-server-andru-intelligence.git)
...
- [https://andru.ai](https://andru.ai)
- [https://github.com/geter-andru/mcp-server-andru-intelligence.git](https://github.com/geter-andru/mcp-server-andru-intelligence.git)

2 source URLs. Raw sources field, verbatim:

https://andru.ai, https://github.com/geter-andru/mcp-server-andru-intelligence.git
...
- **Entry id**: 12-andru-revenue-intelligence
