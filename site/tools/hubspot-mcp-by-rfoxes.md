# HubSpot MCP by rfoxes: MCP server status, API access gate and what it does

> An MCP (Model Context Protocol) server implementation that integrates Claude with HubSpot. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.npmjs.com/package/@rfoxes/mcp-server-hubspot](https://www.npmjs.com/package/@rfoxes/mcp-server-hubspot) · entry id 07-hubspot-mcp-by-rfoxes · source 07-mcp-infrastructure.md line 1562
