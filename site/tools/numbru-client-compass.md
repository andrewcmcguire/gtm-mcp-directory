# numbrU Client Compass: MCP server status, API access gate and what it does

> Type a name. Get a brief on how someone is wired - what they need, how they decide, how to show up. For the... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [numbru.com](https://numbru.com) · entry id 06-numbru-client-compass · source 06-revops-infra.md line 2169

**What it does**
Type a name. Get a brief on how someone is wired - what they need, how they decide, how to show up. For the moments that decide. $5 per compass, $8.99/mo unlimited.
...
[https://numbru.com/docs](https://numbru.com/docs)
...
No GitHub organisation could be tied to numbru.com with evidence on 2026-09-15.
...
- [https://numbru.com/](https://numbru.com/)
- [https://numbru.com/docs](https://numbru.com/docs)
- [https://numbru.com/developers](https://numbru.com/developers)
- [https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm)

4 source URLs. Raw sources field, verbatim:

https://numbru.com/, https://numbru.com/docs, https://numbru.com/developers, https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm

**Notes, verbatim from the file**
mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name numbrU Client Compass (draft listed as numbrU - Client Compass).

**Provenance**

- **Entry id**: 06-numbru-client-compass
