# COACH: MCP server status, API access gate and what it does

> AI Coach gives every field sales rep personalized coaching after every meeting, helps managers prioritize... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [getcoach.com](https://getcoach.com) · entry id 11-coach · source 11-enablement-coaching.md line 440

**What it does**
AI Coach gives every field sales rep personalized coaching after every meeting, helps managers prioritize coaching opportunities, and turns customer conversations into actionable sales intelligence.
...
quoted from [https://www.npmjs.com/package/@robinthues/rt-claude-coach](https://www.npmjs.com/package/@robinthues/rt-claude-coach) on 2026-09-15, via npm, a third party source

```
pip install coach-cli
```

quoted from [https://pypi.org/project/coach-cli/](https://pypi.org/project/coach-cli/) on 2026-09-15, via pypi, a third party source
...
No GitHub organisation could be tied to getcoach.com with evidence on 2026-09-15.
...
- [https://www.getcoach.com/](https://www.getcoach.com/)
...
https://www.getcoach.com/, https://yc-oss.github.io/api/industries/sales.json
