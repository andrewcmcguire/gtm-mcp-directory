# Resquared: MCP server status, API access gate and what it does

> 14M+ verified local businesses, AI-handwritten outreach that learns from every campaign, and a built-in email... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [re2.ai](https://re2.ai) · entry id 02-resquared · source 02-engagement-outbound.md line 1105
...
https://re2.ai/, https://yc-oss.github.io/api/industries/marketing.json
