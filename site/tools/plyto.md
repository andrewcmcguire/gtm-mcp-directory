# Plyto: MCP server status, API access gate and what it does

> Plyto is a CRM powered by an AI agent. Describe what you want and it captures leads, runs ads, closes deals,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://plyto.ai/agent-crm](https://plyto.ai/agent-crm) · entry id 04-plyto · source 04-ai-sdr-agents.md line 1386

**What it does**
Plyto is a CRM powered by an AI agent. Describe what you want and it captures leads, runs ads, closes deals, and ties every dollar to revenue, or run the whole CRM from your own AI (Claude, Cursor, any MCP client). You pay for the platform; AI credits are optional.
...
[https://plyto.ai/developers](https://plyto.ai/developers)
...
No GitHub organisation could be tied to plyto.ai with evidence on 2026-09-15.
...
- [https://plyto.ai/agent-crm](https://plyto.ai/agent-crm)
- [https://plyto.ai/developers](https://plyto.ai/developers)
- [https://plyto.ai/llms.txt](https://plyto.ai/llms.txt)
- [https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm)

4 source URLs. Raw sources field, verbatim:

https://plyto.ai/agent-crm, https://plyto.ai/developers, https://plyto.ai/llms.txt, https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm

**Notes, verbatim from the file**
API mentioned on https://plyto.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12.
