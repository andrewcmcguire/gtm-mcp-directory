# abm.dev: MCP server status, API access gate and what it does

> The account-based marketing API for AI agents: Search, Enrich, and Create across B2B people and companies,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [abm.dev](https://abm.dev) · entry id 05-abm-dev · source 05-signals-intent-abm.md line 1003
...
quoted from [https://abm.dev/docs/cli](https://abm.dev/docs/cli) on 2026-09-26, via npm
...
angles, auth, destinations, enrich, provenance

Where it was documented:

- [https://abm.dev/docs/cli](https://abm.dev/docs/cli) (the page that documented the CLI)
...
[https://abm.dev/docs](https://abm.dev/docs)
...
No GitHub organisation could be tied to abm.dev with evidence on 2026-09-15.
...
- [https://abm.dev](https://abm.dev)
- [https://abm.dev/docs](https://abm.dev/docs)
- [https://abm.dev/llms.txt](https://abm.dev/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales](https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales)

4 source URLs. Raw sources field, verbatim:

https://abm.dev, https://abm.dev/docs, https://abm.dev/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales

**Notes, verbatim from the file**
API mentioned on https://abm.dev/docs; pricing/gate not inferred from presence alone. API mentioned on https://abm.dev/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to signals-intent-abm.
