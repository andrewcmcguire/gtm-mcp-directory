# Kash: MCP server status, API access gate and what it does

> Free POS software for shops & restaurants. Manage sales, inventory and customers in one simple system. Start... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [kash.click](https://kash.click) · entry id 06-kash · source 06-revops-infra.md line 2127
...
No GitHub organisation could be tied to kash.click with evidence on 2026-09-15.
...
- [https://kash.click](https://kash.click)
- [https://kash.click/llms.txt](https://kash.click/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales](https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales)

3 source URLs. Raw sources field, verbatim:

https://kash.click, https://kash.click/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales

**Notes, verbatim from the file**
API mentioned on https://kash.click/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave S 2026-09-12: canonical name Kash (draft listed as Kash - POS, Invoicing, CRM & Webshop).
