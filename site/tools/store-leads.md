# Store Leads: MCP server status, API access gate and what it does

> The most comprehensive list of ecommerce stores including 13,727,714 active stores across 409 platforms... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [storeleads.app](https://storeleads.app) · entry id 01-store-leads · source 01-data-enrichment.md line 1193

**What it does**
The most comprehensive list of ecommerce stores including 13,727,714 active stores across 409 platforms including Shopify, WooCommerce and Square Online.
...
[https://storeleads.app/api](https://storeleads.app/api)
...
No GitHub organisation could be tied to storeleads.app with evidence on 2026-09-15.
...
- [https://storeleads.app/api](https://storeleads.app/api)
- [https://www.clay.com/integrations/data-provider/store-leads](https://www.clay.com/integrations/data-provider/store-leads)

3 source URLs. Raw sources field, verbatim:

https://storeleads.app, https://storeleads.app/api, https://www.clay.com/integrations/data-provider/store-leads

**Notes, verbatim from the file**
API mentioned on https://storeleads.app/api; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 01-store-leads
