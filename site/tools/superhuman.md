# Superhuman: MCP server status, API access gate and what it does

> Superhuman is the AI productivity suite that gives you superpowers everywhere you work. So you can be more... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: superhuman (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [superhuman.com](https://superhuman.com) · entry id 02-superhuman · source 02-engagement-outbound.md line 983
...
```
npm install -g superhuman-cli
```

quoted from [https://www.npmjs.com/package/superhuman-cli](https://www.npmjs.com/package/superhuman-cli) on 2026-09-18, via npm, a third party source

Packages seen, with the version on 2026-09-18:

- [npm: superhuman-cli 0.0.1, third party](https://www.npmjs.com/package/superhuman-cli)
...
[https://superhuman.com/docs](https://superhuman.com/docs)
...
No GitHub organisation could be tied to superhuman.com with evidence on 2026-09-15.
...
- [https://superhuman.com/docs](https://superhuman.com/docs)
- [https://superhuman.com/developers](https://superhuman.com/developers)
- [https://market.zoominfo.com/app/superhuman](https://market.zoominfo.com/app/superhuman)

4 source URLs. Raw sources field, verbatim:

https://superhuman.com/, https://superhuman.com/docs, https://superhuman.com/developers, https://market.zoominfo.com/app/superhuman
