# Positional: MCP server status, API access gate and what it does

> sunbeam is the autonomous SEO agent that runs research, content, and technical fixes end-to-end. Start... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [positional.com](https://positional.com) · entry id 14-positional · source 14-inbound-plg-chat.md line 848
...
- [https://www.sunbeam.ai/](https://www.sunbeam.ai/)
...
https://www.sunbeam.ai/, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from ai-sdr-agents to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-positional
