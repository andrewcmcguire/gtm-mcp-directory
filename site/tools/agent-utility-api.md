# Agent Utility API: MCP server status, API access gate and what it does

> x402 pay-per-call tools: company enrichment, PDF extraction, Amazon/KDP data, YouTube transcripts. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [agent-api-production-169b.up.railway.app](https://agent-api-production-169b.up.railway.app) · entry id 01-agent-utility-api · source 01-data-enrichment.md line 4114
...
https://agent-api-production-169b.up.railway.app

- [https://agent-api-production-169b.up.railway.app](https://agent-api-production-169b.up.railway.app)
