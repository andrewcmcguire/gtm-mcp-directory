# Ranla: MCP server status, API access gate and what it does

> Ranla is a lifecycle and transactional email platform for PLG SaaS. Automations and audiences from product... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [ranla.ai](https://ranla.ai) · entry id 02-ranla · source 02-engagement-outbound.md line 1167

**What it does**
Ranla is a lifecycle and transactional email platform for PLG SaaS. Automations and audiences from product behavior, and a built-in agent that drafts and asks before it sends.
...
quoted from [https://www.npmjs.com/package/ranla-cli](https://www.npmjs.com/package/ranla-cli) on 2026-09-18, via npm

Packages seen, with the version on 2026-09-18:

- [npm: ranla-cli 0.15.5](https://www.npmjs.com/package/ranla-cli)
...
[https://docs.ranla.ai/](https://docs.ranla.ai/)
...
No GitHub organisation could be tied to ranla.ai with evidence on 2026-09-15.
...
- [https://ranla.ai/](https://ranla.ai/)
- [https://docs.ranla.ai/](https://docs.ranla.ai/)
- [https://ranla.ai/llms.txt](https://ranla.ai/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://ranla.ai/, https://docs.ranla.ai/, https://ranla.ai/llms.txt, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://docs.ranla.ai/; pricing/gate not inferred from presence alone. API mentioned on https://ranla.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to engagement-outbound.
