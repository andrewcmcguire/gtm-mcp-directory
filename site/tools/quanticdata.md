# QuanticData: MCP server status, API access gate and what it does

> One web scraping MCP server exposing search, scrape, crawl, map, batch and SEO tools to Claude, Cursor and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://quanticdata.io/mcp](https://quanticdata.io/mcp) · entry id 01-quanticdata · source 01-data-enrichment.md line 4824

**What it does**
One web scraping MCP server exposing search, scrape, crawl, map, batch and SEO tools to Claude, Cursor and any AI agent. Pay per success, $2 free monthly.
...
[https://quanticdata.io/docs/](https://quanticdata.io/docs/)
...
No GitHub organisation could be tied to quanticdata.io with evidence on 2026-09-15.
...
- [https://quanticdata.io/mcp-server/](https://quanticdata.io/mcp-server/)
- [https://quanticdata.io/docs/](https://quanticdata.io/docs/)
- [https://quanticdata.io/llms.txt](https://quanticdata.io/llms.txt)
- [https://registry.smithery.ai/servers?q=enrich](https://registry.smithery.ai/servers?q=enrich)

4 source URLs. Raw sources field, verbatim:

https://quanticdata.io/mcp-server/, https://quanticdata.io/docs/, https://quanticdata.io/llms.txt, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
API mentioned on https://quanticdata.io/docs/; pricing/gate not inferred from presence alone. API mentioned on https://quanticdata.io/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12.

**Provenance**

- **Entry id**: 01-quanticdata
