# ListSignal MCP: MCP server status, API access gate and what it does

> Query 14M+ online businesses by tech stack, revenue, and hiring signals. REST API + MCP server for AI agents.... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [listsignal.com](https://listsignal.com) · entry id 01-listsignal-mcp · source 01-data-enrichment.md line 3219

**What it does**
Query 14M+ online businesses by tech stack, revenue, and hiring signals. REST API + MCP server for AI agents. Free tier: 1,000 lookups/month, no card required.
...
https://github.com/giushansen/listsignal-mcp

- [https://github.com/giushansen/listsignal-mcp](https://github.com/giushansen/listsignal-mcp)
...
[https://listsignal.com/developers](https://listsignal.com/developers)
...
No GitHub organisation could be tied to listsignal.com with evidence on 2026-09-15.
...
- [https://listsignal.com/developers](https://listsignal.com/developers)
- [https://listsignal.com/llms.txt](https://listsignal.com/llms.txt)
- [https://github.com/giushansen/listsignal-mcp](https://github.com/giushansen/listsignal-mcp)

3 source URLs. Raw sources field, verbatim:

https://listsignal.com/developers, https://listsignal.com/llms.txt, https://github.com/giushansen/listsignal-mcp

**Notes, verbatim from the file**
API mentioned on https://listsignal.com/developers; pricing/gate not inferred from presence alone. API mentioned on https://listsignal.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name ListSignal MCP (draft listed as giushansen/listsignal-mcp).

**Provenance**

- **Entry id**: 01-listsignal-mcp
