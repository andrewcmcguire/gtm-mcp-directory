# Quotain: MCP server status, API access gate and what it does

> Quotain turns sales playbooks and real-call evidence into AI buyer simulations, scorecards, and focused... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [quotain.com](https://quotain.com) · entry id 11-quotain · source 11-enablement-coaching.md line 378

**What it does**
Quotain turns sales playbooks and real-call evidence into AI buyer simulations, scorecards, and focused practice for revenue teams.
...
No GitHub organisation could be tied to quotain.com with evidence on 2026-09-15.
...
- [https://www.quotain.com/](https://www.quotain.com/)
- [https://www.quotain.com/llms.txt](https://www.quotain.com/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

3 source URLs. Raw sources field, verbatim:

https://www.quotain.com/, https://www.quotain.com/llms.txt, https://yc-oss.github.io/api/industries/sales.json
