# Semrush: MCP server status, API access gate and what it does

> Semrush is the leading platform to grow and measure brand visibility across AI search, SEO, PPC, social, and... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: semrush-cli (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [semrush.com](https://semrush.com) · entry id 05-semrush · source 05-signals-intent-abm.md line 923
...
quoted from [https://pypi.org/project/semrush-cli/](https://pypi.org/project/semrush-cli/) on 2026-09-18, via pypi, a third party source

Packages seen, with the version on 2026-09-18:

- [pypi: semrush-cli 1.0.1, third party](https://pypi.org/project/semrush-cli/)
- [pypi: semrush-cli 1.0.1, third party](https://pypi.org/project/semrush-cli/)
...
No GitHub organisation could be tied to semrush.com with evidence on 2026-09-15.
...
- [https://www.semrush.com/llms.txt](https://www.semrush.com/llms.txt)
- [https://www.semrush.com/mcp/](https://www.semrush.com/mcp/)
- [https://www.clay.com/integrations/data-provider/semrush](https://www.clay.com/integrations/data-provider/semrush)

4 source URLs. Raw sources field, verbatim:

https://www.semrush.com, https://www.semrush.com/llms.txt, https://www.semrush.com/mcp/, https://www.clay.com/integrations/data-provider/semrush
