# ATLASS OS: MCP server status, API access gate and what it does

> 195 working MCP tools as of September 7, 2026 - CRM, scheduling, banking, payables, payroll and real... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://app.atlass-os.com/mcp](https://app.atlass-os.com/mcp) · entry id 06-atlass-os · source 06-revops-infra.md line 1981
...
- [https://app.atlass-os.com/mcp](https://app.atlass-os.com/mcp)
...
- [https://app.atlass-os.com/mcp](https://app.atlass-os.com/mcp)
- [https://app.atlass-os.com/llms.txt](https://app.atlass-os.com/llms.txt)

2 source URLs. Raw sources field, verbatim:

https://app.atlass-os.com/mcp, https://app.atlass-os.com/llms.txt

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave P 2026-09-12.

**Provenance**

- **Entry id**: 06-atlass-os
