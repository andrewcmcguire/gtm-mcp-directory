# CompCode MCP: MCP server status, API access gate and what it does

> The first commission platform where plans are created, modified, and versioned via API. Statements your team... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [compcode.ai](https://compcode.ai) · entry id 12-compcode-mcp · source 12-forecasting-revenue.md line 452

**What it does**
The first commission platform where plans are created, modified, and versioned via API. Statements your team trusts. Plan changes in minutes, not weeks.
...
https://github.com/compcode-ai/mcp

- [https://github.com/compcode-ai/mcp](https://github.com/compcode-ai/mcp)
...
[https://compcode.ai/docs](https://compcode.ai/docs)
...
No GitHub organisation could be tied to compcode.ai with evidence on 2026-09-15.
...
- [https://compcode.ai](https://compcode.ai)
- [https://compcode.ai/docs](https://compcode.ai/docs)
- [https://compcode.ai/llms.txt](https://compcode.ai/llms.txt)
- [https://github.com/compcode-ai/mcp](https://github.com/compcode-ai/mcp)

4 source URLs. Raw sources field, verbatim:

https://compcode.ai, https://compcode.ai/docs, https://compcode.ai/llms.txt, https://github.com/compcode-ai/mcp

**Notes, verbatim from the file**
API mentioned on https://compcode.ai/docs; pricing/gate not inferred from presence alone. API mentioned on https://compcode.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave N 2026-09-12: canonical name CompCode MCP (draft listed as compcode-ai/mcp). Category corrected from mcp-infrastructure to forecasting-revenue.

**Provenance**

- **Entry id**: 12-compcode-mcp
