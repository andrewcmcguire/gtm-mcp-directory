# GetCrux: MCP server status, API access gate and what it does

> A self-improving system for performance creatives. Crux connects ad data, competitor insight and your brand... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [getcrux.ai](https://getcrux.ai) · entry id 11-getcrux · source 11-enablement-coaching.md line 1038

**What it does**
A self-improving system for performance creatives. Crux connects ad data, competitor insight and your brand kit to go from insight to creative in minutes.
...
No GitHub organisation could be tied to getcrux.ai with evidence on 2026-09-15.
...
- [https://getcrux.ai/](https://getcrux.ai/)
...
https://getcrux.ai/, https://yc-oss.github.io/api/tags/marketing.json
