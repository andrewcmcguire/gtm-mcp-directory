# Bavlio: MCP server status, API access gate and what it does

> Bavlio is an AI-powered sales outreach platform that researches every lead and writes personalized cold email... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [bavlio.com](https://bavlio.com) · entry id 02-bavlio · source 02-engagement-outbound.md line 2487
...
https://github.com/Bavlio/bavlio-mcp

- [https://github.com/Bavlio/bavlio-mcp](https://github.com/Bavlio/bavlio-mcp)
...
[https://bavlio.com/docs/introduction](https://bavlio.com/docs/introduction)
...
No GitHub organisation could be tied to bavlio.com with evidence on 2026-09-15.
...
- [https://bavlio.com](https://bavlio.com)
- [https://bavlio.com/docs/introduction](https://bavlio.com/docs/introduction)
- [https://bavlio.com/llms.txt](https://bavlio.com/llms.txt)
- [https://github.com/Bavlio/bavlio-mcp](https://github.com/Bavlio/bavlio-mcp)

4 source URLs. Raw sources field, verbatim:

https://bavlio.com, https://bavlio.com/docs/introduction, https://bavlio.com/llms.txt, https://github.com/Bavlio/bavlio-mcp

**Notes, verbatim from the file**
API mentioned on https://bavlio.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name Bavlio (draft listed as Bavlio/bavlio-mcp). Category corrected from data-enrichment to engagement-outbound.
