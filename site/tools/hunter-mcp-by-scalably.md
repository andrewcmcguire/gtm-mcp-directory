# Hunter MCP by scalably: MCP server status, API access gate and what it does

> Hunter.io MCP: domain search, email finder and verifier, enrichment, discovery, leads. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://scalably.io/mcp/hunter-mcp](https://scalably.io/mcp/hunter-mcp) · entry id 01-hunter-mcp-by-scalably · source 01-data-enrichment.md line 3139

**What it does**
Hunter.io MCP: domain search, email finder and verifier, enrichment, discovery, leads.
...
https://github.com/scalably-io/hunter-mcp

- [https://github.com/scalably-io/hunter-mcp](https://github.com/scalably-io/hunter-mcp)
...
No GitHub organisation could be tied to scalably.io with evidence on 2026-09-15.
...
- [https://scalably.io/mcp/hunter-mcp](https://scalably.io/mcp/hunter-mcp)
- [https://scalably.io/llms.txt](https://scalably.io/llms.txt)
- [https://scalably.io/mcp/](https://scalably.io/mcp/)
- [https://github.com/scalably-io/hunter-mcp](https://github.com/scalably-io/hunter-mcp)

4 source URLs. Raw sources field, verbatim:

https://scalably.io/mcp/hunter-mcp, https://scalably.io/llms.txt, https://scalably.io/mcp/, https://github.com/scalably-io/hunter-mcp

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name Hunter MCP by scalably (draft listed as scalably-io/hunter-mcp).

**Provenance**

- **Entry id**: 01-hunter-mcp-by-scalably
