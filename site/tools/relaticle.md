# Relaticle: MCP server status, API access gate and what it does

> Open-source CRM your AI agents can write to: 32 MCP tools for companies, people, deals, and tasks. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [mcp.relaticle.com](https://mcp.relaticle.com) · entry id 07-relaticle · source 07-mcp-infrastructure.md line 5292

**What it does**
Open-source CRM your AI agents can write to: 32 MCP tools for companies, people, deals, and tasks.
...
- [https://mcp.relaticle.com](https://mcp.relaticle.com)
...
No GitHub organisation could be tied to mcp.relaticle.com with evidence on 2026-09-15.
...
- [https://relaticle.com/developers](https://relaticle.com/developers)
- [https://mcp.relaticle.com](https://mcp.relaticle.com)

2 source URLs. Raw sources field, verbatim:

https://relaticle.com/developers, https://mcp.relaticle.com

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 405); what_it_does used staging desc. API mentioned on https://relaticle.com/developers; pricing/gate not inferred from presence alone. API mentioned on https://relaticle.com/developers; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12.

**Provenance**

- **Entry id**: 07-relaticle
