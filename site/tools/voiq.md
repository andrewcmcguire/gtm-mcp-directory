# VOIQ: MCP server status, API access gate and what it does

> Conversational AI VoiceBots for Business No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [voiq.com](https://voiq.com) · entry id 03-voiq · source 03-conversation-intel.md line 871

**What it does**
Conversational AI VoiceBots for Business
...
[http://voiq.com/docs](http://voiq.com/docs)
...
No GitHub organisation could be tied to voiq.com with evidence on 2026-09-15.
...
- [http://voiq.com](http://voiq.com)
- [http://voiq.com/docs](http://voiq.com/docs)
- [http://voiq.com/developers](http://voiq.com/developers)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

http://voiq.com, http://voiq.com/docs, http://voiq.com/developers, https://yc-oss.github.io/api/industries/sales.json
