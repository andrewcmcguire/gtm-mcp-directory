...
quoted from [https://resend.com/docs/cli](https://resend.com/docs/cli) on 2026-09-26, via brew

```
curl -fsSL https://resend.com/install.sh | bash
```

quoted from [https://resend.com/docs/cli](https://resend.com/docs/cli) on 2026-09-26, via shell
...
- [npm: resend-cli 2.22.0, third party](https://www.npmjs.com/package/resend-cli)
- [pypi: resend 2.48.0, third party](https://pypi.org/project/resend/)
