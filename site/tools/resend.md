...
quoted from [https://resend.com/docs/cli](https://resend.com/docs/cli) on 2026-09-17, via brew

```
curl -fsSL https://resend.com/install.sh | bash
```

quoted from [https://resend.com/docs/cli](https://resend.com/docs/cli) on 2026-09-17, via shell
...
- [pypi: resend 2.46.0, third party](https://pypi.org/project/resend/)
