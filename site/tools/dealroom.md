# Dealroom: MCP server status, API access gate and what it does

> The global intelligence platform for startup ecosystems. Discover promising startups, track funding rounds,... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: ax-dealroom (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [dealroom.co](https://dealroom.co) · entry id 01-dealroom · source 01-data-enrichment.md line 971

**What it does**
The global intelligence platform for startup ecosystems. Discover promising startups, track funding rounds, and map tech ecosystems globally.
...
quoted from [https://www.npmjs.com/package/ax-dealroom](https://www.npmjs.com/package/ax-dealroom) on 2026-09-26, via npm, a third party source
...
[https://dealroom.co/docs](https://dealroom.co/docs)
...
No GitHub organisation could be tied to dealroom.co with evidence on 2026-09-15.
...
- [https://dealroom.co/docs](https://dealroom.co/docs)
- [https://dealroom.co/developers](https://dealroom.co/developers)
- [https://www.clay.com/integrations/data-provider/dealroom](https://www.clay.com/integrations/data-provider/dealroom)

4 source URLs. Raw sources field, verbatim:

https://dealroom.co, https://dealroom.co/docs, https://dealroom.co/developers, https://www.clay.com/integrations/data-provider/dealroom

**Notes, verbatim from the file**
api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. cli_status=not-checked; no cheap package name probe applicable

**Provenance**

- **Entry id**: 01-dealroom
