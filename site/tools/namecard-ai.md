# Namecard.ai: MCP server status, API access gate and what it does

> Find and connect with 1M+ professionals through warm introductions. 60% response rate. Get matched in 3 days.... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [namecard.ai](https://namecard.ai) · entry id 01-namecard-ai · source 01-data-enrichment.md line 2573

**What it does**
Find and connect with 1M+ professionals through warm introductions. 60% response rate. Get matched in 3 days. AI-powered networking for B2B, partnerships, and conferences.
...
[https://namecard.ai/docs](https://namecard.ai/docs)
...
No GitHub organisation could be tied to namecard.ai with evidence on 2026-09-15.
...
- [https://namecard.ai/](https://namecard.ai/)
- [https://namecard.ai/docs](https://namecard.ai/docs)
- [https://namecard.ai/developers](https://namecard.ai/developers)
- [https://yc-oss.github.io/api/tags/sales.json](https://yc-oss.github.io/api/tags/sales.json)

4 source URLs. Raw sources field, verbatim:

https://namecard.ai/, https://namecard.ai/docs, https://namecard.ai/developers, https://yc-oss.github.io/api/tags/sales.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from enablement-coaching to data-enrichment.

**Provenance**

- **Entry id**: 01-namecard-ai
