# Mailchimp: MCP server status, API access gate and what it does

> Utilize real-time user behavior data and artificial intelligence to convert more customers. Easy to use, get... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: mailchimp (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [mailchimp.com](https://mailchimp.com) · entry id 02-mailchimp · source 02-engagement-outbound.md line 639
...
quoted from [https://pypi.org/project/mailchimp/](https://pypi.org/project/mailchimp/) on 2026-09-18, via pypi, a third party source

Packages seen, with the version on 2026-09-18:

- [pypi: mailchimp 2.0.10, third party](https://pypi.org/project/mailchimp/)
...
[https://mailchimp.com/developer/](https://mailchimp.com/developer/)
...
No GitHub organisation could be tied to mailchimp.com with evidence on 2026-09-15.
...
- [https://mailchimp.com/developer/](https://mailchimp.com/developer/)
- [https://mailchimp.com/llms.txt](https://mailchimp.com/llms.txt)
...
https://mailchimp.com, https://mailchimp.com/developer/, https://mailchimp.com/llms.txt, https://ecosystem.hubspot.com/marketplace/explore/products?eco_PRODUCT_TYPE=APP

**Notes, verbatim from the file**
API mentioned on https://mailchimp.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave A 2026-09-12: canonical name Mailchimp (draft listed as Mailchimp Campaign Sync). Category corrected from video-prospecting to engagement-outbound.

**Provenance**

- **Entry id**: 02-mailchimp
