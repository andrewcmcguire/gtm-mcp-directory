# Studiomeyer CRM: MCP server status, API access gate and what it does

> AI-native CRM with 37 MCP tools. Companies, deals, pipeline, leads, follow-ups, managed by AI. Connect in 30... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [studiomeyer.io](https://studiomeyer.io) · entry id 07-studiomeyer-crm · source 07-mcp-infrastructure.md line 1846

**What it does**
AI-native CRM with 37 MCP tools. Companies, deals, pipeline, leads, follow-ups, managed by AI. Connect in 30 seconds.
...
https://github.com/studiomeyer-io/studiomeyer-crm

- [https://github.com/studiomeyer-io/studiomeyer-crm](https://github.com/studiomeyer-io/studiomeyer-crm)
...
quoted from [https://www.npmjs.com/package/@studiomeyer-io/agent-fleet](https://www.npmjs.com/package/@studiomeyer-io/agent-fleet) on 2026-09-15, via npm

Packages seen, with the version on 2026-09-15:

- [npm: @studiomeyer-io/agent-fleet 0.3.0](https://www.npmjs.com/package/@studiomeyer-io/agent-fleet)
...
[https://studiomeyer.io/de/docs](https://studiomeyer.io/de/docs)
...
No GitHub organisation could be tied to studiomeyer.io with evidence on 2026-09-15.
...
- [https://studiomeyer.io/en/services/crm](https://studiomeyer.io/en/services/crm)
- [https://studiomeyer.io/de/docs](https://studiomeyer.io/de/docs)
- [https://studiomeyer.io/de/developers](https://studiomeyer.io/de/developers)
- [https://github.com/studiomeyer-io/studiomeyer-crm](https://github.com/studiomeyer-io/studiomeyer-crm)

4 source URLs. Raw sources field, verbatim:

https://studiomeyer.io/en/services/crm, https://studiomeyer.io/de/docs, https://studiomeyer.io/de/developers, https://github.com/studiomeyer-io/studiomeyer-crm

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave H 2026-09-12: canonical name Studiomeyer CRM (draft listed as studiomeyer-io/studiomeyer-crm).

**Provenance**

- **Entry id**: 07-studiomeyer-crm
