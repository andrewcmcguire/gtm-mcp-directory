# Kanava AI: MCP server status, API access gate and what it does

> Lovable Generated Project No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [kanava.ai](https://kanava.ai) · entry id 04-kanava-ai · source 04-ai-sdr-agents.md line 1052
...
[https://kanava.ai/docs](https://kanava.ai/docs)
...
No GitHub organisation could be tied to kanava.ai with evidence on 2026-09-15.
...
- [https://kanava.ai/](https://kanava.ai/)
- [https://kanava.ai/docs](https://kanava.ai/docs)
- [https://kanava.ai/developers](https://kanava.ai/developers)
- [https://yc-oss.github.io/api/tags/sales.json](https://yc-oss.github.io/api/tags/sales.json)

4 source URLs. Raw sources field, verbatim:

https://kanava.ai/, https://kanava.ai/docs, https://kanava.ai/developers, https://yc-oss.github.io/api/tags/sales.json

**Notes, verbatim from the file**
API mentioned on https://kanava.ai/docs; pricing/gate not inferred from presence alone. API mentioned on https://kanava.ai/developers; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from revops-infra to ai-sdr-agents.

**Provenance**

- **Entry id**: 04-kanava-ai
