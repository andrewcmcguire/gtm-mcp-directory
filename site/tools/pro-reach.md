# Pro Reach: MCP server status, API access gate and what it does

> Plan and run LinkedIn outreach: templates, leads, confirmation-gated launch, metrics, replies. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://proreach.ai/api/mcp](https://proreach.ai/api/mcp) · entry id 02-pro-reach · source 02-engagement-outbound.md line 3350
...
- [https://proreach.ai/api/mcp](https://proreach.ai/api/mcp)
...
No GitHub organisation could be tied to proreach.ai with evidence on 2026-09-15.
...
- [https://proreach.ai/llms.txt](https://proreach.ai/llms.txt)
- [https://proreach.ai/mcp](https://proreach.ai/mcp)
- [https://proreach.ai/api/mcp](https://proreach.ai/api/mcp)

3 source URLs. Raw sources field, verbatim:

https://proreach.ai/llms.txt, https://proreach.ai/mcp, https://proreach.ai/api/mcp

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 401); what_it_does used staging desc. API mentioned on https://proreach.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12: canonical name Pro Reach (draft listed as Pro Reach LinkedIn Outreach).

**Provenance**

- **Entry id**: 02-pro-reach
