# Parse Brand Visibility MCP: MCP server status, API access gate and what it does

> Look up how any brand surfaces in ChatGPT and Google AI Overviews. The Parse public dataset, served as an MCP... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://parse.gl/mcp](https://parse.gl/mcp) · entry id 05-parse-brand-visibility-mcp · source 05-signals-intent-abm.md line 1908
