# MuntuAI MCP: MCP server status, API access gate and what it does

> Hosted MCP server for MuntuAI outreach campaigns, leads, senders, domains, and analytics. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://api.muntuai.com/api/mcp](https://api.muntuai.com/api/mcp) · entry id 02-muntuai-mcp · source 02-engagement-outbound.md line 3148
...
https://github.com/design-smith/MuntuAI-MCP

- [https://github.com/design-smith/MuntuAI-MCP](https://github.com/design-smith/MuntuAI-MCP)
...
No GitHub organisation could be tied to api.muntuai.com with evidence on 2026-09-15.
...
Homepage fetch failed (URLError: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: Hostname mismatch, certificate is not valid for 'api.muntuai.com'. (_ssl.c:1010)>); what_it_does used staging desc. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name MuntuAI MCP (draft listed as MuntuAI).

**Provenance**

- **Entry id**: 02-muntuai-mcp
