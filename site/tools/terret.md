...
5 candidate accounts seen and rejected by the evidence rules: terret-org, Terreth, terreta-dev, TERRETA-CORE-SHIRTS, Terretech-Apps. A name match alone is never accepted; the account has to point at the vendor domain.
