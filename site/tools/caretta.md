# Caretta: MCP server status, API access gate and what it does

> Realtime AI for sales calls that helps reps answer hard questions, handle objections, and stay sharp before,... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: caretta (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [caretta.so](https://caretta.so) · entry id 03-caretta · source 03-conversation-intel.md line 599
...
quoted from [https://pypi.org/project/caretta/](https://pypi.org/project/caretta/) on 2026-09-15, via pypi, a third party source

Packages seen, with the version on 2026-09-15:

- [pypi: caretta 0.1.2, third party](https://pypi.org/project/caretta/)
...
[https://www.caretta.so/docs](https://www.caretta.so/docs)
...
No GitHub organisation could be tied to caretta.so with evidence on 2026-09-15.
...
- [https://www.caretta.so](https://www.caretta.so)
- [https://www.caretta.so/docs](https://www.caretta.so/docs)
- [https://www.caretta.so/llms.txt](https://www.caretta.so/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://www.caretta.so, https://www.caretta.so/docs, https://www.caretta.so/llms.txt, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
API mentioned on https://www.caretta.so/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to conversation-intel.
