# Salesforce MCP Lib by Damecek: MCP server status, API access gate and what it does

> Salesforce MCP Library is a local stdio bridge for Salesforce MCP endpoints using OAuth client credentials,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://context7.com/damecek/salesforce-mcp-lib](https://context7.com/damecek/salesforce-mcp-lib) · entry id 07-salesforce-mcp-lib-by-damecek · source 07-mcp-infrastructure.md line 654

**What it does**
Salesforce MCP Library is a local stdio bridge for Salesforce MCP endpoints using OAuth client credentials, featuring a reusable Apex MCP library and JSON-RPC 2.0 core. - Latest version
...
- [https://github.com/Damecek/salesforce-mcp-lib](https://github.com/Damecek/salesforce-mcp-lib)
...
quoted from [https://context7.com/cli](https://context7.com/cli) on 2026-09-18, via npx
...
- [https://context7.com/cli](https://context7.com/cli) (the page that documented the CLI)
...
[https://context7.com/docs/overview](https://context7.com/docs/overview)
...
No GitHub organisation could be tied to context7.com with evidence on 2026-09-15.
...
- [https://context7.com/damecek/salesforce-mcp-lib](https://context7.com/damecek/salesforce-mcp-lib)
- [https://context7.com/docs/overview](https://context7.com/docs/overview)
- [https://context7.com/developers](https://context7.com/developers)
- [https://github.com/Damecek/salesforce-mcp-lib](https://github.com/Damecek/salesforce-mcp-lib)

4 source URLs. Raw sources field, verbatim:

https://context7.com/damecek/salesforce-mcp-lib, https://context7.com/docs/overview, https://context7.com/developers, https://github.com/Damecek/salesforce-mcp-lib

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave B 2026-09-12: canonical name Salesforce MCP Lib by Damecek (draft listed as Damecek/salesforce-mcp-lib).

**Provenance**

- **Entry id**: 07-salesforce-mcp-lib-by-damecek
