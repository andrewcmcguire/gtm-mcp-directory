# StrataBook MCP: MCP server status, API access gate and what it does

> MCP - official Strata developer documentation. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://stratabook.org/docs/agent-mcp](https://stratabook.org/docs/agent-mcp) · entry id 07-stratabook-mcp · source 07-mcp-infrastructure.md line 5374

**What it does**
MCP - official Strata developer documentation.
...
[https://stratabook.org/docs/hello-agents](https://stratabook.org/docs/hello-agents)
...
No GitHub organisation could be tied to stratabook.org with evidence on 2026-09-15.
...
- [https://stratabook.org/docs/agent-mcp](https://stratabook.org/docs/agent-mcp)
- [https://stratabook.org/docs/hello-agents](https://stratabook.org/docs/hello-agents)
- [https://stratabook.org/developers](https://stratabook.org/developers)
- [https://www.npmjs.com/search?q=mcp%20intent](https://www.npmjs.com/search?q=mcp%20intent)

4 source URLs. Raw sources field, verbatim:

https://stratabook.org/docs/agent-mcp, https://stratabook.org/docs/hello-agents, https://stratabook.org/developers, https://www.npmjs.com/search?q=mcp%20intent

**Notes, verbatim from the file**
API mentioned on https://stratabook.org/docs/hello-agents; pricing/gate not inferred from presence alone. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave V 2026-09-12: canonical name StrataBook MCP (draft listed as @stratabook/mcp).

**Provenance**

- **Entry id**: 07-stratabook-mcp
