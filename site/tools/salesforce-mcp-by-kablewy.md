# Salesforce MCP by kablewy: MCP server status, API access gate and what it does

> Model Context Protocol server for Salesforce REST API integration - kablewy/salesforce-mcp-server Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/kablewy/salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server) · entry id 07-salesforce-mcp-by-kablewy · source 07-mcp-infrastructure.md line 615
...
- [https://github.com/kablewy/salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)
