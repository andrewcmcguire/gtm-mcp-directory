# Markifact: MCP server status, API access gate and what it does

> Markifact helps marketers use AI agents, workflows, and MCP to create campaigns, analyze performance, and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [markifact.com](https://markifact.com) · entry id 05-markifact · source 05-signals-intent-abm.md line 1786

**What it does**
Markifact helps marketers use AI agents, workflows, and MCP to create campaigns, analyze performance, and automate reporting across Google Ads, Meta Ads, GA4, TikTok Ads, and more.
...
https://registry.smithery.ai/servers?q=salesforce

- [https://registry.smithery.ai/servers?q=salesforce](https://registry.smithery.ai/servers?q=salesforce)
...
No GitHub organisation could be tied to markifact.com with evidence on 2026-09-15.
...
- [https://www.markifact.com/](https://www.markifact.com/)
- [https://www.markifact.com/llms.txt](https://www.markifact.com/llms.txt)
- [https://www.markifact.com/mcp](https://www.markifact.com/mcp)
- [https://registry.smithery.ai/servers?q=salesforce](https://registry.smithery.ai/servers?q=salesforce)

4 source URLs. Raw sources field, verbatim:

https://www.markifact.com/, https://www.markifact.com/llms.txt, https://www.markifact.com/mcp, https://registry.smithery.ai/servers?q=salesforce

**Notes, verbatim from the file**
API mentioned on https://www.markifact.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name Markifact (draft listed as Markifact: AI Performance Marketing).

**Provenance**

- **Entry id**: 05-markifact
