# Yandex Audience MCP: MCP server status, API access gate and what it does

> MCP-сервер для Яндекс Аудиторий - создавать CRM- и LAL-сегменты, управлять пикселями и доступами из... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/A1-x-Tech/mcp-yandex-audience](https://github.com/A1-x-Tech/mcp-yandex-audience) · entry id 05-yandex-audience-mcp · source 05-signals-intent-abm.md line 1952
...
- [https://github.com/A1-x-Tech/mcp-yandex-audience](https://github.com/A1-x-Tech/mcp-yandex-audience)
...
https://github.com/A1-x-Tech/mcp-yandex-audience, https://github.com/docs, https://github.com/developers
...
- **Entry id**: 05-yandex-audience-mcp
