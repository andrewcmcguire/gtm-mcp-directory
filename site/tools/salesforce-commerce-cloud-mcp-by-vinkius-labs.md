# Salesforce Commerce Cloud MCP by vinkius-labs: MCP server status, API access gate and what it does

> Vinkius Edge enterprise Model Context Protocol (MCP) server for Salesforce B2C Commerce Cloud integration. Community MCP, Gate unknown. Checked 2026-09-12.
...
Salesforce Commerce Cloud MCP by vinkius-labs
...
Vendor: [https://vinkius.com/mcp/salesforce-commerce-cloud](https://vinkius.com/mcp/salesforce-commerce-cloud) · entry id 07-salesforce-commerce-cloud-mcp-by-vinkius-labs · source 07-mcp-infrastructure.md line 1582
...
https://github.com/vinkius-labs/salesforce-commerce-mcp

- [https://github.com/vinkius-labs/salesforce-commerce-mcp](https://github.com/vinkius-labs/salesforce-commerce-mcp)
...
- [https://vinkius.com/llms.txt](https://vinkius.com/llms.txt)
- [https://github.com/vinkius-labs/salesforce-commerce-mcp](https://github.com/vinkius-labs/salesforce-commerce-mcp)

2 source URLs. Raw sources field, verbatim:

https://vinkius.com/llms.txt, https://github.com/vinkius-labs/salesforce-commerce-mcp

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 404); what_it_does used staging desc. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave F 2026-09-12: canonical name Salesforce Commerce Cloud MCP by vinkius-labs (draft listed as vinkius-labs/salesforce-commerce-mcp).

**Provenance**

- **Entry id**: 07-salesforce-commerce-cloud-mcp-by-vinkius-labs
