# Prospect: MCP server status, API access gate and what it does

> Find verified emails and mobile numbers for your buyers, right inside your browser. Neuron's contact data... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [tryprospect.com](https://tryprospect.com) · entry id 01-prospect · source 01-data-enrichment.md line 1153
...
- [https://neuron.com/](https://neuron.com/)
- [https://neuron.com/llms.txt](https://neuron.com/llms.txt)
- [https://marketplace.salesloft.com/](https://marketplace.salesloft.com/)

3 source URLs. Raw sources field, verbatim:

https://neuron.com/, https://neuron.com/llms.txt, https://marketplace.salesloft.com/

**Notes, verbatim from the file**
API mentioned on https://neuron.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 01-prospect
