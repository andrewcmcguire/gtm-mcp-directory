# Chameleon: MCP server status, API access gate and what it does

> Chameleon builds context on your product, identifies friction, creates in-app guidance, and monitors... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [chameleon.io](https://chameleon.io) · entry id 14-chameleon · source 14-inbound-plg-chat.md line 680

**What it does**
Chameleon builds context on your product, identifies friction, creates in-app guidance, and monitors outcomes, so your product keeps getting better.
...
[https://help.chameleon.io/en/](https://help.chameleon.io/en/)
...
No GitHub organisation could be tied to chameleon.io with evidence on 2026-09-15.
...
- [https://help.chameleon.io/en/](https://help.chameleon.io/en/)
- [https://developers.chameleon.io/introduction](https://developers.chameleon.io/introduction)
- [https://www.chilipiper.com/integrations/chameleon](https://www.chilipiper.com/integrations/chameleon)

4 source URLs. Raw sources field, verbatim:

https://www.chameleon.io/, https://help.chameleon.io/en/, https://developers.chameleon.io/introduction, https://www.chilipiper.com/integrations/chameleon

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-chameleon
