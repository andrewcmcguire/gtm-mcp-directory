# Salesforce Hosted Custom MCP by Sanket: MCP server status, API access gate and what it does

> Salesforce Hosted Custom MCP Server - MCP Server Definitions, External Service Registrations, and Related... Community MCP, Gate unknown. Checked 2026-09-12.
...
Salesforce Hosted Custom MCP by Sanket
...
Vendor: [https://github.com/SalesforceDiariesBySanket/Salesforce-Hosted-Custom-Mcp-Server](https://github.com/SalesforceDiariesBySanket/Salesforce-Hosted-Custom-Mcp-Server) · entry id 07-salesforce-hosted-custom-mcp-by-sanket · source 07-mcp-infrastructure.md line 1522
...
https://github.com/SalesforceDiariesBySanket/Salesforce-Hosted-Custom-Mcp-Server

- [https://github.com/SalesforceDiariesBySanket/Salesforce-Hosted-Custom-Mcp-Server](https://github.com/SalesforceDiariesBySanket/Salesforce-Hosted-Custom-Mcp-Server)
...
https://github.com/SalesforceDiariesBySanket/Salesforce-Hosted-Custom-Mcp-Server, https://github.com/docs, https://github.com/developers

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave F 2026-09-12: canonical name Salesforce Hosted Custom MCP by Sanket (draft listed as SalesforceDiariesBySanket/Salesforce-Hosted-Custom-Mcp-Server).

**Provenance**

- **Entry id**: 07-salesforce-hosted-custom-mcp-by-sanket
