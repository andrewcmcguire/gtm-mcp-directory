# Echo: MCP server status, API access gate and what it does

> Founder-led sales co-pilot for B2B startups. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [echothat.ai](https://echothat.ai) · entry id 04-echo · source 04-ai-sdr-agents.md line 1072

**What it does**
Founder-led sales co-pilot for B2B startups.
...
[https://www.echothat.ai/docs](https://www.echothat.ai/docs)
...
No GitHub organisation could be tied to echothat.ai with evidence on 2026-09-15.
...
- [https://www.echothat.ai/](https://www.echothat.ai/)
- [https://www.echothat.ai/docs](https://www.echothat.ai/docs)
- [https://www.echothat.ai/developers](https://www.echothat.ai/developers)
- [https://yc-oss.github.io/api/tags/sales.json](https://yc-oss.github.io/api/tags/sales.json)

4 source URLs. Raw sources field, verbatim:

https://www.echothat.ai/, https://www.echothat.ai/docs, https://www.echothat.ai/developers, https://yc-oss.github.io/api/tags/sales.json

**Notes, verbatim from the file**
what_it_does used YC/source one_liner because homepage meta description was empty. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to ai-sdr-agents.
