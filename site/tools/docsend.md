# DocSend: MCP server status, API access gate and what it does

> Secure document sharing and analytics for sales collateral and deal documents (Dropbox DocSend). No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [docsend.com](https://docsend.com) · entry id 13-docsend · source 13-proposals-deals.md line 474
...
Homepage fetch failed or empty: HTTPError 403. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from engagement-outbound to proposals-deals.
