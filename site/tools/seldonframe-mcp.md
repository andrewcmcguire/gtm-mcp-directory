# SeldonFrame MCP: MCP server status, API access gate and what it does

> SeldonFrame is the agent-native, open-source alternative to GoHighLevel for agencies selling AI front offices... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [seldonframe.com](https://seldonframe.com) · entry id 07-seldonframe-mcp · source 07-mcp-infrastructure.md line 4240

**What it does**
SeldonFrame is the agent-native, open-source alternative to GoHighLevel for agencies selling AI front offices to local businesses. Build a branded website, booking flow, CRM, intake, and AI agent for every client from one workspace-then operate it under your agency brand.
...
- [https://github.com/seldonframe/seldonframe](https://github.com/seldonframe/seldonframe)
...
quoted from [https://www.npmjs.com/package/@seldonframe/cli](https://www.npmjs.com/package/@seldonframe/cli) on 2026-09-15, via npm

Packages seen, with the version on 2026-09-15:

- [npm: @seldonframe/cli 0.1.0](https://www.npmjs.com/package/@seldonframe/cli)
...
[https://www.seldonframe.com/docs](https://www.seldonframe.com/docs)
...
No GitHub organisation could be tied to seldonframe.com with evidence on 2026-09-15.
...
- [https://www.seldonframe.com/](https://www.seldonframe.com/)
- [https://www.seldonframe.com/docs](https://www.seldonframe.com/docs)
- [https://www.seldonframe.com/llms.txt](https://www.seldonframe.com/llms.txt)
- [https://github.com/seldonframe/seldonframe](https://github.com/seldonframe/seldonframe)

4 source URLs. Raw sources field, verbatim:

https://www.seldonframe.com/, https://www.seldonframe.com/docs, https://www.seldonframe.com/llms.txt, https://github.com/seldonframe/seldonframe

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name SeldonFrame MCP (draft listed as io.github.seldonframe/seldonframe-mcp).

**Provenance**

- **Entry id**: 07-seldonframe-mcp
