# Leadhound API: MCP server status, API access gate and what it does

> leadhoundapi reads a city Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [leadhoundapi.com](https://leadhoundapi.com) · entry id 01-leadhound-api · source 01-data-enrichment.md line 2633

**What it does**
leadhoundapi reads a city
...
https://leadhoundapi.com

- [https://leadhoundapi.com](https://leadhoundapi.com)
...
No GitHub organisation could be tied to leadhoundapi.com with evidence on 2026-09-15.
...
- [https://leadhoundapi.com](https://leadhoundapi.com)
- [https://leadhoundapi.com/llms.txt](https://leadhoundapi.com/llms.txt)
- [https://leadhoundapi.com/mcp](https://leadhoundapi.com/mcp)

3 source URLs. Raw sources field, verbatim:

https://leadhoundapi.com, https://leadhoundapi.com/llms.txt, https://leadhoundapi.com/mcp

**Notes, verbatim from the file**
API mentioned on https://leadhoundapi.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from mcp-infrastructure to data-enrichment.

**Provenance**

- **Entry id**: 01-leadhound-api
