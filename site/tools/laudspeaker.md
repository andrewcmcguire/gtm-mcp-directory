# Laudspeaker: MCP server status, API access gate and what it does

> Open source mobile marketing platform; alternative to Appcues-style product messaging. No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: clickhouse-migrations

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [laudspeaker.com](https://laudspeaker.com) · entry id 14-laudspeaker · source 14-inbound-plg-chat.md line 888
...
quoted from [https://www.npmjs.com/package/@laudspeaker/clickhouse-migrations](https://www.npmjs.com/package/@laudspeaker/clickhouse-migrations) on 2026-09-17, via npm
...
Homepage fetch failed (URLError: <urlopen error timed out>); what_it_does used YC/source one_liner. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from revops-infra to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-laudspeaker
