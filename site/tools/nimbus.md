# Nimbus: MCP server status, API access gate and what it does

> Run real Salesforce Apex locally - no org, no Docker - then ship through the same tool: gated deploys,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [testnimbus.dev](https://testnimbus.dev) · entry id 07-nimbus · source 07-mcp-infrastructure.md line 1018

**What it does**
Run real Salesforce Apex locally - no org, no Docker - then ship through the same tool: gated deploys, Salesforce validation, release receipts. A typical test runs in tens of milliseconds.
...
https://github.com/nimbus-solution/nimbus

- [https://github.com/nimbus-solution/nimbus](https://github.com/nimbus-solution/nimbus)
...
quoted from [https://www.npmjs.com/package/@nimbus-sh/cli](https://www.npmjs.com/package/@nimbus-sh/cli) on 2026-09-15, via npm, a third party source

Packages seen, with the version on 2026-09-15:

- [npm: @nimbus-sh/cli 0.1.8, third party](https://www.npmjs.com/package/@nimbus-sh/cli)
...
[https://testnimbus.dev/docs](https://testnimbus.dev/docs)
...
No GitHub organisation could be tied to testnimbus.dev with evidence on 2026-09-15.
...
- [https://testnimbus.dev](https://testnimbus.dev)
- [https://testnimbus.dev/docs](https://testnimbus.dev/docs)
- [https://testnimbus.dev/llms.txt](https://testnimbus.dev/llms.txt)
- [https://github.com/nimbus-solution/nimbus](https://github.com/nimbus-solution/nimbus)

4 source URLs. Raw sources field, verbatim:

https://testnimbus.dev, https://testnimbus.dev/docs, https://testnimbus.dev/llms.txt, https://github.com/nimbus-solution/nimbus

**Notes, verbatim from the file**
API mentioned on https://testnimbus.dev/docs; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave D 2026-09-12: canonical name Nimbus (draft listed as nimbus-solution/nimbus).
