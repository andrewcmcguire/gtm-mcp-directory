# Xverum: MCP server status, API access gate and what it does

> Plain-English B2B data search across 1B+ records. Describe who or what you Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [ask.xverum.com](https://ask.xverum.com) · entry id 01-xverum · source 01-data-enrichment.md line 2105

**What it does**
Plain-English B2B data search across 1B+ records. Describe who or what you
...
[https://ask.xverum.com/docs/overview](https://ask.xverum.com/docs/overview)
...
No GitHub organisation could be tied to ask.xverum.com with evidence on 2026-09-15.
...
- [https://ask.xverum.com/](https://ask.xverum.com/)
- [https://ask.xverum.com/docs/overview](https://ask.xverum.com/docs/overview)
- [https://ask.xverum.com/developers](https://ask.xverum.com/developers)
- [https://registry.smithery.ai/servers?q=enrich](https://registry.smithery.ai/servers?q=enrich)

4 source URLs. Raw sources field, verbatim:

https://ask.xverum.com/, https://ask.xverum.com/docs/overview, https://ask.xverum.com/developers, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
API mentioned on https://ask.xverum.com/docs/overview; pricing/gate not inferred from presence alone. API mentioned on https://ask.xverum.com/developers; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave H 2026-09-12: canonical name Xverum (draft listed as xverum mcp).
