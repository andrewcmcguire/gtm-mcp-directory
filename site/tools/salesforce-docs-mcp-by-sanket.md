# Salesforce Docs MCP by Sanket: MCP server status, API access gate and what it does

> A local-first MCP server for searching Salesforce Developer Documentation. Search 360+ official Salesforce... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/SalesforceDiariesBySanket/salesforce-docs-mcp](https://github.com/SalesforceDiariesBySanket/salesforce-docs-mcp) · entry id 07-salesforce-docs-mcp-by-sanket · source 07-mcp-infrastructure.md line 757
...
- [https://github.com/SalesforceDiariesBySanket/salesforce-docs-mcp](https://github.com/SalesforceDiariesBySanket/salesforce-docs-mcp)
...
https://github.com/SalesforceDiariesBySanket/salesforce-docs-mcp, https://github.com/docs, https://github.com/developers

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave C 2026-09-12: canonical name Salesforce Docs MCP by Sanket (draft listed as SalesforceDiariesBySanket/salesforce-docs-mcp).

**Provenance**

- **Entry id**: 07-salesforce-docs-mcp-by-sanket
