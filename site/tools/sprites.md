# Sprites: MCP server status, API access gate and what it does

> Sprites runs your ads on autopilot: Google, Meta, LinkedIn, TikTok, Reddit, ChatGPT. Get better ROI and cut... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [sprites.ai](https://sprites.ai) · entry id 02-sprites · source 02-engagement-outbound.md line 1085

**What it does**
Sprites runs your ads on autopilot: Google, Meta, LinkedIn, TikTok, Reddit, ChatGPT. Get better ROI and cut the agency retainer.
...
No GitHub organisation could be tied to sprites.ai with evidence on 2026-09-15.
...
- [https://www.sprites.ai/](https://www.sprites.ai/)
- [https://www.sprites.ai/llms.txt](https://www.sprites.ai/llms.txt)
- [https://www.sprites.ai/mcp](https://www.sprites.ai/mcp)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://www.sprites.ai/, https://www.sprites.ai/llms.txt, https://www.sprites.ai/mcp, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from signals-intent-abm to engagement-outbound.
