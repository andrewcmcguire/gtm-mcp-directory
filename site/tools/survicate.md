# Survicate: MCP server status, API access gate and what it does

> A customer feedback platform that lets you survey every channel, automate feedback flows, and uncover... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [survicate.com](https://survicate.com) · entry id 14-survicate · source 14-inbound-plg-chat.md line 392
...
No GitHub organisation could be tied to survicate.com with evidence on 2026-09-15.
...
- [https://survicate.com/llms.txt](https://survicate.com/llms.txt)
- [https://collective.gong.io/integrations/survicate](https://collective.gong.io/integrations/survicate)

3 source URLs. Raw sources field, verbatim:

https://survicate.com, https://survicate.com/llms.txt, https://collective.gong.io/integrations/survicate

**Notes, verbatim from the file**
api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. cli_status=not-checked; no cheap package name probe applicable Category corrected from conversation-intel to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-survicate
