# Birdie: MCP server status, API access gate and what it does

> AI Copilot for social sellers. Use Birdie's AI to research leads, generate hyper-personalized copy, and... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: butils (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [getbirdie.io](https://getbirdie.io) · entry id 02-birdie · source 02-engagement-outbound.md line 781
...
- [npm: @birdiedata/butils 1.0.0, third party](https://www.npmjs.com/package/@birdiedata/butils)
