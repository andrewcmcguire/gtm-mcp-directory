# Particle: MCP server status, API access gate and what it does

> Real-time news, company, and podcast intelligence APIs for developers - every story, every public company,... Community MCP, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: particle (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [particle.pro](https://particle.pro) · entry id 01-particle · source 01-data-enrichment.md line 4764
...
quoted from [https://www.npmjs.com/package/particle-cli](https://www.npmjs.com/package/particle-cli) on 2026-09-17, via npm, a third party source

Packages seen, with the version on 2026-09-17:

- [npm: particle-cli 3.50.2, third party](https://www.npmjs.com/package/particle-cli)
...
No GitHub organisation could be tied to particle.pro with evidence on 2026-09-15.
...
- [https://particle.pro](https://particle.pro)
- [https://particle.pro/llms.txt](https://particle.pro/llms.txt)
- [https://registry.smithery.ai/servers?q=enrich](https://registry.smithery.ai/servers?q=enrich)

3 source URLs. Raw sources field, verbatim:

https://particle.pro, https://particle.pro/llms.txt, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
API mentioned on https://particle.pro/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12.

**Provenance**

- **Entry id**: 01-particle
