# MCPCloud CLI: MCP server status, API access gate and what it does

> The official CLI for MCPCloud - manage projects, servers, skills, and API keys from the terminal Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [npmjs.com/package/@mcpcloud/cli](https://npmjs.com/package/@mcpcloud/cli) · entry id 07-mcpcloud-cli · source 07-mcp-infrastructure.md line 2974
