# JackTrade CRM: MCP server status, API access gate and what it does

> Search customers, manage quotes, work orders, action items, and calendar events for your business Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://frostsa2.ed1.jacktrade.xyz/api/v2/mcp](https://frostsa2.ed1.jacktrade.xyz/api/v2/mcp) · entry id 07-jacktrade-crm · source 07-mcp-infrastructure.md line 5168
...
https://github.com/devcham/jacktrade

- [https://github.com/devcham/jacktrade](https://github.com/devcham/jacktrade)
...
Homepage fetch failed (HTTPError 500); what_it_does used staging desc. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave S 2026-09-12.

**Provenance**

- **Entry id**: 07-jacktrade-crm
