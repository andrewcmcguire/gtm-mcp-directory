# Cardinal: MCP server status, API access gate and what it does

> Revenue agents for high-growth companies No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: cardinal (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [trycardinal.com](https://trycardinal.com) · entry id 04-cardinal · source 04-ai-sdr-agents.md line 804

**What it does**
Revenue agents for high-growth companies
...
```
npm install -g cardinal-system
```

quoted from [https://www.npmjs.com/package/cardinal-system](https://www.npmjs.com/package/cardinal-system) on 2026-09-15, via npm, a third party source

Packages seen, with the version on 2026-09-15:

- [npm: cardinal-system 3.0.27, third party](https://www.npmjs.com/package/cardinal-system)
...
No GitHub organisation could be tied to trycardinal.com with evidence on 2026-09-15.
...
- [https://www.trycardinal.com/](https://www.trycardinal.com/)
- [https://yc-oss.github.io/api/companies/all.json](https://yc-oss.github.io/api/companies/all.json)

2 source URLs. Raw sources field, verbatim:

https://www.trycardinal.com/, https://yc-oss.github.io/api/companies/all.json
