# Capix: MCP server status, API access gate and what it does

> Capix uses AI to instantly find and aggregate accurate, up-to-date private company data. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [capix.ai](https://capix.ai) · entry id 01-capix · source 01-data-enrichment.md line 2553

**What it does**
Capix uses AI to instantly find and aggregate accurate, up-to-date private company data.
...
quoted from [https://www.npmjs.com/package/@capixjs/cli](https://www.npmjs.com/package/@capixjs/cli) on 2026-09-18, via npm, a third party source

```
pip install capix
```

quoted from [https://pypi.org/project/capix/](https://pypi.org/project/capix/) on 2026-09-18, via pypi, a third party source

Packages seen, with the version on 2026-09-18:

- [npm: @capixjs/cli 1.0.0, third party](https://www.npmjs.com/package/@capixjs/cli)
- [pypi: capix 0.1.2, third party](https://pypi.org/project/capix/)
...
No GitHub organisation could be tied to capix.ai with evidence on 2026-09-15.
...
- [https://www.capix.ai/](https://www.capix.ai/)
...
https://www.capix.ai/, https://yc-oss.github.io/api/tags/sales-enablement.json
