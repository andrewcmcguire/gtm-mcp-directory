# Kite: MCP server status, API access gate and what it does

> Create professional app demo videos in minutes. Auto cursor follow, zooms, text scenes, 3D mockups, AI... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [kite.video](https://kite.video) · entry id 08-kite · source 08-video-prospecting.md line 368

**What it does**
Create professional app demo videos in minutes. Auto cursor follow, zooms, text scenes, 3D mockups, AI voiceover, music, and more.
...
[https://kite.video/docs](https://kite.video/docs)
...
No GitHub organisation could be tied to kite.video with evidence on 2026-09-15.
...
- [https://kite.video](https://kite.video)
- [https://kite.video/docs](https://kite.video/docs)
- [https://kite.video/developers](https://kite.video/developers)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://kite.video, https://kite.video/docs, https://kite.video/developers, https://yc-oss.github.io/api/industries/marketing.json
