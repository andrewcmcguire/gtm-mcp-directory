# Dyspatch: MCP server status, API access gate and what it does

> Build, collaborate on, and localize on-brand email templates without code. Trusted by Canva, Culture Amp, and... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [dyspatch.io](https://dyspatch.io) · entry id 02-dyspatch · source 02-engagement-outbound.md line 1997

**What it does**
Build, collaborate on, and localize on-brand email templates without code. Trusted by Canva, Culture Amp, and 300+ global teams. See how it works.
...
No GitHub organisation could be tied to dyspatch.io with evidence on 2026-09-15.
...
- [https://www.dyspatch.io](https://www.dyspatch.io)
- [https://www.dyspatch.io/llms.txt](https://www.dyspatch.io/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://www.dyspatch.io, https://www.dyspatch.io/llms.txt, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from ai-sdr-agents to engagement-outbound.

**Provenance**

- **Entry id**: 02-dyspatch
