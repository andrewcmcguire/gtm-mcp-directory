# Origami: MCP server status, API access gate and what it does

> Enter your website. Origami finds the best ways to get you customers. Approve with a click, and Origami runs... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [origami.chat](https://origami.chat) · entry id 02-origami · source 02-engagement-outbound.md line 1491

**What it does**
Enter your website. Origami finds the best ways to get you customers. Approve with a click, and Origami runs the campaigns for you.
...
quoted from [https://www.npmjs.com/package/@weborigami/origami](https://www.npmjs.com/package/@weborigami/origami) on 2026-09-15, via npm, a third party source

Packages seen, with the version on 2026-09-15:

- [npm: @weborigami/origami 0.7.1, third party](https://www.npmjs.com/package/@weborigami/origami)
...
[https://origami.chat/docs](https://origami.chat/docs)
...
No GitHub organisation could be tied to origami.chat with evidence on 2026-09-15.
...
- [https://origami.chat/](https://origami.chat/)
- [https://origami.chat/docs](https://origami.chat/docs)
- [https://origami.chat/developers](https://origami.chat/developers)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://origami.chat/, https://origami.chat/docs, https://origami.chat/developers, https://yc-oss.github.io/api/industries/sales.json
