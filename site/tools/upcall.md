# Upcall: MCP server status, API access gate and what it does

> Upcall is an omnichannel outreach platform powered by real people-not robots. Our U.S.-based team connects... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [upcall.com](https://upcall.com) · entry id 02-upcall · source 02-engagement-outbound.md line 701

**What it does**
Upcall is an omnichannel outreach platform powered by real people-not robots. Our U.S.-based team connects with your leads through phone, email, and SMS, qualifying prospects and engaging customers with smart scripts and seamless CRM integration.
...
[https://www.upcall.com/api](https://www.upcall.com/api)
...
No GitHub organisation could be tied to upcall.com with evidence on 2026-09-15.
...
- [https://www.upcall.com](https://www.upcall.com)
- [https://www.upcall.com/api](https://www.upcall.com/api)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

3 source URLs. Raw sources field, verbatim:

https://www.upcall.com, https://www.upcall.com/api, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
API mentioned on https://www.upcall.com/api; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.
