# Fundz Agent Examples: MCP server status, API access gate and what it does

> Working examples for the Fundz Agent API - buying signals, SEC 8-K and Form D funding evidence for GTM agents... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/Fund-z/agent-examples](https://github.com/Fund-z/agent-examples) · entry id 07-fundz-agent-examples · source 07-mcp-infrastructure.md line 3135
...
https://github.com/Fund-z/agent-examples

- [https://github.com/Fund-z/agent-examples](https://github.com/Fund-z/agent-examples)
