# LinkMCP: MCP server status, API access gate and what it does

> The LinkedIn access layer for AI agents. Search, message, and enrich LinkedIn from Claude, ChatGPT, Cursor,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [app.linkmcp.io](https://app.linkmcp.io) · entry id 01-linkmcp · source 01-data-enrichment.md line 3499

**What it does**
The LinkedIn access layer for AI agents. Search, message, and enrich LinkedIn from Claude, ChatGPT, Cursor, n8n, or your own agent - 31 tools over MCP.
...
https://github.com/linkmcp-io/linkmcp

- [https://github.com/linkmcp-io/linkmcp](https://github.com/linkmcp-io/linkmcp)
...
[https://app.linkmcp.io/docs](https://app.linkmcp.io/docs)
...
No GitHub organisation could be tied to app.linkmcp.io with evidence on 2026-09-15.
...
- [https://app.linkmcp.io](https://app.linkmcp.io)
- [https://app.linkmcp.io/docs](https://app.linkmcp.io/docs)
- [https://app.linkmcp.io/llms.txt](https://app.linkmcp.io/llms.txt)
- [https://github.com/linkmcp-io/linkmcp](https://github.com/linkmcp-io/linkmcp)

4 source URLs. Raw sources field, verbatim:

https://app.linkmcp.io, https://app.linkmcp.io/docs, https://app.linkmcp.io/llms.txt, https://github.com/linkmcp-io/linkmcp

**Notes, verbatim from the file**
API mentioned on https://app.linkmcp.io/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name LinkMCP (draft listed as linkmcp-io/linkmcp).
