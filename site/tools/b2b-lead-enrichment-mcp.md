# B2B Lead Enrichment MCP: MCP server status, API access gate and what it does

> Remote MCP server to enrich company profiles with structured B2B data and confidence scores. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [lead-enrichment-mcp.agent-infra.workers.dev](https://lead-enrichment-mcp.agent-infra.workers.dev) · entry id 01-b2b-lead-enrichment-mcp · source 01-data-enrichment.md line 3994
...
https://github.com/Diego-Costa-Tech/lead-enrichment-mcp

- [https://github.com/Diego-Costa-Tech/lead-enrichment-mcp](https://github.com/Diego-Costa-Tech/lead-enrichment-mcp)
...
- **Discovery** Service discovery evidence: in the server source · calling it reads · from a third party repo, so these are that author's tools, not the vendor's published surface

- **MCP** MCP protocol endpoints evidence: in the server source · calling it reads · from a third party repo, so these are that author's tools, not the vendor's published surface

- **System** System endpoints evidence: in the server source · calling it reads · from a third party repo, so these are that author's tools, not the vendor's published surface

- **Testing** Test endpoints evidence: in the server source · calling it reads · from a third party repo, so these are that author's tools, not the vendor's published surface
...
[https://lead-enrichment-mcp.agent-infra.workers.dev/docs](https://lead-enrichment-mcp.agent-infra.workers.dev/docs)
...
No GitHub organisation could be tied to lead-enrichment-mcp.agent-infra.workers.dev with evidence on 2026-09-15.
...
- [https://lead-enrichment-mcp.agent-infra.workers.dev](https://lead-enrichment-mcp.agent-infra.workers.dev)
- [https://lead-enrichment-mcp.agent-infra.workers.dev/docs](https://lead-enrichment-mcp.agent-infra.workers.dev/docs)
- [https://github.com/Diego-Costa-Tech/lead-enrichment-mcp](https://github.com/Diego-Costa-Tech/lead-enrichment-mcp)

3 source URLs. Raw sources field, verbatim:

https://lead-enrichment-mcp.agent-infra.workers.dev, https://lead-enrichment-mcp.agent-infra.workers.dev/docs, https://github.com/Diego-Costa-Tech/lead-enrichment-mcp

**Notes, verbatim from the file**
what_it_does used staging desc because homepage meta description was empty. API mentioned on https://lead-enrichment-mcp.agent-infra.workers.dev/docs; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave P 2026-09-12: canonical name B2B Lead Enrichment MCP (draft listed as B2B Lead Enrichment).

**Provenance**

- **Entry id**: 01-b2b-lead-enrichment-mcp
