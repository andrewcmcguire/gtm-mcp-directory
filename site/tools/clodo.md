# CLODO: MCP server status, API access gate and what it does

> Find and reach your next customers at the speed of thought. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [clodo.ai](https://clodo.ai) · entry id 01-clodo · source 01-data-enrichment.md line 2125

**What it does**
Find and reach your next customers at the speed of thought.
...
[https://clodo.ai/docs](https://clodo.ai/docs)
...
No GitHub organisation could be tied to clodo.ai with evidence on 2026-09-15.
...
- [https://clodo.ai](https://clodo.ai)
- [https://clodo.ai/docs](https://clodo.ai/docs)
- [https://clodo.ai/api](https://clodo.ai/api)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://clodo.ai, https://clodo.ai/docs, https://clodo.ai/api, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
API mentioned on https://clodo.ai/docs; pricing/gate not inferred from presence alone. API mentioned on https://clodo.ai/api; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from engagement-outbound to data-enrichment.
