# Nynch MCP: MCP server status, API access gate and what it does

> Nynch developer resources for AI agents. Nynch API docs, Nynch OpenAPI specification, Nynch MCP server,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://nynch.com/developers](https://nynch.com/developers) · entry id 07-nynch-mcp · source 07-mcp-infrastructure.md line 2228

**What it does**
Nynch developer resources for AI agents. Nynch API docs, Nynch OpenAPI specification, Nynch MCP server, authentication, and example requests for the Nynch AI CRM.
...
https://github.com/peterod99/nynch-mcp-server

- [https://github.com/peterod99/nynch-mcp-server](https://github.com/peterod99/nynch-mcp-server)
...
[https://www.nynch.com/developers](https://www.nynch.com/developers)
...
No GitHub organisation could be tied to nynch.com with evidence on 2026-09-15.
...
https://www.nynch.com/developers, https://github.com/peterod99/nynch-mcp-server

**Notes, verbatim from the file**
API mentioned on https://www.nynch.com/developers; pricing/gate not inferred from presence alone. API mentioned on https://www.nynch.com/developers; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave I 2026-09-12: canonical name Nynch MCP (draft listed as peterod99/nynch-mcp-server).

**Provenance**

- **Entry id**: 07-nynch-mcp
