# Breadcrumbs: MCP server status, API access gate and what it does

> Optimize your entire funnel, and achieve up to 30% increase from MQL to Opp for Sales-Assisted and PLG... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [breadcrumbs.io](https://breadcrumbs.io) · entry id 14-breadcrumbs · source 14-inbound-plg-chat.md line 930

**What it does**
Optimize your entire funnel, and achieve up to 30% increase from MQL to Opp for Sales-Assisted and PLG motions with Breadcrumbs. Enterprise-Grade Lead Scoring Made for Everyone.
...
[https://breadcrumbs.io/docs](https://breadcrumbs.io/docs)
...
No GitHub organisation could be tied to breadcrumbs.io with evidence on 2026-09-15.
...
- [https://breadcrumbs.io/](https://breadcrumbs.io/)
- [https://breadcrumbs.io/docs](https://breadcrumbs.io/docs)
- [https://breadcrumbs.io/developers](https://breadcrumbs.io/developers)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://breadcrumbs.io/, https://breadcrumbs.io/docs, https://breadcrumbs.io/developers, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave M 2026-09-12: canonical name Breadcrumbs (draft listed as Breadcrumbs.io). Category corrected from data-enrichment to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-breadcrumbs
