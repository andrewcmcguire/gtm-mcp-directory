# Misarreach: MCP server status, API access gate and what it does

> AI-powered multi-channel outreach and lead generation - cold email, LinkedIn automation, a multi-source lead... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [misarreach.com](https://misarreach.com) · entry id 02-misarreach · source 02-engagement-outbound.md line 1631

**What it does**
AI-powered multi-channel outreach and lead generation - cold email, LinkedIn automation, a multi-source lead finder, and a built-in CRM. DPDP/GDPR-compliant.
...
[https://docs.misar.io/reach](https://docs.misar.io/reach)
...
No GitHub organisation could be tied to misarreach.com with evidence on 2026-09-15.
...
- [https://misarreach.com/](https://misarreach.com/)
- [https://docs.misar.io/reach](https://docs.misar.io/reach)
- [https://misarreach.com/llms.txt](https://misarreach.com/llms.txt)
- [https://www.npmjs.com/search?q=mcp%20outreach](https://www.npmjs.com/search?q=mcp%20outreach)

4 source URLs. Raw sources field, verbatim:

https://misarreach.com/, https://docs.misar.io/reach, https://misarreach.com/llms.txt, https://www.npmjs.com/search?q=mcp%20outreach

**Notes, verbatim from the file**
API mentioned on https://docs.misar.io/reach; pricing/gate not inferred from presence alone. API mentioned on https://misarreach.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave G 2026-09-12: canonical name Misarreach (draft listed as @misarreach/mcp). Category corrected from email-deliverability to engagement-outbound.

**Provenance**

- **Entry id**: 02-misarreach
