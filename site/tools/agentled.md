# Agentled: MCP server status, API access gate and what it does

> Discover how Agentled can revolutionize your business operations with AI-driven solutions that optimize... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [agentled.app](https://agentled.app) · entry id 06-agentled · source 06-revops-infra.md line 1454

**What it does**
Discover how Agentled can revolutionize your business operations with AI-driven solutions that optimize sales, marketing, customer success, and more. Scale smarter and grow faster with our cutting-edge platform.
...
quoted from [https://www.npmjs.com/package/@agentled/cli](https://www.npmjs.com/package/@agentled/cli) on 2026-09-15, via npm

Packages seen, with the version on 2026-09-15:

- [npm: @agentled/cli 0.8.3](https://www.npmjs.com/package/@agentled/cli)
...
[https://www.agentled.app/en/docs](https://www.agentled.app/en/docs)
...
No GitHub organisation could be tied to agentled.app with evidence on 2026-09-15.
...
- [https://www.agentled.app/en](https://www.agentled.app/en)
- [https://www.agentled.app/en/docs](https://www.agentled.app/en/docs)
- [https://www.agentled.app/en/developers](https://www.agentled.app/en/developers)
- [https://www.npmjs.com/search?q=mcp%20outreach](https://www.npmjs.com/search?q=mcp%20outreach)

4 source URLs. Raw sources field, verbatim:

https://www.agentled.app/en, https://www.agentled.app/en/docs, https://www.agentled.app/en/developers, https://www.npmjs.com/search?q=mcp%20outreach

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave J 2026-09-12: canonical name Agentled (draft listed as @agentled/mcp-server). Category corrected from mcp-infrastructure to revops-infra.

**Provenance**

- **Entry id**: 06-agentled
