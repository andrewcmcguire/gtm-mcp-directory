# RevOps Eval: MCP server status, API access gate and what it does

> An evaluation benchmark for AI agents on Revenue Operations tasks. Public leaderboard. Open methodology. Real... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [revopseval.com](https://revopseval.com) · entry id 07-revops-eval · source 07-mcp-infrastructure.md line 1180
...
https://github.com/elijeangilles/revops-skills

- [https://github.com/elijeangilles/revops-skills](https://github.com/elijeangilles/revops-skills)
...
[https://revopseval.com/docs](https://revopseval.com/docs)
...
No GitHub organisation could be tied to revopseval.com with evidence on 2026-09-15.
...
- [https://revopseval.com](https://revopseval.com)
- [https://revopseval.com/docs](https://revopseval.com/docs)
- [https://revopseval.com/developers](https://revopseval.com/developers)
- [https://github.com/elijeangilles/revops-skills](https://github.com/elijeangilles/revops-skills)

4 source URLs. Raw sources field, verbatim:

https://revopseval.com, https://revopseval.com/docs, https://revopseval.com/developers, https://github.com/elijeangilles/revops-skills

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave E 2026-09-12: canonical name RevOps Eval (draft listed as elijeangilles/revops-skills).

**Provenance**

- **Entry id**: 07-revops-eval
