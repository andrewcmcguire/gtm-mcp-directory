...
- **Docs URL**: [https://crustdata.com/](https://crustdata.com/)
...
- **execute** Calls Crustdata's data tools evidence: in the vendor docs · calling it reads

- **get_schema** Retrieves schema information for a Crustdata data tool evidence: in the vendor docs · calling it reads
