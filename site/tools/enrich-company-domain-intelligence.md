# Enrich Company Domain Intelligence: MCP server status, API access gate and what it does

> Domain → company name, country, contacts, social profiles. Enterprise enrichment via Elasticsearch. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.tradego.ai/mcp](https://www.tradego.ai/mcp) · entry id 01-enrich-company-domain-intelligence · source 01-data-enrichment.md line 4156

**What it does**
Domain → company name, country, contacts, social profiles. Enterprise enrichment via Elasticsearch.
...
No GitHub organisation could be tied to tradego.ai with evidence on 2026-09-15.
...
Homepage fetch failed (HTTPError 406); what_it_does used staging desc. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave Q 2026-09-12: canonical name Enrich Company Domain Intelligence (draft listed as Enrich - Company Domain Intelligence).

**Provenance**

- **Entry id**: 01-enrich-company-domain-intelligence
