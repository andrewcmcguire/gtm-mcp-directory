# Fintent Signals MCP: MCP server status, API access gate and what it does

> Predictive Signals, Company Search, Sector Trends and Contacts for PEs, IBs, M&A dealmakers. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://app.fintent.ai/api/v2/mcp](https://app.fintent.ai/api/v2/mcp) · entry id 05-fintent-signals-mcp · source 05-signals-intent-abm.md line 1640
...
https://app.fintent.ai/api/v2/mcp

- [https://app.fintent.ai/api/v2/mcp](https://app.fintent.ai/api/v2/mcp)
...
[https://app.fintent.ai/docs](https://app.fintent.ai/docs)
