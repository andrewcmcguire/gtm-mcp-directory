# Listmint: MCP server status, API access gate and what it does

> Listmint offers real-time catch-all email verification and 50%+ more valid emails out of your lead lists.... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [listmint.io](https://listmint.io) · entry id 09-listmint · source 09-email-deliverability.md line 362

**What it does**
Listmint offers real-time catch-all email verification and 50%+ more valid emails out of your lead lists. Sign up for free to get started.
...
No GitHub organisation could be tied to listmint.io with evidence on 2026-09-15.
...
- [https://listmint.io](https://listmint.io)
- [https://www.clay.com/integrations/data-provider/listmint](https://www.clay.com/integrations/data-provider/listmint)

2 source URLs. Raw sources field, verbatim:

https://listmint.io, https://www.clay.com/integrations/data-provider/listmint

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to email-deliverability.

**Provenance**

- **Entry id**: 09-listmint
