# DataMerge: MCP server status, API access gate and what it does

> Enrich B2B leads with verified company data and contact emails. 375M+ companies, 20+ data providers combined.... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [datamerge.ai](https://datamerge.ai) · entry id 01-datamerge · source 01-data-enrichment.md line 4276

**What it does**
Enrich B2B leads with verified company data and contact emails. 375M+ companies, 20+ data providers combined. See a sample on your own data before you pay.
...
[https://www.datamerge.ai/docs](https://www.datamerge.ai/docs)
...
No GitHub organisation could be tied to datamerge.ai with evidence on 2026-09-15.
...
- [https://www.datamerge.ai](https://www.datamerge.ai)
- [https://www.datamerge.ai/docs](https://www.datamerge.ai/docs)
- [https://www.datamerge.ai/developers](https://www.datamerge.ai/developers)
- [https://registry.smithery.ai/servers?q=enrich](https://registry.smithery.ai/servers?q=enrich)

4 source URLs. Raw sources field, verbatim:

https://www.datamerge.ai, https://www.datamerge.ai/docs, https://www.datamerge.ai/developers, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
API mentioned on https://www.datamerge.ai/docs; pricing/gate not inferred from presence alone. API mentioned on https://www.datamerge.ai/developers; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave Q 2026-09-12.

**Provenance**

- **Entry id**: 01-datamerge
