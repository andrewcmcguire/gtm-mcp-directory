# Master Metrics: MCP server status, API access gate and what it does

> Connect any MCP-compatible AI client (Claude, Cursor, Copilot, n8n, Power Automate) to Master Metrics and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [mcp.mastermetrics.com](https://mcp.mastermetrics.com) · entry id 05-master-metrics · source 05-signals-intent-abm.md line 1806

**What it does**
Connect any MCP-compatible AI client (Claude, Cursor, Copilot, n8n, Power Automate) to Master Metrics and query advertising data from Meta, Google, LinkedIn, TikTok and more using natural language.
...
No GitHub organisation could be tied to mcp.mastermetrics.com with evidence on 2026-09-15.
...
- [https://mcp.mastermetrics.com](https://mcp.mastermetrics.com)
- [https://registry.smithery.ai/servers?q=hubspot](https://registry.smithery.ai/servers?q=hubspot)

2 source URLs. Raw sources field, verbatim:

https://mcp.mastermetrics.com, https://registry.smithery.ai/servers?q=hubspot
