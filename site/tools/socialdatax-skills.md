# SocialDataX Skills: MCP server status, API access gate and what it does

> SocialDataX 为 AI 工具和飞书工作流提供小红书、抖音、快手、微博、微信、B站、知乎、TikTok、Instagram、YouTube 和 X（Twitter）等多平台社媒数据接入服务。 Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [socialdatax.com](https://socialdatax.com) · entry id 01-socialdatax-skills · source 01-data-enrichment.md line 4846

**What it does**
SocialDataX 为 AI 工具和飞书工作流提供小红书、抖音、快手、微博、微信、B站、知乎、TikTok、Instagram、YouTube 和 X（Twitter）等多平台社媒数据接入服务。
...
https://www.npmjs.com/search?q=mcp%20intent

- [https://www.npmjs.com/search?q=mcp%20intent](https://www.npmjs.com/search?q=mcp%20intent)
...
[https://socialdatax.com/docs](https://socialdatax.com/docs)
...
No GitHub organisation could be tied to socialdatax.com with evidence on 2026-09-15.
...
- [https://socialdatax.com](https://socialdatax.com)
- [https://socialdatax.com/docs](https://socialdatax.com/docs)
- [https://socialdatax.com/developers](https://socialdatax.com/developers)
- [https://www.npmjs.com/search?q=mcp%20intent](https://www.npmjs.com/search?q=mcp%20intent)

4 source URLs. Raw sources field, verbatim:

https://socialdatax.com, https://socialdatax.com/docs, https://socialdatax.com/developers, https://www.npmjs.com/search?q=mcp%20intent

**Notes, verbatim from the file**
API mentioned on https://socialdatax.com/docs; pricing/gate not inferred from presence alone. API mentioned on https://socialdatax.com/developers; pricing/gate not inferred from presence alone. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave V 2026-09-12: canonical name SocialDataX Skills (draft listed as socialdatax-skills).

**Provenance**

- **Entry id**: 01-socialdatax-skills
