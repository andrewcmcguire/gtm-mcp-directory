# Wokelo: MCP server status, API access gate and what it does

> Company and market intelligence, news, enrichment, and agentic workflows for dealmakers. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [wokelo.ai](https://wokelo.ai) · entry id 01-wokelo · source 01-data-enrichment.md line 1457
...
https://github.com/Wokelo-AI/Wokelo-MCP-Server

- [https://github.com/Wokelo-AI/Wokelo-MCP-Server](https://github.com/Wokelo-AI/Wokelo-MCP-Server)
...
No GitHub organisation could be tied to wokelo.ai with evidence on 2026-09-15.
...
- [https://docs.wokelo.ai/getting-started-mcp](https://docs.wokelo.ai/getting-started-mcp)
- [https://docs.wokelo.ai/llms.txt](https://docs.wokelo.ai/llms.txt)
- [https://docs.wokelo.ai/mcp](https://docs.wokelo.ai/mcp)
- [https://github.com/Wokelo-AI/Wokelo-MCP-Server](https://github.com/Wokelo-AI/Wokelo-MCP-Server)

4 source URLs. Raw sources field, verbatim:

https://docs.wokelo.ai/getting-started-mcp, https://docs.wokelo.ai/llms.txt, https://docs.wokelo.ai/mcp, https://github.com/Wokelo-AI/Wokelo-MCP-Server

**Notes, verbatim from the file**
what_it_does used staging desc because homepage meta description was empty. API mentioned on https://docs.wokelo.ai/llms.txt; pricing/gate not inferred from presence alone. API mentioned on https://docs.wokelo.ai/mcp; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave D 2026-09-12: canonical name Wokelo (draft listed as Wokelo MCP Server).
