# PLOTT: MCP server status, API access gate and what it does

> Turn open UK planning applications into signed contracts. 3D maps, applicant enrichment, AI-drafted letter... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [plott.uk](https://plott.uk) · entry id 02-plott · source 02-engagement-outbound.md line 3450
...
No GitHub organisation could be tied to plott.uk with evidence on 2026-09-15.
...
- [https://plott.uk](https://plott.uk)
- [https://plott.uk/llms.txt](https://plott.uk/llms.txt)
- [https://plott.uk/mcp](https://plott.uk/mcp)
- [https://registry.smithery.ai/servers?q=outreach](https://registry.smithery.ai/servers?q=outreach)

4 source URLs. Raw sources field, verbatim:

https://plott.uk, https://plott.uk/llms.txt, https://plott.uk/mcp, https://registry.smithery.ai/servers?q=outreach

**Notes, verbatim from the file**
API mentioned on https://plott.uk/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12.
