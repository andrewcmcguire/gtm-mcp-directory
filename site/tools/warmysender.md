# WarmySender: MCP server status, API access gate and what it does

> Run your outreach on autopilot with AI agents: cold email, email warmup, LinkedIn, Instagram and multichannel... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [warmysender.com](https://warmysender.com) · entry id 02-warmysender · source 02-engagement-outbound.md line 1125

**What it does**
Run your outreach on autopilot with AI agents: cold email, email warmup, LinkedIn, Instagram and multichannel campaigns plus real-time email verification. Claude, ChatGPT, Cursor, Codex, OpenClaw, Hermes Agent or any MCP agent drives it; the scheduler keeps every account inside safe limits.
...
[https://warmysender.com/docs](https://warmysender.com/docs)
...
No GitHub organisation could be tied to warmysender.com with evidence on 2026-09-15.
...
- [https://warmysender.com](https://warmysender.com)
- [https://warmysender.com/docs](https://warmysender.com/docs)
- [https://warmysender.com/developers](https://warmysender.com/developers)

3 source URLs. Raw sources field, verbatim:

https://warmysender.com, https://warmysender.com/docs, https://warmysender.com/developers

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 02-warmysender
