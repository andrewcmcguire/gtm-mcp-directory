# Lead Enrich MCP by carsonroell-debug: MCP server status, API access gate and what it does

> MCP server for waterfall lead enrichment - cascades Apollo, Clearbit, and Hunter for maximum data coverage -... Community MCP, Gate unknown. Checked 2026-09-12.
...
Lead Enrich MCP by carsonroell-debug
...
Vendor: [https://github.com/carsonroell-debug/leadenrich-mcp](https://github.com/carsonroell-debug/leadenrich-mcp) · entry id 01-lead-enrich-mcp-by-carsonroell-debug · source 01-data-enrichment.md line 4358
...
https://github.com/carsonroell-debug/leadenrich-mcp

- [https://github.com/carsonroell-debug/leadenrich-mcp](https://github.com/carsonroell-debug/leadenrich-mcp)
...
- [https://github.com/carsonlabs/leadenrich-mcp](https://github.com/carsonlabs/leadenrich-mcp)
- [https://github.com/carsonroell-debug/leadenrich-mcp](https://github.com/carsonroell-debug/leadenrich-mcp)
...
https://github.com/carsonlabs/leadenrich-mcp, https://github.com/docs, https://github.com/developers, https://github.com/carsonroell-debug/leadenrich-mcp

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name Lead Enrich MCP by carsonroell-debug (draft listed as io.github.carsonroell-debug/leadenrich-mcp).

**Provenance**

- **Entry id**: 01-lead-enrich-mcp-by-carsonroell-debug
