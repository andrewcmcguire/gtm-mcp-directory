# Spala MCP: MCP server status, API access gate and what it does

> Use the public Spala MCP for discovery, account setup, project handoff, and the Project MCP operating... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://docs.spala.ai/agents/mcp/](https://docs.spala.ai/agents/mcp/) · entry id 07-spala-mcp · source 07-mcp-infrastructure.md line 5394
...
No GitHub organisation could be tied to docs.spala.ai with evidence on 2026-09-15.
...
- [https://docs.spala.ai/agents/mcp/](https://docs.spala.ai/agents/mcp/)
- [https://docs.spala.ai/llms.txt](https://docs.spala.ai/llms.txt)
- [https://www.npmjs.com/search?q=mcp%20intent](https://www.npmjs.com/search?q=mcp%20intent)

3 source URLs. Raw sources field, verbatim:

https://docs.spala.ai/agents/mcp/, https://docs.spala.ai/llms.txt, https://www.npmjs.com/search?q=mcp%20intent

**Notes, verbatim from the file**
API mentioned on https://docs.spala.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave V 2026-09-12: canonical name Spala MCP (draft listed as @spala-ai/mcp-install).

**Provenance**

- **Entry id**: 07-spala-mcp
