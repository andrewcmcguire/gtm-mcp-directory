# Inventive AI: MCP server status, API access gate and what it does

> Inventive AI helps sales teams respond to RFPs 90% faster, with 95% accuracy. Easy setup, one-click... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [inventive.ai](https://inventive.ai) · entry id 13-inventive-ai · source 13-proposals-deals.md line 410

**What it does**
Inventive AI helps sales teams respond to RFPs 90% faster, with 95% accuracy. Easy setup, one-click integrations. Start winning more deals from day one.
...
No GitHub organisation could be tied to inventive.ai with evidence on 2026-09-15.
...
- [https://www.inventive.ai/llms.txt](https://www.inventive.ai/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

3 source URLs. Raw sources field, verbatim:

https://www.inventive.ai/, https://www.inventive.ai/llms.txt, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from ai-sdr-agents to proposals-deals.

**Provenance**

- **Entry id**: 13-inventive-ai
