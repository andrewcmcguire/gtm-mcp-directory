# Salesforce MCP by starcatmeow: MCP server status, API access gate and what it does

> A Salesforce connector MCP Server. Forked from @tsmztech/mcp-server-salesforce Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.npmjs.com/package/@starcatmeow/mcp-server-salesforce](https://www.npmjs.com/package/@starcatmeow/mcp-server-salesforce) · entry id 07-salesforce-mcp-by-starcatmeow · source 07-mcp-infrastructure.md line 1121
...
https://www.npmjs.com/search?q=mcp-server%20salesforce

- [https://www.npmjs.com/search?q=mcp-server%20salesforce](https://www.npmjs.com/search?q=mcp-server%20salesforce)
...
Homepage fetch failed (HTTPError 403); what_it_does used staging desc. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave E 2026-09-12: canonical name Salesforce MCP by starcatmeow (draft listed as @starcatmeow/mcp-server-salesforce).

**Provenance**

- **Entry id**: 07-salesforce-mcp-by-starcatmeow
