# LinkedGrow: MCP server status, API access gate and what it does

> Lead generation on LinkedIn, run by an agent that finds your leads, sends the invitation and opens the... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [linkedgrow.ai](https://linkedgrow.ai) · entry id 02-linkedgrow · source 02-engagement-outbound.md line 841
...
- [https://github.com/DigiHold/LinkedGrow](https://github.com/DigiHold/LinkedGrow)
...
[https://linkedgrow.ai/docs](https://linkedgrow.ai/docs)
...
No GitHub organisation could be tied to linkedgrow.ai with evidence on 2026-09-15.
...
- [https://linkedgrow.ai](https://linkedgrow.ai)
- [https://linkedgrow.ai/docs](https://linkedgrow.ai/docs)
- [https://linkedgrow.ai/llms.txt](https://linkedgrow.ai/llms.txt)
- [https://github.com/DigiHold/LinkedGrow](https://github.com/DigiHold/LinkedGrow)

4 source URLs. Raw sources field, verbatim:

https://linkedgrow.ai, https://linkedgrow.ai/docs, https://linkedgrow.ai/llms.txt, https://github.com/DigiHold/LinkedGrow

**Notes, verbatim from the file**
API mentioned on https://linkedgrow.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave B 2026-09-12: canonical name LinkedGrow (draft listed as DigiHold/LinkedGrow). Category corrected from mcp-infrastructure to engagement-outbound.

**Provenance**

- **Entry id**: 02-linkedgrow
