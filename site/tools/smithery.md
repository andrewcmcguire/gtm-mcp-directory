...
quoted from [https://www.npmjs.com/package/@deploya/smithery-cli](https://www.npmjs.com/package/@deploya/smithery-cli) on 2026-09-15, via npm

```
brew install smithery-cli
```

quoted from [https://formulae.brew.sh/formula/smithery-cli](https://formulae.brew.sh/formula/smithery-cli) on 2026-09-15, via brew
