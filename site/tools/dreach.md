# Dreach: MCP server status, API access gate and what it does

> Managed job-order acquisition for staffing firms. dreach finds employers with fresh, evidenced staffing... No MCP found, Gate unknown. Checked 2026-09-12.
...
No GitHub organisation could be tied to dreach.ai with evidence on 2026-09-15.
...
- [https://dreach.ai](https://dreach.ai)
- [https://dreach.ai/llms.txt](https://dreach.ai/llms.txt)
- [https://dreach.ai/mcp](https://dreach.ai/mcp)
- [https://yc-oss.github.io/api/tags/sales-enablement.json](https://yc-oss.github.io/api/tags/sales-enablement.json)

4 source URLs. Raw sources field, verbatim:

https://dreach.ai, https://dreach.ai/llms.txt, https://dreach.ai/mcp, https://yc-oss.github.io/api/tags/sales-enablement.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from enablement-coaching to engagement-outbound.
