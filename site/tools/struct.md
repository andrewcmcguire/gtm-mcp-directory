# Struct: MCP server status, API access gate and what it does

> Multi-lingual AI voice agents for business workflows. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [struct.app](https://struct.app) · entry id 04-struct · source 04-ai-sdr-agents.md line 1134
...
https://yc-oss.github.io/api/tags/crm.json
