# Penguin AI: MCP server status, API access gate and what it does

> AI Sales Rep for Website Intent Signals No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [penguinai.app](https://penguinai.app) · entry id 04-penguin-ai · source 04-ai-sdr-agents.md line 928

**What it does**
AI Sales Rep for Website Intent Signals
...
[https://penguinai.app/docs](https://penguinai.app/docs)
...
No GitHub organisation could be tied to penguinai.app with evidence on 2026-09-15.
...
- [https://penguinai.app/](https://penguinai.app/)
- [https://penguinai.app/docs](https://penguinai.app/docs)
- [https://penguinai.app/developers](https://penguinai.app/developers)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://penguinai.app/, https://penguinai.app/docs, https://penguinai.app/developers, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
what_it_does used YC/source one_liner because homepage meta description was empty. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from signals-intent-abm to ai-sdr-agents.

**Provenance**

- **Entry id**: 04-penguin-ai
