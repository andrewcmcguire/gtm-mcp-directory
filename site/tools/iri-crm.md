# iri CRM: MCP server status, API access gate and what it does

> Designed for service businesses, agencies, clinics, and e-commerce. WhatsApp, Instagram, ads, and all your... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [iricrm.com](https://iricrm.com) · entry id 06-iri-crm · source 06-revops-infra.md line 2065

**What it does**
Designed for service businesses, agencies, clinics, and e-commerce. WhatsApp, Instagram, ads, and all your tools fully integrated with autonomous AI CRM.
...
[https://iricrm.com/docs](https://iricrm.com/docs)
...
No GitHub organisation could be tied to iricrm.com with evidence on 2026-09-15.
...
- [https://iricrm.com](https://iricrm.com)
- [https://iricrm.com/docs](https://iricrm.com/docs)
- [https://iricrm.com/developers](https://iricrm.com/developers)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales](https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales)

4 source URLs. Raw sources field, verbatim:

https://iricrm.com, https://iricrm.com/docs, https://iricrm.com/developers, https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales

**Notes, verbatim from the file**
mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12.
