# ICT Dialer MCP: MCP server status, API access gate and what it does

> ICTDialer is a cloud-based call center and contact center platform that supports Voice, SMS, and Fax... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [ictdialer.com](https://ictdialer.com) · entry id 02-ict-dialer-mcp · source 02-engagement-outbound.md line 2904

**What it does**
ICTDialer is a cloud-based call center and contact center platform that supports Voice, SMS, and Fax communications technologies. You need internet and a web
...
https://github.com/ictinnovations/ictdialer-mcp

- [https://github.com/ictinnovations/ictdialer-mcp](https://github.com/ictinnovations/ictdialer-mcp)
...
[https://www.ictdialer.com/apis-features/](https://www.ictdialer.com/apis-features/)
...
No GitHub organisation could be tied to ictdialer.com with evidence on 2026-09-15.
...
- [https://www.ictdialer.com/](https://www.ictdialer.com/)
- [https://www.ictdialer.com/apis-features/](https://www.ictdialer.com/apis-features/)
- [https://github.com/ictinnovations/ictdialer-mcp](https://github.com/ictinnovations/ictdialer-mcp)

3 source URLs. Raw sources field, verbatim:

https://www.ictdialer.com/, https://www.ictdialer.com/apis-features/, https://github.com/ictinnovations/ictdialer-mcp

**Notes, verbatim from the file**
API mentioned on https://www.ictdialer.com/apis-features/; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name ICT Dialer MCP (draft listed as io.github.ictinnovations/ictdialer-mcp).

**Provenance**

- **Entry id**: 02-ict-dialer-mcp
