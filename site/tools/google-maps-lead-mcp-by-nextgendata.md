# Google Maps Lead MCP by NextGenData: MCP server status, API access gate and what it does

> MCP server for AI agents: search local businesses on Google Maps, generate leads and validate emails. For... Community MCP, Gate unknown. Checked 2026-09-12.
...
Google Maps Lead MCP by NextGenData
...
Vendor: [https://apify.com/nexgendata/google-maps-mcp-server](https://apify.com/nexgendata/google-maps-mcp-server) · entry id 01-google-maps-lead-mcp-by-nextgendata · source 01-data-enrichment.md line 3834
...
https://apify.com/nexgendata/google-maps-mcp-server

- [https://apify.com/nexgendata/google-maps-mcp-server](https://apify.com/nexgendata/google-maps-mcp-server)
