# FirstTouch: MCP server status, API access gate and what it does

> One MCP connection gives Claude, Cursor, Codex, and ChatGPT real hands in FirstTouch: build audiences, launch... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.firsttouch.com/mcp](https://www.firsttouch.com/mcp) · entry id 02-firsttouch · source 02-engagement-outbound.md line 2842

**What it does**
One MCP connection gives Claude, Cursor, Codex, and ChatGPT real hands in FirstTouch: build audiences, launch flows, discover prospects, and track pipeline.
...
https://github.com/First-Touch-Inc/mcp

- [https://github.com/First-Touch-Inc/mcp](https://github.com/First-Touch-Inc/mcp)
...
No GitHub organisation could be tied to firsttouch.com with evidence on 2026-09-15.
...
- [https://www.firsttouch.com/mcp](https://www.firsttouch.com/mcp)
- [https://docs.firsttouch.com/llms.txt](https://docs.firsttouch.com/llms.txt)
- [https://github.com/First-Touch-Inc/mcp](https://github.com/First-Touch-Inc/mcp)

3 source URLs. Raw sources field, verbatim:

https://www.firsttouch.com/mcp, https://docs.firsttouch.com/llms.txt, https://github.com/First-Touch-Inc/mcp

**Notes, verbatim from the file**
API mentioned on https://docs.firsttouch.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave Q 2026-09-12.

**Provenance**

- **Entry id**: 02-firsttouch
