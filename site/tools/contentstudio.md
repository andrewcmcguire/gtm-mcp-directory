# ContentStudio: MCP server status, API access gate and what it does

> AI social media manager that never sleeps. It knows your brand, creates and publishes on-brand content and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [contentstudio.io](https://contentstudio.io) · entry id 02-contentstudio · source 02-engagement-outbound.md line 2820

**What it does**
AI social media manager that never sleeps. It knows your brand, creates and publishes on-brand content and learns what works. Review on run on autopilot.
...
quoted from [https://www.npmjs.com/package/contentstudio-cli](https://www.npmjs.com/package/contentstudio-cli) on 2026-09-18, via npm

Packages seen, with the version on 2026-09-18:

- [npm: contentstudio-cli 1.5.0](https://www.npmjs.com/package/contentstudio-cli)
...
No GitHub organisation could be tied to contentstudio.io with evidence on 2026-09-15.
...
- [https://contentstudio.io/](https://contentstudio.io/)
- [https://contentstudio.io/llms.txt](https://contentstudio.io/llms.txt)
- [https://registry.smithery.ai/servers?q=hubspot](https://registry.smithery.ai/servers?q=hubspot)

3 source URLs. Raw sources field, verbatim:

https://contentstudio.io/, https://contentstudio.io/llms.txt, https://registry.smithery.ai/servers?q=hubspot

**Notes, verbatim from the file**
API mentioned on https://contentstudio.io/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave P 2026-09-12.

**Provenance**

- **Entry id**: 02-contentstudio
