# Reach MCP: MCP server status, API access gate and what it does

> Reach MCP connects your real LinkedIn account to Claude, ChatGPT, Cursor or n8n. Six ready playbooks: post... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [reachmcp.com](https://reachmcp.com) · entry id 02-reach-mcp · source 02-engagement-outbound.md line 3390

**What it does**
Reach MCP connects your real LinkedIn account to Claude, ChatGPT, Cursor or n8n. Six ready playbooks: post reactions, profile viewers, cold conversations, Sales Navigator search. Every playbook previews before it writes, inside your daily limits. $39/month.
...
No GitHub organisation could be tied to reachmcp.com with evidence on 2026-09-15.
...
- [https://www.reachmcp.com](https://www.reachmcp.com)
- [https://www.reachmcp.com/llms.txt](https://www.reachmcp.com/llms.txt)
- [https://registry.smithery.ai/servers?q=hubspot](https://registry.smithery.ai/servers?q=hubspot)

3 source URLs. Raw sources field, verbatim:

https://www.reachmcp.com, https://www.reachmcp.com/llms.txt, https://registry.smithery.ai/servers?q=hubspot

**Notes, verbatim from the file**
API mentioned on https://www.reachmcp.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12.

**Provenance**

- **Entry id**: 02-reach-mcp
