...
quoted from [https://www.npmjs.com/package/leadmagic-agent-cli](https://www.npmjs.com/package/leadmagic-agent-cli) on 2026-09-08, via npm, a third party source

```
npm install -g leadmagic-cli
```

quoted from [https://www.npmjs.com/package/leadmagic-cli](https://www.npmjs.com/package/leadmagic-cli) on 2026-09-08, via npm, a third party source

```
npx leadmagic-agent-cli
```

quoted from [https://github.com/bcharleson/leadmagic-agent-cli](https://github.com/bcharleson/leadmagic-agent-cli) on 2026-09-08, via npx, a third party source
...
ads, companies, credits, jobs, login, mcp, people
...
- [https://github.com/bcharleson/leadmagic-agent-cli](https://github.com/bcharleson/leadmagic-agent-cli) (the repository that documented it)
