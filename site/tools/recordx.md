# RecordX: MCP server status, API access gate and what it does

> Take meeting notes automatically. RecordX records Zoom, Google Meet, in-person, and uploaded audio, then... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [recordx.io](https://recordx.io) · entry id 03-recordx · source 03-conversation-intel.md line 1138

**What it does**
Take meeting notes automatically. RecordX records Zoom, Google Meet, in-person, and uploaded audio, then delivers transcripts, summaries, and action items.
...
No GitHub organisation could be tied to recordx.io with evidence on 2026-09-15.
...
- [https://recordx.io](https://recordx.io)
- [https://registry.smithery.ai/servers?q=revops](https://registry.smithery.ai/servers?q=revops)

2 source URLs. Raw sources field, verbatim:

https://recordx.io, https://registry.smithery.ai/servers?q=revops
