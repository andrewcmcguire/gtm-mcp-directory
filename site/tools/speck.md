# Speck: MCP server status, API access gate and what it does

> AI notetaker that records meetings, automates research workflows, and performs follow-up actions for sales... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [speck.sh](https://speck.sh) · entry id 03-speck · source 03-conversation-intel.md line 933

**What it does**
AI notetaker that records meetings, automates research workflows, and performs follow-up actions for sales teams.
...
No GitHub organisation could be tied to speck.sh with evidence on 2026-09-15.
...
https://speck.sh, https://yc-oss.github.io/api/tags/sales-enablement.json
