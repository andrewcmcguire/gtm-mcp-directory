# Mamba GTM Hiring Signal MCP: MCP server status, API access gate and what it does

> MCP server for GTM Hiring Signal Scraper. Detects GTM hiring activity from company career pages via Apify.... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/mambalabsdev/mcp-gtm-hiring-signal-scraper](https://github.com/mambalabsdev/mcp-gtm-hiring-signal-scraper) · entry id 05-mamba-gtm-hiring-signal-mcp · source 05-signals-intent-abm.md line 1251
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/mambalabsdev/mcp-gtm-hiring-signal-scraper](https://github.com/mambalabsdev/mcp-gtm-hiring-signal-scraper)
- [https://github.com/punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
...
https://github.com/mambalabsdev/mcp-gtm-hiring-signal-scraper, https://github.com/docs, https://github.com/developers, https://github.com/punkpeye/awesome-mcp-servers

**Notes, verbatim from the file**
mcp_status=community from discovery source awesome-mcp-servers; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave I 2026-09-12: canonical name Mamba GTM Hiring Signal MCP (draft listed as mambalabsdev/mcp-gtm-hiring-signal-scraper). Category corrected from mcp-infrastructure to signals-intent-abm.

**Provenance**

- **Entry id**: 05-mamba-gtm-hiring-signal-mcp
