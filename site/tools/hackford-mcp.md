# Hackford MCP: MCP server status, API access gate and what it does

> Connect ChatGPT, Codex, Claude and other compatible AI agents to Hackford regulated-firm intelligence through... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://hackforddata.com/mcp](https://hackforddata.com/mcp) · entry id 01-hackford-mcp · source 01-data-enrichment.md line 4458

**What it does**
Connect ChatGPT, Codex, Claude and other compatible AI agents to Hackford regulated-firm intelligence through the Hackford MCP beta.
...
https://hackforddata.com/mcp

- [https://hackforddata.com/mcp](https://hackforddata.com/mcp)
...
[https://hackforddata.com/api](https://hackforddata.com/api)
...
No GitHub organisation could be tied to hackforddata.com with evidence on 2026-09-15.
...
- [https://hackforddata.com/mcp](https://hackforddata.com/mcp)
- [https://hackforddata.com/api](https://hackforddata.com/api)
- [https://hackforddata.com/llms.txt](https://hackforddata.com/llms.txt)

3 source URLs. Raw sources field, verbatim:

https://hackforddata.com/mcp, https://hackforddata.com/api, https://hackforddata.com/llms.txt

**Notes, verbatim from the file**
API mentioned on https://hackforddata.com/api; pricing/gate not inferred from presence alone. API mentioned on https://hackforddata.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12.

**Provenance**

- **Entry id**: 01-hackford-mcp
