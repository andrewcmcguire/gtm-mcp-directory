# ScreenshotOne: MCP server status, API access gate and what it does

> Capture reliable website screenshots, PDFs, and scrolling videos with one developer-friendly API. Start free... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [screenshotone.com](https://screenshotone.com) · entry id 01-screenshotone · source 01-data-enrichment.md line 1559

**What it does**
Capture reliable website screenshots, PDFs, and scrolling videos with one developer-friendly API. Start free with ScreenshotOne.
...
[https://screenshotone.com/docs/getting-started/](https://screenshotone.com/docs/getting-started/)
...
No GitHub organisation could be tied to screenshotone.com with evidence on 2026-09-15.
...
- [https://screenshotone.com/docs/getting-started/](https://screenshotone.com/docs/getting-started/)
- [https://www.clay.com/integrations/data-provider/screenshotone](https://www.clay.com/integrations/data-provider/screenshotone)

3 source URLs. Raw sources field, verbatim:

https://screenshotone.com, https://screenshotone.com/docs/getting-started/, https://www.clay.com/integrations/data-provider/screenshotone

**Notes, verbatim from the file**
API mentioned on https://screenshotone.com/docs/getting-started/; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 01-screenshotone
