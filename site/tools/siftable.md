# Siftable: MCP server status, API access gate and what it does

> Siftable MCP server - human planning tasks, executable agent work queues, knowledge, code context, and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [npmjs.com/package/@siftable/mcp-server](https://npmjs.com/package/@siftable/mcp-server) · entry id 07-siftable · source 07-mcp-infrastructure.md line 1141
