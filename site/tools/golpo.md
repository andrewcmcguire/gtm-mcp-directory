# Golpo: MCP server status, API access gate and what it does

> Make AI whiteboard animation videos free in 2 minutes. Turn a prompt, script, or document into a whiteboard... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [video.golpoai.com](https://video.golpoai.com) · entry id 08-golpo · source 08-video-prospecting.md line 430
...
No GitHub organisation could be tied to video.golpoai.com with evidence on 2026-09-15.
...
- [https://video.golpoai.com/](https://video.golpoai.com/)
- [https://video.golpoai.com/llms.txt](https://video.golpoai.com/llms.txt)
- [https://yc-oss.github.io/api/tags/sales-enablement.json](https://yc-oss.github.io/api/tags/sales-enablement.json)

3 source URLs. Raw sources field, verbatim:

https://video.golpoai.com/, https://video.golpoai.com/llms.txt, https://yc-oss.github.io/api/tags/sales-enablement.json

**Notes, verbatim from the file**
API mentioned on https://video.golpoai.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from enablement-coaching to video-prospecting.
