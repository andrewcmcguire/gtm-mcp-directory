# EZ@Work MCP: MCP server status, API access gate and what it does

> Connect EZ@Work to Claude (Claude.ai, Claude Desktop, Claude Code). Manage clients, projects, invoices, and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [ezatwork.com](https://ezatwork.com) · entry id 07-ez-work-mcp · source 07-mcp-infrastructure.md line 3196

**What it does**
Connect EZ@Work to Claude (Claude.ai, Claude Desktop, Claude Code). Manage clients, projects, invoices, and time entries through natural conversation. OAuth 2.1, scoped tokens, full audit log.
...
https://github.com/eranfinish/ezatwork-mcp

- [https://github.com/eranfinish/ezatwork-mcp](https://github.com/eranfinish/ezatwork-mcp)
...
[https://www.ezatwork.com/docs](https://www.ezatwork.com/docs)
...
No GitHub organisation could be tied to ezatwork.com with evidence on 2026-09-15.
...
- [https://www.ezatwork.com/integrations/claude/](https://www.ezatwork.com/integrations/claude/)
- [https://www.ezatwork.com/docs](https://www.ezatwork.com/docs)
- [https://www.ezatwork.com/developers](https://www.ezatwork.com/developers)
- [https://github.com/eranfinish/ezatwork-mcp](https://github.com/eranfinish/ezatwork-mcp)

4 source URLs. Raw sources field, verbatim:

https://www.ezatwork.com/integrations/claude/, https://www.ezatwork.com/docs, https://www.ezatwork.com/developers, https://github.com/eranfinish/ezatwork-mcp

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave M 2026-09-12: canonical name EZ@Work MCP (draft listed as eranfinish/ezatwork-mcp).

**Provenance**

- **Entry id**: 07-ez-work-mcp
