# LeadPages: MCP server status, API access gate and what it does

> AI landing pages with built-in A/B testing, Smart Traffic, and heatmaps. Create pages in 60 seconds. Optimize... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [leadpages.com](https://leadpages.com) · entry id 14-leadpages · source 14-inbound-plg-chat.md line 536
...
[https://leadpages.com/developers/docs](https://leadpages.com/developers/docs)
...
No GitHub organisation could be tied to leadpages.com with evidence on 2026-09-15.
...
- [https://leadpages.com/developers/docs](https://leadpages.com/developers/docs)
- [https://leadpages.com/developers](https://leadpages.com/developers)
- [https://www.chilipiper.com/integrations/leadpages](https://www.chilipiper.com/integrations/leadpages)

4 source URLs. Raw sources field, verbatim:

https://leadpages.com, https://leadpages.com/developers/docs, https://leadpages.com/developers, https://www.chilipiper.com/integrations/leadpages

**Notes, verbatim from the file**
API mentioned on https://leadpages.com/developers/docs; pricing/gate not inferred from presence alone. API mentioned on https://leadpages.com/developers; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from engagement-outbound to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-leadpages
