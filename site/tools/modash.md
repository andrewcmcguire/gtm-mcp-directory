# Modash: MCP server status, API access gate and what it does

> High performing marketing teams use Modash to find, analyze and monitor influencers at scale all over the... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [modash.io](https://modash.io) · entry id 05-modash · source 05-signals-intent-abm.md line 1087
...
[https://www.modash.io/influencer-marketing-api](https://www.modash.io/influencer-marketing-api)
...
No GitHub organisation could be tied to modash.io with evidence on 2026-09-15.
...
- [https://www.modash.io](https://www.modash.io)
- [https://www.modash.io/influencer-marketing-api](https://www.modash.io/influencer-marketing-api)
- [https://www.clay.com/integrations/data-provider/modash](https://www.clay.com/integrations/data-provider/modash)

3 source URLs. Raw sources field, verbatim:

https://www.modash.io, https://www.modash.io/influencer-marketing-api, https://www.clay.com/integrations/data-provider/modash

**Notes, verbatim from the file**
API mentioned on https://www.modash.io/influencer-marketing-api; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to signals-intent-abm.
