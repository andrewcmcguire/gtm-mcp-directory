# Mamba GTM Suite MCP: MCP server status, API access gate and what it does

> MCP server for the full Mamba Labs GTM Suite. All six GTM actors as tools in one server via Apify. Clay-ready... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/mambalabsdev/mcp-gtm-suite](https://github.com/mambalabsdev/mcp-gtm-suite) · entry id 01-mamba-gtm-suite-mcp · source 01-data-enrichment.md line 2307
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/mambalabsdev/mcp-gtm-suite](https://github.com/mambalabsdev/mcp-gtm-suite)
- [https://github.com/punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
...
https://github.com/mambalabsdev/mcp-gtm-suite, https://github.com/docs, https://github.com/developers, https://github.com/punkpeye/awesome-mcp-servers

**Notes, verbatim from the file**
mcp_status=community from discovery source awesome-mcp-servers; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave I 2026-09-12: canonical name Mamba GTM Suite MCP (draft listed as mambalabsdev/mcp-gtm-suite). Category corrected from mcp-infrastructure to data-enrichment.

**Provenance**

- **Entry id**: 01-mamba-gtm-suite-mcp
