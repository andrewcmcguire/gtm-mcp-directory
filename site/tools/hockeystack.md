# HockeyStack: MCP server status, API access gate and what it does

> HockeyStack is an AI powered B2B Revenue Data Platform unifying marketing, product, and sales data, bridging... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [hockeystack.com](https://hockeystack.com) · entry id 05-hockeystack · source 05-signals-intent-abm.md line 759
...
[https://docs.hockeystack.com/](https://docs.hockeystack.com/)
...
No GitHub organisation could be tied to hockeystack.com with evidence on 2026-09-15.
...
- [https://www.hockeystack.com/](https://www.hockeystack.com/)
- [https://docs.hockeystack.com/](https://docs.hockeystack.com/)
- [https://app.hockeystack.com/login?redirect=/api](https://app.hockeystack.com/login?redirect=/api)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://www.hockeystack.com/, https://docs.hockeystack.com/, https://app.hockeystack.com/login?redirect=/api, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
API mentioned on https://docs.hockeystack.com/; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to signals-intent-abm.

**Provenance**

- **Entry id**: 05-hockeystack
