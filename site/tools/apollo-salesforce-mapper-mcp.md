# Apollo-Salesforce Mapper MCP: MCP server status, API access gate and what it does

> Apollo->Salesforce Lead mapper. No LLM. Strict-fail required fields. PASS/REPAIR/FAIL verdict. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://cf-worker.selbyventurecap.workers.dev/mcp](https://cf-worker.selbyventurecap.workers.dev/mcp) · entry id 07-apollo-salesforce-mapper-mcp · source 07-mcp-infrastructure.md line 4604
...
- [https://cf-worker.selbyventurecap.workers.dev/mcp](https://cf-worker.selbyventurecap.workers.dev/mcp)
