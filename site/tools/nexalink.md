# NexaLink: MCP server status, API access gate and what it does

> NexaLink digital business card & personal CRM - edit your card and capture contacts via MCP. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://nexalink.co/api/mcp](https://nexalink.co/api/mcp) · entry id 07-nexalink · source 07-mcp-infrastructure.md line 5190
...
- [https://nexalink.co/api/mcp](https://nexalink.co/api/mcp)
...
No GitHub organisation could be tied to nexalink.co with evidence on 2026-09-15.
