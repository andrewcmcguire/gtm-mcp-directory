# Vibe Prospecting MCP: MCP server status, API access gate and what it does

> Professional prospecting inside the chat you already use. 50+ B2B data sources to build lead lists, research... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [vibeprospecting.ai](https://vibeprospecting.ai) · entry id 07-vibe-prospecting-mcp · source 07-mcp-infrastructure.md line 574

**What it does**
Professional prospecting inside the chat you already use. 50+ B2B data sources to build lead lists, research accounts, and find decision makers.
...
- [https://github.com/explorium-ai/vibeprospecting-mcp](https://github.com/explorium-ai/vibeprospecting-mcp)
...
No GitHub organisation could be tied to vibeprospecting.ai with evidence on 2026-09-15.
...
- [https://www.vibeprospecting.ai/](https://www.vibeprospecting.ai/)
- [https://www.vibeprospecting.ai/llms.txt](https://www.vibeprospecting.ai/llms.txt)
- [https://github.com/explorium-ai/vibeprospecting-mcp](https://github.com/explorium-ai/vibeprospecting-mcp)

3 source URLs. Raw sources field, verbatim:

https://www.vibeprospecting.ai/, https://www.vibeprospecting.ai/llms.txt, https://github.com/explorium-ai/vibeprospecting-mcp

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave B 2026-09-12: canonical name Vibe Prospecting MCP (draft listed as explorium-ai/vibeprospecting-mcp). Category corrected from data-enrichment to mcp-infrastructure.

**Provenance**

- **Entry id**: 07-vibe-prospecting-mcp
