# JobDataLake MCP: MCP server status, API access gate and what it does

> MCP server for JobDataLake - search 1M+ enriched job listings from AI tools - echojobsio/jdl-mcp-server Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/echojobsio/jdl-mcp-server](https://github.com/echojobsio/jdl-mcp-server) · entry id 01-jobdatalake-mcp · source 01-data-enrichment.md line 1741
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/echojobsio/jdl-mcp-server](https://github.com/echojobsio/jdl-mcp-server)
- [https://github.com/punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
