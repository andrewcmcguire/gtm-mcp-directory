# IN2 Agent MCP: MCP server status, API access gate and what it does

> IN2 MCP stdio server: turns Campfire Salesforce requirements into verified org changes, driven by a Claude... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/Intuitive-Intel/in2-agent](https://github.com/Intuitive-Intel/in2-agent) · entry id 07-in2-agent-mcp · source 07-mcp-infrastructure.md line 877
...
https://github.com/docs, https://github.com/developers, https://www.npmjs.com/search?q=mcp-server%20salesforce

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 404); what_it_does used staging desc. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave C 2026-09-12: canonical name IN2 Agent MCP (draft listed as in2-agent-server).

**Provenance**

- **Entry id**: 07-in2-agent-mcp
