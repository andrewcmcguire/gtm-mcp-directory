# Intelligence Aeternum: MCP server status, API access gate and what it does

> High-fidelity, provenance-verified training data for the next generation of AI. 4,000+ tokens per image. C2PA... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [iaeternum.ai](https://iaeternum.ai) · entry id 07-intelligence-aeternum · source 07-mcp-infrastructure.md line 4866

**What it does**
High-fidelity, provenance-verified training data for the next generation of AI. 4,000+ tokens per image. C2PA certified. Available now on HuggingFace.
...
https://github.com/codex-curator/intelligence-aeternum-mcp

- [https://github.com/codex-curator/intelligence-aeternum-mcp](https://github.com/codex-curator/intelligence-aeternum-mcp)
...
[https://iaeternum.ai/docs](https://iaeternum.ai/docs)
...
No GitHub organisation could be tied to iaeternum.ai with evidence on 2026-09-15.
...
- [https://iaeternum.ai](https://iaeternum.ai)
- [https://iaeternum.ai/docs](https://iaeternum.ai/docs)
- [https://iaeternum.ai/developers](https://iaeternum.ai/developers)
- [https://github.com/codex-curator/intelligence-aeternum-mcp](https://github.com/codex-curator/intelligence-aeternum-mcp)

4 source URLs. Raw sources field, verbatim:

https://iaeternum.ai, https://iaeternum.ai/docs, https://iaeternum.ai/developers, https://github.com/codex-curator/intelligence-aeternum-mcp
...
- **Entry id**: 07-intelligence-aeternum
