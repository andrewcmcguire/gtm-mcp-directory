# Leadspace: MCP server status, API access gate and what it does

> Replace static GTM data with real-time intelligence. Unify profiles, activate signals, and keep routing,... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [leadspace.com](https://leadspace.com) · entry id 01-leadspace · source 01-data-enrichment.md line 1031

**What it does**
Replace static GTM data with real-time intelligence. Unify profiles, activate signals, and keep routing, scoring, and targeting accurate.
...
No GitHub organisation could be tied to leadspace.com with evidence on 2026-09-15.
...
- [https://www.leadspace.com](https://www.leadspace.com)
- [https://www.chilipiper.com/integrations/leadspace-smartforms](https://www.chilipiper.com/integrations/leadspace-smartforms)

2 source URLs. Raw sources field, verbatim:

https://www.leadspace.com, https://www.chilipiper.com/integrations/leadspace-smartforms

**Notes, verbatim from the file**
api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Vendor URL resolved via curated name->domain map because staging website pointed at a marketplace hub page. cli_status=not-checked; no cheap package name probe applicable Promote wave A 2026-09-12: canonical name Leadspace (draft listed as Leadspace SmartForms).

**Provenance**

- **Entry id**: 01-leadspace
