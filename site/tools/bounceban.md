# BounceBan: MCP server status, API access gate and what it does

> Best at verifying emails that are catch-all or protected by SEGs (Secure Email Gateway). Single email... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [bounceban.com](https://bounceban.com) · entry id 09-bounceban · source 09-email-deliverability.md line 448

**What it does**
Best at verifying emails that are catch-all or protected by SEGs (Secure Email Gateway). Single email verifications are free and unlimited.
...
No GitHub organisation could be tied to bounceban.com with evidence on 2026-09-15.
...
- [https://www.clay.com/integrations/data-provider/bounceban](https://www.clay.com/integrations/data-provider/bounceban)

2 source URLs. Raw sources field, verbatim:

https://bounceban.com, https://www.clay.com/integrations/data-provider/bounceban
