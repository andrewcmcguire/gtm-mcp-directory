# BlitzIQ: MCP server status, API access gate and what it does

> Note taking workspace for B2B sales teams No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [blitziq.com](https://blitziq.com) · entry id 11-blitziq · source 11-enablement-coaching.md line 936

**What it does**
Note taking workspace for B2B sales teams
...
[http://www.blitziq.com/docs](http://www.blitziq.com/docs)
...
No GitHub organisation could be tied to blitziq.com with evidence on 2026-09-15.
...
- [http://www.blitziq.com](http://www.blitziq.com)
- [http://www.blitziq.com/docs](http://www.blitziq.com/docs)
- [http://www.blitziq.com/developers](http://www.blitziq.com/developers)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

http://www.blitziq.com, http://www.blitziq.com/docs, http://www.blitziq.com/developers, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
what_it_does used YC/source one_liner because homepage meta description was empty. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.
