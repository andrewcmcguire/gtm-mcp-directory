# Company Enrichment MCP by sercanmetalore: MCP server status, API access gate and what it does

> Firmographic profile, NACE/NAICS categorization, and contact extraction from a company domain. Community MCP, Gate unknown. Checked 2026-09-12.
...
Company Enrichment MCP by sercanmetalore
...
Vendor: [https://github.com/sercanmetalore/API-MCP](https://github.com/sercanmetalore/API-MCP) · entry id 01-company-enrichment-mcp-by-sercanmetalore · source 01-data-enrichment.md line 3379
...
https://github.com/sercanmetalore/API-MCP

- [https://github.com/sercanmetalore/API-MCP](https://github.com/sercanmetalore/API-MCP)
...
https://github.com/docs, https://github.com/developers, https://github.com/sercanmetalore/API-MCP

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 404); what_it_does used staging desc. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name Company Enrichment MCP by sercanmetalore (draft listed as io.github.sercanmetalore/company-enrichment-mcp).

**Provenance**

- **Entry id**: 01-company-enrichment-mcp-by-sercanmetalore
