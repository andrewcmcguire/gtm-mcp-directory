# Little Green Light MCP: MCP server status, API access gate and what it does

> A direct, secure, and high-fidelity Model Context Protocol (MCP) Server for the Little Green Light CRM... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/WillHeadlee/Little-Green-Light-MCP-Server](https://github.com/WillHeadlee/Little-Green-Light-MCP-Server) · entry id 07-little-green-light-mcp · source 07-mcp-infrastructure.md line 1423
...
https://github.com/WillHeadlee/Little-Green-Light-MCP-Server

- [https://github.com/WillHeadlee/Little-Green-Light-MCP-Server](https://github.com/WillHeadlee/Little-Green-Light-MCP-Server)
