# Frontrunner: MCP server status, API access gate and what it does

> AI agents for GTM. Frontrunner connects your GTM stack, gives agents the context to act, and keeps your team... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [usefr.com](https://usefr.com) · entry id 04-frontrunner · source 04-ai-sdr-agents.md line 574

**What it does**
AI agents for GTM. Frontrunner connects your GTM stack, gives agents the context to act, and keeps your team running in the same direction.
...
[https://usefr.com/docs](https://usefr.com/docs)
...
No GitHub organisation could be tied to usefr.com with evidence on 2026-09-15.
...
- [https://usefr.com/](https://usefr.com/)
- [https://usefr.com/docs](https://usefr.com/docs)
- [https://usefr.com/developers](https://usefr.com/developers)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://usefr.com/, https://usefr.com/docs, https://usefr.com/developers, https://yc-oss.github.io/api/industries/sales.json
