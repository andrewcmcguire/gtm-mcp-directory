# Relm CRM: MCP server status, API access gate and what it does

> Relm is an API-first CRM built for LLMs and AI agents. Connect Claude, ChatGPT, or any agent - OAuth sign-in... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [relmcrm.com](https://relmcrm.com) · entry id 07-relm-crm · source 07-mcp-infrastructure.md line 1322

**What it does**
Relm is an API-first CRM built for LLMs and AI agents. Connect Claude, ChatGPT, or any agent - OAuth sign-in or an API key - and it reads and writes contacts, companies, deals and activities over REST or native MCP. Free tier, no credit card.
...
- [https://relmcrm.com](https://relmcrm.com)
...
quoted from [https://relmcrm.com/docs](https://relmcrm.com/docs) on 2026-09-17, via npm
...
- [https://relmcrm.com/docs](https://relmcrm.com/docs) (the page that documented the CLI)
...
[https://relmcrm.com/docs](https://relmcrm.com/docs)
...
No GitHub organisation could be tied to relmcrm.com with evidence on 2026-09-15.
...
- [https://relmcrm.com](https://relmcrm.com)
- [https://relmcrm.com/docs](https://relmcrm.com/docs)
- [https://relmcrm.com/llms.txt](https://relmcrm.com/llms.txt)

3 source URLs. Raw sources field, verbatim:

https://relmcrm.com, https://relmcrm.com/docs, https://relmcrm.com/llms.txt

**Notes, verbatim from the file**
API mentioned on https://relmcrm.com/docs; pricing/gate not inferred from presence alone. API mentioned on https://relmcrm.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 07-relm-crm
