# Chatflow: MCP server status, API access gate and what it does

> WhatsApp CRM for AI agents: search contacts, read chats, manage the sales pipeline, send messages. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [chatflow.biz](https://chatflow.biz) · entry id 07-chatflow · source 07-mcp-infrastructure.md line 3798
...
https://github.com/Yersat/chatflow-mcp

- [https://github.com/Yersat/chatflow-mcp](https://github.com/Yersat/chatflow-mcp)
...
[https://chatflow.biz/docs](https://chatflow.biz/docs)
