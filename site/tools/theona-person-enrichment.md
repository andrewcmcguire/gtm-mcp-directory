# Theona Person Enrichment: MCP server status, API access gate and what it does

> Identify a person from partial information and return a profile with a confidence score per field. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://api.theona.ai/mcp/person-enrichment](https://api.theona.ai/mcp/person-enrichment) · entry id 01-theona-person-enrichment · source 01-data-enrichment.md line 4684
...
- [https://api.theona.ai/mcp/person-enrichment](https://api.theona.ai/mcp/person-enrichment)
