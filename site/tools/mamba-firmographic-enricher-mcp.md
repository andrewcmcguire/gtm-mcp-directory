# Mamba Firmographic Enricher MCP: MCP server status, API access gate and what it does

> MCP server for the Mamba Labs Company Firmographic Enricher actor: employees, industry, HQ, founded, revenue,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Mamba Firmographic Enricher MCP
...
Vendor: [github.com/mambalabsdev/mcp-company-firmographic-enricher](https://github.com/mambalabsdev/mcp-company-firmographic-enricher) · entry id 01-mamba-firmographic-enricher-mcp · source 01-data-enrichment.md line 2065
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/mambalabsdev/mcp-company-firmographic-enricher](https://github.com/mambalabsdev/mcp-company-firmographic-enricher)
- [https://github.com/punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
...
https://github.com/mambalabsdev/mcp-company-firmographic-enricher, https://github.com/docs, https://github.com/developers, https://github.com/punkpeye/awesome-mcp-servers

**Notes, verbatim from the file**
mcp_status=community from discovery source awesome-mcp-servers; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave H 2026-09-12: canonical name Mamba Firmographic Enricher MCP (draft listed as mambalabsdev/mcp-company-firmographic-enricher).

**Provenance**

- **Entry id**: 01-mamba-firmographic-enricher-mcp
