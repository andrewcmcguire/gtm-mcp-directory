# Vesxo Connect: MCP server status, API access gate and what it does

> Secure, AI-compatible Model Context Protocol (MCP) server for connecting AI agents to Vesxo SaaS ecosystem... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [npmjs.com/package/@vesxo/connect](https://npmjs.com/package/@vesxo/connect) · entry id 07-vesxo-connect · source 07-mcp-infrastructure.md line 1101
