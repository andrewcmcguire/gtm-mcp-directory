# ManyContacts npm MCP: MCP server status, API access gate and what it does

> # ManyContacts MCP Server  MCP (Model Context Protocol) server for [ManyContacts](https://manycontacts.com) -... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.npmjs.com/package/@manycontacts/mcp](https://www.npmjs.com/package/@manycontacts/mcp) · entry id 07-manycontacts-npm-mcp · source 07-mcp-infrastructure.md line 5230

**What it does**
# ManyContacts MCP Server MCP (Model Context Protocol) server for [ManyContacts](https://manycontacts.com) - the WhatsApp Business CRM. Enables AI agents (Claude, Cursor, Windsurf, etc.) to manage contacts, send WhatsApp messages, run campaigns, configure AI auto-replies, and...
...
Homepage fetch failed (HTTPError 403); what_it_does used staging desc. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name ManyContacts npm MCP (draft listed as ManyContacts.com MCP for WhatsApp Business).

**Provenance**

- **Entry id**: 07-manycontacts-npm-mcp
