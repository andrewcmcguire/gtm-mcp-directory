# GramClaw: MCP server status, API access gate and what it does

> Connect Telegram to Claude, Cursor, and any MCP client with the GramClaw Telegram MCP server. Search chats,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://gramclaw.com/en/telegram-mcp](https://gramclaw.com/en/telegram-mcp) · entry id 02-gramclaw · source 02-engagement-outbound.md line 2964

**What it does**
Connect Telegram to Claude, Cursor, and any MCP client with the GramClaw Telegram MCP server. Search chats, send messages, run broadcasts, and launch campaigns in natural language.
...
https://github.com/liquiden/grmcw

- [https://github.com/liquiden/grmcw](https://github.com/liquiden/grmcw)
...
No GitHub organisation could be tied to gramclaw.com with evidence on 2026-09-15.
...
- [https://gramclaw.com/en/telegram-mcp](https://gramclaw.com/en/telegram-mcp)
- [https://gramclaw.com/llms.txt](https://gramclaw.com/llms.txt)
- [https://github.com/liquiden/grmcw](https://github.com/liquiden/grmcw)

3 source URLs. Raw sources field, verbatim:

https://gramclaw.com/en/telegram-mcp, https://gramclaw.com/llms.txt, https://github.com/liquiden/grmcw

**Notes, verbatim from the file**
API mentioned on https://gramclaw.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12.

**Provenance**

- **Entry id**: 02-gramclaw
