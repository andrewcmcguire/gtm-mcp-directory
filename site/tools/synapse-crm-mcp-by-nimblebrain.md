# Synapse CRM MCP by NimbleBrain: MCP server status, API access gate and what it does

> Lightweight CRM with contact management, deal pipeline, and agent-driven follow-ups ΓÇö Synapse app for... Community MCP, Gate unknown. Checked 2026-09-12.
...
Synapse CRM MCP by NimbleBrain
...
Vendor: [github.com/NimbleBrainInc/synapse-crm](https://github.com/NimbleBrainInc/synapse-crm) · entry id 07-synapse-crm-mcp-by-nimblebrain · source 07-mcp-infrastructure.md line 2351
...
https://github.com/NimbleBrainInc/synapse-crm

- [https://github.com/NimbleBrainInc/synapse-crm](https://github.com/NimbleBrainInc/synapse-crm)
...
[https://mpak.dev/docs/](https://mpak.dev/docs/)
...
- [https://mpak.dev/docs/](https://mpak.dev/docs/)
- [https://mpak.dev/llms.txt](https://mpak.dev/llms.txt)
- [https://github.com/NimbleBrainInc/synapse-crm](https://github.com/NimbleBrainInc/synapse-crm)

3 source URLs. Raw sources field, verbatim:

https://mpak.dev/docs/, https://mpak.dev/llms.txt, https://github.com/NimbleBrainInc/synapse-crm

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 404); what_it_does used staging desc. API mentioned on https://mpak.dev/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave J 2026-09-12: canonical name Synapse CRM MCP by NimbleBrain (draft listed as NimbleBrainInc/synapse-crm).

**Provenance**

- **Entry id**: 07-synapse-crm-mcp-by-nimblebrain
