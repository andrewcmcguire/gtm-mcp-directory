# Infona: MCP server status, API access gate and what it does

> A self-maintaining data layer. Infona holds one reconciled record of what is actually the case, re-verifies... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [infona.ai](https://infona.ai) · entry id 01-infona · source 01-data-enrichment.md line 2693

**What it does**
A self-maintaining data layer. Infona holds one reconciled record of what is actually the case, re-verifies its own facts, de-dupes and enriches them, and carries the source for every claim. Open source, Apache 2.0.
...
quoted from [https://www.npmjs.com/package/@infona-ai/cli](https://www.npmjs.com/package/@infona-ai/cli) on 2026-09-15, via npm

Packages seen, with the version on 2026-09-15:

- [npm: @infona-ai/cli 0.1.66](https://www.npmjs.com/package/@infona-ai/cli)
...
[https://infona.ai/docs](https://infona.ai/docs)
...
No GitHub organisation could be tied to infona.ai with evidence on 2026-09-15.
...
- [https://infona.ai](https://infona.ai)
- [https://infona.ai/docs](https://infona.ai/docs)
- [https://www.npmjs.com/search?q=mcp%20enrichment](https://www.npmjs.com/search?q=mcp%20enrichment)

3 source URLs. Raw sources field, verbatim:

https://infona.ai, https://infona.ai/docs, https://www.npmjs.com/search?q=mcp%20enrichment

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave L 2026-09-12: canonical name Infona (draft listed as @infona-ai/mcp).
