# Local SEO Data: MCP server status, API access gate and what it does

> Get local pack rankings, business profiles, reviews, citations, and competitive intelligence - without paying... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [localseodata.com](https://localseodata.com) · entry id 01-local-seo-data · source 01-data-enrichment.md line 4580

**What it does**
Get local pack rankings, business profiles, reviews, citations, and competitive intelligence - without paying for 5 different tools. One API and MCP server for all your local SEO data needs.
...
https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm

- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm)
...
[https://localseodata.com/docs](https://localseodata.com/docs)
...
No GitHub organisation could be tied to localseodata.com with evidence on 2026-09-15.
...
- [https://localseodata.com](https://localseodata.com)
- [https://localseodata.com/docs](https://localseodata.com/docs)
- [https://localseodata.com/llms.txt](https://localseodata.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm)

4 source URLs. Raw sources field, verbatim:

https://localseodata.com, https://localseodata.com/docs, https://localseodata.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm

**Notes, verbatim from the file**
API mentioned on https://localseodata.com/docs; pricing/gate not inferred from presence alone. API mentioned on https://localseodata.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave S 2026-09-12.

**Provenance**

- **Entry id**: 01-local-seo-data
