# Apollo Agent CLI by bcharleson: MCP server status, API access gate and what it does

> Agent-native CLI and MCP server for Apollo.io REST API - bcharleson/apollo-agent-cli Community MCP, Gate unknown. Checked 2026-09-12.
...
Apollo Agent CLI by bcharleson
...
Vendor: [github.com/bcharleson/apollo-agent-cli](https://github.com/bcharleson/apollo-agent-cli) · entry id 07-apollo-agent-cli-by-bcharleson · source 07-mcp-infrastructure.md line 3759
...
https://github.com/bcharleson/apollo-agent-cli

- [https://github.com/bcharleson/apollo-agent-cli](https://github.com/bcharleson/apollo-agent-cli)
