# Wazion MCP Server: MCP server status, API access gate and what it does

> WAzion MCP Server - Connect AI agents to WhatsApp via WAzion API. Smart copilot, 24/7 automation, mass... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/wazionapps/mcp-server](https://github.com/wazionapps/mcp-server) · entry id 07-wazion-mcp-server · source 07-mcp-infrastructure.md line 4946
...
- [https://github.com/wazionapps/mcp-server](https://github.com/wazionapps/mcp-server)
