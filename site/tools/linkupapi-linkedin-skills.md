# LinkupAPI LinkedIn Skills: MCP server status, API access gate and what it does

> Claude Skills for LinkedIn outreach, high-intent leads, feed engagement, and profile enrichment via LinkupAPI... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [linkupapi.com](https://linkupapi.com) · entry id 01-linkupapi-linkedin-skills · source 01-data-enrichment.md line 2817

**What it does**
Claude Skills for LinkedIn outreach, high-intent leads, feed engagement, and profile enrichment via LinkupAPI MCP.
...
https://github.com/claude-dev-code/claude-skills-linkedin

- [https://github.com/claude-dev-code/claude-skills-linkedin](https://github.com/claude-dev-code/claude-skills-linkedin)
...
No GitHub organisation could be tied to linkupapi.com with evidence on 2026-09-15.
...
- [https://linkupapi.com](https://linkupapi.com)
- [https://linkupapi.com/llms.txt](https://linkupapi.com/llms.txt)
- [https://github.com/claude-dev-code/claude-skills-linkedin](https://github.com/claude-dev-code/claude-skills-linkedin)

3 source URLs. Raw sources field, verbatim:

https://linkupapi.com, https://linkupapi.com/llms.txt, https://github.com/claude-dev-code/claude-skills-linkedin

**Notes, verbatim from the file**
API mentioned on https://linkupapi.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave N 2026-09-12: canonical name LinkupAPI LinkedIn Skills (draft listed as claude-dev-code/claude-skills-linkedin). Category corrected from email-deliverability to data-enrichment.

**Provenance**

- **Entry id**: 01-linkupapi-linkedin-skills
