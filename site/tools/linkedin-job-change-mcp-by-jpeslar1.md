# LinkedIn Job Change MCP by jpeslar1: MCP server status, API access gate and what it does

> Daily job-change trigger for Claude Code. Detects changes the day they happen via LinkedIn MCP (Zevari) - not... Community MCP, Gate unknown. Checked 2026-09-12.
...
LinkedIn Job Change MCP by jpeslar1
...
Vendor: [github.com/jpeslar1/linkedin-mcp-job-change-trigger](https://github.com/jpeslar1/linkedin-mcp-job-change-trigger) · entry id 05-linkedin-job-change-mcp-by-jpeslar1 · source 05-signals-intent-abm.md line 1169
...
https://github.com/jpeslar1/linkedin-mcp-job-change-trigger

- [https://github.com/jpeslar1/linkedin-mcp-job-change-trigger](https://github.com/jpeslar1/linkedin-mcp-job-change-trigger)
...
https://github.com/jpeslar1/linkedin-mcp-job-change-trigger, https://github.com/docs, https://github.com/developers

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave H 2026-09-12: canonical name LinkedIn Job Change MCP by jpeslar1 (draft listed as jpeslar1/linkedin-mcp-job-change-trigger). Category corrected from mcp-infrastructure to signals-intent-abm.

**Provenance**

- **Entry id**: 05-linkedin-job-change-mcp-by-jpeslar1
