# Salesforce MCP by imazhar101: MCP server status, API access gate and what it does

> A lite, single-org Salesforce MCP server on jsforce. Bring-your-own OAuth token, stdio or streamable-HTTP. -... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/imazhar101/salesforce-mcp-jsforce](https://github.com/imazhar101/salesforce-mcp-jsforce) · entry id 07-salesforce-mcp-by-imazhar101 · source 07-mcp-infrastructure.md line 1927
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/imazhar101/salesforce-mcp-jsforce](https://github.com/imazhar101/salesforce-mcp-jsforce)
...
https://github.com/imazhar101/salesforce-mcp-jsforce, https://github.com/docs, https://github.com/developers, https://www.npmjs.com/search?q=mcp-server%20salesforce

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave H 2026-09-12: canonical name Salesforce MCP by imazhar101 (draft listed as @imazhar101/salesforce-mcp-jsforce).

**Provenance**

- **Entry id**: 07-salesforce-mcp-by-imazhar101
