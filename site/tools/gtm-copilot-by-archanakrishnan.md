# GTM Copilot by archanakrishnan: MCP server status, API access gate and what it does

> AI-powered GTM intelligence, lead scoring, personalized outreach, and HubSpot CRM automation built with n8n,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/archanakrishnan094-max/AI-GTM-Copilot-End-to-End-GTM-Intelligence-CRM-Automation](https://github.com/archanakrishnan094-max/AI-GTM-Copilot-End-to-End-GTM-Intelligence-CRM-Automation) · entry id 07-gtm-copilot-by-archanakrishnan · source 07-mcp-infrastructure.md line 2631
...
https://github.com/archanakrishnan094-max/AI-GTM-Copilot-End-to-End-GTM-Intelligence-CRM-Automation

- [https://github.com/archanakrishnan094-max/AI-GTM-Copilot-End-to-End-GTM-Intelligence-CRM-Automation](https://github.com/archanakrishnan094-max/AI-GTM-Copilot-End-to-End-GTM-Intelligence-CRM-Automation)
...
https://github.com/archanakrishnan094-max/AI-GTM-Copilot-End-to-End-GTM-Intelligence-CRM-Automation, https://github.com/docs, https://github.com/developers

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave J 2026-09-12: canonical name GTM Copilot by archanakrishnan (draft listed as archanakrishnan094-max/AI-GTM-Copilot-End-to-End-GTM-Intelligence-CRM-Automation).

**Provenance**

- **Entry id**: 07-gtm-copilot-by-archanakrishnan
