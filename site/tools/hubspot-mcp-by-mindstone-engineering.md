# HubSpot MCP by mindstone-engineering: MCP server status, API access gate and what it does
...
HubSpot MCP by mindstone-engineering
...
Vendor: [github.com/mindstone/mcp-servers](https://github.com/mindstone/mcp-servers) · entry id 07-hubspot-mcp-by-mindstone-engineering · source 07-mcp-infrastructure.md line 1785
...
https://www.npmjs.com/search?q=mcp-server%20hubspot

- [https://www.npmjs.com/search?q=mcp-server%20hubspot](https://www.npmjs.com/search?q=mcp-server%20hubspot)
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/mindstone/mcp-servers/tree/main/connectors/hubspot](https://github.com/mindstone/mcp-servers/tree/main/connectors/hubspot)
...
https://github.com/mindstone/mcp-servers/tree/main/connectors/hubspot, https://github.com/docs, https://github.com/developers, https://www.npmjs.com/search?q=mcp-server%20hubspot

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave G 2026-09-12: canonical name HubSpot MCP by mindstone-engineering (draft listed as @mindstone-engineering/mcp-server-hubspot).

**Provenance**

- **Entry id**: 07-hubspot-mcp-by-mindstone-engineering
