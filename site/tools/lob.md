# Lob: MCP server status, API access gate and what it does

> Automate and personalize direct mail at scale while our nationwide print network speeds delivery, controls... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [lob.com](https://lob.com) · entry id 02-lob · source 02-engagement-outbound.md line 1977

**What it does**
Automate and personalize direct mail at scale while our nationwide print network speeds delivery, controls postage costs, and keeps every send compliant.
...
[https://docs.lob.com/](https://docs.lob.com/)
...
No GitHub organisation could be tied to lob.com with evidence on 2026-09-15.
...
- [https://docs.lob.com/](https://docs.lob.com/)
- [https://www.lob.com/use-cases/in-house-operations](https://www.lob.com/use-cases/in-house-operations)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://www.lob.com/, https://docs.lob.com/, https://www.lob.com/use-cases/in-house-operations, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://docs.lob.com/; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from revops-infra to engagement-outbound.
