# ICT CRM MCP: MCP server status, API access gate and what it does

> ICTCRM is a CRM with a full contact center inside: auto dialer, campaigns, AI voice agent, and a timeline... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [ictcrm.com](https://ictcrm.com) · entry id 07-ict-crm-mcp · source 07-mcp-infrastructure.md line 4686

**What it does**
ICTCRM is a CRM with a full contact center inside: auto dialer, campaigns, AI voice agent, and a timeline that logs every call, text and email automatically.
...
https://github.com/ictinnovations/ictcrm-mcp

- [https://github.com/ictinnovations/ictcrm-mcp](https://github.com/ictinnovations/ictcrm-mcp)
...
No GitHub organisation could be tied to ictcrm.com with evidence on 2026-09-15.
...
- [https://www.ictcrm.com/](https://www.ictcrm.com/)
- [https://www.ictcrm.com/mcp-ai-agent-open-source-crm-agentic-sales/](https://www.ictcrm.com/mcp-ai-agent-open-source-crm-agentic-sales/)
- [https://github.com/ictinnovations/ictcrm-mcp](https://github.com/ictinnovations/ictcrm-mcp)

3 source URLs. Raw sources field, verbatim:

https://www.ictcrm.com/, https://www.ictcrm.com/mcp-ai-agent-open-source-crm-agentic-sales/, https://github.com/ictinnovations/ictcrm-mcp

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name ICT CRM MCP (draft listed as io.github.ictinnovations/ictcrm-mcp).

**Provenance**

- **Entry id**: 07-ict-crm-mcp
