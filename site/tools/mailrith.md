# Mailrith: MCP server status, API access gate and what it does

> Connect Mailrith from Claude Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://mailrith.com/developers/mcp](https://mailrith.com/developers/mcp) · entry id 02-mailrith · source 02-engagement-outbound.md line 3208
...
https://github.com/anrawool/mailrith-agent-platform

- [https://github.com/anrawool/mailrith-agent-platform](https://github.com/anrawool/mailrith-agent-platform)
...
```
npm install -g @mailrith/cli
```

quoted from [https://www.npmjs.com/package/@mailrith/cli](https://www.npmjs.com/package/@mailrith/cli) on 2026-09-18, via npm

Packages seen, with the version on 2026-09-18:

- [npm: @mailrith/cli 1.1.2](https://www.npmjs.com/package/@mailrith/cli)
...
[https://mailrith.com/docs](https://mailrith.com/docs)
...
No GitHub organisation could be tied to mailrith.com with evidence on 2026-09-15.
...
- [https://mailrith.com/developers/mcp](https://mailrith.com/developers/mcp)
- [https://mailrith.com/docs](https://mailrith.com/docs)
- [https://mailrith.com/developers](https://mailrith.com/developers)
- [https://github.com/anrawool/mailrith-agent-platform](https://github.com/anrawool/mailrith-agent-platform)

4 source URLs. Raw sources field, verbatim:

https://mailrith.com/developers/mcp, https://mailrith.com/docs, https://mailrith.com/developers, https://github.com/anrawool/mailrith-agent-platform

**Notes, verbatim from the file**
API mentioned on https://mailrith.com/docs; pricing/gate not inferred from presence alone. API mentioned on https://mailrith.com/developers; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name Mailrith (draft listed as Mailrith Email Marketing).

**Provenance**

- **Entry id**: 02-mailrith
