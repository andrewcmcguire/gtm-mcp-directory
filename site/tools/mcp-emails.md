# MCP Emails: MCP server status, API access gate and what it does

> Connect Gmail, Fastmail, iCloud, Yahoo, Zoho, Yandex, or IMAP email to Claude, Cursor, ChatGPT, and any MCP... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [mcpemails.com](https://mcpemails.com) · entry id 02-mcp-emails · source 02-engagement-outbound.md line 3328

**What it does**
Connect Gmail, Fastmail, iCloud, Yahoo, Zoho, Yandex, or IMAP email to Claude, Cursor, ChatGPT, and any MCP client. Read, search, draft, approve, and send email live with provider-aware controls.
...
No GitHub organisation could be tied to mcpemails.com with evidence on 2026-09-15.
...
- [https://mcpemails.com](https://mcpemails.com)
- [https://mcpemails.com/docs](https://mcpemails.com/docs)
- [https://mcpemails.com/llms.txt](https://mcpemails.com/llms.txt)
- [https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm)

4 source URLs. Raw sources field, verbatim:

https://mcpemails.com, https://mcpemails.com/docs, https://mcpemails.com/llms.txt, https://registry.smithery.ai/servers?page=2&pageSize=100&q=crm

**Notes, verbatim from the file**
API mentioned on https://mcpemails.com/docs; pricing/gate not inferred from presence alone. API mentioned on https://mcpemails.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12.

**Provenance**

- **Entry id**: 02-mcp-emails
