# PromptLoop: MCP server status, API access gate and what it does

> AI platform for GTM & B2B Sales: Automate web scraping, Deep Research, and CRM data enrichment for accurate... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [promptloop.com](https://promptloop.com) · entry id 01-promptloop · source 01-data-enrichment.md line 2533

**What it does**
AI platform for GTM & B2B Sales: Automate web scraping, Deep Research, and CRM data enrichment for accurate B2B insights. 10x faster B2B research. Get started free.
...
quoted from [https://www.npmjs.com/package/@promptloop/cli](https://www.npmjs.com/package/@promptloop/cli) on 2026-09-15, via npm

Packages seen, with the version on 2026-09-15:

- [npm: @promptloop/cli 0.2.0](https://www.npmjs.com/package/@promptloop/cli)
...
[https://www.promptloop.com/docs/choosing-function](https://www.promptloop.com/docs/choosing-function)
...
No GitHub organisation could be tied to promptloop.com with evidence on 2026-09-15.
...
- [https://www.promptloop.com/docs/choosing-function](https://www.promptloop.com/docs/choosing-function)
- [https://www.promptloop.com/llms.txt](https://www.promptloop.com/llms.txt)
- [https://yc-oss.github.io/api/tags/sales.json](https://yc-oss.github.io/api/tags/sales.json)

4 source URLs. Raw sources field, verbatim:

https://www.promptloop.com/, https://www.promptloop.com/docs/choosing-function, https://www.promptloop.com/llms.txt, https://yc-oss.github.io/api/tags/sales.json
