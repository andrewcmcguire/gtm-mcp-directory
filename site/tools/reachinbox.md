# ReachInbox: MCP server status, API access gate and what it does

> Use AI to find prospects that need you, automatically craft personalized cold emails for each, and scale... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [reachinbox.ai](https://reachinbox.ai) · entry id 02-reachinbox · source 02-engagement-outbound.md line 1349

**What it does**
Use AI to find prospects that need you, automatically craft personalized cold emails for each, and scale effortlessly
...
No GitHub organisation could be tied to reachinbox.ai with evidence on 2026-09-15.
...
- [https://reachinbox.ai](https://reachinbox.ai)
- [https://www.clay.com/integrations/data-provider/reachinbox-ai](https://www.clay.com/integrations/data-provider/reachinbox-ai)

2 source URLs. Raw sources field, verbatim:

https://reachinbox.ai, https://www.clay.com/integrations/data-provider/reachinbox-ai

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave F 2026-09-12: canonical name ReachInbox (draft listed as ReachInbox.ai). Category corrected from data-enrichment to engagement-outbound.

**Provenance**

- **Entry id**: 02-reachinbox
