# PartnerStack: MCP server status, API access gate and what it does

> Grow your SaaS brand the easy way. PartnerStack helps you recruit, engage, and scale your entire ecosystem of... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: partnerstack (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [partnerstack.com](https://partnerstack.com) · entry id 06-partnerstack · source 06-revops-infra.md line 1800
...
quoted from [https://www.npmjs.com/package/partnerstack-cli](https://www.npmjs.com/package/partnerstack-cli) on 2026-09-18, via npm, a third party source

Packages seen, with the version on 2026-09-18:

- [npm: partnerstack-cli 0.1.2, third party](https://www.npmjs.com/package/partnerstack-cli)
...
No GitHub organisation could be tied to partnerstack.com with evidence on 2026-09-15.
...
- [https://partnerstack.com/platform/ai](https://partnerstack.com/platform/ai)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://partnerstack.com, https://partnerstack.com/platform/ai, https://yc-oss.github.io/api/industries/marketing.json
