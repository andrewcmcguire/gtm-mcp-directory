# Apex Log MCP by Certinia: MCP server status, API access gate and what it does

> Apex Log MCP Server - AI-powered Salesforce Apex debug log analysis. Find performance bottlenecks, slow... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.npmjs.com/package/@certinia/apex-log-mcp](https://www.npmjs.com/package/@certinia/apex-log-mcp) · entry id 07-apex-log-mcp-by-certinia · source 07-mcp-infrastructure.md line 837
...
- [https://github.com/certinia/debug-log-analyzer-mcp](https://github.com/certinia/debug-log-analyzer-mcp)
...
Homepage fetch failed (HTTPError 403); what_it_does used staging desc. mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave C 2026-09-12: canonical name Apex Log MCP by Certinia (draft listed as certinia/debug-log-analyzer-mcp).

**Provenance**

- **Entry id**: 07-apex-log-mcp-by-certinia
