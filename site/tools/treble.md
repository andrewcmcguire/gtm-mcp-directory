# Treble: MCP server status, API access gate and what it does

> Conoce Treble.ai, la mejor solución de IA para WhatsApp adaptada a cualquier empresa. Llega a más clientes... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: treble (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [treble.ai](https://treble.ai) · entry id 02-treble · source 02-engagement-outbound.md line 1045

**What it does**
Conoce Treble.ai, la mejor solución de IA para WhatsApp adaptada a cualquier empresa. Llega a más clientes con WhatsApp automatizado.
...
quoted from [https://www.npmjs.com/package/@treble-app/cli](https://www.npmjs.com/package/@treble-app/cli) on 2026-09-18, via npm, a third party source

```
pip install treble
```

quoted from [https://pypi.org/project/treble/](https://pypi.org/project/treble/) on 2026-09-18, via pypi, a third party source

Packages seen, with the version on 2026-09-18:

- [npm: @treble-app/cli 1.4.0, third party](https://www.npmjs.com/package/@treble-app/cli)
- [pypi: treble 0.0.1, third party](https://pypi.org/project/treble/)
...
No GitHub organisation could be tied to treble.ai with evidence on 2026-09-15.
...
- [https://treble.ai](https://treble.ai)
- [https://treble.ai/llms.txt](https://treble.ai/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://treble.ai, https://treble.ai/llms.txt, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://treble.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave D 2026-09-12: canonical name Treble (draft listed as treble.ai). Category corrected from ai-sdr-agents to engagement-outbound.
