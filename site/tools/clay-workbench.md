# Clay Workbench: MCP server status, API access gate and what it does

> Build, debug, and run Clay.com workbooks end-to-end via Claude Code. Hybrid router skill with 6 sub-skills:... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/guerrilla2799/clay-workbench](https://github.com/guerrilla2799/clay-workbench) · entry id 01-clay-workbench · source 01-data-enrichment.md line 2431

**What it does**
Build, debug, and run Clay.com workbooks end-to-end via Claude Code. Hybrid router skill with 6 sub-skills: ABM lists, enrichment waterfalls, ICP scoring, outbound, inbound routing, troubleshooting. MCP-first execution. Mandatory credit pre-flight. 8 Global Rules. 3 golden templates. - guerrilla2799/clay-workbench
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/guerrilla2799/clay-workbench](https://github.com/guerrilla2799/clay-workbench)
