# Manatee: MCP server status, API access gate and what it does

> DocSend for demos. No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: manatee (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [trymanatee.com](https://trymanatee.com) · entry id 13-manatee · source 13-proposals-deals.md line 496
...
quoted from [https://www.npmjs.com/package/@trymanateeai/cli](https://www.npmjs.com/package/@trymanateeai/cli) on 2026-09-18, via npm, a third party source

Packages seen, with the version on 2026-09-18:

- [npm: @trymanateeai/cli 0.8.0, third party](https://www.npmjs.com/package/@trymanateeai/cli)
...
No GitHub organisation could be tied to trymanatee.com with evidence on 2026-09-15.
...
https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
Homepage fetch failed (URLError: <urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: Hostname mismatch, certificate is not valid for 'www.trymanatee.com'. (_ssl.c:1010)>); what_it_does used YC/source one_liner. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from revops-infra to proposals-deals.
