# Candu: MCP server status, API access gate and what it does

> Candu lets product and growth teams build, launch, and iterate in-app onboarding & engagement flows-without... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [candu.ai](https://candu.ai) · entry id 14-candu · source 14-inbound-plg-chat.md line 516

**What it does**
Candu lets product and growth teams build, launch, and iterate in-app onboarding & engagement flows-without engineering.
...
No GitHub organisation could be tied to candu.ai with evidence on 2026-09-15.
