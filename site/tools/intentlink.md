# IntentLink: MCP server status, API access gate and what it does

> IntentLink is the commercial intent network for the AI agent era - developers monetize conversations via MCP... Community MCP, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: intentlink (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [intentlink.io](https://intentlink.io) · entry id 05-intentlink · source 05-signals-intent-abm.md line 1682

**What it does**
IntentLink is the commercial intent network for the AI agent era - developers monetize conversations via MCP and Skills; advertisers reach high-intent buyers.
...
https://github.com/whalefuntech/intentlink_docs

- [https://github.com/whalefuntech/intentlink_docs](https://github.com/whalefuntech/intentlink_docs)
...
quoted from [https://www.npmjs.com/package/intentlink-cli](https://www.npmjs.com/package/intentlink-cli) on 2026-09-18, via npm, a third party source

Packages seen, with the version on 2026-09-18:

- [npm: intentlink-cli 1.1.0, third party](https://www.npmjs.com/package/intentlink-cli)
...
[https://intentlink.io/docs](https://intentlink.io/docs)
...
No GitHub organisation could be tied to intentlink.io with evidence on 2026-09-15.
...
- [https://intentlink.io](https://intentlink.io)
- [https://intentlink.io/docs](https://intentlink.io/docs)
- [https://intentlink.io/developers](https://intentlink.io/developers)
- [https://github.com/whalefuntech/intentlink_docs](https://github.com/whalefuntech/intentlink_docs)

4 source URLs. Raw sources field, verbatim:

https://intentlink.io, https://intentlink.io/docs, https://intentlink.io/developers, https://github.com/whalefuntech/intentlink_docs

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name IntentLink (draft listed as io.github.whalefuntech/intentlink).

**Provenance**

- **Entry id**: 05-intentlink
