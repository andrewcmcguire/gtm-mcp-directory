# Noto CRM: MCP server status, API access gate and what it does

> Parle à ton agent IA: leads, relances et deals se mettent à jour automatiquement. Noto est un CRM minimaliste... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [no-to.fr](https://no-to.fr) · entry id 06-noto-crm · source 06-revops-infra.md line 2189

**What it does**
Parle à ton agent IA: leads, relances et deals se mettent à jour automatiquement. Noto est un CRM minimaliste pour freelances et solopreneurs. Gratuit pour commencer.
...
[https://www.no-to.fr/docs](https://www.no-to.fr/docs)
...
No GitHub organisation could be tied to no-to.fr with evidence on 2026-09-15.
...
- [https://www.no-to.fr/](https://www.no-to.fr/)
- [https://www.no-to.fr/docs](https://www.no-to.fr/docs)
- [https://www.no-to.fr/developers](https://www.no-to.fr/developers)
- [https://registry.smithery.ai/servers?page=2&pageSize=100&q=sales](https://registry.smithery.ai/servers?page=2&pageSize=100&q=sales)

4 source URLs. Raw sources field, verbatim:

https://www.no-to.fr/, https://www.no-to.fr/docs, https://www.no-to.fr/developers, https://registry.smithery.ai/servers?page=2&pageSize=100&q=sales

**Notes, verbatim from the file**
mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12.

**Provenance**

- **Entry id**: 06-noto-crm
