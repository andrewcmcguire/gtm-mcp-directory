...
- [https://github.com/ClickHouse/clickhouse-fivetran-destination](https://github.com/ClickHouse/clickhouse-fivetran-destination) (the repository that documented it)
