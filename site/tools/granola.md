...
quoted from [https://www.npmjs.com/package/granola-cli](https://www.npmjs.com/package/granola-cli) on 2026-09-14, via npm, a third party source

```
npm install -g granola-to-minutes
```

quoted from [https://www.npmjs.com/package/granola-to-minutes](https://www.npmjs.com/package/granola-to-minutes) on 2026-09-14, via npm, a third party source

```
npm install -g @toolittlecakes/granola-cli
```

quoted from [https://www.npmjs.com/package/@toolittlecakes/granola-cli](https://www.npmjs.com/package/@toolittlecakes/granola-cli) on 2026-09-14, via npm, a third party source

```
npm install -g @doist/granola-cli
```

quoted from [https://www.npmjs.com/package/@doist/granola-cli](https://www.npmjs.com/package/@doist/granola-cli) on 2026-09-14, via npm, a third party source

```
pip install granola-cli
```

quoted from [https://pypi.org/project/granola-cli/](https://pypi.org/project/granola-cli/) on 2026-09-14, via pypi, a third party source
