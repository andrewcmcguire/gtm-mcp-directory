...
auth, graph, thread, tools, version

Where it was documented:

- [https://github.com/qubitgg/clickerheroes-endgame](https://github.com/qubitgg/clickerheroes-endgame) (the repository that documented it)
