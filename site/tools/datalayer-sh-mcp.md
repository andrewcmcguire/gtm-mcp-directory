# DataLayer.sh MCP: MCP server status, API access gate and what it does

> B2B enrichment API with 60M companies and 300M verified contacts. Enrich by domain or email - get intent... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [datalayer.sh](https://datalayer.sh) · entry id 01-datalayer-sh-mcp · source 01-data-enrichment.md line 3299

**What it does**
B2B enrichment API with 60M companies and 300M verified contacts. Enrich by domain or email - get intent signals, technographics, funding data, and verified contacts in one API call. MCP-native for AI agents.
...
https://github.com/datalayer-sh/mcp

- [https://github.com/datalayer-sh/mcp](https://github.com/datalayer-sh/mcp)
...
[https://datalayer.sh/docs](https://datalayer.sh/docs)
...
No GitHub organisation could be tied to datalayer.sh with evidence on 2026-09-15.
...
- [https://datalayer.sh](https://datalayer.sh)
- [https://datalayer.sh/docs](https://datalayer.sh/docs)
- [https://datalayer.sh/developers](https://datalayer.sh/developers)
- [https://github.com/datalayer-sh/mcp](https://github.com/datalayer-sh/mcp)

4 source URLs. Raw sources field, verbatim:

https://datalayer.sh, https://datalayer.sh/docs, https://datalayer.sh/developers, https://github.com/datalayer-sh/mcp

**Notes, verbatim from the file**
API mentioned on https://datalayer.sh/docs; pricing/gate not inferred from presence alone. API mentioned on https://datalayer.sh/developers; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name DataLayer.sh MCP (draft listed as datalayer-sh/mcp).

**Provenance**

- **Entry id**: 01-datalayer-sh-mcp
