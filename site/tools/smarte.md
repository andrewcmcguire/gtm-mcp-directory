# SMARTe: MCP server status, API access gate and what it does

> Actionable Sales Intelligence built over 289M+ global B2B contacts. Access verified mobile numbers and... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [smarte.pro](https://smarte.pro) · entry id 01-smarte · source 01-data-enrichment.md line 1377

**What it does**
Actionable Sales Intelligence built over 289M+ global B2B contacts. Access verified mobile numbers and business emails for prospecting, trusted by Sales Leaders.
...
[https://www.smarte.pro/api](https://www.smarte.pro/api)
...
No GitHub organisation could be tied to smarte.pro with evidence on 2026-09-15.
...
- [https://www.smarte.pro](https://www.smarte.pro)
- [https://www.smarte.pro/api](https://www.smarte.pro/api)
- [https://www.smarte.pro/llms.txt](https://www.smarte.pro/llms.txt)
- [https://www.clay.com/integrations/data-provider/smarte](https://www.clay.com/integrations/data-provider/smarte)

4 source URLs. Raw sources field, verbatim:

https://www.smarte.pro, https://www.smarte.pro/api, https://www.smarte.pro/llms.txt, https://www.clay.com/integrations/data-provider/smarte

**Notes, verbatim from the file**
API mentioned on https://www.smarte.pro/api; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.
