# LeadGenius: MCP server status, API access gate and what it does

> LeadGenius delivers real-time, compliant B2B contact data and buyer intelligence worldwide. Find... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [leadgenius.com](https://leadgenius.com) · entry id 01-leadgenius · source 01-data-enrichment.md line 1255

**What it does**
LeadGenius delivers real-time, compliant B2B contact data and buyer intelligence worldwide. Find decision-makers, activate leads, and scale revenue with precision.
...
quoted from [https://www.npmjs.com/package/leadgenius-cli](https://www.npmjs.com/package/leadgenius-cli) on 2026-09-17, via npm, a third party source

Packages seen, with the version on 2026-09-17:

- [npm: leadgenius-cli 2.0.15, third party](https://www.npmjs.com/package/leadgenius-cli)
...
No GitHub organisation could be tied to leadgenius.com with evidence on 2026-09-15.
...
- [https://www.leadgenius.com/llms.txt](https://www.leadgenius.com/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

3 source URLs. Raw sources field, verbatim:

https://www.leadgenius.com/, https://www.leadgenius.com/llms.txt, https://yc-oss.github.io/api/industries/sales.json
