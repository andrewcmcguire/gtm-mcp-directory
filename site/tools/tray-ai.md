# Tray.ai: MCP server status, API access gate and what it does

> Tray.ai is the AI-native enterprise iPaaS for building AI agents, governing Model Context Protocol (MCP), and... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [tray.ai](https://tray.ai) · entry id 06-tray-ai · source 06-revops-infra.md line 818

**What it does**
Tray.ai is the AI-native enterprise iPaaS for building AI agents, governing Model Context Protocol (MCP), and integrating 700+ apps - orchestration for data…
...
[https://tray.ai/documentation](https://tray.ai/documentation)
...
No GitHub organisation could be tied to tray.ai with evidence on 2026-09-15.
...
- [https://tray.ai/documentation](https://tray.ai/documentation)
- [https://market.zoominfo.com/app/tray](https://market.zoominfo.com/app/tray)

3 source URLs. Raw sources field, verbatim:

https://tray.ai, https://tray.ai/documentation, https://market.zoominfo.com/app/tray
