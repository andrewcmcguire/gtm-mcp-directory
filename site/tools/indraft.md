# Indraft: MCP server status, API access gate and what it does

> A canonical CRM designed to be read and written by AI agents through MCP and REST, with safe writes, full... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [indraft.io](https://indraft.io) · entry id 07-indraft · source 07-mcp-infrastructure.md line 3576
...
- [https://indraft.io](https://indraft.io)
...
[https://indraft.io/docs](https://indraft.io/docs)
...
https://indraft.io, https://indraft.io/docs

**Notes, verbatim from the file**
API mentioned on https://indraft.io/docs; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave M 2026-09-12: canonical name Indraft (draft listed as io.indraft/mcp).
