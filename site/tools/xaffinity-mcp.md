# xaffinity MCP: MCP server status, API access gate and what it does

> Unofficial strongly-typed Python SDK for the Affinity CRM API - full read/write coverage, Pydantic v2, MCP... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/yaniv-golan/affinity-sdk/tree/main/mcp](https://github.com/yaniv-golan/affinity-sdk/tree/main/mcp) · entry id 07-xaffinity-mcp · source 07-mcp-infrastructure.md line 5456
...
https://github.com/yaniv-golan/affinity-sdk

- [https://github.com/yaniv-golan/affinity-sdk](https://github.com/yaniv-golan/affinity-sdk)
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/yaniv-golan/affinity-sdk](https://github.com/yaniv-golan/affinity-sdk)
- [https://github.com/yaniv-golan/affinity-sdk/tree/main/mcp](https://github.com/yaniv-golan/affinity-sdk/tree/main/mcp)
...
https://github.com/yaniv-golan/affinity-sdk/tree/main/mcp, https://github.com/docs, https://github.com/developers, https://github.com/yaniv-golan/affinity-sdk

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave W 2026-09-12.

**Provenance**

- **Entry id**: 07-xaffinity-mcp
