# Whatcanido: MCP server status, API access gate and what it does

> Most software was built for humans clicking. We build the version the agent can use directly. One install,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [whatcanido.dev](https://whatcanido.dev) · entry id 07-whatcanido · source 07-mcp-infrastructure.md line 1260

**What it does**
Most software was built for humans clicking. We build the version the agent can use directly. One install, typed contracts, live conformance against real backends, MIT-licensed open spec.
...
https://whatcanido.dev/agents

- [https://whatcanido.dev/agents](https://whatcanido.dev/agents)
...
[https://www.whatcanido.dev/developers](https://www.whatcanido.dev/developers)
...
No GitHub organisation could be tied to whatcanido.dev with evidence on 2026-09-15.
...
- [https://www.whatcanido.dev/agents](https://www.whatcanido.dev/agents)
- [https://www.whatcanido.dev/developers](https://www.whatcanido.dev/developers)
- [https://www.whatcanido.dev/llms.txt](https://www.whatcanido.dev/llms.txt)
- [https://whatcanido.dev/agents](https://whatcanido.dev/agents)

4 source URLs. Raw sources field, verbatim:

https://www.whatcanido.dev/agents, https://www.whatcanido.dev/developers, https://www.whatcanido.dev/llms.txt, https://whatcanido.dev/agents

**Notes, verbatim from the file**
API mentioned on https://www.whatcanido.dev/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave E 2026-09-12: canonical name Whatcanido (draft listed as Whatcanido - MCP Server for Service Businesses).

**Provenance**

- **Entry id**: 07-whatcanido
