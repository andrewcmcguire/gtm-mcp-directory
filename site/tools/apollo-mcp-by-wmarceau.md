# Apollo MCP by wmarceau: MCP server status, API access gate and what it does

> Apollo.io lead enrichment and prospecting via MCP Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/MarceauSolutions/dev-sandbox](https://github.com/MarceauSolutions/dev-sandbox) · entry id 01-apollo-mcp-by-wmarceau · source 01-data-enrichment.md line 2897
...
https://github.com/MarceauSolutions/dev-sandbox

- [https://github.com/MarceauSolutions/dev-sandbox](https://github.com/MarceauSolutions/dev-sandbox)
