# SalesBuildr MCP by WYRE-AI: MCP server status, API access gate and what it does

> Manage quotes, proposals, and sales workflows in SalesBuildr. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://conduit.wyre.ai/plugins/salesbuildr](https://conduit.wyre.ai/plugins/salesbuildr) · entry id 13-salesbuildr-mcp-by-wyre-ai · source 13-proposals-deals.md line 729

**What it does**
Manage quotes, proposals, and sales workflows in SalesBuildr.
...
https://github.com/WYRE-AI/salesbuildr-mcp

- [https://github.com/WYRE-AI/salesbuildr-mcp](https://github.com/WYRE-AI/salesbuildr-mcp)
...
[https://conduit.wyre.ai/docs/](https://conduit.wyre.ai/docs/)
...
No GitHub organisation could be tied to conduit.wyre.ai with evidence on 2026-09-15.
...
- [https://conduit.wyre.ai/plugins/salesbuildr](https://conduit.wyre.ai/plugins/salesbuildr)
- [https://conduit.wyre.ai/docs/](https://conduit.wyre.ai/docs/)
- [https://conduit.wyre.ai/llms.txt](https://conduit.wyre.ai/llms.txt)
- [https://github.com/WYRE-AI/salesbuildr-mcp](https://github.com/WYRE-AI/salesbuildr-mcp)

4 source URLs. Raw sources field, verbatim:

https://conduit.wyre.ai/plugins/salesbuildr, https://conduit.wyre.ai/docs/, https://conduit.wyre.ai/llms.txt, https://github.com/WYRE-AI/salesbuildr-mcp

**Notes, verbatim from the file**
API mentioned on https://conduit.wyre.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave W 2026-09-12: canonical name SalesBuildr MCP by WYRE-AI (draft listed as WYRE-AI/salesbuildr-mcp).

**Provenance**

- **Entry id**: 13-salesbuildr-mcp-by-wyre-ai
