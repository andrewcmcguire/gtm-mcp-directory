# Orange Slice: MCP server status, API access gate and what it does

> Build go-to-market workflows with AI. Prospect, enrich, qualify, and automate GTM execution in Orange Slice. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [orangeslice.ai](https://orangeslice.ai) · entry id 01-orange-slice · source 01-data-enrichment.md line 1173
...
```
npm install -g @orangeslice/cli
```

quoted from [https://www.npmjs.com/package/@orangeslice/cli](https://www.npmjs.com/package/@orangeslice/cli) on 2026-09-17, via npm

Packages seen, with the version on 2026-09-17:

- [npm: @orangeslice/cli 3.1.0](https://www.npmjs.com/package/@orangeslice/cli)
...
No GitHub organisation could be tied to orangeslice.ai with evidence on 2026-09-15.
...
- [https://www.orangeslice.ai/](https://www.orangeslice.ai/)
- [https://www.orangeslice.ai/llms.txt](https://www.orangeslice.ai/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

3 source URLs. Raw sources field, verbatim:

https://www.orangeslice.ai/, https://www.orangeslice.ai/llms.txt, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
API mentioned on https://www.orangeslice.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 01-orange-slice
