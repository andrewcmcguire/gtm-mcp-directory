# Prospecting Agent by B-Kirb: MCP server status, API access gate and what it does

> Stateless, cost-capped prospecting agent that turns an intent-data signal into one qualified contact per... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/B-Kirb/prospecting-agent](https://github.com/B-Kirb/prospecting-agent) · entry id 07-prospecting-agent-by-b-kirb · source 07-mcp-infrastructure.md line 2611
...
https://github.com/B-Kirb/prospecting-agent

- [https://github.com/B-Kirb/prospecting-agent](https://github.com/B-Kirb/prospecting-agent)
