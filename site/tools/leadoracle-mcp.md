# LeadOracle MCP: MCP server status, API access gate and what it does

> LeadOracle ΓÇö B2B Lead Intelligence MCP Server | 7 tools | Company lookup, domain enrichment, email finder |... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [tooloracle.io](https://tooloracle.io) · entry id 01-leadoracle-mcp · source 01-data-enrichment.md line 3099

**What it does**
LeadOracle ΓÇö B2B Lead Intelligence MCP Server | 7 tools | Company lookup, domain enrichment, email finder | Part of ToolOracle
...
https://github.com/ToolOracle/leadoracle

- [https://github.com/ToolOracle/leadoracle](https://github.com/ToolOracle/leadoracle)
...
[https://tooloracle.io/docs/](https://tooloracle.io/docs/)
...
No GitHub organisation could be tied to tooloracle.io with evidence on 2026-09-15.
...
- [https://tooloracle.io/lead/mcp](https://tooloracle.io/lead/mcp)
- [https://tooloracle.io/docs/](https://tooloracle.io/docs/)
- [https://tooloracle.io/llms.txt](https://tooloracle.io/llms.txt)
- [https://github.com/ToolOracle/leadoracle](https://github.com/ToolOracle/leadoracle)

4 source URLs. Raw sources field, verbatim:

https://tooloracle.io/lead/mcp, https://tooloracle.io/docs/, https://tooloracle.io/llms.txt, https://github.com/ToolOracle/leadoracle

**Notes, verbatim from the file**
what_it_does used staging desc because homepage meta description was empty. API mentioned on https://tooloracle.io/docs/; pricing/gate not inferred from presence alone. API mentioned on https://tooloracle.io/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name LeadOracle MCP (draft listed as ToolOracle/leadoracle).

**Provenance**

- **Entry id**: 01-leadoracle-mcp
