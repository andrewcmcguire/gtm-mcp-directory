# Forager: MCP server status, API access gate and what it does

> Access 200M+ verified mobile numbers and 800M+ person & company records. Real-time contact intelligence with... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: forager (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [forager.ai](https://forager.ai) · entry id 01-forager · source 01-data-enrichment.md line 2207

**What it does**
Access 200M+ verified mobile numbers and 800M+ person & company records. Real-time contact intelligence with 99% accuracy. Integrate with HubSpot, Salesforce & more.
...
```
npm install -g @datasee/forager
```

quoted from [https://www.npmjs.com/package/@datasee/forager](https://www.npmjs.com/package/@datasee/forager) on 2026-09-26, via npm, a third party source

Packages seen, with the version on 2026-09-26:

- [npm: @datasee/forager 0.1.1, third party](https://www.npmjs.com/package/@datasee/forager)
...
No GitHub organisation could be tied to forager.ai with evidence on 2026-09-15.
...
- [https://www.forager.ai](https://www.forager.ai)
- [https://www.clay.com/integrations/data-provider/forager](https://www.clay.com/integrations/data-provider/forager)

2 source URLs. Raw sources field, verbatim:

https://www.forager.ai, https://www.clay.com/integrations/data-provider/forager
