...
quoted from [https://www.npmjs.com/package/fireflies-cli](https://www.npmjs.com/package/fireflies-cli) on 2026-09-17, via npm, a third party source

```
pip install fireflies-cli
```

quoted from [https://pypi.org/project/fireflies-cli/](https://pypi.org/project/fireflies-cli/) on 2026-09-17, via pypi, a third party source
