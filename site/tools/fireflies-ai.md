...
quoted from [https://www.npmjs.com/package/@cli4ai/fireflies](https://www.npmjs.com/package/@cli4ai/fireflies) on 2026-09-09, via npm, a third party source

```
npm install -g fireflies-export
```

quoted from [https://www.npmjs.com/package/fireflies-export](https://www.npmjs.com/package/fireflies-export) on 2026-09-09, via npm, a third party source

```
npm install -g fireflies-cli
```

quoted from [https://www.npmjs.com/package/fireflies-cli](https://www.npmjs.com/package/fireflies-cli) on 2026-09-09, via npm, a third party source

```
pip install fireflies-cli
```

quoted from [https://pypi.org/project/fireflies-cli/](https://pypi.org/project/fireflies-cli/) on 2026-09-09, via pypi, a third party source
