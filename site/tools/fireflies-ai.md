...
quoted from [https://www.npmjs.com/package/fireflies-export](https://www.npmjs.com/package/fireflies-export) on 2026-09-08, via npm, a third party source

```
npm install -g fireflies-cli
```

quoted from [https://www.npmjs.com/package/fireflies-cli](https://www.npmjs.com/package/fireflies-cli) on 2026-09-08, via npm, a third party source

```
pip install fireflies-cli
```

quoted from [https://pypi.org/project/fireflies-cli/](https://pypi.org/project/fireflies-cli/) on 2026-09-08, via pypi, a third party source

```
brew install --cask fvdm-otinga/tap/fireflies
```

quoted from [https://github.com/fvdm-otinga/fireflies-cli](https://github.com/fvdm-otinga/fireflies-cli) on 2026-09-08, via brew, a third party source

```
curl -fsSL https://raw.githubusercontent.com/fvdm-otinga/fireflies-cli/main/scripts/install.sh | bash
```

quoted from [https://github.com/fvdm-otinga/fireflies-cli](https://github.com/fvdm-otinga/fireflies-cli) on 2026-09-08, via shell, a third party source

```
go install github.com/fvdm-otinga/fireflies-cli@latest
```

quoted from [https://github.com/fvdm-otinga/fireflies-cli](https://github.com/fvdm-otinga/fireflies-cli) on 2026-09-08, via go, a third party source
...
analytics, askfred, auth, login, mcp, meetings, realtime, transcript, transcripts, upload, users
...
- [https://github.com/fvdm-otinga/fireflies-cli](https://github.com/fvdm-otinga/fireflies-cli) (the repository that documented it)
