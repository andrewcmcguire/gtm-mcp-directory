# YouSpot: MCP server status, API access gate and what it does

> A personal CRM for AI-native, connected professionals. It remembers everyone you know, and answers in plain... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [youspot.com](https://youspot.com) · entry id 07-youspot · source 07-mcp-infrastructure.md line 1604

**What it does**
A personal CRM for AI-native, connected professionals. It remembers everyone you know, and answers in plain English.
...
quoted from [https://youspot.com/docs](https://youspot.com/docs) on 2026-09-18, via npx

```
pip install youspot
```

quoted from [https://youspot.com/docs](https://youspot.com/docs) on 2026-09-18, via pypi

```
gem install youspot
```

quoted from [https://youspot.com/docs](https://youspot.com/docs) on 2026-09-18, via gem

```
npm install -g youspot
```

quoted from [https://www.npmjs.com/package/youspot](https://www.npmjs.com/package/youspot) on 2026-09-18, via npm
...
- [npm: youspot 0.2.0](https://www.npmjs.com/package/youspot)
...
[https://youspot.com/docs](https://youspot.com/docs)
...
No GitHub organisation could be tied to youspot.com with evidence on 2026-09-15.
...
- [https://youspot.com](https://youspot.com)
- [https://youspot.com/docs](https://youspot.com/docs)
- [https://youspot.com/llms.txt](https://youspot.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm)

4 source URLs. Raw sources field, verbatim:

https://youspot.com, https://youspot.com/docs, https://youspot.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm

**Notes, verbatim from the file**
API mentioned on https://youspot.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.
