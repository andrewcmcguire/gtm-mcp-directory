# HumanHours: MCP server status, API access gate and what it does

> HumanHours runs a hosted [Model Context Protocol](https://modelcontextprotocol.io) server, so any MCP client... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://humanhours.dev/docs/mcp](https://humanhours.dev/docs/mcp) · entry id 07-humanhours · source 07-mcp-infrastructure.md line 4986

**What it does**
HumanHours runs a hosted [Model Context Protocol](https://modelcontextprotocol.io) server, so any MCP client can log agent ROI and ask about a workspace in p...
...
https://github.com/triadgit/humanhours-mcp

- [https://github.com/triadgit/humanhours-mcp](https://github.com/triadgit/humanhours-mcp)
...
[https://humanhours.dev/docs](https://humanhours.dev/docs)
...
No GitHub organisation could be tied to humanhours.dev with evidence on 2026-09-15.
...
- [https://humanhours.dev/docs/mcp](https://humanhours.dev/docs/mcp)
- [https://humanhours.dev/docs](https://humanhours.dev/docs)
- [https://humanhours.dev/login?next=%2Fdevelopers](https://humanhours.dev/login?next=%2Fdevelopers)
- [https://github.com/triadgit/humanhours-mcp](https://github.com/triadgit/humanhours-mcp)

4 source URLs. Raw sources field, verbatim:

https://humanhours.dev/docs/mcp, https://humanhours.dev/docs, https://humanhours.dev/login?next=%2Fdevelopers, https://github.com/triadgit/humanhours-mcp

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12.

**Provenance**

- **Entry id**: 07-humanhours
