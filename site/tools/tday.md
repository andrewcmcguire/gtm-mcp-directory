# tday: MCP server status, API access gate and what it does

> tday is the brand-aware design partner that already knows your colors, fonts, and voice. Type the brief, pick... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [tday.com](https://tday.com) · entry id 11-tday · source 11-enablement-coaching.md line 542

**What it does**
tday is the brand-aware design partner that already knows your colors, fonts, and voice. Type the brief, pick the format, ship the post - same hour, every hour.
...
[https://tday.com/docs](https://tday.com/docs)
...
No GitHub organisation could be tied to tday.com with evidence on 2026-09-15.
...
- [https://tday.com](https://tday.com)
- [https://tday.com/docs](https://tday.com/docs)
- [https://tday.com/login?callbackURL=%2Fdevelopers](https://tday.com/login?callbackURL=%2Fdevelopers)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://tday.com, https://tday.com/docs, https://tday.com/login?callbackURL=%2Fdevelopers, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://tday.com/docs; pricing/gate not inferred from presence alone. API mentioned on https://tday.com/login?callbackURL=%2Fdevelopers; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave D 2026-09-12: canonical name tday (draft listed as tday.com). Category corrected from signals-intent-abm to enablement-coaching.
