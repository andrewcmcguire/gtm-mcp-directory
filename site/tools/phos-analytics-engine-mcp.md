# Phos Analytics Engine MCP: MCP server status, API access gate and what it does

> AI analytics - sales analysis, ML forecasting, customer segmentation. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://analytics.phos.nz/mcp](https://analytics.phos.nz/mcp) · entry id 12-phos-analytics-engine-mcp · source 12-forecasting-revenue.md line 710
...
https://github.com/albermm/analytics-engine

- [https://github.com/albermm/analytics-engine](https://github.com/albermm/analytics-engine)
