# Vogent: MCP server status, API access gate and what it does

> Vogent is the all-in-one platform to build, test, and deploy AI voice agents. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [vogent.ai](https://vogent.ai) · entry id 04-vogent · source 04-ai-sdr-agents.md line 1114
...
https://www.vogent.ai/, https://yc-oss.github.io/api/tags/sales.json
