# Adrata: MCP server status, API access gate and what it does

> The strategy and intelligence layer for enterprise deals. Adrata understands the full buying group,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [adrata.com](https://adrata.com) · entry id 07-adrata · source 07-mcp-infrastructure.md line 2832

**What it does**
The strategy and intelligence layer for enterprise deals. Adrata understands the full buying group, buyer-side AI, evidence, and route to the next move.
...
[https://adrata.com/developers](https://adrata.com/developers)
...
No GitHub organisation could be tied to adrata.com with evidence on 2026-09-15.
...
- [https://adrata.com](https://adrata.com)
- [https://adrata.com/developers](https://adrata.com/developers)
- [https://adrata.com/api](https://adrata.com/api)
- [https://www.npmjs.com/search?q=mcp%20crm](https://www.npmjs.com/search?q=mcp%20crm)

4 source URLs. Raw sources field, verbatim:

https://adrata.com, https://adrata.com/developers, https://adrata.com/api, https://www.npmjs.com/search?q=mcp%20crm

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave K 2026-09-12: canonical name Adrata (draft listed as @adrata/adrata-mcp).
