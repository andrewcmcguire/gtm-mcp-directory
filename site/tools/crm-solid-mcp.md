# CRM Solid MCP: MCP server status, API access gate and what it does

> Connect AI agents like Claude Desktop and Cursor to your CRM Solid workspace through the Model Context... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://docs.crmsolid.com/integrations/mcp/](https://docs.crmsolid.com/integrations/mcp/) · entry id 07-crm-solid-mcp · source 07-mcp-infrastructure.md line 2168

**What it does**
Connect AI agents like Claude Desktop and Cursor to your CRM Solid workspace through the Model Context Protocol (MCP).
...
[https://docs.crmsolid.com/api](https://docs.crmsolid.com/api)
...
No GitHub organisation could be tied to docs.crmsolid.com with evidence on 2026-09-15.
...
- [https://docs.crmsolid.com/integrations/mcp/](https://docs.crmsolid.com/integrations/mcp/)
- [https://docs.crmsolid.com/api](https://docs.crmsolid.com/api)
- [https://www.npmjs.com/search?q=mcp%20crm](https://www.npmjs.com/search?q=mcp%20crm)

3 source URLs. Raw sources field, verbatim:

https://docs.crmsolid.com/integrations/mcp/, https://docs.crmsolid.com/api, https://www.npmjs.com/search?q=mcp%20crm

**Notes, verbatim from the file**
API mentioned on https://docs.crmsolid.com/api; pricing/gate not inferred from presence alone. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave I 2026-09-12: canonical name CRM Solid MCP (draft listed as @crmsolid/mcp-server).

**Provenance**

- **Entry id**: 07-crm-solid-mcp
