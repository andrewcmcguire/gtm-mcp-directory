# Outreach MCP by mindstone-engineering: MCP server status, API access gate and what it does

> Production-ready MCP connectors for popular SaaS tools. Works with Claude Desktop, Cursor, Rebel, and any MCP... Community MCP, Gate unknown. Checked 2026-09-12.
...
Outreach MCP by mindstone-engineering
...
Vendor: [github.com/nspr-io/mcp-servers](https://github.com/nspr-io/mcp-servers) · entry id 07-outreach-mcp-by-mindstone-engineering · source 07-mcp-infrastructure.md line 1765
...
https://www.npmjs.com/search?q=mcp-server%20outreach

- [https://www.npmjs.com/search?q=mcp-server%20outreach](https://www.npmjs.com/search?q=mcp-server%20outreach)
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/mindstone/mcp-servers/tree/main/connectors/outreach](https://github.com/mindstone/mcp-servers/tree/main/connectors/outreach)
...
https://github.com/mindstone/mcp-servers/tree/main/connectors/outreach, https://github.com/docs, https://github.com/developers, https://www.npmjs.com/search?q=mcp-server%20outreach

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave G 2026-09-12: canonical name Outreach MCP by mindstone-engineering (draft listed as @mindstone-engineering/mcp-server-outreach).

**Provenance**

- **Entry id**: 07-outreach-mcp-by-mindstone-engineering
