# Crustdata MCP: MCP server status, API access gate and what it does

> Crustdata provides real-time B2B data API for AI agents with 1B+ people and 60M+ companies to power sales,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [crustdata.com](https://crustdata.com) · entry id 01-crustdata-mcp · source 01-data-enrichment.md line 3419
...
No GitHub organisation could be tied to crustdata.com with evidence on 2026-09-15.
...
- [https://crustdata.com](https://crustdata.com)
- [https://crustdata.com/](https://crustdata.com/)
- [https://crustdata.com/llms.txt](https://crustdata.com/llms.txt)

3 source URLs. Raw sources field, verbatim:

https://crustdata.com, https://crustdata.com/, https://crustdata.com/llms.txt

**Notes, verbatim from the file**
API mentioned on https://crustdata.com/; pricing/gate not inferred from presence alone. API mentioned on https://crustdata.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name Crustdata MCP (draft listed as io.github.mhimed-crustdata/crustdata).

**Provenance**

- **Entry id**: 01-crustdata-mcp
