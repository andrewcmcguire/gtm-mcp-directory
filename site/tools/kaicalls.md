# KaiCalls: MCP server status, API access gate and what it does

> KaiCalls is a phone service with a built-in secretary. Your number can answer, route, text, follow up, and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [kaicalls.com](https://kaicalls.com) · entry id 04-kaicalls · source 04-ai-sdr-agents.md line 1344
...
https://registry.smithery.ai/servers?q=dialer

- [https://registry.smithery.ai/servers?q=dialer](https://registry.smithery.ai/servers?q=dialer)
...
[https://www.kaicalls.com/docs](https://www.kaicalls.com/docs)
...
No GitHub organisation could be tied to kaicalls.com with evidence on 2026-09-15.
...
- [https://www.kaicalls.com](https://www.kaicalls.com)
- [https://www.kaicalls.com/docs](https://www.kaicalls.com/docs)
- [https://www.kaicalls.com/developers](https://www.kaicalls.com/developers)
- [https://registry.smithery.ai/servers?q=dialer](https://registry.smithery.ai/servers?q=dialer)

4 source URLs. Raw sources field, verbatim:

https://www.kaicalls.com, https://www.kaicalls.com/docs, https://www.kaicalls.com/developers, https://registry.smithery.ai/servers?q=dialer

**Notes, verbatim from the file**
mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave S 2026-09-12.

**Provenance**

- **Entry id**: 04-kaicalls
