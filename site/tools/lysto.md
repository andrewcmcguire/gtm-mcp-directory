# Lysto: MCP server status, API access gate and what it does

> Revenue intelligence platforms for startups No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [lysto.ai](https://lysto.ai) · entry id 12-lysto · source 12-forecasting-revenue.md line 408
...
[https://lysto.ai/docs](https://lysto.ai/docs)
...
No GitHub organisation could be tied to lysto.ai with evidence on 2026-09-15.
...
- [https://lysto.ai/](https://lysto.ai/)
- [https://lysto.ai/docs](https://lysto.ai/docs)
- [https://lysto.ai/developers](https://lysto.ai/developers)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

4 source URLs. Raw sources field, verbatim:

https://lysto.ai/, https://lysto.ai/docs, https://lysto.ai/developers, https://yc-oss.github.io/api/industries/sales.json
