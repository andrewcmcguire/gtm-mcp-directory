# EveryoneSocial: MCP server status, API access gate and what it does

> The advocacy platform trusted by enterprise comms, marketing, and compliance teams. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [everyonesocial.com](https://everyonesocial.com) · entry id 11-everyonesocial · source 11-enablement-coaching.md line 854

**What it does**
The advocacy platform trusted by enterprise comms, marketing, and compliance teams.
...
[https://developers.everyonesocial.com/password?redirect=/](https://developers.everyonesocial.com/password?redirect=/)
...
No GitHub organisation could be tied to everyonesocial.com with evidence on 2026-09-15.
...
- [https://everyonesocial.com](https://everyonesocial.com)
- [https://developers.everyonesocial.com/password?redirect=/](https://developers.everyonesocial.com/password?redirect=/)
- [https://marketplace.salesloft.com/](https://marketplace.salesloft.com/)

3 source URLs. Raw sources field, verbatim:

https://everyonesocial.com, https://developers.everyonesocial.com/password?redirect=/, https://marketplace.salesloft.com/

**Notes, verbatim from the file**
API mentioned on https://developers.everyonesocial.com/password?redirect=/; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to enablement-coaching.

**Provenance**

- **Entry id**: 11-everyonesocial
