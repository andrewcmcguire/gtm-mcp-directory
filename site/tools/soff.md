# Soff: MCP server status, API access gate and what it does

> AI Agents for Distributors No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [soff.ai](https://soff.ai) · entry id 04-soff · source 04-ai-sdr-agents.md line 1030
...
Homepage fetch failed (HTTPError 404); what_it_does used YC/source one_liner. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.
