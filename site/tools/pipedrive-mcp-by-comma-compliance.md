# Pipedrive MCP by comma-compliance: MCP server status, API access gate and what it does

> Pipedrive CRM server for the Model Context Protocol (MCP). 75 tools covering full CRUD, custom field... Community MCP, Gate unknown. Checked 2026-09-12.
...
Pipedrive MCP by comma-compliance
...
Vendor: [https://github.com/comma-compliance/pipedrive-mcp](https://github.com/comma-compliance/pipedrive-mcp) · entry id 07-pipedrive-mcp-by-comma-compliance · source 07-mcp-infrastructure.md line 717
...
https://github.com/comma-compliance/pipedrive-mcp

- [https://github.com/comma-compliance/pipedrive-mcp](https://github.com/comma-compliance/pipedrive-mcp)
