# Kuli: MCP server status, API access gate and what it does

> AI agent that runs influencer marketing for consumer brands. Kuli removes the manual work and makes them 10×... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [kuli.one](https://kuli.one) · entry id 02-kuli · source 02-engagement-outbound.md line 1227

**What it does**
AI agent that runs influencer marketing for consumer brands. Kuli removes the manual work and makes them 10× more efficient.
...
[https://kuli.one/docs](https://kuli.one/docs)
...
No GitHub organisation could be tied to kuli.one with evidence on 2026-09-15.
...
- [https://kuli.one](https://kuli.one)
- [https://kuli.one/docs](https://kuli.one/docs)
- [https://kuli.one/developers](https://kuli.one/developers)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://kuli.one, https://kuli.one/docs, https://kuli.one/developers, https://yc-oss.github.io/api/industries/marketing.json
