# Data Parrot AI Revenue Analyst: MCP server status, API access gate and what it does

> Data Parrot brings AI revenue analysis of your HubSpot data into your AI tools. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://api-v3.dataparrot.ai/api/v3/data-parrot/mcp](https://api-v3.dataparrot.ai/api/v3/data-parrot/mcp) · entry id 12-data-parrot-ai-revenue-analyst · source 12-forecasting-revenue.md line 666
...
- [https://api-v3.dataparrot.ai/api/v3/data-parrot/mcp](https://api-v3.dataparrot.ai/api/v3/data-parrot/mcp)
...
- **Entry id**: 12-data-parrot-ai-revenue-analyst
