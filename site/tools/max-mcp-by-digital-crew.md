# Max MCP by Digital Crew: MCP server status, API access gate and what it does

> Model Context Protocol (MCP) server for Max, Digital Crew's AI sales agent. Exposes workspace profile tools... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [max-mcp-server.vercel.app](https://max-mcp-server.vercel.app) · entry id 07-max-mcp-by-digital-crew · source 07-mcp-infrastructure.md line 3276
...
https://github.com/Digital-Crew-Technologies/max-mcp-server

- [https://github.com/Digital-Crew-Technologies/max-mcp-server](https://github.com/Digital-Crew-Technologies/max-mcp-server)
...
No GitHub organisation could be tied to max-mcp-server.vercel.app with evidence on 2026-09-15.
