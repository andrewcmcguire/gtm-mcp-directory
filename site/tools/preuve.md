# Preuve: MCP server status, API access gate and what it does

> Startup validation API and remote MCP server. Score any idea from 60+ live sources inside Claude, Cursor,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://preuve.ai/mcp](https://preuve.ai/mcp) · entry id 01-preuve · source 01-data-enrichment.md line 4804

**What it does**
Startup validation API and remote MCP server. Score any idea from 60+ live sources inside Claude, Cursor, Codex or Hermes, in one tool call. Start free.
...
[https://preuve.ai/mcp](https://preuve.ai/mcp)
...
No GitHub organisation could be tied to preuve.ai with evidence on 2026-09-15.
...
- [https://preuve.ai/mcp](https://preuve.ai/mcp)
- [https://preuve.ai/llms.txt](https://preuve.ai/llms.txt)
- [https://registry.smithery.ai/servers?q=enrich](https://registry.smithery.ai/servers?q=enrich)

3 source URLs. Raw sources field, verbatim:

https://preuve.ai/mcp, https://preuve.ai/llms.txt, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
API mentioned on https://preuve.ai/mcp; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12: canonical name Preuve (draft listed as Preuve AI Market Research).
