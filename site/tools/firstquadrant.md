# FirstQuadrant: MCP server status, API access gate and what it does

> FirstQuadrant helps founders and revenue teams move faster, stay organized, and close more deals, by... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [firstquadrant.ai](https://firstquadrant.ai) · entry id 04-firstquadrant · source 04-ai-sdr-agents.md line 948
...
No GitHub organisation could be tied to firstquadrant.ai with evidence on 2026-09-15.
...
https://firstquadrant.ai, https://yc-oss.github.io/api/industries/sales.json
