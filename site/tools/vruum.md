# Vruum: MCP server status, API access gate and what it does

> The AI SDR alternative: the revenue orchestration layer for marketing, research, managed outbound,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [vruum.ai](https://vruum.ai) · entry id 04-vruum · source 04-ai-sdr-agents.md line 678

**What it does**
The AI SDR alternative: the revenue orchestration layer for marketing, research, managed outbound, partnerships, referrals, and winbacks. Run it yourself in your AI, or have a GTM engineer run it for you.
...
quoted from [https://www.npmjs.com/package/@vruum/cli](https://www.npmjs.com/package/@vruum/cli) on 2026-09-26, via npm

Packages seen, with the version on 2026-09-26:

- [npm: @vruum/cli 0.6.0](https://www.npmjs.com/package/@vruum/cli)
...
[https://vruum.ai/docs](https://vruum.ai/docs)
...
No GitHub organisation could be tied to vruum.ai with evidence on 2026-09-15.
...
- [https://vruum.ai](https://vruum.ai)
- [https://vruum.ai/docs](https://vruum.ai/docs)
- [https://vruum.ai/auth/login](https://vruum.ai/auth/login)
- [https://www.npmjs.com/search?q=mcp%20gtm](https://www.npmjs.com/search?q=mcp%20gtm)

4 source URLs. Raw sources field, verbatim:

https://vruum.ai, https://vruum.ai/docs, https://vruum.ai/auth/login, https://www.npmjs.com/search?q=mcp%20gtm

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave E 2026-09-12: canonical name Vruum (draft listed as @vruum/skills). Category corrected from mcp-infrastructure to ai-sdr-agents.
