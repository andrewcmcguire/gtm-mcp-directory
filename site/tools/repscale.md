# RepScale: MCP server status, API access gate and what it does

> Stop editing what AI wrote for 30 minutes. RepScale researches prospects, writes outreach, and preps meetings... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [repscale.ai](https://repscale.ai) · entry id 02-repscale · source 02-engagement-outbound.md line 1389

**What it does**
Stop editing what AI wrote for 30 minutes. RepScale researches prospects, writes outreach, and preps meetings in one connected workflow. Free tier, no credit card.
...
- [https://repscale.ai](https://repscale.ai)
...
[https://repscale.ai/api](https://repscale.ai/api)
...
No GitHub organisation could be tied to repscale.ai with evidence on 2026-09-15.
...
- [https://repscale.ai](https://repscale.ai)
- [https://repscale.ai/api](https://repscale.ai/api)
- [https://repscale.ai/llms.txt](https://repscale.ai/llms.txt)

3 source URLs. Raw sources field, verbatim:

https://repscale.ai, https://repscale.ai/api, https://repscale.ai/llms.txt

**Notes, verbatim from the file**
API mentioned on https://repscale.ai/api; pricing/gate not inferred from presence alone. API mentioned on https://repscale.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 02-repscale
