# Helm AI: MCP server status, API access gate and what it does

> Put your business on autopilot. Run projects, manage customers, automate operations, and deploy AI workers... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [gethelm.ai](https://gethelm.ai) · entry id 06-helm-ai · source 06-revops-infra.md line 1392

**What it does**
Put your business on autopilot. Run projects, manage customers, automate operations, and deploy AI workers from one platform built to help your business do more with less.
...
```
npm install -g @helm-ai/cli
```

quoted from [https://www.npmjs.com/package/@helm-ai/cli](https://www.npmjs.com/package/@helm-ai/cli) on 2026-09-18, via npm

Packages seen, with the version on 2026-09-18:

- [npm: @helm-ai/cli 0.22.0](https://www.npmjs.com/package/@helm-ai/cli)
...
[https://gethelm.ai/docs](https://gethelm.ai/docs)
...
No GitHub organisation could be tied to gethelm.ai with evidence on 2026-09-15.
...
- [https://gethelm.ai](https://gethelm.ai)
- [https://gethelm.ai/docs](https://gethelm.ai/docs)
- [https://gethelm.ai/agents/connect](https://gethelm.ai/agents/connect)
- [https://www.npmjs.com/search?q=mcp%20crm](https://www.npmjs.com/search?q=mcp%20crm)

4 source URLs. Raw sources field, verbatim:

https://gethelm.ai, https://gethelm.ai/docs, https://gethelm.ai/agents/connect, https://www.npmjs.com/search?q=mcp%20crm

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave I 2026-09-12: canonical name Helm AI (draft listed as @helm-ai/mcp-server). Category corrected from mcp-infrastructure to revops-infra.
