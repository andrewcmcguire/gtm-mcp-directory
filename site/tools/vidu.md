# Vidu: MCP server status, API access gate and what it does

> Automatically generated, AI personalized videos for your sales team's outreach No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [vidu.io](https://vidu.io) · entry id 08-vidu · source 08-video-prospecting.md line 324

**What it does**
Automatically generated, AI personalized videos for your sales team's outreach
...
No GitHub organisation could be tied to vidu.io with evidence on 2026-09-15.
...
- [https://www.vidu.io](https://www.vidu.io)
- [https://marketplace.salesloft.com/t/category?page=4](https://marketplace.salesloft.com/t/category?page=4)

2 source URLs. Raw sources field, verbatim:

https://www.vidu.io, https://marketplace.salesloft.com/t/category?page=4

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from engagement-outbound to video-prospecting.
