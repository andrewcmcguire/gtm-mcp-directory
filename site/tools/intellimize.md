# Intellimize: MCP server status, API access gate and what it does

> Webflow Optimize brings A/B testing and personalization to your website, on any CMS. Leverage AI-driven... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [intellimize.com](https://intellimize.com) · entry id 14-intellimize · source 14-inbound-plg-chat.md line 618
...
No GitHub organisation could be tied to intellimize.com with evidence on 2026-09-15.
...
- [https://webflow.com/feature/optimize](https://webflow.com/feature/optimize)
- [https://webflow.com/llms.txt](https://webflow.com/llms.txt)
- [https://demandbase.partnerfleet.app/partners/webflow-optimize](https://demandbase.partnerfleet.app/partners/webflow-optimize)

3 source URLs. Raw sources field, verbatim:

https://webflow.com/feature/optimize, https://webflow.com/llms.txt, https://demandbase.partnerfleet.app/partners/webflow-optimize

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from signals-intent-abm to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-intellimize
