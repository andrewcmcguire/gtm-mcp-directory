# CampaignStack: MCP server status, API access gate and what it does

> LinkedIn outreach for lead-gen agencies, built around the accounts: per-account daily budgets, warm-up ramps,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [campaignstack.io](https://campaignstack.io) · entry id 02-campaignstack · source 02-engagement-outbound.md line 2924

**What it does**
LinkedIn outreach for lead-gen agencies, built around the accounts: per-account daily budgets, warm-up ramps, business-hours sends, review before each send.
...
https://campaignstack.io

- [https://campaignstack.io](https://campaignstack.io)
...
No GitHub organisation could be tied to campaignstack.io with evidence on 2026-09-15.
...
- [https://campaignstack.io](https://campaignstack.io)
- [https://campaignstack.io/llms.txt](https://campaignstack.io/llms.txt)

2 source URLs. Raw sources field, verbatim:

https://campaignstack.io, https://campaignstack.io/llms.txt

**Notes, verbatim from the file**
API mentioned on https://campaignstack.io/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name CampaignStack (draft listed as io.campaignstack/campaignstack).

**Provenance**

- **Entry id**: 02-campaignstack
