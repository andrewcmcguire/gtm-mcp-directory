# Salesforce MCP by mindstone: MCP server status, API access gate and what it does
...
Vendor: [github.com/mindstone/mcp-servers](https://github.com/mindstone/mcp-servers) · entry id 07-salesforce-mcp-by-mindstone · source 07-mcp-infrastructure.md line 1745
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/mindstone/mcp-servers/tree/main/connectors/salesforce](https://github.com/mindstone/mcp-servers/tree/main/connectors/salesforce)
...
https://github.com/mindstone/mcp-servers/tree/main/connectors/salesforce, https://github.com/docs, https://github.com/developers, https://www.npmjs.com/search?q=mcp-server%20salesforce

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave G 2026-09-12: canonical name Salesforce MCP by mindstone (draft listed as @mindstone/mcp-server-salesforce).

**Provenance**

- **Entry id**: 07-salesforce-mcp-by-mindstone
