# MentionAgent: MCP server status, API access gate and what it does

> Link building outreach from your agent: review drafts, send the batch, answer publisher replies. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://mentionagent.ai/mcp](https://mentionagent.ai/mcp) · entry id 02-mentionagent · source 02-engagement-outbound.md line 3168
...
- [https://github.com/BuildsbyMatt/mentionagent-claude-skill](https://github.com/BuildsbyMatt/mentionagent-claude-skill)
...
[https://mentionagent.ai/developers/](https://mentionagent.ai/developers/)
...
No GitHub organisation could be tied to mentionagent.ai with evidence on 2026-09-15.
...
- [https://mentionagent.ai/developers/](https://mentionagent.ai/developers/)
- [https://mentionagent.ai/llms.txt](https://mentionagent.ai/llms.txt)
- [https://github.com/BuildsbyMatt/mentionagent-claude-skill](https://github.com/BuildsbyMatt/mentionagent-claude-skill)

3 source URLs. Raw sources field, verbatim:

https://mentionagent.ai/developers/, https://mentionagent.ai/llms.txt, https://github.com/BuildsbyMatt/mentionagent-claude-skill

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 401); what_it_does used staging desc. API mentioned on https://mentionagent.ai/developers/; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12.

**Provenance**

- **Entry id**: 02-mentionagent
