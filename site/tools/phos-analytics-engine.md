# Phos Analytics Engine: MCP server status, API access gate and what it does

> Sales analytics, ML forecasting, customer segmentation, and trend analysis. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://ae.phos.nz/mcp](https://ae.phos.nz/mcp) · entry id 12-phos-analytics-engine · source 12-forecasting-revenue.md line 752
...
https://ae.phos.nz/mcp

- [https://ae.phos.nz/mcp](https://ae.phos.nz/mcp)
...
Homepage fetch failed (HTTPError 502); what_it_does used staging desc. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12.

**Provenance**

- **Entry id**: 12-phos-analytics-engine
