# MachFive Cold Email MCP: MCP server status, API access gate and what it does

> Learn how to connect your AI assistant to MachFive using the Model Context Protocol (MCP) for automated cold... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://help.machfive.io/categories/integrations/machfive-mcp-server](https://help.machfive.io/categories/integrations/machfive-mcp-server) · entry id 02-machfive-cold-email-mcp · source 02-engagement-outbound.md line 3268
...
No GitHub organisation could be tied to help.machfive.io with evidence on 2026-09-15.
...
- [https://help.machfive.io/categories/integrations/machfive-mcp-server](https://help.machfive.io/categories/integrations/machfive-mcp-server)
- [https://registry.smithery.ai/servers?q=outreach](https://registry.smithery.ai/servers?q=outreach)

2 source URLs. Raw sources field, verbatim:

https://help.machfive.io/categories/integrations/machfive-mcp-server, https://registry.smithery.ai/servers?q=outreach

**Notes, verbatim from the file**
mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name MachFive Cold Email MCP (draft listed as MachFive Cold Email).

**Provenance**

- **Entry id**: 02-machfive-cold-email-mcp
