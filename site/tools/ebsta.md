...
> Revenue-intelligence add-on for Salesforce/HubSpot that syncs email and calendar activity into the CRM and... No MCP found, Gate unknown. Checked 2026-08-24.
...
unknown. No developer/API documentation or self-serve API tier was found anywhere. Product pricing itself runs Relationship Intelligence (~$60/user/mo) and Revenue Intelligence (~$70/user/mo) tiers per third-party aggregators (not confirmed with numeric pricing on the live vendor page), a 14-day free trial requiring a Salesforce/HubSpot connection, and a sales-gated Enterprise tier.
