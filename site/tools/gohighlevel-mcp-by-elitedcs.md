# GoHighLevel MCP by elitedcs: MCP server status, API access gate and what it does

> GHL Command - run your entire GoHighLevel agency from Claude. 232 tools across 48 modules, the only tool that... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://elitedcs.com/ghl-mcp-server](https://elitedcs.com/ghl-mcp-server) · entry id 07-gohighlevel-mcp-by-elitedcs · source 07-mcp-infrastructure.md line 2148

**What it does**
GHL Command - run your entire GoHighLevel agency from Claude. 232 tools across 48 modules, the only tool that builds and audits GHL workflows by AI. $97/mo covers UNLIMITED sub-accounts on 3 machines - never billed per account. Save 5+ hours on your first client build or your first month back.
...
- [https://elitedcs.com/ghl-mcp-server](https://elitedcs.com/ghl-mcp-server)
- [https://elitedcs.com/llms.txt](https://elitedcs.com/llms.txt)
- [https://www.npmjs.com/search?q=mcp%20crm](https://www.npmjs.com/search?q=mcp%20crm)

3 source URLs. Raw sources field, verbatim:

https://elitedcs.com/ghl-mcp-server, https://elitedcs.com/llms.txt, https://www.npmjs.com/search?q=mcp%20crm

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave I 2026-09-12: canonical name GoHighLevel MCP by elitedcs (draft listed as @elitedcs/ghl-mcp).

**Provenance**

- **Entry id**: 07-gohighlevel-mcp-by-elitedcs
