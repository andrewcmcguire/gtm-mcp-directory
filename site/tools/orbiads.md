# Orbiads: MCP server status, API access gate and what it does

> The most complete MCP server for Google Ad Manager. Drive GAM from your AI agents, deploy in 5 minutes, 50... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [orbiads.com](https://orbiads.com) · entry id 07-orbiads · source 07-mcp-infrastructure.md line 5250

**What it does**
The most complete MCP server for Google Ad Manager. Drive GAM from your AI agents, deploy in 5 minutes, 50 MCP tools. Saga-pattern for zero errors.
...
quoted from [https://orbiads.com/docs/cli](https://orbiads.com/docs/cli) on 2026-09-18, via pypi
...
[https://orbiads.com/docs](https://orbiads.com/docs)
...
- [https://orbiads.com/](https://orbiads.com/)
- [https://orbiads.com/docs](https://orbiads.com/docs)
- [https://orbiads.com/llms.txt](https://orbiads.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm)

4 source URLs. Raw sources field, verbatim:

https://orbiads.com/, https://orbiads.com/docs, https://orbiads.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm

**Notes, verbatim from the file**
API mentioned on https://orbiads.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12.
