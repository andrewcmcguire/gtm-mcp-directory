# Rivia.AI: MCP server status, API access gate and what it does

> Show, onboard, and grow your product with interactive demos, smart onboarding, and AI-powered insights. All... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [rivia.ai](https://rivia.ai) · entry id 11-rivia-ai · source 11-enablement-coaching.md line 772

**What it does**
Show, onboard, and grow your product with interactive demos, smart onboarding, and AI-powered insights. All in one platform.
...
[https://rivia.ai/docs](https://rivia.ai/docs)
...
No GitHub organisation could be tied to rivia.ai with evidence on 2026-09-15.
...
- [https://rivia.ai](https://rivia.ai)
- [https://rivia.ai/docs](https://rivia.ai/docs)
- [https://rivia.ai/developers](https://rivia.ai/developers)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://rivia.ai, https://rivia.ai/docs, https://rivia.ai/developers, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://rivia.ai/docs; pricing/gate not inferred from presence alone. API mentioned on https://rivia.ai/developers; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from revops-infra to enablement-coaching.

**Provenance**

- **Entry id**: 11-rivia-ai
