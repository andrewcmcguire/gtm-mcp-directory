# MailerLite MCP by UsefulAPI: MCP server status, API access gate and what it does

> Read subscribers, groups, campaigns, fields, segments, automations, webhooks; safe additive writes. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://mailerlite.usefulapi.io/mcp](https://mailerlite.usefulapi.io/mcp) · entry id 02-mailerlite-mcp-by-usefulapi · source 02-engagement-outbound.md line 2984
...
- [https://usefulapi.io/mailerlite/](https://usefulapi.io/mailerlite/)
- [https://usefulapi.io/docs](https://usefulapi.io/docs)
