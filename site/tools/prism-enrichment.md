# Prism Enrichment: MCP server status, API access gate and what it does

> Prism returns company, web search, scrape, places and contact data for any domain in one keyless call - about... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [enrich.gocreativeai.com](https://enrich.gocreativeai.com) · entry id 01-prism-enrichment · source 01-data-enrichment.md line 1641

**What it does**
Prism returns company, web search, scrape, places and contact data for any domain in one keyless call - about 12x cheaper than buying each category separately. Pay per call in USDC on Base or Solana.
...
https://enrich.gocreativeai.com

- [https://enrich.gocreativeai.com](https://enrich.gocreativeai.com)
...
No GitHub organisation could be tied to enrich.gocreativeai.com with evidence on 2026-09-15.
...
- [https://enrich.gocreativeai.com](https://enrich.gocreativeai.com)
- [https://enrich.gocreativeai.com/llms.txt](https://enrich.gocreativeai.com/llms.txt)

2 source URLs. Raw sources field, verbatim:

https://enrich.gocreativeai.com, https://enrich.gocreativeai.com/llms.txt

**Notes, verbatim from the file**
API mentioned on https://enrich.gocreativeai.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave F 2026-09-12: canonical name Prism Enrichment (draft listed as Prism - Data Enrichment for AI Agents).

**Provenance**

- **Entry id**: 01-prism-enrichment
