# Olark: MCP server status, API access gate and what it does

> Built for the marketer doing five jobs at once - Olark's AI agent answers questions, qualifies visitors, and... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [olark.com](https://olark.com) · entry id 14-olark · source 14-inbound-plg-chat.md line 702

**What it does**
Built for the marketer doing five jobs at once - Olark's AI agent answers questions, qualifies visitors, and knows exactly when to bring in a human. Trained on your own site in under a minute.
...
[https://www.olark.com/api](https://www.olark.com/api)
...
No GitHub organisation could be tied to olark.com with evidence on 2026-09-15.
...
https://www.olark.com/, https://www.olark.com/api, https://yc-oss.github.io/api/tags/sales.json

**Notes, verbatim from the file**
API mentioned on https://www.olark.com/api; pricing/gate not inferred from presence alone. API mentioned on https://www.olark.com/api; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to inbound-plg-chat.
