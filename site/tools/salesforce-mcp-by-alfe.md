# Salesforce MCP by alfe: MCP server status, API access gate and what it does

> Alfe gives your business an always-on AI agent that can answer customers, follow up leads, coordinate work,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [alfe.ai](https://alfe.ai) · entry id 07-salesforce-mcp-by-alfe · source 07-mcp-infrastructure.md line 2550

**What it does**
Alfe gives your business an always-on AI agent that can answer customers, follow up leads, coordinate work, and use the tools your team already relies on.
...
```
npm install -g @alfe.ai/cli
```

quoted from [https://www.npmjs.com/package/@alfe.ai/cli](https://www.npmjs.com/package/@alfe.ai/cli) on 2026-09-26, via npm

Packages seen, with the version on 2026-09-26:

- [npm: @alfe.ai/cli 0.5.30](https://www.npmjs.com/package/@alfe.ai/cli)
...
[https://alfe.ai/developers](https://alfe.ai/developers)
...
No GitHub organisation could be tied to alfe.ai with evidence on 2026-09-15.
...
- [https://alfe.ai](https://alfe.ai)
- [https://alfe.ai/developers](https://alfe.ai/developers)
- [https://alfe.ai/llms.txt](https://alfe.ai/llms.txt)
- [https://www.npmjs.com/search?q=mcp%20salesforce](https://www.npmjs.com/search?q=mcp%20salesforce)

4 source URLs. Raw sources field, verbatim:

https://alfe.ai, https://alfe.ai/developers, https://alfe.ai/llms.txt, https://www.npmjs.com/search?q=mcp%20salesforce

**Notes, verbatim from the file**
API mentioned on https://alfe.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave J 2026-09-12: canonical name Salesforce MCP by alfe (draft listed as @alfe.ai/salesforce-mcp).

**Provenance**

- **Entry id**: 07-salesforce-mcp-by-alfe
