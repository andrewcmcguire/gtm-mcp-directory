# Local MCP CRM: MCP server status, API access gate and what it does

> Local-first CRM built on the Model Context Protocol (MCP) - customer/project management exposed as MCP tools,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/bhairavaa/local-mcp-crm](https://github.com/bhairavaa/local-mcp-crm) · entry id 07-local-mcp-crm · source 07-mcp-infrastructure.md line 3879

**What it does**
Local-first CRM built on the Model Context Protocol (MCP) - customer/project management exposed as MCP tools, usable from a custom LlamaIndex agent or directly in Claude Code or any other applications supporting MCP Servers or resources. - bhairavaa/local-mcp-crm
...
https://github.com/bhairavaa/local-mcp-crm

- [https://github.com/bhairavaa/local-mcp-crm](https://github.com/bhairavaa/local-mcp-crm)
