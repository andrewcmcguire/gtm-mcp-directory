# Magellan Data: MCP server status, API access gate and what it does

> Parent companies, PE ownership, corporate families, and portfolio siblings - delivered as a hosted MCP server... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [magellandata.io](https://magellandata.io) · entry id 01-magellan-data · source 01-data-enrichment.md line 2005
...
[https://magellandata.io/docs](https://magellandata.io/docs)
...
No GitHub organisation could be tied to magellandata.io with evidence on 2026-09-15.
...
- [https://magellandata.io](https://magellandata.io)
- [https://magellandata.io/docs](https://magellandata.io/docs)
- [https://magellandata.io/developers](https://magellandata.io/developers)
- [https://www.clay.com/integrations/data-provider/magellan-data](https://www.clay.com/integrations/data-provider/magellan-data)

4 source URLs. Raw sources field, verbatim:

https://magellandata.io, https://magellandata.io/docs, https://magellandata.io/developers, https://www.clay.com/integrations/data-provider/magellan-data
