# ACA Automated Client Acquisition: MCP server status, API access gate and what it does

> AI content generation, lead management, and multi-channel outreach campaigns. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.automatedclientacquisition.com/api/mcp](https://www.automatedclientacquisition.com/api/mcp) · entry id 02-aca-automated-client-acquisition · source 02-engagement-outbound.md line 2800
...
https://github.com/seguelaCedric/screenshot-perfect

- [https://github.com/seguelaCedric/screenshot-perfect](https://github.com/seguelaCedric/screenshot-perfect)
...
[https://www.automatedclientacquisition.com/docs](https://www.automatedclientacquisition.com/docs)
...
No GitHub organisation could be tied to automatedclientacquisition.com with evidence on 2026-09-15.
...
- [https://www.automatedclientacquisition.com/api/mcp](https://www.automatedclientacquisition.com/api/mcp)
- [https://www.automatedclientacquisition.com/docs](https://www.automatedclientacquisition.com/docs)
- [https://www.automatedclientacquisition.com/developers](https://www.automatedclientacquisition.com/developers)
- [https://github.com/seguelaCedric/screenshot-perfect](https://github.com/seguelaCedric/screenshot-perfect)

4 source URLs. Raw sources field, verbatim:

https://www.automatedclientacquisition.com/api/mcp, https://www.automatedclientacquisition.com/docs, https://www.automatedclientacquisition.com/developers, https://github.com/seguelaCedric/screenshot-perfect

**Notes, verbatim from the file**
what_it_does used staging desc because homepage meta description was empty. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave P 2026-09-12: canonical name ACA Automated Client Acquisition (draft listed as ACA - Automated Client Acquisition).

**Provenance**

- **Entry id**: 02-aca-automated-client-acquisition
