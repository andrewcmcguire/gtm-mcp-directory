# Moltline Outbound: MCP server status, API access gate and what it does
...
Vendor: [moltlinestudio.com](https://moltlinestudio.com) · entry id 02-moltline-outbound · source 02-engagement-outbound.md line 3228
...
https://moltlinestudio.com, https://moltlinestudio.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales

**Notes, verbatim from the file**
API mentioned on https://moltlinestudio.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12.

**Provenance**

- **Entry id**: 02-moltline-outbound
