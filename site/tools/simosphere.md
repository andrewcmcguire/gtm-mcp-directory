# SIMOSphere: MCP server status, API access gate and what it does

> European AI orchestration platform - connects CRM, ERP, documents with LLMs. GDPR-compliant, EU-hosted,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [simosphereai.com](https://simosphereai.com) · entry id 07-simosphere · source 07-mcp-infrastructure.md line 1078

**What it does**
European AI orchestration platform - connects CRM, ERP, documents with LLMs. GDPR-compliant, EU-hosted, MCP-native. 4 tools: search_documents, query_database, create_record, send_notification.
...
quoted from [https://www.npmjs.com/package/@simosphere/cli](https://www.npmjs.com/package/@simosphere/cli) on 2026-09-18, via npm

Packages seen, with the version on 2026-09-18:

- [npm: @simosphere/cli 0.1.1](https://www.npmjs.com/package/@simosphere/cli)
...
[https://simosphereai.com/developers](https://simosphereai.com/developers)
...
No GitHub organisation could be tied to simosphereai.com with evidence on 2026-09-15.
...
- [https://simosphereai.com/developers](https://simosphereai.com/developers)
- [https://simosphereai.com/llms.txt](https://simosphereai.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm)

3 source URLs. Raw sources field, verbatim:

https://simosphereai.com/developers, https://simosphereai.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm

**Notes, verbatim from the file**
Homepage fetch failed (TimeoutError: The read operation timed out); what_it_does used staging desc. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave D 2026-09-12: canonical name SIMOSphere (draft listed as SIMOSphere AI).

**Provenance**

- **Entry id**: 07-simosphere
