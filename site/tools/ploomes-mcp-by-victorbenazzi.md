# Ploomes MCP by victorbenazzi: MCP server status, API access gate and what it does

> Unofficial Model Context Protocol server that connects AI agents to the Ploomes CRM REST API -... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/victorbenazzi/ploomes-mcp-server](https://github.com/victorbenazzi/ploomes-mcp-server) · entry id 07-ploomes-mcp-by-victorbenazzi · source 07-mcp-infrastructure.md line 1645
...
https://github.com/victorbenazzi/ploomes-mcp-server

- [https://github.com/victorbenazzi/ploomes-mcp-server](https://github.com/victorbenazzi/ploomes-mcp-server)
