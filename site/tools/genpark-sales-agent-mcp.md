# GenPark Sales Agent MCP: MCP server status, API access gate and what it does

> Autonomous outbound B2B sales development representative. - alphaparkinc/genpark-sales-agent Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/alphaparkinc/genpark-sales-agent](https://github.com/alphaparkinc/genpark-sales-agent) · entry id 04-genpark-sales-agent-mcp · source 04-ai-sdr-agents.md line 1156
...
https://github.com/alphaparkinc/genpark-sales-agent

- [https://github.com/alphaparkinc/genpark-sales-agent](https://github.com/alphaparkinc/genpark-sales-agent)
