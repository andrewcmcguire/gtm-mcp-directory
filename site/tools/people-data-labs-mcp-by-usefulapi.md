# People Data Labs MCP by UsefulAPI: MCP server status, API access gate and what it does

> Enrich and search people and companies, resolve identities, and enrich IP addresses. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://peopledatalabs.usefulapi.io/mcp](https://peopledatalabs.usefulapi.io/mcp) · entry id 01-people-data-labs-mcp-by-usefulapi · source 01-data-enrichment.md line 4398
...
[https://usefulapi.io/docs](https://usefulapi.io/docs)
...
- [https://usefulapi.io/peopledatalabs/](https://usefulapi.io/peopledatalabs/)
- [https://usefulapi.io/docs](https://usefulapi.io/docs)
- [https://usefulapi.io/developers](https://usefulapi.io/developers)
- [https://github.com/m190/usefulapi-mcp](https://github.com/m190/usefulapi-mcp)

4 source URLs. Raw sources field, verbatim:

https://usefulapi.io/peopledatalabs/, https://usefulapi.io/docs, https://usefulapi.io/developers, https://github.com/m190/usefulapi-mcp

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name People Data Labs MCP by UsefulAPI (draft listed as io.usefulapi/peopledatalabs).

**Provenance**

- **Entry id**: 01-people-data-labs-mcp-by-usefulapi
