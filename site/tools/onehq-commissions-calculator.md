# OneHQ Commissions Calculator: MCP server status, API access gate and what it does

> OneHQ brings CRM, commissions, case management, and reporting together in one place, so insurance teams can... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [onehq.com](https://onehq.com) · entry id 12-onehq-commissions-calculator · source 12-forecasting-revenue.md line 730

**What it does**
OneHQ brings CRM, commissions, case management, and reporting together in one place, so insurance teams can reduce busy work, help more clients, and scale.
...
No GitHub organisation could be tied to onehq.com with evidence on 2026-09-15.
...
- [https://www.onehq.com/](https://www.onehq.com/)
- [https://www.onehq.com/llms.txt](https://www.onehq.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm)

3 source URLs. Raw sources field, verbatim:

https://www.onehq.com/, https://www.onehq.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm

**Notes, verbatim from the file**
API mentioned on https://www.onehq.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name OneHQ Commissions Calculator (draft listed as onehq-comissions-calculator).

**Provenance**

- **Entry id**: 12-onehq-commissions-calculator
