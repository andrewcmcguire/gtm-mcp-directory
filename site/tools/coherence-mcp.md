# Coherence MCP: MCP server status, API access gate and what it does

> Coherence is the agentic customer operations platform that connects CRM data, email, campaigns, websites,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [getcoherence.io](https://getcoherence.io) · entry id 07-coherence-mcp · source 07-mcp-infrastructure.md line 4826

**What it does**
Coherence is the agentic customer operations platform that connects CRM data, email, campaigns, websites, workflows, and AI agents in one shared context.
...
https://github.com/Brightyard/brightyard-platform

- [https://github.com/Brightyard/brightyard-platform](https://github.com/Brightyard/brightyard-platform)
...
[https://getcoherence.io/docs](https://getcoherence.io/docs)
...
No GitHub organisation could be tied to getcoherence.io with evidence on 2026-09-15.
...
- [https://getcoherence.io](https://getcoherence.io)
- [https://getcoherence.io/docs](https://getcoherence.io/docs)
- [https://getcoherence.io/llms.txt](https://getcoherence.io/llms.txt)
- [https://github.com/Brightyard/brightyard-platform](https://github.com/Brightyard/brightyard-platform)

4 source URLs. Raw sources field, verbatim:

https://getcoherence.io, https://getcoherence.io/docs, https://getcoherence.io/llms.txt, https://github.com/Brightyard/brightyard-platform

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name Coherence MCP (draft listed as io.getcoherence/mcp).

**Provenance**

- **Entry id**: 07-coherence-mcp
