# ContactOut: MCP server status, API access gate and what it does

> Most accurate email finder for personal and work email outreach. Email lookup, campaign tool, and AI writer.... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: contactout (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [contactout.com](https://contactout.com) · entry id 01-contactout · source 01-data-enrichment.md line 2349
...
quoted from [https://www.npmjs.com/package/contactout-agent-cli](https://www.npmjs.com/package/contactout-agent-cli) on 2026-09-15, via npm, a third party source
...
No GitHub organisation could be tied to contactout.com with evidence on 2026-09-15.
...
- [https://contactout.com/llms.txt](https://contactout.com/llms.txt)
- [https://www.clay.com/integrations/data-provider/contactout](https://www.clay.com/integrations/data-provider/contactout)

3 source URLs. Raw sources field, verbatim:

https://contactout.com, https://contactout.com/llms.txt, https://www.clay.com/integrations/data-provider/contactout

**Notes, verbatim from the file**
API mentioned on https://contactout.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 01-contactout
