# Zaymo: MCP server status, API access gate and what it does

> Interactivity converts. Embed interactive, shoppable checkout in your emails. No redirect, no friction. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [zaymo.com](https://zaymo.com) · entry id 02-zaymo · source 02-engagement-outbound.md line 1795
...
- [https://www.zaymo.com/](https://www.zaymo.com/)
...
https://www.zaymo.com/, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from forecasting-revenue to engagement-outbound.
