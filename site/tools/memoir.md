# Memoir: MCP server status, API access gate and what it does

> Software ships faster than teams can explain it. Memoir closes the gap. No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: memoir (community)

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [trymemoir.ai](https://trymemoir.ai) · entry id 11-memoir · source 11-enablement-coaching.md line 624

**What it does**
Software ships faster than teams can explain it. Memoir closes the gap.
...
quoted from [https://www.npmjs.com/package/memoir-cli](https://www.npmjs.com/package/memoir-cli) on 2026-09-26, via npm, a third party source

```
npm install -g @memoir/dispatch
```

quoted from [https://www.npmjs.com/package/@memoir/dispatch](https://www.npmjs.com/package/@memoir/dispatch) on 2026-09-26, via npm, a third party source

Packages seen, with the version on 2026-09-26:

- [npm: memoir-cli 3.17.1, third party](https://www.npmjs.com/package/memoir-cli)
- [npm: @memoir/dispatch 0.1.0, third party](https://www.npmjs.com/package/@memoir/dispatch)
...
No GitHub organisation could be tied to trymemoir.ai with evidence on 2026-09-15.
...
- [https://www.trymemoir.ai/](https://www.trymemoir.ai/)
...
https://www.trymemoir.ai/, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from ai-sdr-agents to enablement-coaching.
