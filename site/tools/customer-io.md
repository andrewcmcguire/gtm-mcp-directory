# Customer.io: MCP server status, API access gate and what it does

> Customer.io is a customer engagement platform for creating personalized journeys and better business outcomes... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [customer.io](https://customer.io) · entry id 14-customer-io · source 14-inbound-plg-chat.md line 806
...
quoted from [https://docs.customer.io/](https://docs.customer.io/) on 2026-09-26, via npm
...
[https://docs.customer.io/](https://docs.customer.io/)
...
No GitHub organisation could be tied to customer.io with evidence on 2026-09-15.
...
- [https://docs.customer.io/](https://docs.customer.io/)
- [https://docs.customer.io/integrations/api/customerio-apis/](https://docs.customer.io/integrations/api/customerio-apis/)
- [https://www.clay.com/integrations/data-provider/customer-io](https://www.clay.com/integrations/data-provider/customer-io)

4 source URLs. Raw sources field, verbatim:

https://customer.io, https://docs.customer.io/, https://docs.customer.io/integrations/api/customerio-apis/, https://www.clay.com/integrations/data-provider/customer-io

**Notes, verbatim from the file**
API mentioned on https://docs.customer.io/integrations/api/customerio-apis/; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-customer-io
