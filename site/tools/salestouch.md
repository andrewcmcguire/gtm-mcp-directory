# SalesTouch: MCP server status, API access gate and what it does

> Make LinkedIn callable from Claude, Codex, ChatGPT, or any MCP-compatible AI agent. Search, read, message,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [salestouch.io](https://salestouch.io) · entry id 02-salestouch · source 02-engagement-outbound.md line 3472

**What it does**
Make LinkedIn callable from Claude, Codex, ChatGPT, or any MCP-compatible AI agent. Search, read, message, follow up, and publish through one controlled endpoint.
...
quoted from [https://www.npmjs.com/package/@salestouch/cli](https://www.npmjs.com/package/@salestouch/cli) on 2026-09-18, via npm

Packages seen, with the version on 2026-09-18:

- [npm: @salestouch/cli 0.1.7](https://www.npmjs.com/package/@salestouch/cli)
...
[https://www.salestouch.io/docs](https://www.salestouch.io/docs)
...
No GitHub organisation could be tied to salestouch.io with evidence on 2026-09-15.
...
- [https://www.salestouch.io](https://www.salestouch.io)
- [https://www.salestouch.io/docs](https://www.salestouch.io/docs)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales](https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales)

3 source URLs. Raw sources field, verbatim:

https://www.salestouch.io, https://www.salestouch.io/docs, https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales

**Notes, verbatim from the file**
API mentioned on https://www.salestouch.io/docs; pricing/gate not inferred from presence alone. API mentioned on https://www.salestouch.io/docs; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave V 2026-09-12.

**Provenance**

- **Entry id**: 02-salestouch
