# PitchIQ MCP: MCP server status, API access gate and what it does

> Chuhching is the agent-native business platform: CRM, outreach, scheduling, community, and automation that... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [chuhching.com](https://chuhching.com) · entry id 11-pitchiq-mcp · source 11-enablement-coaching.md line 1258

**What it does**
Chuhching is the agent-native business platform: CRM, outreach, scheduling, community, and automation that you and your AI agents run together.
...
- [https://github.com/astafford8488/PitchIQ](https://github.com/astafford8488/PitchIQ)
...
[https://www.chuhching.com/login?next=%2Fdocs](https://www.chuhching.com/login?next=%2Fdocs)
...
No GitHub organisation could be tied to chuhching.com with evidence on 2026-09-15.
...
- [https://www.chuhching.com](https://www.chuhching.com)
- [https://www.chuhching.com/login?next=%2Fdocs](https://www.chuhching.com/login?next=%2Fdocs)
- [https://www.chuhching.com/llms.txt](https://www.chuhching.com/llms.txt)
- [https://github.com/astafford8488/PitchIQ](https://github.com/astafford8488/PitchIQ)

4 source URLs. Raw sources field, verbatim:

https://www.chuhching.com, https://www.chuhching.com/login?next=%2Fdocs, https://www.chuhching.com/llms.txt, https://github.com/astafford8488/PitchIQ

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name PitchIQ MCP (draft listed as io.github.astafford8488/pitchiq-mcp).

**Provenance**

- **Entry id**: 11-pitchiq-mcp
