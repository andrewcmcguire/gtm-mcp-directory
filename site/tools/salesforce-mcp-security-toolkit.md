# Salesforce MCP Security Toolkit: MCP server status, API access gate and what it does

> **Adversarial MCP integration testing toolkit for Salesforce ΓÇö seeds ~270 records across Account, Contact,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Salesforce MCP Security Toolkit
...
Vendor: [github.com/ccmalcom/SFDC-MCP-Security-Toolkit](https://github.com/ccmalcom/SFDC-MCP-Security-Toolkit) · entry id 07-salesforce-mcp-security-toolkit · source 07-mcp-infrastructure.md line 3738
...
https://github.com/ccmalcom/SFDC-MCP-Security-Toolkit

- [https://github.com/ccmalcom/SFDC-MCP-Security-Toolkit](https://github.com/ccmalcom/SFDC-MCP-Security-Toolkit)
...
[https://login.salesforce.com/api](https://login.salesforce.com/api)
...
- [https://login.salesforce.com/packaging/installPackage.apexp?p0=04tdM000000SWszQAG](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tdM000000SWszQAG)
- [https://login.salesforce.com/api](https://login.salesforce.com/api)
- [https://login.salesforce.com/mcp](https://login.salesforce.com/mcp)
- [https://github.com/ccmalcom/SFDC-MCP-Security-Toolkit](https://github.com/ccmalcom/SFDC-MCP-Security-Toolkit)

4 source URLs. Raw sources field, verbatim:

https://login.salesforce.com/packaging/installPackage.apexp?p0=04tdM000000SWszQAG, https://login.salesforce.com/api, https://login.salesforce.com/mcp, https://github.com/ccmalcom/SFDC-MCP-Security-Toolkit

**Notes, verbatim from the file**
what_it_does used staging desc because homepage meta description was empty. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave N 2026-09-12: canonical name Salesforce MCP Security Toolkit (draft listed as ccmalcom/SFDC-MCP-Security-Toolkit).

**Provenance**

- **Entry id**: 07-salesforce-mcp-security-toolkit
