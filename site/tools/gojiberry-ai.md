# Gojiberry AI: MCP server status, API access gate and what it does

> Gojiberry AI detects warm leads from 15+ buying and social signals, filters them by your ICP, and runs... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [gojiberry.ai](https://gojiberry.ai) · entry id 04-gojiberry-ai · source 04-ai-sdr-agents.md line 784
...
No GitHub organisation could be tied to gojiberry.ai with evidence on 2026-09-15.
...
- [https://gojiberry.ai/](https://gojiberry.ai/)
...
https://gojiberry.ai/, https://yc-oss.github.io/api/industries/sales.json
