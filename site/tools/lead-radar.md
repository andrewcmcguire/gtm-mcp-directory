# Lead Radar: MCP server status, API access gate and what it does

> Détectez toutes les entreprises d'une zone géographique (données Google Maps), extrayez leurs coordonnées et... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [lead-radar.fr](https://lead-radar.fr) · entry id 01-lead-radar · source 01-data-enrichment.md line 2653

**What it does**
Détectez toutes les entreprises d'une zone géographique (données Google Maps), extrayez leurs coordonnées et enrichissez avec des emails de contact.
...
- [https://lead-radar.fr](https://lead-radar.fr)
...
[https://lead-radar.fr/developers](https://lead-radar.fr/developers)
...
No GitHub organisation could be tied to lead-radar.fr with evidence on 2026-09-15.
...
- [https://lead-radar.fr](https://lead-radar.fr)
- [https://lead-radar.fr/developers](https://lead-radar.fr/developers)
- [https://lead-radar.fr/llms.txt](https://lead-radar.fr/llms.txt)

3 source URLs. Raw sources field, verbatim:

https://lead-radar.fr, https://lead-radar.fr/developers, https://lead-radar.fr/llms.txt

**Notes, verbatim from the file**
API mentioned on https://lead-radar.fr/developers; pricing/gate not inferred from presence alone. API mentioned on https://lead-radar.fr/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 01-lead-radar
