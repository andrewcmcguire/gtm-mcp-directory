# Toflow: MCP server status, API access gate and what it does

> toflow.ai is a LinkedIn automation tool for sales teams, agencies, and GTM experts. Run automated LinkedIn... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [toflow.ai](https://toflow.ai) · entry id 02-toflow · source 02-engagement-outbound.md line 1611

**What it does**
toflow.ai is a LinkedIn automation tool for sales teams, agencies, and GTM experts. Run automated LinkedIn outreach, enrich contacts, and sequence across email and WhatsApp, just by chatting with AI.
...
https://github.com/toflow-ai/toflow-mcp

- [https://github.com/toflow-ai/toflow-mcp](https://github.com/toflow-ai/toflow-mcp)
...
[https://toflow.ai/docs](https://toflow.ai/docs)
...
No GitHub organisation could be tied to toflow.ai with evidence on 2026-09-15.
...
- [https://toflow.ai?utm_source=github&utm_medium=mcp&utm_campaign=toflow-github](https://toflow.ai?utm_source=github&utm_medium=mcp&utm_campaign=toflow-github)
- [https://toflow.ai/docs](https://toflow.ai/docs)
- [https://toflow.ai/llms.txt](https://toflow.ai/llms.txt)
- [https://github.com/toflow-ai/toflow-mcp](https://github.com/toflow-ai/toflow-mcp)

4 source URLs. Raw sources field, verbatim:

https://toflow.ai?utm_source=github&utm_medium=mcp&utm_campaign=toflow-github, https://toflow.ai/docs, https://toflow.ai/llms.txt, https://github.com/toflow-ai/toflow-mcp

**Notes, verbatim from the file**
API mentioned on https://toflow.ai/docs; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave G 2026-09-12: canonical name Toflow (draft listed as toflow-ai/toflow-mcp). Category corrected from data-enrichment to engagement-outbound.
