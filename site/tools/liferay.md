# Liferay: MCP server status, API access gate and what it does

> Digital Experience Platform designed for complexity. Integrates with everything: CMS ✓ DAM ✓ Commerce ✓ AI ✓... No MCP found, Gate unknown. Checked 2026-09-12.
...
RESEARCHED
Checked 2026-09-12
CLI: liferay-npm-bundler

> **RESEARCHED** Facts from public sources with URLs. No usage claims. Nobody has run this tool. The other tier is BENCH-TESTED, which means Andrew personally ran the tool on a stated date and cannot be bought at any price. Across the whole directory that count is 1.

Vendor: [liferay.com](https://liferay.com) · entry id 14-liferay · source 14-inbound-plg-chat.md line 638

**What it does**
Digital Experience Platform designed for complexity. Integrates with everything: CMS ✓ DAM ✓ Commerce ✓ AI ✓ Low Code ✓ Search ✓ and more!
...
quoted from [https://www.npmjs.com/package/liferay-npm-bundler](https://www.npmjs.com/package/liferay-npm-bundler) on 2026-09-18, via npm
...
[https://www.liferay.com/developers](https://www.liferay.com/developers)
...
No GitHub organisation could be tied to liferay.com with evidence on 2026-09-15.
...
- [https://www.liferay.com/developers](https://www.liferay.com/developers)
- [https://demandbase.partnerfleet.app/partners/liferay](https://demandbase.partnerfleet.app/partners/liferay)

3 source URLs. Raw sources field, verbatim:

https://www.liferay.com, https://www.liferay.com/developers, https://demandbase.partnerfleet.app/partners/liferay

**Notes, verbatim from the file**
API mentioned on https://www.liferay.com/developers; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to inbound-plg-chat.
