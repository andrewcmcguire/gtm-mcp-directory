# AstroFabric MCP: MCP server status, API access gate and what it does

> Build with AstroFabric's autonomous intelligence platform using REST, MCP and CLI across datasets,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [astrofabric.ai](https://astrofabric.ai) · entry id 01-astrofabric-mcp · source 01-data-enrichment.md line 3479

**What it does**
Build with AstroFabric's autonomous intelligence platform using REST, MCP and CLI across datasets, enrichment, signals, audiences and governed delivery.
...
https://github.com/sam1siam/astrofabric-mcp

- [https://github.com/sam1siam/astrofabric-mcp](https://github.com/sam1siam/astrofabric-mcp)
...
quoted from [https://www.astrofabric.ai/docs](https://www.astrofabric.ai/docs) on 2026-09-15, via npm
...
[https://www.astrofabric.ai/docs](https://www.astrofabric.ai/docs)
...
No GitHub organisation could be tied to astrofabric.ai with evidence on 2026-09-15.
...
- [https://www.astrofabric.ai/docs](https://www.astrofabric.ai/docs)
- [https://www.astrofabric.ai/login?next=%2Fdevelopers](https://www.astrofabric.ai/login?next=%2Fdevelopers)
- [https://github.com/sam1siam/astrofabric-mcp](https://github.com/sam1siam/astrofabric-mcp)

3 source URLs. Raw sources field, verbatim:

https://www.astrofabric.ai/docs, https://www.astrofabric.ai/login?next=%2Fdevelopers, https://github.com/sam1siam/astrofabric-mcp

**Notes, verbatim from the file**
API mentioned on https://www.astrofabric.ai/docs; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name AstroFabric MCP (draft listed as sam1siam/astrofabric-mcp).

**Provenance**

- **Entry id**: 01-astrofabric-mcp
