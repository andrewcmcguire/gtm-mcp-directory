# TimelinesAI: MCP server status, API access gate and what it does

> Connect both WhatsApp Business API and personal numbers to your CRM. Sync every conversation, work from one... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [timelines.ai](https://timelines.ai) · entry id 02-timelinesai · source 02-engagement-outbound.md line 943
...
[https://timelines.ai/docs/introduction](https://timelines.ai/docs/introduction)
...
- [https://timelines.ai](https://timelines.ai)
- [https://timelines.ai/docs/introduction](https://timelines.ai/docs/introduction)
- [https://www.clay.com/integrations/data-provider/timelinesai](https://www.clay.com/integrations/data-provider/timelinesai)

3 source URLs. Raw sources field, verbatim:

https://timelines.ai, https://timelines.ai/docs/introduction, https://www.clay.com/integrations/data-provider/timelinesai
