# ZOOQ: MCP server status, API access gate and what it does

> Feed your AI agent live LinkedIn data: profiles, companies, jobs, emails. One API key, MCP-ready. 300 free... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [zooq.dev](https://zooq.dev) · entry id 01-zooq · source 01-data-enrichment.md line 1539

**What it does**
Feed your AI agent live LinkedIn data: profiles, companies, jobs, emails. One API key, MCP-ready. 300 free credits, no card.
...
[https://zooq.dev/docs](https://zooq.dev/docs)
...
No GitHub organisation could be tied to zooq.dev with evidence on 2026-09-15.
...
- [https://zooq.dev](https://zooq.dev)
- [https://zooq.dev/docs](https://zooq.dev/docs)
- [https://zooq.dev/llms.txt](https://zooq.dev/llms.txt)
- [https://registry.smithery.ai/servers?q=enrich](https://registry.smithery.ai/servers?q=enrich)

4 source URLs. Raw sources field, verbatim:

https://zooq.dev, https://zooq.dev/docs, https://zooq.dev/llms.txt, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
API mentioned on https://zooq.dev/docs; pricing/gate not inferred from presence alone. API mentioned on https://zooq.dev/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave E 2026-09-12: canonical name ZOOQ (draft listed as ZOOQ - LinkedIn Data for AI Agents).
