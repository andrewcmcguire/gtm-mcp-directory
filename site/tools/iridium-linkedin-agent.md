# Iridium LinkedIn Agent: MCP server status, API access gate and what it does

> An MCP server that gives AI agents live LinkedIn data and the ability to act: commenting, outreach,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [iridiumhqmcp.com](https://iridiumhqmcp.com) · entry id 07-iridium-linkedin-agent · source 07-mcp-infrastructure.md line 2370

**What it does**
An MCP server that gives AI agents live LinkedIn data and the ability to act: commenting, outreach, messaging, with every action logged and human approval before anything posts.
...
https://github.com/nikhilkulkarni1755/iridium-linkedin-agent

- [https://github.com/nikhilkulkarni1755/iridium-linkedin-agent](https://github.com/nikhilkulkarni1755/iridium-linkedin-agent)
...
[https://iridiumhqmcp.com/docs](https://iridiumhqmcp.com/docs)
...
No GitHub organisation could be tied to iridiumhqmcp.com with evidence on 2026-09-15.
...
- [https://iridiumhqmcp.com](https://iridiumhqmcp.com)
- [https://iridiumhqmcp.com/docs](https://iridiumhqmcp.com/docs)
- [https://iridiumhqmcp.com/developers](https://iridiumhqmcp.com/developers)
- [https://github.com/nikhilkulkarni1755/iridium-linkedin-agent](https://github.com/nikhilkulkarni1755/iridium-linkedin-agent)

4 source URLs. Raw sources field, verbatim:

https://iridiumhqmcp.com, https://iridiumhqmcp.com/docs, https://iridiumhqmcp.com/developers, https://github.com/nikhilkulkarni1755/iridium-linkedin-agent

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave J 2026-09-12: canonical name Iridium LinkedIn Agent (draft listed as nikhilkulkarni1755/iridium-linkedin-agent).

**Provenance**

- **Entry id**: 07-iridium-linkedin-agent
