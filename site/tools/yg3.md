# YG3: MCP server status, API access gate and what it does

> Provision a YG3 marketing workspace from any autonomous agent - no signup. Bearer-token MCP with 200+ tools... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [yg3.ai](https://yg3.ai) · entry id 07-yg3 · source 07-mcp-infrastructure.md line 1058

**What it does**
Provision a YG3 marketing workspace from any autonomous agent - no signup. Bearer-token MCP with 200+ tools for content, SEO, outbound, LinkedIn, and paid ads.
...
https://github.com/YG3-ai/yg3-mcp

- [https://github.com/YG3-ai/yg3-mcp](https://github.com/YG3-ai/yg3-mcp)
...
No GitHub organisation could be tied to yg3.ai with evidence on 2026-09-15.
...
- [https://www.yg3.ai/for-agents](https://www.yg3.ai/for-agents)
- [https://www.yg3.ai/llms.txt](https://www.yg3.ai/llms.txt)
- [https://github.com/YG3-ai/yg3-mcp](https://github.com/YG3-ai/yg3-mcp)

3 source URLs. Raw sources field, verbatim:

https://www.yg3.ai/for-agents, https://www.yg3.ai/llms.txt, https://github.com/YG3-ai/yg3-mcp

**Notes, verbatim from the file**
API mentioned on https://www.yg3.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave D 2026-09-12: canonical name YG3 (draft listed as YG3 Marketing MCP). Category corrected from engagement-outbound to mcp-infrastructure.
