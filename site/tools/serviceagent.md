# ServiceAgent: MCP server status, API access gate and what it does

> Discover ServiceAgent, the AI platform running your front and back office. Handle calls, CRM, scheduling,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [serviceagent.ai](https://serviceagent.ai) · entry id 07-serviceagent · source 07-mcp-infrastructure.md line 1280
...
- [https://serviceagent.ai](https://serviceagent.ai)
...
quoted from [https://www.npmjs.com/package/@serviceagent/cli-dev](https://www.npmjs.com/package/@serviceagent/cli-dev) on 2026-09-18, via npm

```
npm install -g @serviceagent/cli
```

quoted from [https://www.npmjs.com/package/@serviceagent/cli](https://www.npmjs.com/package/@serviceagent/cli) on 2026-09-18, via npm
...
[https://serviceagent.ai/docs](https://serviceagent.ai/docs)
