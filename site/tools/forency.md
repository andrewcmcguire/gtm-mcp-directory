# Forency: MCP server status, API access gate and what it does

> Investigate any website's tech stack. Forency detects the CMS, frameworks, analytics, payments, CRM and 100+... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [forency.io](https://forency.io) · entry id 07-forency · source 07-mcp-infrastructure.md line 4766

**What it does**
Investigate any website's tech stack. Forency detects the CMS, frameworks, analytics, payments, CRM and 100+ technologies that matter - via REST API and MCP server, built for AI agents first.
...
https://github.com/cheevahagadog/forency-mcp

- [https://github.com/cheevahagadog/forency-mcp](https://github.com/cheevahagadog/forency-mcp)
...
[https://forency.io/docs](https://forency.io/docs)
...
No GitHub organisation could be tied to forency.io with evidence on 2026-09-15.
...
- [https://forency.io](https://forency.io)
- [https://forency.io/docs](https://forency.io/docs)
- [https://github.com/cheevahagadog/forency-mcp](https://github.com/cheevahagadog/forency-mcp)

3 source URLs. Raw sources field, verbatim:

https://forency.io, https://forency.io/docs, https://github.com/cheevahagadog/forency-mcp

**Notes, verbatim from the file**
API mentioned on https://forency.io/docs; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name Forency (draft listed as io.github.cheevahagadog/forency).
