# Phos Sales Engine: MCP server status, API access gate and what it does

> B2B lead generation - prospect discovery, ICP scoring, outreach, and pipeline management. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://se.phos.nz/mcp](https://se.phos.nz/mcp) · entry id 02-phos-sales-engine · source 02-engagement-outbound.md line 3370
...
- [https://se.phos.nz/mcp](https://se.phos.nz/mcp)
