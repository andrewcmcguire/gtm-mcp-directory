# ActiveCampaign: MCP server status, API access gate and what it does

> Go beyond marketing automation with ActiveCampaign's autonomous marketing platform. Your team of AI agents... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [activecampaign.com](https://activecampaign.com) · entry id 02-activecampaign · source 02-engagement-outbound.md line 801
...
No GitHub organisation could be tied to activecampaign.com with evidence on 2026-09-15.
...
- [https://developers.activecampaign.com/reference/overview](https://developers.activecampaign.com/reference/overview)
- [https://www.clay.com/integrations/data-provider/activecampaign](https://www.clay.com/integrations/data-provider/activecampaign)

3 source URLs. Raw sources field, verbatim:

https://www.activecampaign.com, https://developers.activecampaign.com/reference/overview, https://www.clay.com/integrations/data-provider/activecampaign

**Notes, verbatim from the file**
API mentioned on https://developers.activecampaign.com/reference/overview; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to engagement-outbound.

**Provenance**

- **Entry id**: 02-activecampaign
