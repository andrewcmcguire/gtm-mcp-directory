...
quoted from [https://developers.apideck.com/cli](https://developers.apideck.com/cli) on 2026-09-17, via go

```
docker run apideck/cli
```

quoted from [https://developers.apideck.com/cli](https://developers.apideck.com/cli) on 2026-09-17, via docker
