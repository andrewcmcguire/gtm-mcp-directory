# PulseAgent MCP: MCP server status, API access gate and what it does

> MCP server for PulseAgent - let Claude Code, Cursor, and Codex interact with your AI digital workers, CRM,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/iPythoning/pulseagent-mcp-server](https://github.com/iPythoning/pulseagent-mcp-server) · entry id 07-pulseagent-mcp · source 07-mcp-infrastructure.md line 3055
...
https://github.com/iPythoning/pulseagent-mcp-server

- [https://github.com/iPythoning/pulseagent-mcp-server](https://github.com/iPythoning/pulseagent-mcp-server)
