# AlphaAI: MCP server status, API access gate and what it does

> Financial news MCP server for ChatGPT, Claude, Gemini, Cursor, VS Code, Windsurf and any spec-compliant... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://alphai.io/mcp](https://alphai.io/mcp) · entry id 01-alphaai · source 01-data-enrichment.md line 4014

**What it does**
Financial news MCP server for ChatGPT, Claude, Gemini, Cursor, VS Code, Windsurf and any spec-compliant client. Relevance-scored feed, OAuth 2.1, 13 tools.
...
https://github.com/makeev/alphai-mcp

- [https://github.com/makeev/alphai-mcp](https://github.com/makeev/alphai-mcp)
...
- **Client** Config evidence: in a README table · calling it reads · from a third party repo, so these are that author's tools, not the vendor's published surface

- **Price** $0 (no card) evidence: in a README table · calling it reads · from a third party repo, so these are that author's tools, not the vendor's published surface
...
[https://alphai.io/developers](https://alphai.io/developers)
...
No GitHub organisation could be tied to alphai.io with evidence on 2026-09-15.
...
- [https://alphai.io/mcp](https://alphai.io/mcp)
- [https://alphai.io/developers](https://alphai.io/developers)
- [https://alphai.io/llms.txt](https://alphai.io/llms.txt)
- [https://github.com/makeev/alphai-mcp](https://github.com/makeev/alphai-mcp)

4 source URLs. Raw sources field, verbatim:

https://alphai.io/mcp, https://alphai.io/developers, https://alphai.io/llms.txt, https://github.com/makeev/alphai-mcp

**Notes, verbatim from the file**
API mentioned on https://alphai.io/developers; pricing/gate not inferred from presence alone. API mentioned on https://alphai.io/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave P 2026-09-12.
