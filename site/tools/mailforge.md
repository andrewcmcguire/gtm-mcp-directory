...
analytics, campaign, config, contact, dashboard, inbox, init, send, template

Where it was documented:

- [https://github.com/gitstq/MailForge-CLI](https://github.com/gitstq/MailForge-CLI) (the repository that documented it)
