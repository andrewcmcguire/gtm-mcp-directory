# CustomerOS: MCP server status, API access gate and what it does

> CustomerOS uncovers hidden pipeline that actually converts. It No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [customeros.ai](https://customeros.ai) · entry id 05-customeros · source 05-signals-intent-abm.md line 1377

**What it does**
CustomerOS uncovers hidden pipeline that actually converts. It
...
No GitHub organisation could be tied to customeros.ai with evidence on 2026-09-15.
...
- [https://customeros.ai](https://customeros.ai)
- [https://customeros.ai/llms.txt](https://customeros.ai/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

3 source URLs. Raw sources field, verbatim:

https://customeros.ai, https://customeros.ai/llms.txt, https://yc-oss.github.io/api/industries/sales.json
