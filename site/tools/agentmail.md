# AgentMail: MCP server status, API access gate and what it does

> AgentMail gives AI agents real email inboxes. Create, send, receive, and search messages via REST API - built... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [agentmail.to](https://agentmail.to) · entry id 02-agentmail · source 02-engagement-outbound.md line 821
...
quoted from [https://www.npmjs.com/package/agentmail-cli](https://www.npmjs.com/package/agentmail-cli) on 2026-09-18, via npm
...
- [npm: agentmail-cli 1.5.0](https://www.npmjs.com/package/agentmail-cli)
...
- [npm: @stepandel/agentmail-cli 1.0.0, third party](https://www.npmjs.com/package/@stepandel/agentmail-cli)
...
[https://www.agentmail.to/docs](https://www.agentmail.to/docs)
...
- [https://www.agentmail.to](https://www.agentmail.to)
- [https://www.agentmail.to/docs](https://www.agentmail.to/docs)
- [https://www.agentmail.to/llms.txt](https://www.agentmail.to/llms.txt)
- [https://www.clay.com/integrations/data-provider/agentmail](https://www.clay.com/integrations/data-provider/agentmail)

4 source URLs. Raw sources field, verbatim:

https://www.agentmail.to, https://www.agentmail.to/docs, https://www.agentmail.to/llms.txt, https://www.clay.com/integrations/data-provider/agentmail

**Notes, verbatim from the file**
API mentioned on https://www.agentmail.to/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to engagement-outbound.

**Provenance**

- **Entry id**: 02-agentmail
