...
async, class, double, int, long, sealed, string, struct

Where it was documented:

- [https://github.com/eventhorizon-cli/BufferQueue](https://github.com/eventhorizon-cli/BufferQueue) (the repository that documented it)
