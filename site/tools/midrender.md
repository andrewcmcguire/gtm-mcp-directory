# Midrender: MCP server status, API access gate and what it does

> Create motion animations in collaboration with AI. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [midrender.com](https://midrender.com) · entry id 08-midrender · source 08-video-prospecting.md line 410
...
No GitHub organisation could be tied to midrender.com with evidence on 2026-09-15.
...
- [https://midrender.com](https://midrender.com)
...
https://midrender.com, https://yc-oss.github.io/api/tags/marketing.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from ai-sdr-agents to video-prospecting.

**Provenance**

- **Entry id**: 08-midrender
