# LeadSmarts: MCP server status, API access gate and what it does

> Qualify B2B leads: live-web research, Hot/Warm/Cold verdicts with evidence, and outreach drafts. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://bjmsxprjidjdyquiroxy.supabase.co/functions/v1/mcp-server](https://bjmsxprjidjdyquiroxy.supabase.co/functions/v1/mcp-server) · entry id 02-leadsmarts · source 02-engagement-outbound.md line 2740
...
https://bjmsxprjidjdyquiroxy.supabase.co/functions/v1/mcp-server

- [https://bjmsxprjidjdyquiroxy.supabase.co/functions/v1/mcp-server](https://bjmsxprjidjdyquiroxy.supabase.co/functions/v1/mcp-server)
