# PropelAgent Studio: MCP server status, API access gate and what it does

> AI agent platform: manage leads, conversations, bots, calendar and CRM via MCP. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.propelagent.studio/api/mcp](https://www.propelagent.studio/api/mcp) · entry id 04-propelagent-studio · source 04-ai-sdr-agents.md line 1366
...
https://github.com/contacto291/propelagentstudio

- [https://github.com/contacto291/propelagentstudio](https://github.com/contacto291/propelagentstudio)
...
- **Entry id**: 04-propelagent-studio
