...
quoted from [https://anyquery.dev/docs](https://anyquery.dev/docs) on 2026-09-15, via brew

```
curl -fsSL https://anyquery.dev/install.sh | sh
```

quoted from [https://anyquery.dev/docs](https://anyquery.dev/docs) on 2026-09-15, via shell

```
winget install JulienCagniart.anyquery
```

quoted from [https://anyquery.dev/docs](https://anyquery.dev/docs) on 2026-09-15, via winget

```
scoop install anyquery
```

quoted from [https://anyquery.dev/docs](https://anyquery.dev/docs) on 2026-09-15, via scoop
