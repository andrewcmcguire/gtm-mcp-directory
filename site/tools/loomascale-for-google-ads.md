# LoomaScale for Google Ads: MCP server status, API access gate and what it does

> An AI ad operator for Google Ads. Brief it in ChatGPT - it builds, monitors, and improves your campaigns.... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [ai.loomascale.com](https://ai.loomascale.com) · entry id 02-loomascale-for-google-ads · source 02-engagement-outbound.md line 3086
...
[https://ai.loomascale.com/docs](https://ai.loomascale.com/docs)
...
No GitHub organisation could be tied to ai.loomascale.com with evidence on 2026-09-15.
...
- [https://ai.loomascale.com](https://ai.loomascale.com)
- [https://ai.loomascale.com/docs](https://ai.loomascale.com/docs)
- [https://ai.loomascale.com/llms.txt](https://ai.loomascale.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm)

4 source URLs. Raw sources field, verbatim:

https://ai.loomascale.com, https://ai.loomascale.com/docs, https://ai.loomascale.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm

**Notes, verbatim from the file**
API mentioned on https://ai.loomascale.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave S 2026-09-12.

**Provenance**

- **Entry id**: 02-loomascale-for-google-ads
