# Alyce: MCP server status, API access gate and what it does

> Could not fully document product behavior from a live vendor homepage this pass (fetch status=None... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [alyce.com](https://alyce.com) · entry id 02-alyce · source 02-engagement-outbound.md line 2343

**What it does**
Could not fully document product behavior from a live vendor homepage this pass (fetch status=None error=URLError: <urlopen error [Errno 11001] getaddrinfo failed>).
...
quoted from [https://www.npmjs.com/package/alyce](https://www.npmjs.com/package/alyce) on 2026-09-18, via npm, a third party source

Packages seen, with the version on 2026-09-18:

- [npm: alyce 0.3.4, third party](https://www.npmjs.com/package/alyce)
...
No GitHub organisation could be tied to alyce.com with evidence on 2026-09-15.
...
https://marketplace.salesloft.com/

**Notes, verbatim from the file**
Homepage fetch failed or empty: URLError: <urlopen error [Errno 11001] getaddrinfo failed>. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.
