# item: MCP server status, API access gate and what it does

> item is the AI-native system that understands your business, knows your customers, and does the work -... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [item.app](https://item.app) · entry id 04-item · source 04-ai-sdr-agents.md line 634

**What it does**
item is the AI-native system that understands your business, knows your customers, and does the work - Designed to replace your CRM.
...
No GitHub organisation could be tied to item.app with evidence on 2026-09-15.
...
https://item.app, https://yc-oss.github.io/api/industries/sales.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to ai-sdr-agents.
