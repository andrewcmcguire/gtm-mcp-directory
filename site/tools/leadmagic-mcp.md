# LeadMagic MCP: MCP server status, API access gate and what it does

> Local TypeScript MCP server for the LeadMagic API: email finder, email validation, company enrichment, and... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [leadmagic.io](https://leadmagic.io) · entry id 01-leadmagic-mcp · source 01-data-enrichment.md line 3199

**What it does**
Local TypeScript MCP server for the LeadMagic API: email finder, email validation, company enrichment, and research tools over stdio.
...
[https://leadmagic.io/docs](https://leadmagic.io/docs)
...
No GitHub organisation could be tied to leadmagic.io with evidence on 2026-09-15.
...
- [https://leadmagic.io/docs/mcp/setup?utm_source=github&utm_medium=referral&utm_campaign=leadmagic-mcp&utm_content=repository-about](https://leadmagic.io/docs/mcp/setup?utm_source=github&utm_medium=referral&utm_campaign=leadmagic-mcp&utm_content=repository-about)
- [https://leadmagic.io/docs](https://leadmagic.io/docs)
- [https://leadmagic.io/llms.txt](https://leadmagic.io/llms.txt)
- [https://github.com/LeadMagic/leadmagic-mcp](https://github.com/LeadMagic/leadmagic-mcp)

4 source URLs. Raw sources field, verbatim:

https://leadmagic.io/docs/mcp/setup?utm_source=github&utm_medium=referral&utm_campaign=leadmagic-mcp&utm_content=repository-about, https://leadmagic.io/docs, https://leadmagic.io/llms.txt, https://github.com/LeadMagic/leadmagic-mcp

**Notes, verbatim from the file**
API mentioned on https://leadmagic.io/docs; pricing/gate not inferred from presence alone. API mentioned on https://leadmagic.io/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name LeadMagic MCP (draft listed as LeadMagic/leadmagic-mcp).

**Provenance**

- **Entry id**: 01-leadmagic-mcp
