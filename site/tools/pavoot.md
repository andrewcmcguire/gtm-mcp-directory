# Pavoot: MCP server status, API access gate and what it does

> Pavoot is the YC-backed AI agent for events. Source the right attendees, personalize every invite, and turn... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [pavoot.com](https://pavoot.com) · entry id 02-pavoot · source 02-engagement-outbound.md line 1917
...
- [https://pavoot.com](https://pavoot.com)
- [https://pavoot.com/llms.txt](https://pavoot.com/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://pavoot.com, https://pavoot.com/llms.txt, https://yc-oss.github.io/api/industries/marketing.json
