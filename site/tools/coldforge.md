# Coldforge: MCP server status, API access gate and what it does

> Honest, local-first cold outreach toolkit: research, personalize, sequence, send, follow. CLI + MCP server,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/Makeph/coldforge](https://github.com/Makeph/coldforge) · entry id 07-coldforge · source 07-mcp-infrastructure.md line 2450
...
- [https://github.com/Makeph/coldforge](https://github.com/Makeph/coldforge)
