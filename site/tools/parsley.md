# Parsley: MCP server status, API access gate and what it does

> Query buyer intent signals, MEDDIC qualifications, and lead scores from Parsley. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.parsley.id/api/mcp](https://www.parsley.id/api/mcp) · entry id 05-parsley · source 05-signals-intent-abm.md line 1868
...
https://github.com/peterjduffy/parsley-mcp

- [https://github.com/peterjduffy/parsley-mcp](https://github.com/peterjduffy/parsley-mcp)
...
[https://www.parsley.id/docs](https://www.parsley.id/docs)
...
No GitHub organisation could be tied to parsley.id with evidence on 2026-09-15.
...
- [https://www.parsley.id/docs](https://www.parsley.id/docs)
- [https://www.parsley.id/documentation](https://www.parsley.id/documentation)
- [https://github.com/peterjduffy/parsley-mcp](https://github.com/peterjduffy/parsley-mcp)

3 source URLs. Raw sources field, verbatim:

https://www.parsley.id/docs, https://www.parsley.id/documentation, https://github.com/peterjduffy/parsley-mcp

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 403); what_it_does used staging desc. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave U 2026-09-12: canonical name Parsley (draft listed as Parsley - Buyer Intent Signals).
