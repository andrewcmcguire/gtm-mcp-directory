# Sitefire: MCP server status, API access gate and what it does

> Sitefire helps brands market their products to AI agents. Track AI visibility, identify what gets cited, and... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [sitefire.ai](https://sitefire.ai) · entry id 05-sitefire · source 05-signals-intent-abm.md line 841

**What it does**
Sitefire helps brands market their products to AI agents. Track AI visibility, identify what gets cited, and ship brand-aware content that ranks in generative answers.
...
[https://sitefire.ai/docs](https://sitefire.ai/docs)
...
No GitHub organisation could be tied to sitefire.ai with evidence on 2026-09-15.
...
- [https://sitefire.ai](https://sitefire.ai)
- [https://sitefire.ai/docs](https://sitefire.ai/docs)
- [https://sitefire.ai/llms.txt](https://sitefire.ai/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://sitefire.ai, https://sitefire.ai/docs, https://sitefire.ai/llms.txt, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://sitefire.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from ai-sdr-agents to signals-intent-abm.

**Provenance**

- **Entry id**: 05-sitefire
