# Salesforce MCP by SurajAdsul: MCP server status, API access gate and what it does

> An MCP (Model Context Protocol) server implementation that integrates Claude with Salesforce, enabling... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/SurajAdsul/mcp-server-salesforce](https://github.com/SurajAdsul/mcp-server-salesforce) · entry id 07-salesforce-mcp-by-surajadsul · source 07-mcp-infrastructure.md line 495

**What it does**
An MCP (Model Context Protocol) server implementation that integrates Claude with Salesforce, enabling natural language interactions with your Salesforce data and metadata. This server allows Claude to query, modify, and manage your Salesforce objects and records using everyday language. - SurajAdsul/mcp-server-salesforce
...
- [https://github.com/SurajAdsul/mcp-server-salesforce](https://github.com/SurajAdsul/mcp-server-salesforce)
