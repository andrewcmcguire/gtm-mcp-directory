# Accordo Agent CRM MCP: MCP server status, API access gate and what it does

> The open-source framework your coding agent - Claude Code, Codex, Gemini CLI - uses to build a custom CRM as... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [accordo.dev](https://accordo.dev) · entry id 07-accordo-agent-crm-mcp · source 07-mcp-infrastructure.md line 4646

**What it does**
The open-source framework your coding agent - Claude Code, Codex, Gemini CLI - uses to build a custom CRM as code you own, with deterministic policy and audit.
...
- [https://github.com/khaoss85/agent-crm](https://github.com/khaoss85/agent-crm)
...
No GitHub organisation could be tied to accordo.dev with evidence on 2026-09-15.
...
- [https://accordo.dev](https://accordo.dev)
- [https://accordo.dev/llms.txt](https://accordo.dev/llms.txt)
- [https://github.com/khaoss85/agent-crm](https://github.com/khaoss85/agent-crm)

3 source URLs. Raw sources field, verbatim:

https://accordo.dev, https://accordo.dev/llms.txt, https://github.com/khaoss85/agent-crm

**Notes, verbatim from the file**
API mentioned on https://accordo.dev/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12: canonical name Accordo Agent CRM MCP (draft listed as io.github.khaoss85/agent-crm).

**Provenance**

- **Entry id**: 07-accordo-agent-crm-mcp
