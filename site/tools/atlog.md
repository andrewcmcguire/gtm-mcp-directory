# Atlog: MCP server status, API access gate and what it does

> Atlog is TCPA-compliant voice AI for collections and customer service. Automate outbound calls, recover... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [atlog.ai](https://atlog.ai) · entry id 02-atlog · source 02-engagement-outbound.md line 1775

**What it does**
Atlog is TCPA-compliant voice AI for collections and customer service. Automate outbound calls, recover payments, and stay legally protected. Backed by Y Combinator.
...
No GitHub organisation could be tied to atlog.ai with evidence on 2026-09-15.
...
- [https://www.atlog.ai/](https://www.atlog.ai/)
- [https://www.atlog.ai/llms.txt](https://www.atlog.ai/llms.txt)
- [https://yc-oss.github.io/api/companies/all.json](https://yc-oss.github.io/api/companies/all.json)

3 source URLs. Raw sources field, verbatim:

https://www.atlog.ai/, https://www.atlog.ai/llms.txt, https://yc-oss.github.io/api/companies/all.json
