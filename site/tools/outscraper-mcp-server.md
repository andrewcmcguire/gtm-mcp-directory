# Outscraper MCP Server: MCP server status, API access gate and what it does

> Outscraper MCP business discovery, Maps intelligence, enrichment, reviews, and contact data. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://mcp.outscraper.com/mcp](https://mcp.outscraper.com/mcp) · entry id 01-outscraper-mcp-server · source 01-data-enrichment.md line 4602
...
https://github.com/outscraper/outscraper-mcp-server

- [https://github.com/outscraper/outscraper-mcp-server](https://github.com/outscraper/outscraper-mcp-server)
...
quoted from [https://www.npmjs.com/package/outscraper-cli](https://www.npmjs.com/package/outscraper-cli) on 2026-09-17, via npm

Packages seen, with the version on 2026-09-17:

- [npm: outscraper-cli 0.2.1](https://www.npmjs.com/package/outscraper-cli)
...
Homepage fetch failed (HTTPError 405); what_it_does used staging desc. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12.

**Provenance**

- **Entry id**: 01-outscraper-mcp-server
