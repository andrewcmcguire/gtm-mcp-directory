# Gauge: MCP server status, API access gate and what it does

> Track, analyze, and improve your brand's presence across ChatGPT, Gemini, Perplexity, and AI search. Complete... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [withgauge.com](https://withgauge.com) · entry id 05-gauge · source 05-signals-intent-abm.md line 1293
...
quoted from [https://www.npmjs.com/package/@withgauge/cli](https://www.npmjs.com/package/@withgauge/cli) on 2026-09-15, via npm

Packages seen, with the version on 2026-09-15:

- [npm: @withgauge/cli 0.10.0](https://www.npmjs.com/package/@withgauge/cli)
- [npm: @getgauge/cli 1.6.36, third party](https://www.npmjs.com/package/@getgauge/cli)
...
No GitHub organisation could be tied to withgauge.com with evidence on 2026-09-15.
...
- [https://www.withgauge.com/](https://www.withgauge.com/)
- [https://www.withgauge.com/llms.txt](https://www.withgauge.com/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://www.withgauge.com/, https://www.withgauge.com/llms.txt, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://www.withgauge.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to signals-intent-abm.
