...
quoted from [https://docs.getcargo.ai/cli/overview](https://docs.getcargo.ai/cli/overview) on 2026-09-26, via npx

Login or key hint seen on the page:

cargo-ai login --token
- [npm: @cargo-ai/cli 1.0.101](https://www.npmjs.com/package/@cargo-ai/cli)
