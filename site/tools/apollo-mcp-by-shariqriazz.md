# Apollo MCP by shariqriazz: MCP server status, API access gate and what it does

> MCP server for Apollo.io lead search, contact enrichment, account data, sequences, and engagement reporting.... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/shariqriazz/apollo-io-mcp-server](https://github.com/shariqriazz/apollo-io-mcp-server) · entry id 07-apollo-mcp-by-shariqriazz · source 07-mcp-infrastructure.md line 3035
...
https://github.com/shariqriazz/apollo-io-mcp-server

- [https://github.com/shariqriazz/apollo-io-mcp-server](https://github.com/shariqriazz/apollo-io-mcp-server)
...
https://github.com/shariqriazz/apollo-io-mcp-server, https://github.com/docs, https://github.com/developers

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave L 2026-09-12: canonical name Apollo MCP by shariqriazz (draft listed as shariqriazz/apollo-io-mcp-server). Category corrected from data-enrichment to mcp-infrastructure.

**Provenance**

- **Entry id**: 07-apollo-mcp-by-shariqriazz
