# ScraperCity: MCP server status, API access gate and what it does

> ScraperCity CLI & MCP Server - B2B lead generation for AI agents. 20+ scrapers accessible via CLI, MCP, or... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/scrapercity/scrapercity-cli](https://github.com/scrapercity/scrapercity-cli) · entry id 01-scrapercity · source 01-data-enrichment.md line 2085
...
- [https://github.com/docs](https://github.com/docs)
- [https://github.com/punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)
- [https://github.com/scrapercity/scrapercity-cli](https://github.com/scrapercity/scrapercity-cli)
...
https://github.com/scrapercity/scrapercity-cli, https://github.com/docs, https://github.com/developers, https://github.com/punkpeye/awesome-mcp-servers

**Notes, verbatim from the file**
mcp_status=community from discovery source awesome-mcp-servers; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave H 2026-09-12: canonical name ScraperCity (draft listed as scrapercity/scrapercity-cli). Category corrected from mcp-infrastructure to data-enrichment.

**Provenance**

- **Entry id**: 01-scrapercity
