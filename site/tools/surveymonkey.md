# SurveyMonkey: MCP server status, API access gate and what it does

> Easily create surveys and forms with AI and templates for employee and customer feedback, market research,... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [surveymonkey.com](https://surveymonkey.com) · entry id 14-surveymonkey · source 14-inbound-plg-chat.md line 432
...
No GitHub organisation could be tied to surveymonkey.com with evidence on 2026-09-15.
...
- [https://www.surveymonkey.com/llms.txt](https://www.surveymonkey.com/llms.txt)
...
https://www.surveymonkey.com, https://www.surveymonkey.com/llms.txt, https://ecosystem.hubspot.com/marketplace/explore/products?eco_PRODUCT_TYPE=APP

**Notes, verbatim from the file**
API mentioned on https://www.surveymonkey.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from revops-infra to inbound-plg-chat.

**Provenance**

- **Entry id**: 14-surveymonkey
