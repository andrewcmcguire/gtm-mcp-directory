# LeadScout MCP: MCP server status, API access gate and what it does

> MCP server for LeadScout Spanish B2B lead generation for PyMEs. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://chenagent.dev/mcp-family](https://chenagent.dev/mcp-family) · entry id 01-leadscout-mcp · source 01-data-enrichment.md line 3359
...
https://github.com/alexchenai/leadscout-mcp

- [https://github.com/alexchenai/leadscout-mcp](https://github.com/alexchenai/leadscout-mcp)
...
Homepage fetch failed (TimeoutError: The read operation timed out); what_it_does used staging desc. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name LeadScout MCP (draft listed as alexchenai/leadscout-mcp). Category corrected from mcp-infrastructure to data-enrichment.

**Provenance**

- **Entry id**: 01-leadscout-mcp
