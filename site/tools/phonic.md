# Phonic: MCP server status, API access gate and what it does

> Build voice agents as natural as humans. 750ms latency, 50+ languages, audio-native AI. Trusted by teams... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [phonic.ai](https://phonic.ai) · entry id 03-phonic · source 03-conversation-intel.md line 891

**What it does**
Build voice agents as natural as humans. 750ms latency, 50+ languages, audio-native AI. Trusted by teams shipping voice in production. Try free.
...
quoted from [https://www.npmjs.com/package/@phonic-ai/cli](https://www.npmjs.com/package/@phonic-ai/cli) on 2026-09-15, via npm
...
No GitHub organisation could be tied to phonic.ai with evidence on 2026-09-15.
...
- [https://phonic.ai/mcp](https://phonic.ai/mcp)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://phonic.ai, https://phonic.ai/mcp, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from ai-sdr-agents to conversation-intel.
