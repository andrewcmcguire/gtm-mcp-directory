# Demodesk: MCP server status, API access gate and what it does

> Record every sales call, update your CRM, coach reps, and draft follow-ups automatically. GDPR-native, built... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [demodesk.com](https://demodesk.com) · entry id 03-demodesk · source 03-conversation-intel.md line 557
...
No GitHub organisation could be tied to demodesk.com with evidence on 2026-09-15.
...
- [https://demodesk.ai/](https://demodesk.ai/)
- [https://demodesk.ai/llms.txt](https://demodesk.ai/llms.txt)
- [https://yc-oss.github.io/api/industries/sales.json](https://yc-oss.github.io/api/industries/sales.json)

3 source URLs. Raw sources field, verbatim:

https://demodesk.ai/, https://demodesk.ai/llms.txt, https://yc-oss.github.io/api/industries/sales.json
