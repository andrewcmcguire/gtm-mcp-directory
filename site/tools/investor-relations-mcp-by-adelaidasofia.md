# Investor Relations MCP by adelaidasofia: MCP server status, API access gate and what it does

> FastMCP seed raise pipeline tracker - syncs from Obsidian CRM, generates meeting prep, tracks follow-up... Community MCP, Gate unknown. Checked 2026-09-12.
...
Investor Relations MCP by adelaidasofia
...
Vendor: [https://github.com/adelaidasofia/investor-relations-mcp](https://github.com/adelaidasofia/investor-relations-mcp) · entry id 07-investor-relations-mcp-by-adelaidasofia · source 07-mcp-infrastructure.md line 4544
...
https://github.com/adelaidasofia/investor-relations-mcp

- [https://github.com/adelaidasofia/investor-relations-mcp](https://github.com/adelaidasofia/investor-relations-mcp)
...
https://github.com/adelaidasofia/investor-relations-mcp, https://github.com/docs, https://github.com/developers

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave Q 2026-09-12: canonical name Investor Relations MCP by adelaidasofia (draft listed as FastMCP seed raise pipeline tracker - syncs from Obsidian CRM, generates meeting).

**Provenance**

- **Entry id**: 07-investor-relations-mcp-by-adelaidasofia
