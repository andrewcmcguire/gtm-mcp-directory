# MisarMail MCP: MCP server status, API access gate and what it does

> Free AI email marketing: send bulk campaigns, automate flows, manage a shared inbox, and use your own domain... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [misarmail.com](https://misarmail.com) · entry id 02-misarmail-mcp · source 02-engagement-outbound.md line 3248

**What it does**
Free AI email marketing: send bulk campaigns, automate flows, manage a shared inbox, and use your own domain or a free @misar.io address. No card needed.
...
[https://docs.misar.io/mail](https://docs.misar.io/mail)
...
No GitHub organisation could be tied to misarmail.com with evidence on 2026-09-15.
...
- [https://misarmail.com/](https://misarmail.com/)
- [https://docs.misar.io/mail](https://docs.misar.io/mail)
- [https://misarmail.com/developers](https://misarmail.com/developers)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm)

4 source URLs. Raw sources field, verbatim:

https://misarmail.com/, https://docs.misar.io/mail, https://misarmail.com/developers, https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm

**Notes, verbatim from the file**
API mentioned on https://docs.misar.io/mail; pricing/gate not inferred from presence alone. API mentioned on https://misarmail.com/developers; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name MisarMail MCP (draft listed as MisarMail MCP Server).

**Provenance**

- **Entry id**: 02-misarmail-mcp
