# MCP Lead Gen by FlipFactory: MCP server status, API access gate and what it does

> Could not fully document product behavior from a live vendor homepage this pass (fetch status=404... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/FlipFactory-it-com/flipfactory-mcp-leadgen](https://github.com/FlipFactory-it-com/flipfactory-mcp-leadgen) · entry id 01-mcp-lead-gen-by-flipfactory · source 01-data-enrichment.md line 4642
...
https://github.com/docs, https://github.com/developers, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
Homepage fetch failed or empty: HTTPError 404. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name MCP Lead Gen by FlipFactory (draft listed as MCP Lead Gen - Free AI Lead Generation).

**Provenance**

- **Entry id**: 01-mcp-lead-gen-by-flipfactory
