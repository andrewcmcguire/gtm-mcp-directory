# Alysio: MCP server status, API access gate and what it does

> Alysio is the GTM AI Workspace powered by a Context Engine. Connect Salesforce, HubSpot and Gong using MCP... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [alysio.ai](https://alysio.ai) · entry id 04-alysio · source 04-ai-sdr-agents.md line 450
...
- [https://alysio.ai/](https://alysio.ai/)
- [https://market.zoominfo.com/app/alysio](https://market.zoominfo.com/app/alysio)

2 source URLs. Raw sources field, verbatim:

https://alysio.ai/, https://market.zoominfo.com/app/alysio

**Notes, verbatim from the file**
api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. cli_status=not-checked; no cheap package name probe applicable Category corrected from data-enrichment to ai-sdr-agents.
