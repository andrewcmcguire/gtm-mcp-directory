# KrispCall: MCP server status, API access gate and what it does

> Manage calls, SMS, and customer conversations across 100+ countries with AI-powered tools and CRM... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [krispcall.com](https://krispcall.com) · entry id 02-krispcall · source 02-engagement-outbound.md line 1875

**What it does**
Manage calls, SMS, and customer conversations across 100+ countries with AI-powered tools and CRM integrations. Trusted by 9,000+ businesses worldwide.
...
[https://krispcall.com/api-pricing-carrier-lookup/](https://krispcall.com/api-pricing-carrier-lookup/)
...
No GitHub organisation could be tied to krispcall.com with evidence on 2026-09-15.
...
- [https://krispcall.com](https://krispcall.com)
- [https://krispcall.com/api-pricing-carrier-lookup/](https://krispcall.com/api-pricing-carrier-lookup/)
- [https://krispcall.com/llms.txt](https://krispcall.com/llms.txt)
- [https://marketplace.salesloft.com/t/category?page=3](https://marketplace.salesloft.com/t/category?page=3)

4 source URLs. Raw sources field, verbatim:

https://krispcall.com, https://krispcall.com/api-pricing-carrier-lookup/, https://krispcall.com/llms.txt, https://marketplace.salesloft.com/t/category?page=3
