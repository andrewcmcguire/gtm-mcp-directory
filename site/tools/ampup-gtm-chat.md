# AmpUp GTM Chat: MCP server status, API access gate and what it does

> Chat over your CRM, meetings, and knowledge base. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [chat.ampup.ai](https://chat.ampup.ai) · entry id 07-ampup-gtm-chat · source 07-mcp-infrastructure.md line 2912

**What it does**
Chat over your CRM, meetings, and knowledge base.
...
- [https://github.com/A79-ai/gtm-agentic-chat](https://github.com/A79-ai/gtm-agentic-chat)
...
quoted from [https://pypi.org/project/ampup/](https://pypi.org/project/ampup/) on 2026-09-17, via pypi, a third party source
...
[https://chat.ampup.ai/docs](https://chat.ampup.ai/docs)
...
No GitHub organisation could be tied to chat.ampup.ai with evidence on 2026-09-15.
...
- [https://chat.ampup.ai](https://chat.ampup.ai)
- [https://chat.ampup.ai/docs](https://chat.ampup.ai/docs)
- [https://chat.ampup.ai/developers](https://chat.ampup.ai/developers)
- [https://github.com/A79-ai/gtm-agentic-chat](https://github.com/A79-ai/gtm-agentic-chat)

4 source URLs. Raw sources field, verbatim:

https://chat.ampup.ai, https://chat.ampup.ai/docs, https://chat.ampup.ai/developers, https://github.com/A79-ai/gtm-agentic-chat

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave K 2026-09-12: canonical name AmpUp GTM Chat (draft listed as A79-ai/gtm-agentic-chat).

**Provenance**

- **Entry id**: 07-ampup-gtm-chat
