...
5 candidate accounts seen and rejected by the evidence rules: Honeyfy, Gongoliers, Gongosoft, Gongju-Unity-Bootcamp, GongGroup. A name match alone is never accepted; the account has to point at the vendor domain.
