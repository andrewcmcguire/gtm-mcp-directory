# GenPark Lead Scoring Skill: MCP server status, API access gate and what it does

> B2B lead scoring and buyer intent data enricher skill for AI agents. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [genpark.ai](https://genpark.ai) · entry id 01-genpark-lead-scoring-skill · source 01-data-enrichment.md line 3019

**What it does**
B2B lead scoring and buyer intent data enricher skill for AI agents.
...
https://github.com/alphaparkinc/genpark-lead-scoring-intent-data-enricher-skill

- [https://github.com/alphaparkinc/genpark-lead-scoring-intent-data-enricher-skill](https://github.com/alphaparkinc/genpark-lead-scoring-intent-data-enricher-skill)
...
https://genpark.ai, https://genpark.ai/sign-in?redirect_url=https%3A%2F%2Fgenpark.ai%2Fdocs, https://genpark.ai/sign-in?redirect_url=https%3A%2F%2Fgenpark.ai%2Fdevelopers, https://github.com/alphaparkinc/genpark-lead-scoring-intent-data-enricher-skill

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave O 2026-09-12: canonical name GenPark Lead Scoring Skill (draft listed as alphaparkinc/genpark-lead-scoring-intent-data-enricher-skill).

**Provenance**

- **Entry id**: 01-genpark-lead-scoring-skill
