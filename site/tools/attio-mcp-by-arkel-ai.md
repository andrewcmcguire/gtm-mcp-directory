# Attio MCP by Arkel-ai: MCP server status, API access gate and what it does

> Community MCP server for Attio CRM so agents can work pipeline and account data. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/Arkel-ai/attio-mcp-server](https://github.com/Arkel-ai/attio-mcp-server) · entry id 07-attio-mcp-by-arkel-ai · source 07-mcp-infrastructure.md line 3939
...
https://github.com/Arkel-ai/attio-mcp-server

- [https://github.com/Arkel-ai/attio-mcp-server](https://github.com/Arkel-ai/attio-mcp-server)
...
[https://docs.attio.com/docs/overview](https://docs.attio.com/docs/overview)
...
- [https://docs.attio.com/docs/overview](https://docs.attio.com/docs/overview)
- [https://attio.com/platform/developers](https://attio.com/platform/developers)
- [https://github.com/Arkel-ai/attio-mcp-server](https://github.com/Arkel-ai/attio-mcp-server)

4 source URLs. Raw sources field, verbatim:

https://attio.com, https://docs.attio.com/docs/overview, https://attio.com/platform/developers, https://github.com/Arkel-ai/attio-mcp-server

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave N 2026-09-12: canonical name Attio MCP by Arkel-ai (draft listed as Arkel-ai/attio-mcp-server). Category corrected from data-enrichment to mcp-infrastructure.

**Provenance**

- **Entry id**: 07-attio-mcp-by-arkel-ai
