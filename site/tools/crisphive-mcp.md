# CrispHive MCP: MCP server status, API access gate and what it does

> The scheduling & dispatch API for field-service teams. Create bookings, preview emergency cascades, and map... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [docs.crisphive.com/mcp](https://docs.crisphive.com/mcp) · entry id 10-crisphive-mcp · source 10-scheduling-routing.md line 320

**What it does**
The scheduling & dispatch API for field-service teams. Create bookings, preview emergency cascades, and map technicians to service boundaries.
...
**RevOps role**
Scheduling, routing, or meeting orchestration layer
...
https://github.com/crisphive/crisphive-mcp

- [https://github.com/crisphive/crisphive-mcp](https://github.com/crisphive/crisphive-mcp)
...
[https://docs.crisphive.com/docs/introduction](https://docs.crisphive.com/docs/introduction)
...
No GitHub organisation could be tied to docs.crisphive.com with evidence on 2026-09-15.
...
- [https://docs.crisphive.com/mcp](https://docs.crisphive.com/mcp)
- [https://docs.crisphive.com/docs/introduction](https://docs.crisphive.com/docs/introduction)
- [https://docs.crisphive.com/llms.txt](https://docs.crisphive.com/llms.txt)
- [https://github.com/crisphive/crisphive-mcp](https://github.com/crisphive/crisphive-mcp)

4 source URLs. Raw sources field, verbatim:

https://docs.crisphive.com/mcp, https://docs.crisphive.com/docs/introduction, https://docs.crisphive.com/llms.txt, https://github.com/crisphive/crisphive-mcp

**Notes, verbatim from the file**
API mentioned on https://docs.crisphive.com/docs/introduction; pricing/gate not inferred from presence alone. API mentioned on https://docs.crisphive.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-server-topic; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave N 2026-09-12: canonical name CrispHive MCP (draft listed as crisphive/crisphive-mcp). Category corrected from mcp-infrastructure to scheduling-routing.

**Provenance**

- **Entry id**: 10-crisphive-mcp
