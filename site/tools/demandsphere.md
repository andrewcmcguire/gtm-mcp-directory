# DemandSphere: MCP server status, API access gate and what it does

> Global SERP and AI search analytics platform for in-house and agency teams. Track AI Overviews, AI Mode,... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [demandsphere.com](https://demandsphere.com) · entry id 05-demandsphere · source 05-signals-intent-abm.md line 903
...
No GitHub organisation could be tied to demandsphere.com with evidence on 2026-09-15.
...
- [https://www.demandsphere.com/llms.txt](https://www.demandsphere.com/llms.txt)
- [https://www.demandsphere.com/mcp](https://www.demandsphere.com/mcp)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

4 source URLs. Raw sources field, verbatim:

https://www.demandsphere.com/, https://www.demandsphere.com/llms.txt, https://www.demandsphere.com/mcp, https://yc-oss.github.io/api/industries/marketing.json

**Notes, verbatim from the file**
API mentioned on https://www.demandsphere.com/mcp; pricing/gate not inferred from presence alone. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to signals-intent-abm.

**Provenance**

- **Entry id**: 05-demandsphere
