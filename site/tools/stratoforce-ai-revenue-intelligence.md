# StratoForce AI Revenue Intelligence: MCP server status, API access gate and what it does

> 15 AI revenue intelligence tools for Salesforce - pipeline, deals, coaching, competitors. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://stratoforce-mcp.stratoforce.workers.dev/mcp](https://stratoforce-mcp.stratoforce.workers.dev/mcp) · entry id 12-stratoforce-ai-revenue-intelligence · source 12-forecasting-revenue.md line 794
...
https://github.com/Stratoforce-AI-LLC/stratoforce-mcp-server

- [https://github.com/Stratoforce-AI-LLC/stratoforce-mcp-server](https://github.com/Stratoforce-AI-LLC/stratoforce-mcp-server)
...
- [https://stratoforce-mcp.stratoforce.workers.dev/mcp](https://stratoforce-mcp.stratoforce.workers.dev/mcp)
- [https://github.com/Stratoforce-AI-LLC/stratoforce-mcp-server](https://github.com/Stratoforce-AI-LLC/stratoforce-mcp-server)

2 source URLs. Raw sources field, verbatim:

https://stratoforce-mcp.stratoforce.workers.dev/mcp, https://github.com/Stratoforce-AI-LLC/stratoforce-mcp-server
...
- **Entry id**: 12-stratoforce-ai-revenue-intelligence
