# Mailcannon: MCP server status, API access gate and what it does

> AI-powered email outreach platform - send campaigns with deliverability tracking. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://www.thinkandautomate.dev/api/mcp](https://www.thinkandautomate.dev/api/mcp) · entry id 09-mailcannon · source 09-email-deliverability.md line 616
...
https://github.com/AinaLuc/mailcannon

- [https://github.com/AinaLuc/mailcannon](https://github.com/AinaLuc/mailcannon)
