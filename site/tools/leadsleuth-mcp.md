# LeadSleuth MCP: MCP server status, API access gate and what it does

> Connect AI agents to your LeadSleuth leads via the Model Context Protocol: step-by-step setup for Claude... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://leads.zalize.com/docs/mcp](https://leads.zalize.com/docs/mcp) · entry id 02-leadsleuth-mcp · source 02-engagement-outbound.md line 2700

**What it does**
Connect AI agents to your LeadSleuth leads via the Model Context Protocol: step-by-step setup for Claude Desktop, Claude Code, ChatGPT and Cursor with copy-paste configs.
...
https://github.com/wookat/leadsleuth

- [https://github.com/wookat/leadsleuth](https://github.com/wookat/leadsleuth)
...
[https://leads.zalize.com/docs](https://leads.zalize.com/docs)
...
No GitHub organisation could be tied to leads.zalize.com with evidence on 2026-09-15.
...
- [https://leads.zalize.com/docs/mcp/](https://leads.zalize.com/docs/mcp/)
- [https://leads.zalize.com/docs](https://leads.zalize.com/docs)
- [https://leads.zalize.com/developers](https://leads.zalize.com/developers)
- [https://github.com/wookat/leadsleuth](https://github.com/wookat/leadsleuth)

4 source URLs. Raw sources field, verbatim:

https://leads.zalize.com/docs/mcp/, https://leads.zalize.com/docs, https://leads.zalize.com/developers, https://github.com/wookat/leadsleuth

**Notes, verbatim from the file**
mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave P 2026-09-12: canonical name LeadSleuth MCP (draft listed as com.zalize.leads/leadsleuth).

**Provenance**

- **Entry id**: 02-leadsleuth-mcp
