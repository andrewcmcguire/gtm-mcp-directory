# Rafiki: MCP server status, API access gate and what it does

> Rafiki AI is an AI-powered sales intelligence platform that analyzes every sales conversation, coaches reps,... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [getrafiki.ai](https://getrafiki.ai) · entry id 03-rafiki · source 03-conversation-intel.md line 723

**What it does**
Rafiki AI is an AI-powered sales intelligence platform that analyzes every sales conversation, coaches reps, and surfaces deals that need attention.
...
No GitHub organisation could be tied to getrafiki.ai with evidence on 2026-09-15.
