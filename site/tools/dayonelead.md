# DayOneLead: MCP server status, API access gate and what it does

> DayOneLead documentation. What every filter and tool means: Today's Leads, All Leads, CRM, Email Outreach,... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://dayonelead.com/docs](https://dayonelead.com/docs) · entry id 01-dayonelead · source 01-data-enrichment.md line 4256

**What it does**
DayOneLead documentation. What every filter and tool means: Today's Leads, All Leads, CRM, Email Outreach, and Export.
...
[https://dayonelead.com/docs](https://dayonelead.com/docs)
...
No GitHub organisation could be tied to dayonelead.com with evidence on 2026-09-15.
...
- [https://dayonelead.com/docs](https://dayonelead.com/docs)
- [https://dayonelead.com/llms.txt](https://dayonelead.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales](https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales)

3 source URLs. Raw sources field, verbatim:

https://dayonelead.com/docs, https://dayonelead.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=sales

**Notes, verbatim from the file**
mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave Q 2026-09-12.

**Provenance**

- **Entry id**: 01-dayonelead
