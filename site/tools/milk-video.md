# Milk Video: MCP server status, API access gate and what it does

> Create video testimonials with a link. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [milkvideo.com](https://milkvideo.com) · entry id 08-milk-video · source 08-video-prospecting.md line 472
...
Homepage fetch failed (HTTPError 429); what_it_does used YC/source one_liner. mcp_status none-found with dated probe 2026-09-12; no first-party MCP URL confirmed from fetched pages. No official MCP invented. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone.

**Provenance**

- **Entry id**: 08-milk-video
