# Mamba GTM Job Discovery MCP: MCP server status, API access gate and what it does

> Developer tools for GTM data enrichment. Apify actors and MCP servers for hiring signals, tech stack... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [mambabuilt.com](https://mambabuilt.com) · entry id 01-mamba-gtm-job-discovery-mcp · source 01-data-enrichment.md line 1965
...
- [https://mambabuilt.com](https://mambabuilt.com)
- [https://mambabuilt.com/llms.txt](https://mambabuilt.com/llms.txt)
- [https://www.npmjs.com/search?q=mcp%20gtm](https://www.npmjs.com/search?q=mcp%20gtm)

3 source URLs. Raw sources field, verbatim:

https://mambabuilt.com, https://mambabuilt.com/llms.txt, https://www.npmjs.com/search?q=mcp%20gtm

**Notes, verbatim from the file**
mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave H 2026-09-12: canonical name Mamba GTM Job Discovery MCP (draft listed as @mambalabsdev/mcp-gtm-job-discovery).

**Provenance**

- **Entry id**: 01-mamba-gtm-job-discovery-mcp
