# Setu Email MCP by gitmanhimanshu: MCP server status, API access gate and what it does

> Setu is an AI-powered Model Context Protocol (MCP) server that lets Claude, ChatGPT, and Cursor automate... Community MCP, Gate unknown. Checked 2026-09-12.
...
Setu Email MCP by gitmanhimanshu
...
Vendor: [setu.mimanasa.online](https://setu.mimanasa.online) · entry id 07-setu-email-mcp-by-gitmanhimanshu · source 07-mcp-infrastructure.md line 2268
...
https://github.com/gitmanhimanshu/Email_automation

- [https://github.com/gitmanhimanshu/Email_automation](https://github.com/gitmanhimanshu/Email_automation)
...
[https://setu.mimanasa.online/docs](https://setu.mimanasa.online/docs)
...
No GitHub organisation could be tied to setu.mimanasa.online with evidence on 2026-09-15.
...
- [https://setu.mimanasa.online](https://setu.mimanasa.online)
- [https://setu.mimanasa.online/docs](https://setu.mimanasa.online/docs)
- [https://setu.mimanasa.online/llms.txt](https://setu.mimanasa.online/llms.txt)
- [https://github.com/gitmanhimanshu/Email_automation](https://github.com/gitmanhimanshu/Email_automation)

4 source URLs. Raw sources field, verbatim:

https://setu.mimanasa.online, https://setu.mimanasa.online/docs, https://setu.mimanasa.online/llms.txt, https://github.com/gitmanhimanshu/Email_automation

**Notes, verbatim from the file**
API mentioned on https://setu.mimanasa.online/docs; pricing/gate not inferred from presence alone. API mentioned on https://setu.mimanasa.online/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave I 2026-09-12: canonical name Setu Email MCP by gitmanhimanshu (draft listed as gitmanhimanshu/Email_automation).

**Provenance**

- **Entry id**: 07-setu-email-mcp-by-gitmanhimanshu
