# Opus Growth: MCP server status, API access gate and what it does

> The connector for Claude and ChatGPT: run Google, Meta, Microsoft, TikTok and LinkedIn ads from one chat.... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [opus-growth.com](https://opus-growth.com) · entry id 05-opus-growth · source 05-signals-intent-abm.md line 1826

**What it does**
The connector for Claude and ChatGPT: run Google, Meta, Microsoft, TikTok and LinkedIn ads from one chat. Safe writes with preview and approval. Free with 75…
...
[https://platform.opus-growth.com/docs](https://platform.opus-growth.com/docs)
...
No GitHub organisation could be tied to opus-growth.com with evidence on 2026-09-15.
...
- [https://opus-growth.com/](https://opus-growth.com/)
- [https://platform.opus-growth.com/docs](https://platform.opus-growth.com/docs)
- [https://opus-growth.com/llms.txt](https://opus-growth.com/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm)

4 source URLs. Raw sources field, verbatim:

https://opus-growth.com/, https://platform.opus-growth.com/docs, https://opus-growth.com/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=gtm

**Notes, verbatim from the file**
mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12: canonical name Opus Growth (draft listed as Opus Growth | Ad Operations for Google, Meta, Microsoft, TikTok and LinkedIn Ads).

**Provenance**

- **Entry id**: 05-opus-growth
