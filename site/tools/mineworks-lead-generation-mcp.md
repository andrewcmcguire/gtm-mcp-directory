# MineWorks Lead Generation MCP: MCP server status, API access gate and what it does

> B2B and local lead gen: verified emails, site contacts, Maps and Yellow Pages leads. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://themineworks--lead-generation-mcp.apify.actor/mcp](https://themineworks--lead-generation-mcp.apify.actor/mcp) · entry id 01-mineworks-lead-generation-mcp · source 01-data-enrichment.md line 4074
...
- [https://github.com/themineworks/mcp-servers](https://github.com/themineworks/mcp-servers)
