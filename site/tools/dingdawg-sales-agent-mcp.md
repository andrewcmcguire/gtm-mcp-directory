# DingDawg Sales Agent MCP: MCP server status, API access gate and what it does

> DingDawg Agent 1 - Governance receipts for AI agents. Deploy governed AI agents with signed audit trails. EU... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/dingdawg/dingdawg-agent-1](https://github.com/dingdawg/dingdawg-agent-1) · entry id 04-dingdawg-sales-agent-mcp · source 04-ai-sdr-agents.md line 1302
...
https://github.com/dingdawg/dingdawg-agent-1

- [https://github.com/dingdawg/dingdawg-agent-1](https://github.com/dingdawg/dingdawg-agent-1)
