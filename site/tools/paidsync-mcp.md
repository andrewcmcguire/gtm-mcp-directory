# PaidSync MCP: MCP server status, API access gate and what it does

> The MCP server that runs Google, Meta, LinkedIn, TikTok ads from Claude, ChatGPT, and Gemini. 470+ tools, 14... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [paidsync.ai](https://paidsync.ai) · entry id 07-paidsync-mcp · source 07-mcp-infrastructure.md line 2330

**What it does**
The MCP server that runs Google, Meta, LinkedIn, TikTok ads from Claude, ChatGPT, and Gemini. 470+ tools, 14 platforms, approval-gated. Free to start.
...
https://github.com/PaidSync/paidsync-mcp

- [https://github.com/PaidSync/paidsync-mcp](https://github.com/PaidSync/paidsync-mcp)
...
[https://paidsync.ai/docs](https://paidsync.ai/docs)
...
No GitHub organisation could be tied to paidsync.ai with evidence on 2026-09-15.
