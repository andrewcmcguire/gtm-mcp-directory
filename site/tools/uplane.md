# Uplane: MCP server status, API access gate and what it does

> uplane makes hundreds of on-brand ads and matching landing pages, runs them across Meta, Google, and TikTok,... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [uplane.com](https://uplane.com) · entry id 14-uplane · source 14-inbound-plg-chat.md line 576

**What it does**
uplane makes hundreds of on-brand ads and matching landing pages, runs them across Meta, Google, and TikTok, and steers budget to whatever performs.
...
No GitHub organisation could be tied to uplane.com with evidence on 2026-09-15.
...
- [https://uplane.com](https://uplane.com)
- [https://uplane.com/llms.txt](https://uplane.com/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://uplane.com, https://uplane.com/llms.txt, https://yc-oss.github.io/api/industries/marketing.json
