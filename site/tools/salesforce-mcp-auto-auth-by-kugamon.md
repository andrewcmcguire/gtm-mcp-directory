# Salesforce MCP Auto Auth by kugamon: MCP server status, API access gate and what it does

> Fastest to Enable Salesforce MCP server for Claude Desktop with automatic session refresh from your Chrome... Community MCP, Gate unknown. Checked 2026-09-12.
...
Salesforce MCP Auto Auth by kugamon
...
Vendor: [https://pypi.org/project/salesforce-mcp-auto-auth-chrome](https://pypi.org/project/salesforce-mcp-auto-auth-chrome) · entry id 07-salesforce-mcp-auto-auth-by-kugamon · source 07-mcp-infrastructure.md line 2692

**What it does**
Fastest to Enable Salesforce MCP server for Claude Desktop with automatic session refresh from your Chrome browser ΓÇö no External App needed
...
https://github.com/kugamon/salesforce-mcp-auto-auth-chrome

- [https://github.com/kugamon/salesforce-mcp-auto-auth-chrome](https://github.com/kugamon/salesforce-mcp-auto-auth-chrome)
...
No GitHub organisation could be tied to pypi.org with evidence on 2026-09-15.
