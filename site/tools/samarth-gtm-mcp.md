# Samarth GTM MCP: MCP server status, API access gate and what it does

> MCP server for Samarth Analytics Google Tag Manager operations - samarthanalytics-sj/samarth-analytics-mcp Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/samarthanalytics-sj/samarth-analytics-mcp](https://github.com/samarthanalytics-sj/samarth-analytics-mcp) · entry id 07-samarth-gtm-mcp · source 07-mcp-infrastructure.md line 5066
...
- [https://github.com/samarthanalytics-sj/samarth-analytics-mcp](https://github.com/samarthanalytics-sj/samarth-analytics-mcp)
