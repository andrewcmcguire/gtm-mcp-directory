...
- **Docs URL**: [https://www.warmly.ai/launches/warmly-mcp-and-api-are-live](https://www.warmly.ai/launches/warmly-mcp-and-api-are-live)
...
- **get_credits_remaining** Snapshot of your workspace's credit balance for the current monthly window. evidence: in the vendor docs · calling it reads

- **list_warm_accounts** Same data grouped by company. Adds visitor aggregations. evidence: in the vendor docs · calling it reads
