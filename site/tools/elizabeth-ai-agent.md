# Elizabeth AI Agent: MCP server status, API access gate and what it does

> Fully autonomous AI sales agent on WhatsApp Business API. Groq LLM · Firebase Cloud Functions · Firestore ·... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://github.com/gcarreno-dev/elizabeth-ai-agent](https://github.com/gcarreno-dev/elizabeth-ai-agent) · entry id 04-elizabeth-ai-agent · source 04-ai-sdr-agents.md line 866

**What it does**
Fully autonomous AI sales agent on WhatsApp Business API. Groq LLM · Firebase Cloud Functions · Firestore · Google Sheets ETL · MCP server · finite-state lead pipeline from cold outreach to qualified handoff - zero human intervention. - gcarreno-dev/elizabeth-ai-agent
...
https://github.com/gcarreno-dev/elizabeth-ai-agent

- [https://github.com/gcarreno-dev/elizabeth-ai-agent](https://github.com/gcarreno-dev/elizabeth-ai-agent)
