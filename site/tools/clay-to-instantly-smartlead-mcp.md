# Clay to Instantly/Smartlead MCP: MCP server status, API access gate and what it does

> MCP server for the Mamba Labs Sequencer Lead Push actor on Apify. Push enriched leads into an Instantly or... Community MCP, Gate unknown. Checked 2026-09-12.
...
Clay to Instantly/Smartlead MCP
...
Vendor: [github.com/mambalabsdev/mcp-clay-to-instantly-smartlead-push](https://github.com/mambalabsdev/mcp-clay-to-instantly-smartlead-push) · entry id 07-clay-to-instantly-smartlead-mcp · source 07-mcp-infrastructure.md line 3477
...
https://github.com/mambalabsdev/mcp-clay-to-instantly-smartlead-push

- [https://github.com/mambalabsdev/mcp-clay-to-instantly-smartlead-push](https://github.com/mambalabsdev/mcp-clay-to-instantly-smartlead-push)
...
https://github.com/mambalabsdev/mcp-clay-to-instantly-smartlead-push, https://github.com/docs, https://github.com/developers

**Notes, verbatim from the file**
mcp_status=community from discovery source github-mcp-gtm-search; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave M 2026-09-12: canonical name Clay to Instantly/Smartlead MCP (draft listed as mambalabsdev/mcp-clay-to-instantly-smartlead-push). Category corrected from data-enrichment to mcp-infrastructure.

**Provenance**

- **Entry id**: 07-clay-to-instantly-smartlead-mcp
