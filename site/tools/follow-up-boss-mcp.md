# Follow Up Boss MCP: MCP server status, API access gate and what it does

> Connect the Follow Up Boss real estate CRM to ChatGPT, Claude, Cursor, and other AI assistants with one... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [github.com/theperrygroup/Follow-Up-Boss-MCP](https://github.com/theperrygroup/Follow-Up-Boss-MCP) · entry id 07-follow-up-boss-mcp · source 07-mcp-infrastructure.md line 1685
...
https://github.com/theperrygroup/Follow-Up-Boss-MCP

- [https://github.com/theperrygroup/Follow-Up-Boss-MCP](https://github.com/theperrygroup/Follow-Up-Boss-MCP)
