# Vsyble: MCP server status, API access gate and what it does

> Official Vsyble client, CLI, and MCP server for people search, company search, and enrichment. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [vsyble.com](https://vsyble.com) · entry id 01-vsyble · source 01-data-enrichment.md line 2673

**What it does**
Official Vsyble client, CLI, and MCP server for people search, company search, and enrichment.
...
https://www.npmjs.com/search?q=mcp%20enrichment

- [https://www.npmjs.com/search?q=mcp%20enrichment](https://www.npmjs.com/search?q=mcp%20enrichment)
...
```
npm install -g vsyble
```

quoted from [https://www.npmjs.com/package/vsyble](https://www.npmjs.com/package/vsyble) on 2026-09-17, via npm

```
npm install -g @vsyble.com/cli
```

quoted from [https://www.npmjs.com/package/@vsyble.com/cli](https://www.npmjs.com/package/@vsyble.com/cli) on 2026-09-17, via npm

Packages seen, with the version on 2026-09-17:

- [npm: vsyble 2.0.4](https://www.npmjs.com/package/vsyble)
- [npm: @vsyble.com/cli 1.0.2](https://www.npmjs.com/package/@vsyble.com/cli)
...
[https://app.vsyble.com/docs](https://app.vsyble.com/docs)
...
No GitHub organisation could be tied to vsyble.com with evidence on 2026-09-15.
...
- [https://app.vsyble.com/docs](https://app.vsyble.com/docs)
- [https://app.vsyble.com/developers](https://app.vsyble.com/developers)
- [https://www.npmjs.com/search?q=mcp%20enrichment](https://www.npmjs.com/search?q=mcp%20enrichment)

3 source URLs. Raw sources field, verbatim:

https://app.vsyble.com/docs, https://app.vsyble.com/developers, https://www.npmjs.com/search?q=mcp%20enrichment

**Notes, verbatim from the file**
Homepage fetch failed (HTTPError 405); what_it_does used staging desc. mcp_status=community from discovery source npm-mcp-gtm; mcp_url is the listed package/repo URL, not an official vendor MCP claim. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave L 2026-09-12: canonical name Vsyble (draft listed as vsyble).
