# Kubaru: MCP server status, API access gate and what it does

> Are you looking for a better way to assign leads, cases, and other objects in Salesforce? Kubaru is the most... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [kubaru.io](https://kubaru.io) · entry id 10-kubaru · source 10-scheduling-routing.md line 429

**What it does**
Are you looking for a better way to assign leads, cases, and other objects in Salesforce? Kubaru is the most popular assignment app on the AppExchange.

**AI features, separated from automation with an AI label on it**
Not evidenced from fetched pages this pass; no AI feature claims recorded without a source URL.

**RevOps role**
Meeting booking, lead assignment, or routing layer in the GTM funnel
...
[https://kubaru.io/help/](https://kubaru.io/help/)
...
No GitHub organisation could be tied to kubaru.io with evidence on 2026-09-15.
...
- [https://kubaru.io](https://kubaru.io)
- [https://kubaru.io/help/](https://kubaru.io/help/)
- [https://kubaru.io/llms.txt](https://kubaru.io/llms.txt)
- [https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3A00000EnyrOUAR](https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3A00000EnyrOUAR)

4 source URLs. Raw sources field, verbatim:

https://kubaru.io, https://kubaru.io/help/, https://kubaru.io/llms.txt, https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3A00000EnyrOUAR
