# QuadSci: MCP server status, API access gate and what it does

> Customer Intelligence AI that predicts churn and growth from product telemetry, CRM data and conversational... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [quadsci.ai](https://quadsci.ai) · entry id 12-quadsci · source 12-forecasting-revenue.md line 386

**What it does**
Customer Intelligence AI that predicts churn and growth from product telemetry, CRM data and conversational signals.
...
[https://quadsci.ai/docs](https://quadsci.ai/docs)
...
No GitHub organisation could be tied to quadsci.ai with evidence on 2026-09-15.
...
- [https://quadsci.ai](https://quadsci.ai)
- [https://quadsci.ai/docs](https://quadsci.ai/docs)
- [https://quadsci.ai/developers](https://quadsci.ai/developers)
- [https://marketplace.salesloft.com/t/category?page=13](https://marketplace.salesloft.com/t/category?page=13)

4 source URLs. Raw sources field, verbatim:

https://quadsci.ai, https://quadsci.ai/docs, https://quadsci.ai/developers, https://marketplace.salesloft.com/t/category?page=13
