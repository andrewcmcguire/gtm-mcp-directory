# SendPulse: MCP server status, API access gate and what it does

> Bring MCP into your SendPulse workflows and let an AI agent handle your email marketing, chatbots, and CRM.... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://sendpulse.com/features/mcp](https://sendpulse.com/features/mcp) · entry id 02-sendpulse · source 02-engagement-outbound.md line 3512

**What it does**
Bring MCP into your SendPulse workflows and let an AI agent handle your email marketing, chatbots, and CRM. Courses, students, and assignment grading...
...
https://github.com/sendpulse/mcp-server

- [https://github.com/sendpulse/mcp-server](https://github.com/sendpulse/mcp-server)
...
[https://sendpulse.com/integrations/api](https://sendpulse.com/integrations/api)
...
No GitHub organisation could be tied to sendpulse.com with evidence on 2026-09-15.
...
- [https://sendpulse.com/features/mcp](https://sendpulse.com/features/mcp)
- [https://sendpulse.com/integrations/api](https://sendpulse.com/integrations/api)
- [https://sendpulse.com/llms.txt](https://sendpulse.com/llms.txt)
- [https://github.com/sendpulse/mcp-server](https://github.com/sendpulse/mcp-server)

4 source URLs. Raw sources field, verbatim:

https://sendpulse.com/features/mcp, https://sendpulse.com/integrations/api, https://sendpulse.com/llms.txt, https://github.com/sendpulse/mcp-server

**Notes, verbatim from the file**
API mentioned on https://sendpulse.com/integrations/api; pricing/gate not inferred from presence alone. API mentioned on https://sendpulse.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave V 2026-09-12.

**Provenance**

- **Entry id**: 02-sendpulse
