# GoHighLevel MCP by northrosetech: MCP server status, API access gate and what it does

> A comprehensive Model Context Protocol (MCP) server that connects AI assistants directly to your GoHighLevel... Community MCP, Gate unknown. Checked 2026-09-12.
...
GoHighLevel MCP by northrosetech
...
Vendor: [https://github.com/northrosetech/ghl-mcp-server](https://github.com/northrosetech/ghl-mcp-server) · entry id 07-gohighlevel-mcp-by-northrosetech · source 07-mcp-infrastructure.md line 4281

**What it does**
A comprehensive Model Context Protocol (MCP) server that connects AI assistants directly to your GoHighLevel CRM. Supports **60+ tools** across contacts, conversations, calendars, pipelines, payments, invoices, workflows, custom fields, social media, and more. - northrosetech/ghl-mcp-server
...
https://github.com/northrosetech/ghl-mcp-server

- [https://github.com/northrosetech/ghl-mcp-server](https://github.com/northrosetech/ghl-mcp-server)
