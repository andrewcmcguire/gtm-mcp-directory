# Dust: MCP server status, API access gate and what it does

> Dust connects your company knowledge, tools, and teams so you can create, share, and run agents across real... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [dust.tt](https://dust.tt) · entry id 06-dust · source 06-revops-infra.md line 1042
...
quoted from [https://docs.dust.tt/docs/developer-platform/dust-cli/dust-cli](https://docs.dust.tt/docs/developer-platform/dust-cli/dust-cli) on 2026-09-15, via npm
...
No GitHub organisation could be tied to dust.tt with evidence on 2026-09-15.
...
- [https://market.zoominfo.com/app/dust](https://market.zoominfo.com/app/dust)

2 source URLs. Raw sources field, verbatim:

https://dust.tt, https://market.zoominfo.com/app/dust
