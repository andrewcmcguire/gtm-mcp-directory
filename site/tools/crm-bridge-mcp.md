# CRM Bridge MCP: MCP server status, API access gate and what it does

> Sales pipeline and CRM intelligence MCP server - HubSpot, Pipedrive, Salesforce Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [npmjs.com/package/@craftpipe/crmbridge-mcp](https://npmjs.com/package/@craftpipe/crmbridge-mcp) · entry id 07-crm-bridge-mcp · source 07-mcp-infrastructure.md line 2490
