# Incwo MCP: MCP server status, API access gate and what it does

> incwo réunit CRM, devis, factures, achats, stocks et caisse - avec iris, l’assistante IA intégrée qui répond... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [incwo.com](https://incwo.com) · entry id 07-incwo-mcp · source 07-mcp-infrastructure.md line 4886

**What it does**
incwo réunit CRM, devis, factures, achats, stocks et caisse - avec iris, l’assistante IA intégrée qui répond et prépare vos actions. Certifié NF, prêt pour 2026.
...
- [https://www.incwo.com](https://www.incwo.com)
...
quoted from [https://www.npmjs.com/package/incwo-cli](https://www.npmjs.com/package/incwo-cli) on 2026-09-17, via npm

Packages seen, with the version on 2026-09-17:

- [npm: incwo-cli 0.1.3](https://www.npmjs.com/package/incwo-cli)
...
No GitHub organisation could be tied to incwo.com with evidence on 2026-09-15.
...
- [https://go.incwo.com/](https://go.incwo.com/)
- [https://go.incwo.com/llms.txt](https://go.incwo.com/llms.txt)
- [https://www.incwo.com](https://www.incwo.com)

3 source URLs. Raw sources field, verbatim:

https://go.incwo.com/, https://go.incwo.com/llms.txt, https://www.incwo.com

**Notes, verbatim from the file**
API mentioned on https://go.incwo.com/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave R 2026-09-12.

**Provenance**

- **Entry id**: 07-incwo-mcp
