# xpay Lead Gen: MCP server status, API access gate and what it does

> 50+ lead gen tools. Apollo, Hunter, Nyne, Tomba, Sixtyfour, Fiber, Exa. Pay-per-use via x402. Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [https://lead-gen.mcp.xpay.sh/mcp](https://lead-gen.mcp.xpay.sh/mcp) · entry id 01-xpay-lead-gen · source 01-data-enrichment.md line 4888
...
https://github.com/xpaysh/mcp-server

- [https://github.com/xpaysh/mcp-server](https://github.com/xpaysh/mcp-server)
...
quoted from [https://www.npmjs.com/package/@xpaysh/cli](https://www.npmjs.com/package/@xpaysh/cli) on 2026-09-26, via npm

Packages seen, with the version on 2026-09-26:

- [npm: @xpaysh/cli 0.1.0](https://www.npmjs.com/package/@xpaysh/cli)
...
No GitHub organisation could be tied to lead-gen.mcp.xpay.sh with evidence on 2026-09-15.
...
- [https://lead-gen.mcp.xpay.sh/mcp](https://lead-gen.mcp.xpay.sh/mcp)
- [https://lead-gen.mcp.xpay.sh/llms.txt](https://lead-gen.mcp.xpay.sh/llms.txt)
- [https://github.com/xpaysh/mcp-server](https://github.com/xpaysh/mcp-server)

3 source URLs. Raw sources field, verbatim:

https://lead-gen.mcp.xpay.sh/mcp, https://lead-gen.mcp.xpay.sh/llms.txt, https://github.com/xpaysh/mcp-server

**Notes, verbatim from the file**
what_it_does used staging desc because homepage meta description was empty. API mentioned on https://lead-gen.mcp.xpay.sh/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from official-mcp-registry listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave W 2026-09-12.

**Provenance**

- **Entry id**: 01-xpay-lead-gen
