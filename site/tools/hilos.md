# Hilos: MCP server status, API access gate and what it does

> Perfila leads, automatiza seguimientos e integra con tus herramientas favoritas para aumentar tu conversión. No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [hilos.io](https://hilos.io) · entry id 02-hilos · source 02-engagement-outbound.md line 2365
...
[https://hilos.io/docs/en/user/hilos-101/introduction](https://hilos.io/docs/en/user/hilos-101/introduction)
...
- [https://hilos.io](https://hilos.io)
- [https://hilos.io/docs/en/user/hilos-101/introduction](https://hilos.io/docs/en/user/hilos-101/introduction)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://hilos.io, https://hilos.io/docs/en/user/hilos-101/introduction, https://yc-oss.github.io/api/industries/marketing.json
