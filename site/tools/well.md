# Well: MCP server status, API access gate and what it does

> Well is the business context layer that captures your data, enriches it, and closes your books, so you can... Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [wellapp.ai](https://wellapp.ai) · entry id 06-well · source 06-revops-infra.md line 1738

**What it does**
Well is the business context layer that captures your data, enriches it, and closes your books, so you can ask your business anything. Try Well free today.
...
[https://wellapp.ai/docs/index.html](https://wellapp.ai/docs/index.html)
...
No GitHub organisation could be tied to wellapp.ai with evidence on 2026-09-15.
...
- [https://wellapp.ai/](https://wellapp.ai/)
- [https://wellapp.ai/docs/index.html](https://wellapp.ai/docs/index.html)
- [https://wellapp.ai/llms.txt](https://wellapp.ai/llms.txt)
- [https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm](https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm)

4 source URLs. Raw sources field, verbatim:

https://wellapp.ai/, https://wellapp.ai/docs/index.html, https://wellapp.ai/llms.txt, https://registry.smithery.ai/servers?page=1&pageSize=100&q=crm

**Notes, verbatim from the file**
API mentioned on https://wellapp.ai/docs/index.html; pricing/gate not inferred from presence alone. API mentioned on https://wellapp.ai/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Category corrected from data-enrichment to revops-infra.
