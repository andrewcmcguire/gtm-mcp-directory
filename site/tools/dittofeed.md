# Dittofeed: MCP server status, API access gate and what it does

> The open-source, embeddable customer engagement platform for automating email, SMS, mobile push, WhatsApp, &... No MCP found, Gate unknown. Checked 2026-09-12.
...
Vendor: [dittofeed.com](https://dittofeed.com) · entry id 14-dittofeed · source 14-inbound-plg-chat.md line 786

**What it does**
The open-source, embeddable customer engagement platform for automating email, SMS, mobile push, WhatsApp, & more. Low-code customer segmentation, message templates, and a simple drag-and-drop journey builder.
...
No GitHub organisation could be tied to dittofeed.com with evidence on 2026-09-15.
...
- [https://www.dittofeed.com/](https://www.dittofeed.com/)
- [https://www.dittofeed.com/llms.txt](https://www.dittofeed.com/llms.txt)
- [https://yc-oss.github.io/api/industries/marketing.json](https://yc-oss.github.io/api/industries/marketing.json)

3 source URLs. Raw sources field, verbatim:

https://www.dittofeed.com/, https://www.dittofeed.com/llms.txt, https://yc-oss.github.io/api/industries/marketing.json
