# OutSend: MCP server status, API access gate and what it does

> Lancez un vrai scrape Google Maps depuis la page d Community MCP, Gate unknown. Checked 2026-09-12.
...
Vendor: [outsend.xyz](https://outsend.xyz) · entry id 01-outsend · source 01-data-enrichment.md line 4622

**What it does**
Lancez un vrai scrape Google Maps depuis la page d
...
[https://outsend.xyz/docs](https://outsend.xyz/docs)
...
No GitHub organisation could be tied to outsend.xyz with evidence on 2026-09-15.
...
- [https://outsend.xyz](https://outsend.xyz)
- [https://outsend.xyz/docs](https://outsend.xyz/docs)
- [https://outsend.xyz/llms.txt](https://outsend.xyz/llms.txt)
- [https://registry.smithery.ai/servers?q=enrich](https://registry.smithery.ai/servers?q=enrich)

4 source URLs. Raw sources field, verbatim:

https://outsend.xyz, https://outsend.xyz/docs, https://outsend.xyz/llms.txt, https://registry.smithery.ai/servers?q=enrich

**Notes, verbatim from the file**
API mentioned on https://outsend.xyz/docs; pricing/gate not inferred from presence alone. API mentioned on https://outsend.xyz/llms.txt; pricing/gate not inferred from presence alone. mcp_status=community from smithery listing; not an invented official vendor MCP. mcp_url is the registry/listing or product MCP URL from staging. api_gate unknown with dated probe 2026-09-12; free/paid not inferred from HTTP status alone. Promote wave T 2026-09-12.
