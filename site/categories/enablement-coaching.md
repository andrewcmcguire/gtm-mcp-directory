# Enablement & Coaching: 57 tools, 2 with an official MCP server

> Content-management-and-training platforms (Mindtickle, WorkRamp, Continu, Trainual) sit alongside a... 57 tools counted, 2 with an official MCP server and 0 free to start.
...
---
[Directory](../index.md) /
[By category](index.md) / Enablement & Coaching
...
Source file: 11-enablement-coaching.md · content sha256 e599a8e580b941e1... · counts reconciled against tools_recount.py at build time.
...
- [BuzzBoard Connect](../tools/buzzboard-connect.md) buzzboard.com Sell, launch, and manage multi‑channel programs-ads, social posts, emails, SEO content-for thousands of SMB customers. Double revenue without adding headcount. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
...
- [Demo Gorilla](../tools/demo-gorilla.md) demogorilla.com Demo Gorilla is a browser extension that tells your sales team exactly what to say to sell your product. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
...
- [Gamifier](../tools/gamifier.md) gamifier.co Gamifier turns CRM activity into goals, challenges, leaderboards, rewards, and feedback for sales and support teams. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)

- [GetCrux](../tools/getcrux.md) getcrux.ai A self-improving system for performance creatives. Crux connects ad data, competitor insight and your brand kit to go from insight to creative in minutes. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
...
- [KAON Interactive](../tools/kaon-interactive.md) kaon.com Kaon creates simple, interactive applications for B2B buyers to explore your complex value story. These omnichannel solutions meet customers' desire for self-discovery and empower outcome-based sellers. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)

- [Lavender](../tools/lavender.md) lavender.ai A Chrome extension and browser sidebar that sits inside Gmail, Outlook, and sales engagement tools and scores a rep's email draft 1-100 in real time while suggesting rewrites, with a team dashboard that turns... [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
...
- [Luthor](../tools/luthor.md) luthor.ai Luthor is an enterprise marketing compliance platform that reviews content against regulations and internal policies so teams can publish faster and defend every decision with clear evidence. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
...
- [Prelay](../tools/prelay.md) prelay.com Team Selling Platform [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
...
- [Quotain](../tools/quotain.md) quotain.com Quotain turns sales playbooks and real-call evidence into AI buyer simulations, scorecards, and focused practice for revenue teams. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)

- [Resonance](../tools/resonance.md) useresonance.com Self-improving content bank for marketing teams. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)

- [Rivia.AI](../tools/rivia-ai.md) rivia.ai Show, onboard, and grow your product with interactive demos, smart onboarding, and AI-powered insights. All in one platform. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)

- [SalesHood](../tools/saleshood.md) saleshood.com Build Winning Revenue Teams. Develop sellers, guide buyers, and drive faster execution with AI built for GTM teams. [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
...
- [SilkChart](../tools/silkchart.md) silkchart.com SilkChart analyzes sales calls and measures how well playbooks are executed. It proactively surfaces coaching opportunities to managers, and provides reps with actionable feedback to drive better conversations... [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)

- [SizzleKick](../tools/sizzlekick.md) sizzlekick.com SizzleKick delivers daily AI sales coaching that helps every rep build stronger habits, improve skills and sell more consistently. Designed for sales leaders who want predictable, repeatable performance across... [No MCP found](../mcp/none-found.md) · [Gate unknown](../gates/unknown.md)
