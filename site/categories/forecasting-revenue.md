# Forecasting & Revenue: 18 tools, 3 with an official MCP server

> Tools that try to answer "how much will we actually close this quarter" - CRM-native ML forecast... 18 tools counted, 3 with an official MCP server and 1 free to start.
...
Source file: 12-forecasting-revenue.md · content sha256 b44f425efe4d1ec2... · counts reconciled against tools_recount.py at build time.
