# Scheduling & Routing: 19 tools, 5 with an official MCP server

> The last mile of a GTM motion: turning a qualified lead into a meeting on a rep's calendar,... 19 tools counted, 5 with an official MCP server and 2 free to start.
...
---
[Directory](../index.md) /
[By category](index.md) / Scheduling & Routing
...
- **ship a CLI (official) as of 2026-09-26**: 0
...
Source file: 10-scheduling-routing.md · content sha256 839eddeddc20c270... · counts reconciled against tools_recount.py at build time.

- [The 9 with an MCP server](../lists/mcp-scheduling-routing.md)
...
- [Calendly](../tools/calendly.md) calendly.com Prospect-facing scheduling links and booking pages that let invitees book meetings directly onto a rep's calendar based on defined availability rules. [Official MCP](../mcp/official.md) · [Free to start](../gates/free.md) · CLI: calendly (community)
...
- [Reclaim.ai](../tools/reclaim-ai.md) reclaim.ai AI calendar app that auto-schedules tasks, habits, and focus time around a user's existing meetings, dynamically defending and rebalancing the calendar as things change. [Official MCP](../mcp/official.md) · [Gate unknown](../gates/unknown.md) · CLI: reclaim-cli (community)

- [RevenueHero](../tools/revenuehero.md) revenuehero.io Instant meeting-scheduling and inbound-lead-routing tool that qualifies web-form leads against CRM data and books them directly onto the right rep's calendar without a redirect. [Official MCP](../mcp/official.md) · [Gate unknown](../gates/unknown.md)
...
- [Coordinalo](../tools/coordinalo.md) coordinalo.com Scheduling, availability, clients, billing and CRM for appointment-based services. [Community MCP](../mcp/community.md) · [Gate unknown](../gates/unknown.md)
