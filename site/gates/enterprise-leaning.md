...
> 8 of 336 GTM tools in this directory are enterprise leaning. Self-serve on paper, gated in practice. One entry sits here.
...
---
[Directory](../index.md) /
[By access gate](index.md) / Enterprise leaning
...
8 of 336 entries. Ordered by the published rule: official MCP first, then community, then unknown, then n/a, then none-found; within each band gate order is free, paid, enterprise-leaning, enterprise-only, unknown; then alphabetical by name. Computed, never curated, never purchasable.
