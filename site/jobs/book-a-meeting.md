# Book a meeting: 26 GTM tools, 10 with an official MCP server

> Actually put a meeting on a calendar, whether by link, invite or negotiated time. 12 of the 26 entries tagged with this job carry an MCP server of some kind, 10 of them official. Counted 2026-09-08 from the directory data.
...
Actually put a meeting on a calendar, whether by link, invite or negotiated time.
...
12 of the 26 entries tagged with this job carry an MCP server of some kind, 10 of them official. 23 of the 26 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- book a meeting
- schedule a call with this prospect
- get a time on the calendar
- set up a demo

**Where these tools live**

- [Scheduling & Routing](../categories/scheduling-routing.md): 10 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 8 tagged
- [RevOps Infra](../categories/revops-infra.md): 2 tagged
- [Video Prospecting](../categories/video-prospecting.md): 2 tagged
- [Inbound & PLG Chat](../categories/inbound-plg-chat.md): 2 tagged
- [Engagement & Outbound](../categories/engagement-outbound.md): 1 tagged
- [Conversation Intel](../categories/conversation-intel.md): 1 tagged

### The 26 entries tagged book-a-meeting
...
- [Answer an inbound chat or call](answer-inbound-chat.md)
