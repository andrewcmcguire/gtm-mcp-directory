...
> Return the roll-up, the commit, the deal-likelihood scores and the risk flags. 8 of the 22 entries tagged with this job carry an MCP server of some kind, 8 of them official. Counted 2026-09-17 from the directory data.
...
8 of the 22 entries tagged with this job carry an MCP server of some kind, 8 of them official. 19 of the 22 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-17 from directory.json.
