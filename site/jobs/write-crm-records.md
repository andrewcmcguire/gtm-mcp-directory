...
> Create or update records, log activity, or push data back into a system of record. 20 of the 28 entries tagged with this job carry an MCP server of some kind, 19 of them official. Counted 2026-09-08 from the directory data.
...
20 of the 28 entries tagged with this job carry an MCP server of some kind, 19 of them official. 25 of the 28 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- update this deal in the crm
- log the call to salesforce
- write crm records
- create a contact
- push this back to hubspot

**Where these tools live**

- [Conversation Intel](../categories/conversation-intel.md): 10 tagged
- [RevOps Infra](../categories/revops-infra.md): 7 tagged
- [Engagement & Outbound](../categories/engagement-outbound.md): 4 tagged
- [Forecasting & Revenue](../categories/forecasting-revenue.md): 3 tagged
- [Data & Enrichment](../categories/data-enrichment.md): 2 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 1 tagged
- [MCP Layer](../categories/mcp-infrastructure.md): 1 tagged

### The 28 entries tagged write-crm-records
...
- [Sync records between systems](sync-records-between-systems.md)
