...
> Create or update records, log activity, or push data back into a system of record. 20 of the 28 entries tagged with this job carry an MCP server of some kind, 19 of them official. Counted 2026-09-10 from the directory data.
...
20 of the 28 entries tagged with this job carry an MCP server of some kind, 19 of them official. 25 of the 28 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-10 from directory.json.
