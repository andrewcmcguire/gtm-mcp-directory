...
> Put a document into a signing flow and track its state to signed. 3 of the 6 entries tagged with this job carry an MCP server of some kind, 3 of them official. Counted 2026-09-03 from the directory data.
...
**Job · send-document-for-signature**

## Send a document for signature

Put a document into a signing flow and track its state to signed.
...
3 of the 6 entries tagged with this job carry an MCP server of some kind, 3 of them official. All 6 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-03 from directory.json.
...
- e-sign a contract
- get the msa signed
- check whether they signed yet

**Where these tools live**

- [Proposals & Deals](../categories/proposals-deals.md): 6 tagged

### The 6 entries tagged send-document-for-signature
