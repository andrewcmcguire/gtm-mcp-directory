...
> Put a document into a signing flow and track its state to signed. 3 of the 6 entries tagged with this job carry an MCP server of some kind, 3 of them official. Counted 2026-09-20 from the directory data.
...
3 of the 6 entries tagged with this job carry an MCP server of some kind, 3 of them official. All 6 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-20 from directory.json.
