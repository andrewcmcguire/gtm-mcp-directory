...
> Run analytical queries against the modeled GTM data, not against the CRM. 2 of the 2 entries tagged with this job carry an MCP server of some kind, 2 of them official. Counted 2026-09-11 from the directory data.
...
2 of the 2 entries tagged with this job carry an MCP server of some kind, 2 of them official. All 2 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-11 from directory.json.
