...
> Run analytical queries against the modeled GTM data, not against the CRM. 2 of the 2 entries tagged with this job carry an MCP server of some kind, 2 of them official. Counted 2026-09-08 from the directory data.
...
**Job · query-data-warehouse**

## Query a data warehouse

Run analytical queries against the modeled GTM data, not against the CRM.
...
2 of the 2 entries tagged with this job carry an MCP server of some kind, 2 of them official. All 2 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- query the warehouse
- run sql against our gtm data
- ask a question of snowflake
- read the modeled revenue data

**Where these tools live**

- [RevOps Infra](../categories/revops-infra.md): 2 tagged

### The 2 entries tagged query-data-warehouse
