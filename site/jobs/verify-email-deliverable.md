...
> Check an address against the mail server or a verification pipeline before anything is sent to it. 14 of the 15 entries tagged with this job carry an MCP server of some kind, 12 of them official. Counted 2026-09-10 from the directory data.
...
Verify an email is deliverable

**Job · verify-email-deliverable**

## Verify an email is deliverable

Check an address against the mail server or a verification pipeline before anything is sent to it.
...
14 of the 15 entries tagged with this job carry an MCP server of some kind, 12 of them official. All 15 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-10 from directory.json.
...
- check deliverability before i send
- clean this email list
- smtp verification

**Where these tools live**

- [Data & Enrichment](../categories/data-enrichment.md): 12 tagged
- [Engagement & Outbound](../categories/engagement-outbound.md): 2 tagged
- [Email Deliverability](../categories/email-deliverability.md): 1 tagged

### The 15 entries tagged verify-email-deliverable
...
- [Find a work email address](find-work-email.md)
