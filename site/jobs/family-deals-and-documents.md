# Deal execution and documents - GTM jobs an agent can ask for

> Quote it, paper it, sign it, and share it with the buyer. 6 jobs and 31 tagged entries in The GTM MCP Directory.

*Markdown twin of the HTML page at the same path. Same content, no navigation, no styling, no scripts. Links below point at other twins. Site map for machines: [llms.txt](../llms.txt). The whole dataset: [directory.json](../data/directory.json).*

---
[Directory](../index.md) /
[By job](index.md) / Deal execution and documents

**Job family**

## Deal execution and documents

Quote it, paper it, sign it, and share it with the buyer. 6 jobs, 31 tagged entries, 24 distinct entries across the family.

- [Generate a proposal or quote](generate-proposal-or-quote.md) - 5 tools · 1 official MCP. Produce the priced document: CPQ output, proposal, quote, interactive pricing page.
- [Send a document for signature](send-document-for-signature.md) - 6 tools · 3 official MCP. Put a document into a signing flow and track its state to signed.
- [Read contract terms](read-contract-terms.md) - 3 tools · 3 official MCP. Query executed agreements for their terms, dates, obligations or status.
- [Create a digital sales room](create-digital-sales-room.md) - 5 tools · 2 official MCP. Stand up a buyer-facing shared space with collateral, a mutual action plan and engagement tracking.
- [Retrieve sales content](retrieve-sales-content.md) - 9 tools · 4 official MCP. Return the approved collateral, messaging or positioning a rep or an agent should use right now.
- [Draft an RFP or questionnaire response](draft-rfp-response.md) - 3 tools · 2 official MCP. Auto-answer RFP, RFI, DDQ and security-questionnaire items from a governed content library.
