...
> Trigger or execute a multi-step workflow across tools, deterministic or agent-driven. 11 of the 18 entries tagged with this job carry an MCP server of some kind, 10 of them official. Counted 2026-09-15 from the directory data.
...
11 of the 18 entries tagged with this job carry an MCP server of some kind, 10 of them official. 15 of the 18 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-15 from directory.json.
