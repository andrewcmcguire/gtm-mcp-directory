# Run an automation workflow: 18 GTM tools, 10 with an official MCP server

> Trigger or execute a multi-step workflow across tools, deterministic or agent-driven. 11 of the 18 entries tagged with this job carry an MCP server of some kind, 10 of them official. Counted 2026-09-08 from the directory data.
...
**Job · run-automation-workflow**

## Run an automation workflow

Trigger or execute a multi-step workflow across tools, deterministic or agent-driven.
...
11 of the 18 entries tagged with this job carry an MCP server of some kind, 10 of them official. 15 of the 18 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- [RevOps Infra](../categories/revops-infra.md): 11 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 3 tagged
...
### The 18 entries tagged run-automation-workflow
