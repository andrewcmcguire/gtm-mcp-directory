...
> Query across many recorded conversations at once rather than fetching one by id. 5 of the 5 entries tagged with this job carry an MCP server of some kind, 5 of them official. Counted 2026-09-10 from the directory data.
...
5 of the 5 entries tagged with this job carry an MCP server of some kind, 5 of them official. All 5 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-10 from directory.json.
