...
> Hand it a profile URL or a scraped profile and get a structured person record back. 9 of the 12 entries tagged with this job carry an MCP server of some kind, 8 of them official. Counted 2026-09-20 from the directory data.
...
9 of the 12 entries tagged with this job carry an MCP server of some kind, 8 of them official. All 12 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-20 from directory.json.
