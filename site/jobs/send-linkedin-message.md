...
> Act on LinkedIn: connect, message, follow up. Carries standing platform-terms risk the directory flags on files 02 and 05. 15 of the 22 entries tagged with this job carry an MCP server of some kind, 14 of them official. Counted 2026-09-07 from the directory data.
...
15 of the 22 entries tagged with this job carry an MCP server of some kind, 14 of them official. 19 of the 22 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-07 from directory.json.
