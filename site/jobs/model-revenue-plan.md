...
> Build or query the plan side: quota, capacity, territory, scenarios, comp. 3 of the 7 entries tagged with this job carry an MCP server of some kind, 3 of them official. Counted 2026-09-26 from the directory data.
...
3 of the 7 entries tagged with this job carry an MCP server of some kind, 3 of them official. All 7 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-26 from directory.json.
