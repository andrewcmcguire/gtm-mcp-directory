...
> Return company-level events: funding rounds, M&A, leadership changes, expansion, press. 11 of the 12 entries tagged with this job carry an MCP server of some kind, 10 of them official. Counted 2026-09-11 from the directory data.
...
11 of the 12 entries tagged with this job carry an MCP server of some kind, 10 of them official. 11 of the 12 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-11 from directory.json.
