# Answer an inbound chat or call: 21 GTM tools, 12 with an official MCP server

> Hold a live two-way conversation with an inbound visitor or caller, by text or voice, and qualify or resolve it. 14 of the 21 entries tagged with this job carry an MCP server of some kind, 12 of them official. Counted 2026-09-08 from the directory data.
...
Answer an inbound chat or call

**Job · answer-inbound-chat**

## Answer an inbound chat or call

Hold a live two-way conversation with an inbound visitor or caller, by text or voice, and qualify or resolve it.
...
14 of the 21 entries tagged with this job carry an MCP server of some kind, 12 of them official. 16 of the 21 tagged entries are distinct products; the other 5 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- ai chatbot on my site
- handle an inbound call
- live conversational agent for visitors

**Where these tools live**

- [Inbound & PLG Chat](../categories/inbound-plg-chat.md): 9 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 4 tagged
- [RevOps Infra](../categories/revops-infra.md): 3 tagged
- [Data & Enrichment](../categories/data-enrichment.md): 1 tagged
- [Signals & Intent](../categories/signals-intent-abm.md): 1 tagged
- [Video Prospecting](../categories/video-prospecting.md): 1 tagged
- [Scheduling & Routing](../categories/scheduling-routing.md): 1 tagged
- [Forecasting & Revenue](../categories/forecasting-revenue.md): 1 tagged

### The 21 entries tagged answer-inbound-chat
...
- [Fetch a call transcript](fetch-call-transcript.md)
- [Search across recorded calls](search-call-library.md)
- [Summarize a meeting](summarize-meeting.md)
- [Extract deal signals from calls](extract-deal-signals-from-calls.md)
- [Book a meeting](book-a-meeting.md)
- [Read calendar availability](read-calendar-availability.md)
