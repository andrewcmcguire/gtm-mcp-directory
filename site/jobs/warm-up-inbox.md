...
> Build or repair sender reputation by generating engagement against a mailbox over time. 9 of the 13 entries tagged with this job carry an MCP server of some kind, 9 of them official. Counted 2026-09-13 from the directory data.
...
9 of the 13 entries tagged with this job carry an MCP server of some kind, 9 of them official. 12 of the 13 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-13 from directory.json.
