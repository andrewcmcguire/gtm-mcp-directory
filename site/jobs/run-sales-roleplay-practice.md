...
> Hold a simulated buyer conversation with a rep and grade it. A distinct product class, not a feature of call scoring. 3 of the 11 entries tagged with this job carry an MCP server of some kind, 3 of them official. Counted 2026-09-18 from the directory data.
...
3 of the 11 entries tagged with this job carry an MCP server of some kind, 3 of them official. 10 of the 11 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-18 from directory.json.
