...
> Produce the priced document: CPQ output, proposal, quote, interactive pricing page. 2 of the 5 entries tagged with this job carry an MCP server of some kind, 1 of them official. Counted 2026-09-18 from the directory data.
...
2 of the 5 entries tagged with this job carry an MCP server of some kind, 1 of them official. All 5 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-18 from directory.json.
