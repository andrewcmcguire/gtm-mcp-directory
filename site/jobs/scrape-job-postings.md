...
> Query live or historical job listings as a hiring, budget or tech-stack signal. 5 of the 5 entries tagged with this job carry an MCP server of some kind, 5 of them official. Counted 2026-08-25 from the directory data.
...
**Job · scrape-job-postings**

## Scrape job postings

Query live or historical job listings as a hiring, budget or tech-stack signal.
...
5 of the 5 entries tagged with this job carry an MCP server of some kind, 5 of them official. 4 of the 5 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-08-25 from directory.json.
...
- scrape job postings
- what is this company hiring for
- find companies hiring for this role
- job board data as an intent signal
...
### The 5 entries tagged scrape-job-postings
