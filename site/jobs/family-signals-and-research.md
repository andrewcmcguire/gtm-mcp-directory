# Signals and research - GTM jobs an agent can ask for

> Find out something changed, or find out what is true right now. 9 jobs and 117 tagged entries in The GTM MCP Directory.
...
---
[Directory](../index.md) /
[By job](index.md) / Signals and research
...
- [Fetch buyer intent signals](fetch-buyer-intent-signals.md) - 30 tools · 20 official MCP. Return third-party or aggregated research/engagement signals saying an account may be in market.
...
- [Detect a company's tech stack](detect-technographics.md) - 14 tools · 11 official MCP. Return what software a company runs, from fingerprinting, job posts or a licensed technographic dataset.
