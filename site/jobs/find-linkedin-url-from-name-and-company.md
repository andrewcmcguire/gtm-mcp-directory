# Find a person's LinkedIn URL from a name and company: 22 GTM tools, 18 with an official MCP server

> Hand it a person's name plus a company name or domain and get the LinkedIn profile URL back. The inverse of enrich-person-from-linkedin-url, which needs the URL as input. Added 2026-09-03 by the owner; see the header. 20 of the 22 entries tagged with this job carry an MCP server of some kind, 18 of them official. Counted 2026-09-08 from the directory data.
...
Find a person's LinkedIn URL from a name and company

**Job · find-linkedin-url-from-name-and-company**

## Find a person's LinkedIn URL from a name and company

Hand it a person's name plus a company name or domain and get the LinkedIn profile URL back. The inverse of enrich-person-from-linkedin-url, which needs the URL as input. Added 2026-09-03 by the owner; see the header.
...
20 of the 22 entries tagged with this job carry an MCP server of some kind, 18 of them official. 21 of the 22 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- linkedin profile url from name
- linkedin url from name and company
- linkedin profile from name and company
- person name and company to linkedin
- name and company to linkedin url
- lookup linkedin url by name
- linkedin lookup from name and company
- which linkedin profile belongs to this person
- i have a name and a company and need the linkedin profile
- get the linkedin profile url for a person name
- linkedin profile finder
- linkedin url finder

**Where these tools live**

- [Data & Enrichment](../categories/data-enrichment.md): 19 tagged
- [Engagement & Outbound](../categories/engagement-outbound.md): 2 tagged
- [Signals & Intent](../categories/signals-intent-abm.md): 1 tagged

### The 22 entries tagged find-linkedin-url-from-name-and-company
