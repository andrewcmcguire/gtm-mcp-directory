...
> Watch social, forum, community and news surfaces for a keyword, brand or competitor and alert on matches. 9 of the 12 entries tagged with this job carry an MCP server of some kind, 5 of them official. Counted 2026-09-15 from the directory data.
...
9 of the 12 entries tagged with this job carry an MCP server of some kind, 5 of them official. 11 of the 12 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-15 from directory.json.
