...
> Grade a rep against a scorecard, methodology or behaviour set and produce coaching output. 10 of the 25 entries tagged with this job carry an MCP server of some kind, 7 of them official. Counted 2026-09-03 from the directory data.
...
10 of the 25 entries tagged with this job carry an MCP server of some kind, 7 of them official. 24 of the 25 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-03 from directory.json.
