# Score rep performance: 25 GTM tools, 8 with an official MCP server

> Grade a rep against a scorecard, methodology or behaviour set and produce coaching output. 10 of the 25 entries tagged with this job carry an MCP server of some kind, 8 of them official. Counted 2026-09-08 from the directory data.
...
**Job · score-rep-performance**

## Score rep performance

Grade a rep against a scorecard, methodology or behaviour set and produce coaching output.
...
10 of the 25 entries tagged with this job carry an MCP server of some kind, 8 of them official. 24 of the 25 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- score rep performance
- how is this rep doing
- coaching scorecard
- grade this call against our methodology

**Where these tools live**

- [Conversation Intel](../categories/conversation-intel.md): 9 tagged
- [Enablement & Coaching](../categories/enablement-coaching.md): 9 tagged
- [Engagement & Outbound](../categories/engagement-outbound.md): 3 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 2 tagged
- [Forecasting & Revenue](../categories/forecasting-revenue.md): 2 tagged

### The 25 entries tagged score-rep-performance
...
- [Read the pipeline forecast](read-pipeline-forecast.md)
- [Model a revenue plan](model-revenue-plan.md)
- [Score and prioritize leads](score-and-prioritize-leads.md)
- [Run a sales roleplay practice](run-sales-roleplay-practice.md)
