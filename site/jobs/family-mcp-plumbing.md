# MCP plumbing - GTM jobs an agent can ask for

> Find servers, or stand between an agent and somebody's SaaS. 2 jobs and 14 tagged entries in The GTM MCP Directory.
...
---
[Directory](../index.md) /
[By job](index.md) / MCP plumbing

**Job family**

## MCP plumbing

Find servers, or stand between an agent and somebody's SaaS. 2 jobs, 14 tagged entries, 13 distinct entries across the family.

- [Discover MCP servers](discover-mcp-servers.md) - 5 tools · 1 official MCP. Search or browse a registry of MCP servers. The meta-job this whole directory also performs.
- [Proxy tool calls to SaaS apps](proxy-tool-calls-to-saas.md) - 9 tools · 9 official MCP. Stand between an agent and many SaaS APIs, handling auth and normalisation so the agent does not wire each vendor itself.
