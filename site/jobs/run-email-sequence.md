# Run an email sequence: 45 GTM tools, 27 with an official MCP server

> Enroll contacts in a multi-step cadence and send it. The execution step, not the writing step. 29 of the 45 entries tagged with this job carry an MCP server of some kind, 27 of them official. Counted 2026-09-08 from the directory data.
...
**Job · run-email-sequence**

## Run an email sequence

Enroll contacts in a multi-step cadence and send it. The execution step, not the writing step.
...
29 of the 45 entries tagged with this job carry an MCP server of some kind, 27 of them official. 38 of the 45 tagged entries are distinct products; the other 7 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- send sequenced outreach
- put these people in a cadence
...
- [Engagement & Outbound](../categories/engagement-outbound.md): 21 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 14 tagged
- [Data & Enrichment](../categories/data-enrichment.md): 4 tagged
- [RevOps Infra](../categories/revops-infra.md): 3 tagged
- [Signals & Intent](../categories/signals-intent-abm.md): 1 tagged
- [Forecasting & Revenue](../categories/forecasting-revenue.md): 1 tagged
- [Inbound & PLG Chat](../categories/inbound-plg-chat.md): 1 tagged

### The 45 entries tagged run-email-sequence
...
- [Send a LinkedIn message or connection request](send-linkedin-message.md)
- [Draft personalized outreach](draft-personalized-outreach.md)
- [Place an outbound call](place-outbound-call.md)
- [Create and send a prospecting video](create-and-send-prospecting-video.md)
- [Read outreach performance](read-outreach-performance.md)
- [Run an autonomous SDR agent](run-autonomous-sdr-agent.md)
