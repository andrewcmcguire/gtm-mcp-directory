# Run an email sequence: 45 GTM tools, 22 with an official MCP server

> Enroll contacts in a multi-step cadence and send it. The execution step, not the writing step. 25 of the 45 entries tagged with this job carry an MCP server of some kind, 22 of them official. Counted 2026-08-25 from the directory data.
...
25 of the 45 entries tagged with this job carry an MCP server of some kind, 22 of them official. 38 of the 45 tagged entries are distinct products; the other 7 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-08-25 from directory.json.
