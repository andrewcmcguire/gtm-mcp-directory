...
> Stand up a buyer-facing shared space with collateral, a mutual action plan and engagement tracking. 2 of the 5 entries tagged with this job carry an MCP server of some kind, 2 of them official. Counted 2026-09-13 from the directory data.
...
2 of the 5 entries tagged with this job carry an MCP server of some kind, 2 of them official. 4 of the 5 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-13 from directory.json.
