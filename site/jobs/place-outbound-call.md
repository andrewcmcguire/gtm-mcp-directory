...
> Dial, including parallel and power dialing, and connect a rep or an agent to a live answer. 13 of the 22 entries tagged with this job carry an MCP server of some kind, 13 of them official. Counted 2026-09-15 from the directory data.
...
13 of the 22 entries tagged with this job carry an MCP server of some kind, 13 of them official. 19 of the 22 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-15 from directory.json.
