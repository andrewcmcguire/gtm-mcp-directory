...
> Stand between an agent and many SaaS APIs, handling auth and normalisation so the agent does not wire each vendor itself. 9 of the 9 entries tagged with this job carry an MCP server of some kind, 9 of them official. Counted 2026-09-18 from the directory data.
...
9 of the 9 entries tagged with this job carry an MCP server of some kind, 9 of them official. All 9 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-18 from directory.json.
