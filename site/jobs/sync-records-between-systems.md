...
> Move data between the warehouse, the CRM and the rest of the stack. ETL, reverse ETL, MDM. 8 of the 9 entries tagged with this job carry an MCP server of some kind, 8 of them official. Counted 2026-08-28 from the directory data.
...
8 of the 9 entries tagged with this job carry an MCP server of some kind, 8 of them official. All 9 tagged entries are distinct products. 0 have been bench tested. Counted 2026-08-28 from directory.json.
