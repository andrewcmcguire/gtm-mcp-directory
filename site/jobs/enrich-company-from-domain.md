...
> Hand it a domain or company name and get firmographics back. 26 of the 34 entries tagged with this job carry an MCP server of some kind, 24 of them official. Counted 2026-09-08 from the directory data.
...
**Job · enrich-company-from-domain**

## Enrich a company from a domain

Hand it a domain or company name and get firmographics back.
...
26 of the 34 entries tagged with this job carry an MCP server of some kind, 24 of them official. 31 of the 34 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- enrich this company
- get firmographics for a domain
- how big is this company
- fill in company fields from a website

**Where these tools live**

- [Data & Enrichment](../categories/data-enrichment.md): 20 tagged
- [Signals & Intent](../categories/signals-intent-abm.md): 9 tagged
- [RevOps Infra](../categories/revops-infra.md): 3 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 1 tagged
- [Scheduling & Routing](../categories/scheduling-routing.md): 1 tagged

### The 34 entries tagged enrich-company-from-domain
...
- [Search people by criteria](search-people-by-criteria.md)
- [Search companies by firmographics](search-companies-by-firmographics.md)
- [Enrich a person from a LinkedIn URL](enrich-person-from-linkedin-url.md)
