...
> Produce a synthesized read on a company or person from many sources, for prep or qualification rather than as a raw data pull. 12 of the 17 entries tagged with this job carry an MCP server of some kind, 11 of them official. Counted 2026-09-26 from the directory data.
...
12 of the 17 entries tagged with this job carry an MCP server of some kind, 11 of them official. 16 of the 17 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 1 have been bench tested. Counted 2026-09-26 from directory.json.
