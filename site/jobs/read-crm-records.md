# Read CRM records: 13 GTM tools, 10 with an official MCP server

> Query contacts, accounts, deals and activity out of a system of record. 10 of the 13 entries tagged with this job carry an MCP server of some kind, 10 of them official. Counted 2026-09-08 from the directory data.
...
**Job · read-crm-records**

## Read CRM records

Query contacts, accounts, deals and activity out of a system of record.
...
10 of the 13 entries tagged with this job carry an MCP server of some kind, 10 of them official. 10 of the 13 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- read crm records
- get my open deals
- look up this contact in the crm
- query salesforce
- what is in hubspot for this account
...
### The 13 entries tagged read-crm-records
