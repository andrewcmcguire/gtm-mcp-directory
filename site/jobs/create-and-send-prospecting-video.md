...
> Record or generate a personalized video and deliver it into an email, sequence or CRM step. 9 of the 14 entries tagged with this job carry an MCP server of some kind, 3 of them official. Counted 2026-09-03 from the directory data.
...
Create and send a prospecting video

**Job · create-and-send-prospecting-video**

## Create and send a prospecting video

Record or generate a personalized video and deliver it into an email, sequence or CRM step.
...
9 of the 14 entries tagged with this job carry an MCP server of some kind, 3 of them official. 13 of the 14 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-03 from directory.json.
...
- make a prospecting video
- generate a video for each prospect
- video message a prospect

**Where these tools live**

- [Video Prospecting](../categories/video-prospecting.md): 13 tagged
- [Proposals & Deals](../categories/proposals-deals.md): 1 tagged

### The 14 entries tagged create-and-send-prospecting-video
