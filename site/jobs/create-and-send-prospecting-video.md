...
> Record or generate a personalized video and deliver it into an email, sequence or CRM step. 9 of the 14 entries tagged with this job carry an MCP server of some kind, 3 of them official. Counted 2026-09-17 from the directory data.
...
9 of the 14 entries tagged with this job carry an MCP server of some kind, 3 of them official. 13 of the 14 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-17 from directory.json.
