...
> Answer "who already knows somebody here" from team, partner or relationship-graph data rather than from a bought contact list. 3 of the 4 entries tagged with this job carry an MCP server of some kind, 3 of them official. Counted 2026-09-20 from the directory data.
...
3 of the 4 entries tagged with this job carry an MCP server of some kind, 3 of them official. All 4 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-20 from directory.json.
