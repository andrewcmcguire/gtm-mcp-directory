# Fetch buyer intent signals: 30 GTM tools, 20 with an official MCP server

> Return third-party or aggregated research/engagement signals saying an account may be in market. 22 of the 30 entries tagged with this job carry an MCP server of some kind, 20 of them official. Counted 2026-09-13 from the directory data.
...
**Job · fetch-buyer-intent-signals**

## Fetch buyer intent signals

Return third-party or aggregated research/engagement signals saying an account may be in market.
...
22 of the 30 entries tagged with this job carry an MCP server of some kind, 20 of them official. 26 of the 30 tagged entries are distinct products; the other 4 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-13 from directory.json.
...
- get intent data for these companies
- buying signals for my target list
- is this account researching us

**Where these tools live**

- [Signals & Intent](../categories/signals-intent-abm.md): 16 tagged
- [AI SDRs](../categories/ai-sdr-agents.md): 6 tagged
- [Engagement & Outbound](../categories/engagement-outbound.md): 4 tagged
- [Data & Enrichment](../categories/data-enrichment.md): 3 tagged
- [Community & Dark Social](../categories/community-dark-social.md): 1 tagged

### The 30 entries tagged fetch-buyer-intent-signals
...
- [Scrape a web page for facts](scrape-web-page-for-facts.md)
