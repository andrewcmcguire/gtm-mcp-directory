...
> Return third-party or aggregated research/engagement signals saying an account may be in market. 22 of the 30 entries tagged with this job carry an MCP server of some kind, 20 of them official. Counted 2026-09-04 from the directory data.
...
22 of the 30 entries tagged with this job carry an MCP server of some kind, 20 of them official. 26 of the 30 tagged entries are distinct products; the other 4 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-04 from directory.json.
