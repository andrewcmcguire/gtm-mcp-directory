# Score and prioritize leads: 24 GTM tools, 15 with an official MCP server

> Rank accounts, leads or contacts by fit, intent or qualification and say what to work first. 15 of the 24 entries tagged with this job carry an MCP server of some kind, 15 of them official. Counted 2026-09-08 from the directory data.
...
**Job · score-and-prioritize-leads**

## Score and prioritize leads

Rank accounts, leads or contacts by fit, intent or qualification and say what to work first.
...
15 of the 24 entries tagged with this job carry an MCP server of some kind, 15 of them official. 21 of the 24 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-08 from directory.json.
...
- score these leads
- which accounts should i work first
- prioritize my list
- qualify this lead
- icp fit score
...
- [AI SDRs](../categories/ai-sdr-agents.md): 5 tagged
- [Data & Enrichment](../categories/data-enrichment.md): 4 tagged
- [Signals & Intent](../categories/signals-intent-abm.md): 4 tagged
- [RevOps Infra](../categories/revops-infra.md): 4 tagged
- [Scheduling & Routing](../categories/scheduling-routing.md): 3 tagged
...
### The 24 entries tagged score-and-prioritize-leads
