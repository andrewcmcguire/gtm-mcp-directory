...
> Rank accounts, leads or contacts by fit, intent or qualification and say what to work first. 15 of the 24 entries tagged with this job carry an MCP server of some kind, 15 of them official. Counted 2026-08-28 from the directory data.
...
15 of the 24 entries tagged with this job carry an MCP server of some kind, 15 of them official. 21 of the 24 tagged entries are distinct products; the other 3 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-08-28 from directory.json.
