...
> Watch known contacts and tell you when they move, get promoted or land somewhere new. 7 of the 10 entries tagged with this job carry an MCP server of some kind, 5 of them official. Counted 2026-09-18 from the directory data.
...
7 of the 10 entries tagged with this job carry an MCP server of some kind, 5 of them official. 9 of the 10 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-18 from directory.json.
