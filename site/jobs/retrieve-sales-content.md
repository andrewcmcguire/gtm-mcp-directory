...
> Return the approved collateral, messaging or positioning a rep or an agent should use right now. 4 of the 9 entries tagged with this job carry an MCP server of some kind, 4 of them official. Counted 2026-09-14 from the directory data.
...
4 of the 9 entries tagged with this job carry an MCP server of some kind, 4 of them official. All 9 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-14 from directory.json.
