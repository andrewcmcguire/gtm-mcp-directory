...
> Produce a ranked or filtered account universe from an ICP definition or a set of best customers. 6 of the 7 entries tagged with this job carry an MCP server of some kind, 5 of them official. Counted 2026-09-04 from the directory data.
...
6 of the 7 entries tagged with this job carry an MCP server of some kind, 5 of them official. All 7 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-04 from directory.json.
