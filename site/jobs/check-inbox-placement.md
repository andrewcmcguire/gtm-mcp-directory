...
> Measure where mail actually lands: inbox, promotions or spam, per provider. 1 of the 4 entries tagged with this job carry an MCP server of some kind, 1 of them official. Counted 2026-09-07 from the directory data.
...
1 of the 4 entries tagged with this job carry an MCP server of some kind, 1 of them official. All 4 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-07 from directory.json.
