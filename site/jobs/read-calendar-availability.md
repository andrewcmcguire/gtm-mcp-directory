...
> Return open slots, availability rules or existing bookings without necessarily writing anything. 8 of the 12 entries tagged with this job carry an MCP server of some kind, 6 of them official. Counted 2026-08-28 from the directory data.
...
8 of the 12 entries tagged with this job carry an MCP server of some kind, 6 of them official. 11 of the 12 tagged entries are distinct products; the other 1 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-08-28 from directory.json.
