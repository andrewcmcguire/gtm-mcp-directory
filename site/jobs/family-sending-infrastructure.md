# Sending infrastructure - GTM jobs an agent can ask for

> Own the mailboxes, the reputation and the placement. 3 jobs and 26 tagged entries in The GTM MCP Directory.
...
---
[Directory](../index.md) /
[By job](index.md) / Sending infrastructure
...
- [Warm up an inbox](warm-up-inbox.md) - 13 tools · 9 official MCP. Build or repair sender reputation by generating engagement against a mailbox over time.
