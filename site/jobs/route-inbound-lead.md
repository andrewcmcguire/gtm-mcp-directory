...
> Decide which rep, queue or territory an inbound lead or signal belongs to and hand it over. 4 of the 9 entries tagged with this job carry an MCP server of some kind, 4 of them official. Counted 2026-09-04 from the directory data.
...
4 of the 9 entries tagged with this job carry an MCP server of some kind, 4 of them official. 7 of the 9 tagged entries are distinct products; the other 2 are the same product cross listed in a second category. 0 have been bench tested. Counted 2026-09-04 from directory.json.
