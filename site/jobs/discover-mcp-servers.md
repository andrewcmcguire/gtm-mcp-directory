...
> Search or browse a registry of MCP servers. The meta-job this whole directory also performs. 1 of the 5 entries tagged with this job carry an MCP server of some kind, 1 of them official. Counted 2026-09-10 from the directory data.
...
**Job · discover-mcp-servers**

## Discover MCP servers

Search or browse a registry of MCP servers. The meta-job this whole directory also performs.
...
1 of the 5 entries tagged with this job carry an MCP server of some kind, 1 of them official. All 5 tagged entries are distinct products. 0 have been bench tested. Counted 2026-09-10 from directory.json.
...
- find an mcp server for this
- discover mcp servers
- browse the mcp registry
- is there an mcp for this tool

**Where these tools live**

- [MCP Layer](../categories/mcp-infrastructure.md): 5 tagged

### The 5 entries tagged discover-mcp-servers
...
- [Proxy tool calls to SaaS apps](proxy-tool-calls-to-saas.md)
