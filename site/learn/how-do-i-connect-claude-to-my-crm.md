...
> Connect an AI assistant to your CRM through an MCP server. Which CRM and RevOps tools have one (29 official of 85), what to check first, and the order to do it in.
...
RevOps Infra is the best covered layer in this directory: 29 official servers and 11 community across 85 entries, with only 44 where none was found. Check your specific system on [the RevOps tools with MCP servers list](../lists/mcp-revops-infra.md), and read the auth field on its page before anything else.
