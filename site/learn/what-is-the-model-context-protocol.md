...
Adoption is visible in this directory's own data rather than in anyone's press release. 200 of 1,032 go to market vendors ship a first party server today, and the auth notes on those entries name Claude, ChatGPT and Cursor as the clients they document sign in flows for.
