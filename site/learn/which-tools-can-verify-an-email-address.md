...
> 12 of the 15 GTM tools tagged with this job ship an official MCP server, 14 are reachable without a contract. The full list, counted 2026-09-11.
...
15 products in this directory are tagged with this job. 12 of the 15 tagged entries have an official MCP server and 2 have a community one, so an agent can call 14 of them directly. 14 are reachable by one person without a contract. Counted 2026-09-11.
