...
> 22 of the 29 GTM tools tagged with this job ship an official MCP server, 22 are reachable without a contract. The full list, counted 2026-09-14.
...
29 products in this directory are tagged with this job. 22 of the 29 tagged entries have an official MCP server and 2 have a community one, so an agent can call 24 of them directly. 22 are reachable by one person without a contract. Counted 2026-09-14.
...
What it can tell you is which ones an agent can call without you writing a client, and which ones you can get into without a contract.

## The numbers, generated at build time

| Measure | Count | Of what |
|---|---|---|
| Entries tagged find-work-email | 29 | of 1,252 directory entries |
...
| No server found | 5 | on the date each entry was checked |
| Free to start | 12 | no payment, no sales call |
| Solo reachable | 22 | free or paid self serve |
...
- [The GTM MCP Directory, find a work email address](../jobs/find-work-email.md) this site
