...
- **The recorder's REST API with a thin wrapper.** Fine, and about an afternoon of work if the API is documented. 229 of 739 entries in this directory record a documentation URL.
