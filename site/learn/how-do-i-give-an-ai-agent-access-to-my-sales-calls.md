...
- **The recorder's REST API with a thin wrapper.** Fine, and about an afternoon of work if the API is documented. 302 of 884 entries in this directory record a documentation URL.
