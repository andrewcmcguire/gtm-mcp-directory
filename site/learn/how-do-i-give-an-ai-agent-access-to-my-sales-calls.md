...
- **The recorder's REST API with a thin wrapper.** Fine, and about an afternoon of work if the API is documented. 114 of 514 entries in this directory record a documentation URL.
