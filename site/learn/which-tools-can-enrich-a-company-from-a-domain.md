...
> 24 of the 34 GTM tools tagged with this job ship an official MCP server, 23 are reachable without a contract. The full list, counted 2026-09-04.
...
31 products in this directory are tagged with this job. 24 of the 34 tagged entries have an official MCP server and 2 have a community one, so an agent can call 26 of them directly. 23 are reachable by one person without a contract. Counted 2026-09-04.
