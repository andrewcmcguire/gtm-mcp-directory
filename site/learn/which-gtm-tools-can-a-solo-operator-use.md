...
> 210 of 694 GTM tools are free to start or paid self serve, and 168 of those also have an MCP server. The list one person with a credit card can build on. Counted 2026-09-12.
...
- Together, 210 of 694 entries, or 30%, pass the gate test.
...
- 391 do not publish enough for the gate to be established at all, and are recorded as unknown rather than guessed.
