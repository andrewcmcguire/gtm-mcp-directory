...
> 210 of 1,251 GTM tools are free to start or paid self serve, and 168 of those also have an MCP server. The list one person with a credit card can build on. Counted 2026-09-12.
...
- Together, 210 of 1,251 entries, or 17%, pass the gate test.
...
- 948 do not publish enough for the gate to be established at all, and are recorded as unknown rather than guessed.
