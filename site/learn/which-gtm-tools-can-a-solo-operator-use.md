...
> 210 of 1,252 GTM tools are free to start or paid self serve, and 168 of those also have an MCP server. The list one person with a credit card can build on. Counted 2026-09-14.
...
- 78 entries are free to start: sign up, get a key, no conversation.

- 132 are paid self serve: a credit card is enough.

- Together, 210 of 1,252 entries, or 17%, pass the gate test.
...
- 949 do not publish enough for the gate to be established at all, and are recorded as unknown rather than guessed.

## Callable and reachable, both

162 unique products pass both tests. Here are the first fifteen in the published order.
...
147 more are on the linked page. The cut is the display limit, not a ranking.

[The full solo reachable list is here](../lists/solo-reachable.md), and the [78 free tiers are here](../lists/free-api-tiers.md).

## What free does not mean

This directory tracks one thing about money: whether the door opens without a sales call. It does not track prices, credit costs, quota sizes or rate limits, and none of them should be inferred from anything on this page. Enrichment in particular is metered, and an agent in a loop can spend a month's quota before lunch.
