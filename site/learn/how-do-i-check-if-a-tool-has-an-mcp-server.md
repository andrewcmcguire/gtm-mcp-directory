...
- **Their GitHub organisation.** 98 entries here already carry a github.com URL somewhere in their fields and 83 of those are in the mcp_url field itself, which usually means a local server you run yourself.
