...
You give the client a URL, it connects over HTTP, and auth is usually a browser sign in that hands back a scoped token. Nothing is installed and the vendor ships updates without you. Of the 225 servers counted here, [the OAuth ones](../lists/auth-oauth.md) are almost all this shape.
