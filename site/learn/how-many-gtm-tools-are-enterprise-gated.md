# How many GTM tools are enterprise gated? 79 of 1252, counted

> 79 of 1,252 GTM tools need a contract before anybody gets API access, and 39 of those ship an official MCP server most people cannot call. Counted 2026-09-14.
...
79 of the 1,252 entries in this directory are enterprise only: API access needs a contract, a seat count or a procurement cycle. One more is enterprise leaning. 39 of them ship an official MCP server that a solo operator still cannot reach.
...
| [Signals & Intent](../categories/signals-intent-abm.md) | 10 | 86 | 12% |
...
Counted 2026-09-14. 949 further entries do not publish enough for the gate to be established at all and are recorded as unknown rather than guessed into a bucket.
