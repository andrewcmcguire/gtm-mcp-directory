...
> An AI SDR is software that runs the top of the sales funnel end to end. 65 of them are in this directory and 8 ship an official MCP server. Counted 2026-09-12.
