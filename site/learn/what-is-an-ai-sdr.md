...
> An AI SDR is software that runs the top of the sales funnel end to end. 33 of them are in this directory and 8 ship an official MCP server. Counted 2026-09-12.
...
There are 33 AI SDR entries here. **8 have an official MCP server** and 23 have none found. 13 do not publish enough for the access gate to be established at all.
