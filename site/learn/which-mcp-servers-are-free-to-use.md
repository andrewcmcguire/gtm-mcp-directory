...
- **Tracked:** whether a solo operator can get API access at all, in four buckets, with a source. 78 entries are free to start, 132 paid self serve, 79 enterprise only, 436 unknown.
