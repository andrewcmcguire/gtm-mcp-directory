...
> Of 56 jobs in the vocabulary, 1 have no tool at all with a first party MCP server. The gaps in the map, and the thinly covered jobs next to them. Counted 2026-09-09.
...
Counted 2026-09-09 from the per job blocks in directory.json.
