...
> Of 55 jobs in the vocabulary, 2 have no tool at all with a first party MCP server. The gaps in the map, and the thinly covered jobs next to them. Counted 2026-08-25.
...
Counted 2026-08-25 from the per job blocks in directory.json.
