...
A GTM tech stack is every system a revenue team sells through, from the data that starts a conversation to the document that closes it. In this directory it is 15 layers and 694 tools, and the interesting question about a stack is no longer what is in it but how much of it anything can call.
...
|---|---|---|---|---|
| [MCP Layer](../categories/mcp-infrastructure.md) | 97 | 14 | 78 | 95% |
| [Data & Enrichment](../categories/data-enrichment.md) | 109 | 42 | 21 | 58% |
...
| [RevOps Infra](../categories/revops-infra.md) | 64 | 29 | 4 | 52% |
...
| [Signals & Intent](../categories/signals-intent-abm.md) | 55 | 20 | 3 | 42% |
| [Engagement & Outbound](../categories/engagement-outbound.md) | 92 | 23 | 10 | 36% |
| [Inbound & PLG Chat](../categories/inbound-plg-chat.md) | 39 | 11 | 2 | 33% |
| [AI SDRs](../categories/ai-sdr-agents.md) | 41 | 8 | 3 | 27% |
| [Email Deliverability](../categories/email-deliverability.md) | 19 | 4 | 0 | 21% |
| [Forecasting & Revenue](../categories/forecasting-revenue.md) | 21 | 3 | 0 | 14% |
| [Enablement & Coaching](../categories/enablement-coaching.md) | 39 | 2 | 1 | 8% |

Counted 2026-09-12. Totals sum to 694 entries, which includes 16 products deliberately listed in two categories.

## What the ordering tells you

The top of that table is the infrastructure and data layers, where the API was always the product. The bottom is where the interface is the product: enablement, forecasting, community. The category sold hardest on autonomy, AI SDRs, sits well down it with 8 official servers out of 41.
