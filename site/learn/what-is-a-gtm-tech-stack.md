...
A GTM tech stack is every system a revenue team sells through, from the data that starts a conversation to the document that closes it. In this directory it is 15 layers and 1,252 tools, and the interesting question about a stack is no longer what is in it but how much of it anything can call.
...
| [Signals & Intent](../categories/signals-intent-abm.md) | 86 | 21 | 25 | 53% |
...
Counted 2026-09-14. Totals sum to 1,252 entries, which includes 16 products deliberately listed in two categories.
