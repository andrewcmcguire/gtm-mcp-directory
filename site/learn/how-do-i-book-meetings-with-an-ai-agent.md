...
Scheduling & Routing has 5 official servers and 2 community across 17 entries, with 9 entries whose access gate could not be established from public sources. It is a middling category by coverage, which is worth knowing before you design a flow that assumes the booking step is the easy one.
