# What percentage of GTM tools can an AI agent reach? 51%, and less once you count the gate

> 51% of 514 GTM tools have an MCP server. Once the access gate is applied the reachable number drops again. The arithmetic, counted 2026-09-12.
...
51% of the 514 go to market tools counted here have an MCP server of any kind. Applying the second filter, that you can actually get an account without a contract, 168 entries pass both tests, which is 33% of the directory.

## The funnel

| Filter | Entries left | Share of 514 |
|---|---|---|
| Every tool counted | 514 | 100% |
| Has a server of any kind | 264 | 51% |
| Server is first party | 200 | 39% |
| Server, and free or paid self serve | 168 | 33% |
| Server, first party, and free to start | 62 | 12% |
...
Do not read 51% as a permanent state. It is a reading taken on 2026-09-12 from 514 entries whose facts were pulled by hand on 2026-08-24, 2026-08-25, 2026-09-02, 2026-09-03, 2026-09-07, 2026-09-12. The point of stamping every number with a date is that the next reading is comparable to this one.
