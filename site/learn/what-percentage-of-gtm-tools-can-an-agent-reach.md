...
> 62% of 293 GTM tools have an MCP server. Once the access gate is applied the reachable number drops again. The arithmetic, counted 2026-09-04.
...
Counted 2026-09-04 from directory.json. The last row is the honest floor of this whole exercise and it is published on the front page rather than buried here.
...
Do not read 62% as a permanent state. It is a reading taken on 2026-09-04 from 293 entries whose facts were pulled by hand on 2026-08-24, 2026-08-25, 2026-09-02, 2026-09-03. The point of stamping every number with a date is that the next reading is comparable to this one.
