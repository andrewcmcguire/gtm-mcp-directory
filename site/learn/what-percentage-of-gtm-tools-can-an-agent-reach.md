...
> 59% of 1,252 GTM tools have an MCP server. Once the access gate is applied the reachable number drops again. The arithmetic, counted 2026-09-15.
...
Counted 2026-09-15 from directory.json. The last row is the honest floor of this whole exercise and it is published on the front page rather than buried here.
...
Do not read 59% as a permanent state. It is a reading taken on 2026-09-15 from 1,252 entries whose facts were pulled by hand on 2026-08-24, 2026-08-25, 2026-09-02, 2026-09-03, 2026-09-07, 2026-09-12, 2026-09-14. The point of stamping every number with a date is that the next reading is comparable to this one.
