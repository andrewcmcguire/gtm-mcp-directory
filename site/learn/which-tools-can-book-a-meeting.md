...
> 10 of the 26 GTM tools tagged with this job ship an official MCP server, 10 are reachable without a contract. The full list, counted 2026-09-21.
...
23 products in this directory are tagged with this job. 10 of the 26 tagged entries have an official MCP server and 2 have a community one, so an agent can call 12 of them directly. 10 are reachable by one person without a contract. Counted 2026-09-21.
