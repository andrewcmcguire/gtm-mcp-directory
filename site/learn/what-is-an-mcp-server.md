...
> An MCP server is a small program that exposes one system's capabilities to an AI agent in a standard shape. 144 of 293 GTM tools ship one officially. Counted 2026-08-25.
