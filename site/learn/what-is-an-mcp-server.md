...
> An MCP server is a small program that exposes one system's capabilities to an AI agent in a standard shape. 200 of 336 GTM tools ship one officially. Counted 2026-09-09.
