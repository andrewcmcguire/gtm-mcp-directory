...
> An MCP server is a small program that exposes one system's capabilities to an AI agent in a standard shape. 201 of 1,252 GTM tools ship one officially. Counted 2026-09-17.
