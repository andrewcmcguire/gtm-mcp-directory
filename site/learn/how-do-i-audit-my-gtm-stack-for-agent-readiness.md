...
- **Your access.** Not the published gate, your actual contract. Plenty of enterprise gated tools are wide open to a customer who already has the agreement, which is why 40 entries here ship an official server behind a gate that is irrelevant if you are already inside it.
...
- **Reachable share.** How many of your tools an agent can call at all. The directory wide figure is 65%, so anything above that is a good stack for this.
