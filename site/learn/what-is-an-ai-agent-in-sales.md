...
Across 1,252 tools, 741 are callable through MCP and 168 are reachable by one person without a contract. By job, the loop above currently looks like this:
...
Counted 2026-09-14. Official MCP counts entries, and an entry can be cross listed in a second category, which is why these numbers are entry counts rather than product counts.
