...
Across 1,032 tools, 521 are callable through MCP and 168 are reachable by one person without a contract. By job, the loop above currently looks like this:
