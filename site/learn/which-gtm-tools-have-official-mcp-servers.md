# Which GTM tools have official MCP servers? 200 of 884, counted

> 200 of 884 go to market tools ship an MCP server their own vendor builds and maintains. The full list by category, with server URLs and auth. Counted 2026-09-12.
...
200 of the 884 go to market tools in this directory ship an official MCP server, meaning the vendor builds and maintains it. A further 215 have a community built server. The heaviest concentrations are in enrichment, RevOps infrastructure and signals.
...
|---|---|---|---|---|
| [Data & Enrichment](../categories/data-enrichment.md) | 42 | 28 | 137 | [open](../lists/mcp-data-enrichment.md) |
| [RevOps Infra](../categories/revops-infra.md) | 29 | 11 | 85 | [open](../lists/mcp-revops-infra.md) |
| [Engagement & Outbound](../categories/engagement-outbound.md) | 23 | 11 | 116 | [open](../lists/mcp-engagement-outbound.md) |
| [Signals & Intent](../categories/signals-intent-abm.md) | 20 | 5 | 63 | [open](../lists/mcp-signals-intent-abm.md) |
| [Conversation Intel](../categories/conversation-intel.md) | 19 | 2 | 43 | [open](../lists/mcp-conversation-intel.md) |
| [MCP Layer](../categories/mcp-infrastructure.md) | 14 | 137 | 156 | [open](../lists/mcp-mcp-infrastructure.md) |
| [Inbound & PLG Chat](../categories/inbound-plg-chat.md) | 11 | 2 | 47 | [open](../lists/mcp-inbound-plg-chat.md) |
| [AI SDRs](../categories/ai-sdr-agents.md) | 8 | 4 | 52 | [open](../lists/mcp-ai-sdr-agents.md) |
| [Proposals & Deals](../categories/proposals-deals.md) | 8 | 2 | 26 | [open](../lists/mcp-proposals-deals.md) |
...
| [Forecasting & Revenue](../categories/forecasting-revenue.md) | 3 | 0 | 22 | [open](../lists/mcp-forecasting-revenue.md) |
| [Enablement & Coaching](../categories/enablement-coaching.md) | 2 | 1 | 54 | [open](../lists/mcp-enablement-coaching.md) |
...
All 200 are published on one page with the server URL, the auth model and the access gate for each: [the official MCP servers list](../lists/official-mcp-servers.md). 433 entries across the directory carry a parseable server URL; where a vendor claims a server in prose without one, that is recorded as a risk on the methodology page rather than quietly cleaned up.
