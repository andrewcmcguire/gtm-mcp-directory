# Affinity: products, MCP servers and connect URLs, one vendor page

> Affinity (affinity.co): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 52 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [affinity.co](https://affinity.co) · vendor page id affinity-co
...
- **Tools catalogued**: 52 named across 1 measured server, harvested 2026-09-14

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 0 community only, 1 none found, harvested 2026-09-14

- **GitHub organisation**: [github.com/affinity](https://github.com/affinity), tied to the domain with evidence 2026-09-08
...
- **Tools catalogued**: 52 named, harvested 2026-09-14, catalogue fixed
