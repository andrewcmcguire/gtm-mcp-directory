# Leaderra: products, MCP servers and connect URLs, one vendor page

> Leaderra (leaderra.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [leaderra.ai](https://leaderra.ai) · vendor page id leaderra-ai
...
- **GitHub organisation**: none tied to leaderra.ai with evidence on 2026-09-15
...
Leaderra is an AI appointment setter for the leads you already have - inbound, CRM and old lists. It answers in seconds and follows up for weeks across email, phone, WhatsApp, iMessage and SMS, then books the real ones on your calendar. We provide the phone...
