# Anymail Finder: products, MCP servers and connect URLs, one vendor page

> Anymail Finder (anymailfinder.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [anymailfinder.com](https://anymailfinder.com) · vendor page id anymailfinder-com
...
- **GitHub organisation**: none tied to anymailfinder.com with evidence on 2026-09-08
...
- **Connect URL**: [https://api.anymailfinder.com/mcp](https://api.anymailfinder.com/mcp) (endpoint)
...
- [https://api.anymailfinder.com/mcp](https://api.anymailfinder.com/mcp) (Anymail Finder, endpoint, probed 2026-09-04)
...
No GitHub organisation could be tied to anymailfinder.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

1 candidate account seen and rejected by the evidence rules: anymailfinder. A name match alone is never accepted; the account has to point at the vendor domain.
