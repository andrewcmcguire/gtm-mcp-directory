# Glama (MCP directory): products, MCP servers and connect URLs, one vendor page

> Glama (MCP directory) (glama.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [glama.ai](https://glama.ai) · vendor page id glama-ai
...
- **GitHub organisation**: [github.com/glama-ai](https://github.com/glama-ai), tied to the domain with evidence 2026-09-08
