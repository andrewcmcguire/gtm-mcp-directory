...
> Explorium (explorium.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 11 tools catalogued. Data baked 2026-09-08.
...
### [Explorium](../tools/explorium.md) explorium community CLI
...
Login or key hint: explorium config init --api-key "your_api_key_here"

4 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/explorium.md).
