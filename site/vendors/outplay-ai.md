# Outplay: products, MCP servers and connect URLs, one vendor page

> Outplay (outplay.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [outplay.ai](https://outplay.ai) · vendor page id outplay-ai
...
- **GitHub organisation**: none tied to outplay.ai with evidence on 2026-09-08
...
No GitHub organisation could be tied to outplay.ai with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: OutplayerApp, outplay-hq, PalazeOutplay, OutplayEntertainment, OutplayedApps. A name match alone is never accepted; the account has to point at the vendor domain.
