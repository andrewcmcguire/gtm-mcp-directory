# Hive: products, MCP servers and connect URLs, one vendor page

> Hive (hive.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [hive.co](https://hive.co) · vendor page id hive-co
...
- **GitHub organisation**: none tied to hive.co with evidence on 2026-09-15
...
No GitHub organisation could be tied to hive.co with evidence on 2026-09-15.
