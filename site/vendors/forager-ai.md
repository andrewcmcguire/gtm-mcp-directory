# Forager: products, MCP servers and connect URLs, one vendor page

> Forager (forager.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [forager.ai](https://forager.ai) · vendor page id forager-ai
...
- **GitHub organisation**: none tied to forager.ai with evidence on 2026-09-15
...
### [Forager](../tools/forager.md) forager community CLI
...
harvested 2026-09-26, all on the [tool page](../tools/forager.md).
