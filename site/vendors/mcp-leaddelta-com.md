# LeadDelta MCP: products, MCP servers and connect URLs, one vendor page

> LeadDelta MCP (mcp.leaddelta.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.leaddelta.com](https://mcp.leaddelta.com) · vendor page id mcp-leaddelta-com
...
- **GitHub organisation**: none tied to mcp.leaddelta.com with evidence on 2026-09-15
...
No GitHub organisation could be tied to mcp.leaddelta.com with evidence on 2026-09-15.
