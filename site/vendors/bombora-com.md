# Bombora (Company Surge): products, MCP servers and connect URLs, one vendor page

> Bombora (Company Surge) (bombora.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [bombora.com](https://bombora.com) · vendor page id bombora-com
...
- **GitHub organisation**: [github.com/bomboradata](https://github.com/bomboradata), tied to the domain with evidence 2026-09-08
...
Detects which companies are actively researching specific B2B topics by aggregating content-consumption data (article reads, downloads) across a co-op of 5,000+ B2B publisher sites, then measures spikes in a company's topic-research volume relative to its own...
