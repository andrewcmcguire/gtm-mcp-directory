# Infona: products, MCP servers and connect URLs, one vendor page

> Infona (infona.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [infona.ai](https://infona.ai) · vendor page id infona-ai
...
- **GitHub organisation**: none tied to infona.ai with evidence on 2026-09-15
...
### [Infona](../tools/infona.md) infona official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/infona.md).
