# Seismic: products, MCP servers and connect URLs, one vendor page

> Seismic (seismic.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 20 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [seismic.com](https://seismic.com) · vendor page id seismic-com
...
- **Tools catalogued**: 20 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: [github.com/seismic](https://github.com/seismic), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://developer.seismic.com/seismicsoftware/docs/seismic-mcp-server](https://developer.seismic.com/seismicsoftware/docs/seismic-mcp-server) (docs page)
...
- [https://developer.seismic.com/seismicsoftware/docs/seismic-mcp-server](https://developer.seismic.com/seismicsoftware/docs/seismic-mcp-server) (Seismic, docs page, probed 2026-09-04)
