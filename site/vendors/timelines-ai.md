# TimelinesAI: products, MCP servers and connect URLs, one vendor page

> TimelinesAI (timelines.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [timelines.ai](https://timelines.ai) · vendor page id timelines-ai
...
- **GitHub organisation**: none tied to timelines.ai with evidence on 2026-09-15
...
Connect both WhatsApp Business API and personal numbers to your CRM. Sync every conversation, work from one shared team inbox, and automate with AI workflows.
...
No GitHub organisation could be tied to timelines.ai with evidence on 2026-09-15.
