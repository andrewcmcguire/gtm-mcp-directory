# Bonjoro: products, MCP servers and connect URLs, one vendor page

> Bonjoro (bonjoro.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 3 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [bonjoro.com](https://bonjoro.com) · vendor page id bonjoro-com
...
- **GitHub organisation**: [github.com/Vimily](https://github.com/Vimily), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://zapier.com/mcp/bonjoro](https://zapier.com/mcp/bonjoro) (docs page)
...
- [https://zapier.com/mcp/bonjoro](https://zapier.com/mcp/bonjoro) (Bonjoro, docs page, probed 2026-09-04)
