# Nex: products, MCP servers and connect URLs, one vendor page

> Nex (nex.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [nex.ai](https://nex.ai) · vendor page id nex-ai
...
- **GitHub organisation**: none tied to nex.ai with evidence on 2026-09-15
...
### [Nex](../tools/nex.md) nex official CLI
...
1 more install command, harvested 2026-09-15, all on the [tool page](../tools/nex.md).
