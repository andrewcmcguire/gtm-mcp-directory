# 3Bids Contractor: products, MCP servers and connect URLs, one vendor page

> 3Bids Contractor (3bids.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [3bids.io](https://3bids.io) · vendor page id 3bids-io
...
- **GitHub organisation**: none tied to 3bids.io with evidence on 2026-09-15
