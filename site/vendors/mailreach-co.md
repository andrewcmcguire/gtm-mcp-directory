# Mailreach: products, MCP servers and connect URLs, one vendor page

> Mailreach (mailreach.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mailreach.co](https://mailreach.co) · vendor page id mailreach-co
...
- **GitHub organisation**: none tied to mailreach.co with evidence on 2026-09-08
...
No GitHub organisation could be tied to mailreach.co with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

1 candidate account seen and rejected by the evidence rules: mailreacher. A name match alone is never accepted; the account has to point at the vendor domain.
