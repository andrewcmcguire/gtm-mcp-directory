# Mailrith: products, MCP servers and connect URLs, one vendor page

> Mailrith (mailrith.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [mailrith.com](https://mailrith.com) · vendor page id mailrith-com
...
- **GitHub organisation**: none tied to mailrith.com with evidence on 2026-09-15
...
### [Mailrith](../tools/mailrith.md) mailrith official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/mailrith.md).
