# Artisan AI (Ava): products, MCP servers and connect URLs, one vendor page

> Artisan AI (Ava) (artisan.co): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 4 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [artisan.co](https://artisan.co) · vendor page id artisan-co
...
- **Tools catalogued**: 4 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: [github.com/Artisan-AI](https://github.com/Artisan-AI), tied to the domain with evidence 2026-09-08
...
- **Endpoint probe**: answered as an MCP server, 2026-09-04

- **Connect URL**: [https://www.artisan.co/mcp](https://www.artisan.co/mcp) (endpoint)

- **Tools catalogued**: 4 named, harvested 2026-09-17, catalogue fixed
...
- [https://www.artisan.co/mcp](https://www.artisan.co/mcp) (Artisan AI (Ava), endpoint, probed 2026-09-04)
...
[github.com/Artisan-AI](https://github.com/Artisan-AI) tied to the vendor by rule 3, account website https://www.artisan.co has the vendor's domain, confidence strong

- **Public repositories**: 1, forks excluded, as read on 2026-09-08
- **Mention MCP**: 0 of them
- **Look like CLIs**: 0 of them
- **Latest push**: 2026-05-25

The five most recently pushed, on 2026-09-08:

| Repository | Kind | Description | Stars | Pushed | Latest release |
|---|---|---|---|---|---|
| [mitch-prototypes](https://github.com/Artisan-AI/mitch-prototypes) | other | Interactive prototypes for Artisan product design | 0 | 2026-05-25 | |
