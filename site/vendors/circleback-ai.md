...
> Circleback (circleback.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-10.
...
quoted from [https://support.circleback.ai/en/articles/14677613-circleback-cli](https://support.circleback.ai/en/articles/14677613-circleback-cli) on 2026-09-10, via npm

Login or key hint: cb auth

11 subcommands seen, harvested 2026-09-10, all on the [tool page](../tools/circleback.md).
