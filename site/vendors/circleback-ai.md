...
> Circleback (circleback.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-12.
...
11 subcommands seen, harvested 2026-09-12, all on the [tool page](../tools/circleback.md).
