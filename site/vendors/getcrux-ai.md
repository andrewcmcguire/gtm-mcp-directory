# GetCrux: products, MCP servers and connect URLs, one vendor page

> GetCrux (getcrux.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [getcrux.ai](https://getcrux.ai) · vendor page id getcrux-ai
...
- **GitHub organisation**: none tied to getcrux.ai with evidence on 2026-09-15
