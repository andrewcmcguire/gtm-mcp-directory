# Fluint: products, MCP servers and connect URLs, one vendor page

> Fluint (fluint.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [fluint.io](https://fluint.io) · vendor page id fluint-io
...
- **GitHub organisation**: none tied to fluint.io with evidence on 2026-09-15
