# Modash: products, MCP servers and connect URLs, one vendor page

> Modash (modash.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [modash.io](https://modash.io) · vendor page id modash-io
...
- **GitHub organisation**: none tied to modash.io with evidence on 2026-09-15
