# Orbit: products, MCP servers and connect URLs, one vendor page

> Orbit (orbit.love): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [orbit.love](https://orbit.love) · vendor page id orbit-love
...
- **GitHub organisation**: [github.com/orbit-love](https://github.com/orbit-love), tied to the domain with evidence 2026-09-08
...
Was a community-analytics platform that aggregated activity across Discord, Slack, GitHub, and social channels into a unified per-person engagement score ("Orbit Level") to identify a community's most valuable contributors.
