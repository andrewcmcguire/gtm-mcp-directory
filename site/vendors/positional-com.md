# Positional: products, MCP servers and connect URLs, one vendor page

> Positional (positional.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [positional.com](https://positional.com) · vendor page id positional-com
...
- **GitHub organisation**: none tied to positional.com with evidence on 2026-09-15
...
sunbeam is the autonomous SEO agent that runs research, content, and technical fixes end-to-end. Start winning SEO from day one.
...
No GitHub organisation could be tied to positional.com with evidence on 2026-09-15.
