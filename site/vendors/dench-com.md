# Dench: products, MCP servers and connect URLs, one vendor page

> Dench (dench.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [dench.com](https://dench.com) · vendor page id dench-com
...
- **GitHub organisation**: none tied to dench.com with evidence on 2026-09-15
...
### [Dench](../tools/dench.md) dench official CLI

```
npx -y -p @dench.com/cli
```

quoted from [https://www.dench.com/docs](https://www.dench.com/docs) on 2026-09-17, via npx

Login or key hint: export DENCH_API_KEY = ""

4 more install commands, 7 subcommands seen, harvested 2026-09-17, all on the [tool page](../tools/dench.md).
