...
> Dench (dench.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
4 more install commands, 7 subcommands seen, harvested 2026-09-18, all on the [tool page](../tools/dench.md).
