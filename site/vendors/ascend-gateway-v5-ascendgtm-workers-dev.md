# Ascend GTM Gateway: products, MCP servers and connect URLs, one vendor page

> Ascend GTM Gateway (ascend-gateway-v5.ascendgtm.workers.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [ascend-gateway-v5.ascendgtm.workers.dev](https://ascend-gateway-v5.ascendgtm.workers.dev) · vendor page id ascend-gateway-v5-ascendgtm-workers-dev
...
- **GitHub organisation**: none tied to ascend-gateway-v5.ascendgtm.workers.dev with evidence on 2026-09-15
...
No GitHub organisation could be tied to ascend-gateway-v5.ascendgtm.workers.dev with evidence on 2026-09-15.
