# Capix: products, MCP servers and connect URLs, one vendor page

> Capix (capix.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
Vendor domain: [capix.ai](https://capix.ai) · vendor page id capix-ai
...
- **GitHub organisation**: none tied to capix.ai with evidence on 2026-09-15
...
### [Capix](../tools/capix.md) capix community CLI
...
1 more install command, harvested 2026-09-18, all on the [tool page](../tools/capix.md).
