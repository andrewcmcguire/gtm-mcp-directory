# Resquared: products, MCP servers and connect URLs, one vendor page

> Resquared (re2.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [re2.ai](https://re2.ai) · vendor page id re2-ai
...
- **GitHub organisation**: none tied to re2.ai with evidence on 2026-09-15
...
14M+ verified local businesses, AI-handwritten outreach that learns from every campaign, and a built-in email delivery system. All in one tool.
...
No GitHub organisation could be tied to re2.ai with evidence on 2026-09-15.
