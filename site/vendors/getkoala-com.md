# Koala: products, MCP servers and connect URLs, one vendor page

> Koala (getkoala.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [getkoala.com](https://getkoala.com) · vendor page id getkoala-com
...
[MCP not applicable](../mcp/n-a.md) · [Paid, self-serve](../gates/paid.md)
