# Close (Close CRM): products, MCP servers and connect URLs, one vendor page

> Close (Close CRM) (close.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 116 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [close.com](https://close.com) · vendor page id close-com
...
- **Tools catalogued**: 116 named across 1 measured server, harvested 2026-09-14

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 0 community only, 1 none found, harvested 2026-09-14

- **GitHub organisation**: [github.com/close](https://github.com/close), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://help.close.com/integrations/close-mcp-server](https://help.close.com/integrations/close-mcp-server) (docs page)

- **Tools catalogued**: 116 named, harvested 2026-09-14, catalogue fixed
...
- [https://help.close.com/integrations/close-mcp-server](https://help.close.com/integrations/close-mcp-server) (Close (Close CRM), docs page, probed 2026-09-04)
