# Windsor.ai: products, MCP servers and connect URLs, one vendor page

> Windsor.ai (windsor.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [windsor.ai](https://windsor.ai) · vendor page id windsor-ai
...
- **GitHub organisation**: none tied to windsor.ai with evidence on 2026-09-15
...
### [Windsor.ai](../tools/windsor-ai.md) windsor-ai community CLI
...
harvested 2026-09-17, all on the [tool page](../tools/windsor-ai.md).
