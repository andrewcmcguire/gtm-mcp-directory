# Loom: products, MCP servers and connect URLs, one vendor page

> Loom (loom.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 60 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [loom.com](https://loom.com) · vendor page id loom-com
...
- **Tools catalogued**: 60 named across 1 measured server, harvested 2026-09-14

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 0 community only, 1 none found, harvested 2026-09-14

- **GitHub organisation**: [github.com/loomhq](https://github.com/loomhq), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/karbassi/mcp-loom](https://github.com/karbassi/mcp-loom) (docs page)

- **Tools catalogued**: 60 named, harvested 2026-09-14, catalogue fixed
...
- [https://github.com/karbassi/mcp-loom](https://github.com/karbassi/mcp-loom) (Loom, docs page, probed 2026-09-04)
