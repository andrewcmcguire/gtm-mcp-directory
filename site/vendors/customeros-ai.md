# CustomerOS: products, MCP servers and connect URLs, one vendor page

> CustomerOS (customeros.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [customeros.ai](https://customeros.ai) · vendor page id customeros-ai
...
- **GitHub organisation**: none tied to customeros.ai with evidence on 2026-09-15
