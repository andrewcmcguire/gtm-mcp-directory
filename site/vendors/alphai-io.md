# AlphaAI: products, MCP servers and connect URLs, one vendor page

> AlphaAI (alphai.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 2 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [alphai.io](https://alphai.io) · vendor page id alphai-io
...
- **Tools catalogued**: 2 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: none tied to alphai.io with evidence on 2026-09-15
...
- **Tools catalogued**: 2 named, harvested 2026-09-17, catalogue fixed
