# Vidu: products, MCP servers and connect URLs, one vendor page

> Vidu (vidu.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [vidu.io](https://vidu.io) · vendor page id vidu-io
...
- **GitHub organisation**: none tied to vidu.io with evidence on 2026-09-15
