# n8n: products, MCP servers and connect URLs, one vendor page

> n8n (n8n.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [n8n.io](https://n8n.io) · vendor page id n8n-io
...
- **Tools catalogued**: 0 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: [github.com/n8n-io](https://github.com/n8n-io), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.mcptrigger](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.mcptrigger) (docs page)

- **Tools catalogued**: 0 named, harvested 2026-09-17, catalogue dynamic, the server exposes the customer's own workspace
...
- [https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.mcptrigger](https://docs.n8n.io/integrations/builtin/core-nodes/n8n-nodes-langchain.mcptrigger) (n8n, docs page, probed 2026-09-04)
