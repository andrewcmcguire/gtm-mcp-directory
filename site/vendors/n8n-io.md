...
> n8n (n8n.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
- **Tools catalogued**: 0 named across 1 measured server, harvested 2026-09-26
...
- **Tools catalogued**: 0 named, harvested 2026-09-26, catalogue dynamic, the server exposes the customer's own workspace
