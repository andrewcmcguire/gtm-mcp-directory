# BetterContact: products, MCP servers and connect URLs, one vendor page

> BetterContact (bettercontact.rocks): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-21.
...
Vendor domain: [bettercontact.rocks](https://bettercontact.rocks) · vendor page id bettercontact-rocks
...
- **GitHub organisation**: [github.com/bettercontactorg](https://github.com/bettercontactorg), tied to the domain with evidence 2026-09-08
...
### [BetterContact](../tools/bettercontact.md) bettercontact official CLI

```
npm install -g bettercontact
```

quoted from [https://www.npmjs.com/package/bettercontact](https://www.npmjs.com/package/bettercontact) on 2026-09-18, via npm

harvested 2026-09-18, all on the [tool page](../tools/bettercontact.md).
