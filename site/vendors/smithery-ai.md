# Smithery: products, MCP servers and connect URLs, one vendor page

> Smithery (smithery.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [smithery.ai](https://smithery.ai) · vendor page id smithery-ai
...
### [Smithery](../tools/smithery.md) smithery official CLI

```
npm install -g @smithery/cli
```

quoted from [https://www.npmjs.com/package/@smithery/cli](https://www.npmjs.com/package/@smithery/cli) on 2026-09-26, via npm

2 more install commands, harvested 2026-09-26, all on the [tool page](../tools/smithery.md).
