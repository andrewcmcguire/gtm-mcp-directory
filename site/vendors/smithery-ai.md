...
> Smithery (smithery.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-21.
...
quoted from [https://www.npmjs.com/package/@smithery/cli](https://www.npmjs.com/package/@smithery/cli) on 2026-09-18, via npm

2 more install commands, harvested 2026-09-18, all on the [tool page](../tools/smithery.md).
