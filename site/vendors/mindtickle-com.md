# Mindtickle: products, MCP servers and connect URLs, one vendor page

> Mindtickle (mindtickle.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [mindtickle.com](https://mindtickle.com) · vendor page id mindtickle-com
...
- **GitHub organisation**: [github.com/MindTickle](https://github.com/MindTickle), tied to the domain with evidence 2026-09-08
...
[MCP unknown](../mcp/unknown.md) · [Enterprise only](../gates/enterprise-only.md)
