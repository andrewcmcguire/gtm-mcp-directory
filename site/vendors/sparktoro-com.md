# SparkToro: products, MCP servers and connect URLs, one vendor page

> SparkToro (sparktoro.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [sparktoro.com](https://sparktoro.com) · vendor page id sparktoro-com
...
- **GitHub organisation**: [github.com/SparkToro](https://github.com/SparkToro), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://sparktoro.com/mcp](https://sparktoro.com/mcp) (docs page)
...
- [https://sparktoro.com/mcp](https://sparktoro.com/mcp) (SparkToro, docs page, probed 2026-09-04)
