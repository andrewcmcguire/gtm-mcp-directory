# ATLASS OS: products, MCP servers and connect URLs, one vendor page

> ATLASS OS (app.atlass-os.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [app.atlass-os.com](https://app.atlass-os.com) · vendor page id app-atlass-os-com
...
- **GitHub organisation**: none tied to app.atlass-os.com with evidence on 2026-09-15
...
195 working MCP tools as of September 7, 2026 - CRM, scheduling, banking, payables, payroll and real double-entry books, driveable by your own AI through one audited surface with scoped, in-app-minted tokens.
...
No GitHub organisation could be tied to app.atlass-os.com with evidence on 2026-09-15.
