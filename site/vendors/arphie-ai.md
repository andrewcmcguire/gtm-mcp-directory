# Arphie: products, MCP servers and connect URLs, one vendor page

> Arphie (arphie.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [arphie.ai](https://arphie.ai) · vendor page id arphie-ai
...
- **GitHub organisation**: [github.com/Arphie-AI](https://github.com/Arphie-AI), tied to the domain with evidence 2026-09-08
