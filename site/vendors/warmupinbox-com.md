# Warmup Inbox: products, MCP servers and connect URLs, one vendor page

> Warmup Inbox (warmupinbox.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [warmupinbox.com](https://warmupinbox.com) · vendor page id warmupinbox-com
...
- **GitHub organisation**: none tied to warmupinbox.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to warmupinbox.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

1 candidate account seen and rejected by the evidence rules: norbelys-com. A name match alone is never accepted; the account has to point at the vendor domain.
