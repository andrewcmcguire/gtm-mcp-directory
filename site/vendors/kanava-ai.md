# Kanava AI: products, MCP servers and connect URLs, one vendor page

> Kanava AI (kanava.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [kanava.ai](https://kanava.ai) · vendor page id kanava-ai
...
- **GitHub organisation**: none tied to kanava.ai with evidence on 2026-09-15
