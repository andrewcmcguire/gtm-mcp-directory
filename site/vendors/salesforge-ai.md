...
> Salesforge (salesforge.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 109 tools catalogued. Data baked 2026-09-11.
...
- **Tools catalogued**: 109 named across 1 measured server, harvested 2026-09-11
...
- **Tools catalogued**: 109 named, harvested 2026-09-11, catalogue fixed
...
harvested 2026-09-11, all on the [tool page](../tools/salesforge.md).
