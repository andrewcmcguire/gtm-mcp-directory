# Nooks: products, MCP servers and connect URLs, one vendor page

> Nooks (nooks.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [nooks.ai](https://nooks.ai) · vendor page id nooks-ai
...
- **Connect URL**: [https://mcp.nooks.in/mcp](https://mcp.nooks.in/mcp) (endpoint)
