# SigParser: products, MCP servers and connect URLs, one vendor page

> SigParser (sigparser.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [sigparser.com](https://sigparser.com) · vendor page id sigparser-com
...
- **GitHub organisation**: [github.com/DragnetTech](https://github.com/DragnetTech), tied to the domain with evidence 2026-09-08
...
A relationship-intelligence and contact-capture product that scans connected mailboxes, calendars and address books, parses email signatures, and turns the result into contact and company records with who-knows-who relationship scores, exportable to a CRM, a...
