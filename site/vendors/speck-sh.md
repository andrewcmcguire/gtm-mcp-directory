# Speck: products, MCP servers and connect URLs, one vendor page

> Speck (speck.sh): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [speck.sh](https://speck.sh) · vendor page id speck-sh
...
- **GitHub organisation**: none tied to speck.sh with evidence on 2026-09-15
