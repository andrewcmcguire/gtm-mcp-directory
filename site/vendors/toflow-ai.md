# Toflow: products, MCP servers and connect URLs, one vendor page

> Toflow (toflow.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [toflow.ai](https://toflow.ai) · vendor page id toflow-ai
...
- **GitHub organisation**: none tied to toflow.ai with evidence on 2026-09-15
