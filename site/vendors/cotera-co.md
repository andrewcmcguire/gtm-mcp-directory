# Cotera: products, MCP servers and connect URLs, one vendor page

> Cotera (cotera.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [cotera.co](https://cotera.co) · vendor page id cotera-co
...
- **GitHub organisation**: none tied to cotera.co with evidence on 2026-09-15
...
### [Cotera](../tools/cotera.md) cli official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/cotera.md).
