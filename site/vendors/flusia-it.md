# Flusia CRM: products, MCP servers and connect URLs, one vendor page

> Flusia CRM (flusia.it): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [flusia.it](https://flusia.it) · vendor page id flusia-it
...
- **GitHub organisation**: none tied to flusia.it with evidence on 2026-09-15
