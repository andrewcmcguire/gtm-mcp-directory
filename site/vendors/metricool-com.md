# Metricool: products, MCP servers and connect URLs, one vendor page

> Metricool (metricool.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [metricool.com](https://metricool.com) · vendor page id metricool-com
...
- **GitHub organisation**: [github.com/metricool](https://github.com/metricool), tied to the domain with evidence 2026-09-08
