# Tavily: products, MCP servers and connect URLs, one vendor page

> Tavily (tavily.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [tavily.com](https://tavily.com) · vendor page id tavily-com
...
### [Tavily](../tools/tavily.md) tavily-cli official CLI

```
pip install tavily-cli
```

quoted from [https://pypi.org/project/tavily-cli/](https://pypi.org/project/tavily-cli/) on 2026-09-15, via pypi

harvested 2026-09-15, all on the [tool page](../tools/tavily.md).
