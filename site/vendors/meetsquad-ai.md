# Squad: products, MCP servers and connect URLs, one vendor page

> Squad (meetsquad.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [meetsquad.ai](https://meetsquad.ai) · vendor page id meetsquad-ai
...
- **GitHub organisation**: none tied to meetsquad.ai with evidence on 2026-09-15
...
### [Squad](../tools/squad.md) squad official CLI
...
Login or key hint: squad auth

1 more install command, 2 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/squad.md).
