# ICT Contact MCP: products, MCP servers and connect URLs, one vendor page

> ICT Contact MCP (ictcontact.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [ictcontact.com](https://ictcontact.com) · vendor page id ictcontact-com
...
- **GitHub organisation**: none tied to ictcontact.com with evidence on 2026-09-15
...
ICTContact is AI-powered contact center software with builtin CRM, Omnichannel support, WhatsApp integration, progressive dialer, preview dialer, IVR studio, and CRM buisness automation.
...
No GitHub organisation could be tied to ictcontact.com with evidence on 2026-09-15.
