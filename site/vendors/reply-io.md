...
> Reply.io (reply.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 71 tools catalogued. Data baked 2026-09-13.
...
- **Tools catalogued**: 71 named across 1 measured server, harvested 2026-09-13
...
- **Tools catalogued**: 71 named, harvested 2026-09-13, catalogue fixed
...
quoted from [https://docs.reply.io/cli/overview](https://docs.reply.io/cli/overview) on 2026-09-13, via npm

Login or key hint: reply auth

1 more install command, 5 subcommands seen, harvested 2026-09-13, all on the [tool page](../tools/reply-io.md).
