# LinkDeal: products, MCP servers and connect URLs, one vendor page

> LinkDeal (app.linkdeal.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [app.linkdeal.ai](https://app.linkdeal.ai) · vendor page id app-linkdeal-ai
...
- **GitHub organisation**: none tied to app.linkdeal.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to app.linkdeal.ai with evidence on 2026-09-15.
