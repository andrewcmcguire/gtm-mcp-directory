# Tray.ai: products, MCP servers and connect URLs, one vendor page

> Tray.ai (tray.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [tray.ai](https://tray.ai) · vendor page id tray-ai
...
- **GitHub organisation**: none tied to tray.ai with evidence on 2026-09-15
