# Second Nature: products, MCP servers and connect URLs, one vendor page

> Second Nature (secondnature.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [secondnature.ai](https://secondnature.ai) · vendor page id secondnature-ai
...
- **GitHub organisation**: [github.com/secondnatureai](https://github.com/secondnatureai), tied to the domain with evidence 2026-09-08
