# RaiseKit: products, MCP servers and connect URLs, one vendor page

> RaiseKit (raisekit.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [raisekit.co](https://raisekit.co) · vendor page id raisekit-co
...
- **GitHub organisation**: none tied to raisekit.co with evidence on 2026-09-15
