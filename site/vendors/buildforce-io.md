# Buildforce Agentic Ops: products, MCP servers and connect URLs, one vendor page

> Buildforce Agentic Ops (buildforce.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [buildforce.io](https://buildforce.io) · vendor page id buildforce-io
...
- **GitHub organisation**: none tied to buildforce.io with evidence on 2026-09-15
