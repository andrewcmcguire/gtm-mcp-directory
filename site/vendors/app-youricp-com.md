# YourICP MCP: products, MCP servers and connect URLs, one vendor page

> YourICP MCP (app.youricp.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [app.youricp.com](https://app.youricp.com) · vendor page id app-youricp-com
...
- **GitHub organisation**: none tied to app.youricp.com with evidence on 2026-09-15
...
Official open-source MCP server for YourICP contact enrichment & B2B data cleaning.
...
No GitHub organisation could be tied to app.youricp.com with evidence on 2026-09-15.
