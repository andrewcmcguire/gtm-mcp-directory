# Offorte: products, MCP servers and connect URLs, one vendor page

> Offorte (offorte.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 15 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [offorte.com](https://offorte.com) · vendor page id offorte-com
...
- **Tools catalogued**: 15 named across 1 measured server, harvested 2026-09-14

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 0 community only, 1 none found, harvested 2026-09-14

- **GitHub organisation**: [github.com/offorte](https://github.com/offorte), tied to the domain with evidence 2026-09-08
...
- **Tools catalogued**: 15 named, harvested 2026-09-14, catalogue fixed
