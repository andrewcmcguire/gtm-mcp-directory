# Salesforce MCP Auto Auth by kugamon: products, MCP servers and connect URLs, one vendor page

> Salesforce MCP Auto Auth by kugamon (pypi.org): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [pypi.org](https://pypi.org) · vendor page id pypi-org
...
- **GitHub organisation**: none tied to pypi.org with evidence on 2026-09-15
