# Abstrakt: products, MCP servers and connect URLs, one vendor page

> Abstrakt (abstrakt.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [abstrakt.ai](https://abstrakt.ai) · vendor page id abstrakt-ai
...
- **GitHub organisation**: none tied to abstrakt.ai with evidence on 2026-09-15
