...
> Fivetran (fivetran.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 2 tools catalogued. Data baked 2026-09-13.
...
quoted from [https://pypi.org/project/fivetran-cli/](https://pypi.org/project/fivetran-cli/) on 2026-09-13, via pypi, a third party source

harvested 2026-09-13, all on the [tool page](../tools/fivetran.md).
