# Topo: products, MCP servers and connect URLs, one vendor page

> Topo (topo.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [topo.io](https://topo.io) · vendor page id topo-io
...
- **GitHub organisation**: none tied to topo.io with evidence on 2026-09-15
