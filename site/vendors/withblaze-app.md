# Blaze: products, MCP servers and connect URLs, one vendor page

> Blaze (withblaze.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [withblaze.app](https://withblaze.app) · vendor page id withblaze-app
...
- **GitHub organisation**: none tied to withblaze.app with evidence on 2026-09-15
...
Marketing automation for the modern world
...
No GitHub organisation could be tied to withblaze.app with evidence on 2026-09-15.
