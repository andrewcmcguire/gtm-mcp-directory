# COACH: products, MCP servers and connect URLs, one vendor page

> COACH (getcoach.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [getcoach.com](https://getcoach.com) · vendor page id getcoach-com
...
- **GitHub organisation**: none tied to getcoach.com with evidence on 2026-09-15
...
### [COACH](../tools/coach.md) coach-cli community CLI
...
harvested 2026-09-26, all on the [tool page](../tools/coach.md).
