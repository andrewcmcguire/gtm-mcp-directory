# Datagma: products, MCP servers and connect URLs, one vendor page

> Datagma (datagma.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [datagma.com](https://datagma.com) · vendor page id datagma-com
...
- **GitHub organisation**: [github.com/datagma](https://github.com/datagma), tied to the domain with evidence 2026-09-08
...
[github.com/datagma](https://github.com/datagma) tied to the vendor by rule 3, account website https://datagma.com has the vendor's domain, confidence strong
