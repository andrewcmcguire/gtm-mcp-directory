# LeadGenius: products, MCP servers and connect URLs, one vendor page

> LeadGenius (leadgenius.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [leadgenius.com](https://leadgenius.com) · vendor page id leadgenius-com
...
- **GitHub organisation**: none tied to leadgenius.com with evidence on 2026-09-15
...
### [LeadGenius](../tools/leadgenius.md) lgp community CLI
...
harvested 2026-09-26, all on the [tool page](../tools/leadgenius.md).
