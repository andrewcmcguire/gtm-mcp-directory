# GTM Buddy: products, MCP servers and connect URLs, one vendor page

> GTM Buddy (gtmbuddy.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [gtmbuddy.ai](https://gtmbuddy.ai) · vendor page id gtmbuddy-ai
...
- **GitHub organisation**: none tied to gtmbuddy.ai with evidence on 2026-09-15
...
Activate reps who think, adapt, and close with autonomy. GTM Buddy turns enablement into a revenue activation engine with real-time deal guidance.
...
No GitHub organisation could be tied to gtmbuddy.ai with evidence on 2026-09-15.
