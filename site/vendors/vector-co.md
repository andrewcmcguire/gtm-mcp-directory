# Vector (vector.co): products, MCP servers and connect URLs, one vendor page

> Vector (vector.co) (vector.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-12.
...
Vendor domain: [vector.co](https://vector.co) · vendor page id vector-co
...
- **GitHub organisation**: none tied to vector.co with evidence on 2026-09-08
...
Identifies named individual buyers (not just companies) by resolving anonymous website visitors and ad-click engagement to real contacts, then tracks their behavior (job changes, CRM activity, ad engagement) across the buyer journey via a "Shared Experience...

[MCP unknown](../mcp/unknown.md) · [Paid, self-serve](../gates/paid.md)
...
### [Vector (vector.co)](../tools/vector.md) vector_cli community CLI
...
quoted from [https://pypi.org/project/vector_cli/](https://pypi.org/project/vector_cli/) on 2026-09-12, via pypi, a third party source

harvested 2026-09-12, all on the [tool page](../tools/vector.md).
