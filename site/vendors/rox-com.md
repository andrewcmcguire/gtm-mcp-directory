# Rox: products, MCP servers and connect URLs, one vendor page

> Rox (rox.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [rox.com](https://rox.com) · vendor page id rox-com
...
- **GitHub organisation**: [github.com/Rox-AI](https://github.com/Rox-AI), tied to the domain with evidence 2026-09-08
...
An AI-powered revenue automation platform for enterprise sales teams, positioned as an autonomous SDR-style agent handling pipeline generation, lead qualification, meeting booking, deal management, and account expansion "on autopilot."
