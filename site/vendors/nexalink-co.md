# NexaLink: products, MCP servers and connect URLs, one vendor page

> NexaLink (nexalink.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [nexalink.co](https://nexalink.co) · vendor page id nexalink-co
...
- **GitHub organisation**: none tied to nexalink.co with evidence on 2026-09-15
