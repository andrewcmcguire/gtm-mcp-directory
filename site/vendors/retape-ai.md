# Retape: products, MCP servers and connect URLs, one vendor page

> Retape (retape.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [retape.ai](https://retape.ai) · vendor page id retape-ai
...
- **GitHub organisation**: none tied to retape.ai with evidence on 2026-09-15
