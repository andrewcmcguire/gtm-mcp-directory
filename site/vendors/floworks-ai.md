# Floworks: products, MCP servers and connect URLs, one vendor page

> Floworks (floworks.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [floworks.ai](https://floworks.ai) · vendor page id floworks-ai
...
- **GitHub organisation**: none tied to floworks.ai with evidence on 2026-09-15
