# Recapped.io: products, MCP servers and connect URLs, one vendor page

> Recapped.io (recapped.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [recapped.io](https://recapped.io) · vendor page id recapped-io
...
- **GitHub organisation**: none tied to recapped.io with evidence on 2026-09-08
...
[No MCP found](../mcp/none-found.md) · [Free to start](../gates/free.md)
