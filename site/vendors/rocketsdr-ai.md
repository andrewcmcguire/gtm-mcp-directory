# RocketSDR: products, MCP servers and connect URLs, one vendor page

> RocketSDR (rocketsdr.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [rocketsdr.ai](https://rocketsdr.ai) · vendor page id rocketsdr-ai
...
- **GitHub organisation**: none tied to rocketsdr.ai with evidence on 2026-09-15
