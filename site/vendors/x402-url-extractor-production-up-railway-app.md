# x402 Data Gateway MCP: products, MCP servers and connect URLs, one vendor page

> x402 Data Gateway MCP (x402-url-extractor-production.up.railway.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [x402-url-extractor-production.up.railway.app](https://x402-url-extractor-production.up.railway.app) · vendor page id x402-url-extractor-production-up-railway-app
...
- **GitHub organisation**: none tied to x402-url-extractor-production.up.railway.app with evidence on 2026-09-15
...
### [x402 Data Gateway MCP](../tools/x402-data-gateway-mcp.md) railway official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/x402-data-gateway-mcp.md).
