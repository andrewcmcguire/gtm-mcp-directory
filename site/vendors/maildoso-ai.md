# Maildoso: products, MCP servers and connect URLs, one vendor page

> Maildoso (maildoso.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [maildoso.ai](https://maildoso.ai) · vendor page id maildoso-ai
...
- **Connect URL**: [https://maildoso.ai/](https://maildoso.ai/) (docs page)
...
- [https://maildoso.ai/](https://maildoso.ai/) (Maildoso, docs page, probed 2026-09-04)
