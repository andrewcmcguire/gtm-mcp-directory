# Make: products, MCP servers and connect URLs, one vendor page

> Make (make.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [make.com](https://make.com) · vendor page id make-com
...
- **Connect URL**: [https://developers.make.com/mcp-server](https://developers.make.com/mcp-server) (docs page)
