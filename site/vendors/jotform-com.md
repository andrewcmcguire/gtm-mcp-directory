# Jotform: products, MCP servers and connect URLs, one vendor page

> Jotform (jotform.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [jotform.com](https://jotform.com) · vendor page id jotform-com
...
- **GitHub organisation**: [github.com/jotform](https://github.com/jotform), tied to the domain with evidence 2026-09-08
