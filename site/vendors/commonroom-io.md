...
> Common Room (commonroom.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 15 tools catalogued. Data baked 2026-09-15.
...
quoted from [https://www.npmjs.com/package/@commonroomio/cli](https://www.npmjs.com/package/@commonroomio/cli) on 2026-09-15, via npm

harvested 2026-09-15, all on the [tool page](../tools/common-room.md).
