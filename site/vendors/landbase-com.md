# Landbase: products, MCP servers and connect URLs, one vendor page

> Landbase (landbase.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [landbase.com](https://landbase.com) · vendor page id landbase-com
...
- **GitHub organisation**: none tied to landbase.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to landbase.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

4 candidate accounts seen and rejected by the evidence rules: landbase, landbaseapp, landbase-org, landbasedaliens. A name match alone is never accepted; the account has to point at the vendor domain.
