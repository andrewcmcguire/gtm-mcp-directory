# Parallel Tasks: products, MCP servers and connect URLs, one vendor page

> Parallel Tasks (parallel.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [parallel.ai](https://parallel.ai) · vendor page id parallel-ai
...
- **GitHub organisation**: none tied to parallel.ai with evidence on 2026-09-15
