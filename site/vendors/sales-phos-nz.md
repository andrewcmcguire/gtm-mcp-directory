# Phos Sales Engine MCP: products, MCP servers and connect URLs, one vendor page

> Phos Sales Engine MCP (sales.phos.nz): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [sales.phos.nz](https://sales.phos.nz) · vendor page id sales-phos-nz
...
- **GitHub organisation**: none tied to sales.phos.nz with evidence on 2026-09-15
...
No GitHub organisation could be tied to sales.phos.nz with evidence on 2026-09-15.
