# HeyReach: products, MCP servers and connect URLs, one vendor page

> HeyReach (heyreach.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 8 tools catalogued. Data baked 2026-09-08.
...
Vendor domain: [heyreach.io](https://heyreach.io) · vendor page id heyreach-io
...
- **Tools catalogued**: 8 named across 1 measured server, harvested 2026-09-08

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 1 of 1 official, 0 community only, 0 none found, harvested 2026-09-08

- **GitHub organisation**: [github.com/HeyReach](https://github.com/HeyReach), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://www.heyreach.io/mcp](https://www.heyreach.io/mcp) (docs page)

- **Tools catalogued**: 8 named, harvested 2026-09-08, catalogue fixed
...
- [https://www.heyreach.io/mcp](https://www.heyreach.io/mcp) (HeyReach, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [HeyReach](../tools/heyreach.md) heyreach official CLI
...
Login or key hint: heyreach auth

4 more install commands, 7 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/heyreach.md).
