...
> HeyReach (heyreach.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 8 tools catalogued. Data baked 2026-09-14.
...
- **Tools catalogued**: 8 named across 1 measured server, harvested 2026-09-14
...
- **Tools catalogued**: 8 named, harvested 2026-09-14, catalogue fixed
...
quoted from [https://www.npmjs.com/package/heyreach-cli](https://www.npmjs.com/package/heyreach-cli) on 2026-09-14, via npm, a third party source

harvested 2026-09-14, all on the [tool page](../tools/heyreach.md).
