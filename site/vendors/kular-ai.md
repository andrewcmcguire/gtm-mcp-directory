# Kular: products, MCP servers and connect URLs, one vendor page

> Kular (kular.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [kular.ai](https://kular.ai) · vendor page id kular-ai
...
- **GitHub organisation**: none tied to kular.ai with evidence on 2026-09-15
...
Kular AI helps businesses generate qualified leads through AI-driven outreach solutions. Pay only for results with a simple setup and personalized campaigns.
...
No GitHub organisation could be tied to kular.ai with evidence on 2026-09-15.
