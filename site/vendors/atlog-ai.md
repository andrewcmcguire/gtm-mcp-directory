# Atlog: products, MCP servers and connect URLs, one vendor page

> Atlog (atlog.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [atlog.ai](https://atlog.ai) · vendor page id atlog-ai
...
- **GitHub organisation**: none tied to atlog.ai with evidence on 2026-09-15
