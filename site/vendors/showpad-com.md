...
> Showpad (showpad.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 12 tools catalogued. Data baked 2026-09-13.
...
- **Tools catalogued**: 12 named across 1 measured server, harvested 2026-09-13
...
- **Tools catalogued**: 12 named, harvested 2026-09-13, catalogue fixed
...
quoted from [https://www.npmjs.com/package/@showpad/cli](https://www.npmjs.com/package/@showpad/cli) on 2026-09-13, via npm

1 more install command, harvested 2026-09-13, all on the [tool page](../tools/showpad.md).
