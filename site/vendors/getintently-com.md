# Intently (getintently.com): products, MCP servers and connect URLs, one vendor page

> Intently (getintently.com) (getintently.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [getintently.com](https://getintently.com) · vendor page id getintently-com
...
- **GitHub organisation**: none tied to getintently.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to getintently.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

4 candidate accounts seen and rejected by the evidence rules: intently-gg, getintently, Intently-app, Intently-Inc. A name match alone is never accepted; the account has to point at the vendor domain.
