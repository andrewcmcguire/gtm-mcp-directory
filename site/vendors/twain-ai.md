# Twain: products, MCP servers and connect URLs, one vendor page

> Twain (twain.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
Vendor domain: [twain.ai](https://twain.ai) · vendor page id twain-ai
...
- **GitHub organisation**: none tied to twain.ai with evidence on 2026-09-15
...
### [Twain](../tools/twain.md) twain-md community CLI
...
harvested 2026-09-18, all on the [tool page](../tools/twain.md).
