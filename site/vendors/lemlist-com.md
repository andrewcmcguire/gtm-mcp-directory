...
> lemlist (lemlist.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-10.
...
quoted from [https://www.npmjs.com/package/@lemlist-official/cli](https://www.npmjs.com/package/@lemlist-official/cli) on 2026-09-10, via npm, a third party source

harvested 2026-09-10, all on the [tool page](../tools/lemlist.md).
