...
> lemlist (lemlist.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-08.
...
Login or key hint: export LEMLIST_API_KEY="your_key_here"

1 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/lemlist.md).
