...
> ZoomInfo (zoominfo.com): 2 products in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 56 tools catalogued. Data baked 2026-09-10.
...
- **Tools catalogued**: 56 named across 2 measured servers, harvested 2026-09-10

- **Bench tested**: 0 of 2 here, 1 of 336 across the directory

- **Ships a CLI**: 2 of 2 official, 0 community only, 0 none found, harvested 2026-09-10
...
- **Tools catalogued**: 17 named, harvested 2026-09-10, catalogue fixed
...
- **Tools catalogued**: 39 named, harvested 2026-09-10, catalogue fixed
...
quoted from [https://gtm.ai/docs/cli](https://gtm.ai/docs/cli) on 2026-09-10, via npm

Login or key hint: gtm auth

1 more install command, 4 subcommands seen, harvested 2026-09-10, all on the [tool page](../tools/zoominfo.md).
