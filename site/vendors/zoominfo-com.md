...
> ZoomInfo (zoominfo.com): 2 products in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 56 tools catalogued. Data baked 2026-09-26.
...
- **Tools catalogued**: 56 named across 2 measured servers, harvested 2026-09-26
...
- **Tools catalogued**: 17 named, harvested 2026-09-26, catalogue fixed
...
- **Tools catalogued**: 39 named, harvested 2026-09-26, catalogue fixed
...
quoted from [https://gtm.ai/docs/cli](https://gtm.ai/docs/cli) on 2026-09-26, via npm

Login or key hint: gtm auth

2 more install commands, 8 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/zoominfo.md).
