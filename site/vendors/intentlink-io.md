# IntentLink: products, MCP servers and connect URLs, one vendor page

> IntentLink (intentlink.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
Vendor domain: [intentlink.io](https://intentlink.io) · vendor page id intentlink-io
...
- **GitHub organisation**: none tied to intentlink.io with evidence on 2026-09-15
...
### [IntentLink](../tools/intentlink.md) intentlink community CLI
...
harvested 2026-09-18, all on the [tool page](../tools/intentlink.md).
