# Cardinal: products, MCP servers and connect URLs, one vendor page

> Cardinal (trycardinal.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
Vendor domain: [trycardinal.com](https://trycardinal.com) · vendor page id trycardinal-com
...
- **GitHub organisation**: none tied to trycardinal.com with evidence on 2026-09-15
...
### [Cardinal](../tools/cardinal.md) cardinal community CLI
...
harvested 2026-09-18, all on the [tool page](../tools/cardinal.md).
