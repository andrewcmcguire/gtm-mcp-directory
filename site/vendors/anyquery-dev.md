# Anyquery: products, MCP servers and connect URLs, one vendor page

> Anyquery (anyquery.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [anyquery.dev](https://anyquery.dev) · vendor page id anyquery-dev
...
- **GitHub organisation**: none tied to anyquery.dev with evidence on 2026-09-15
...
### [Anyquery](../tools/anyquery.md) anyquery official CLI
...
3 more install commands, 13 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/anyquery.md).
