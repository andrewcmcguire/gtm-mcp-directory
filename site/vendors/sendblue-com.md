# Sendblue: products, MCP servers and connect URLs, one vendor page

> Sendblue (sendblue.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [sendblue.com](https://sendblue.com) · vendor page id sendblue-com
...
- **GitHub organisation**: none tied to sendblue.com with evidence on 2026-09-15
...
### [Sendblue](../tools/sendblue.md) sendblue official CLI
...
Login or key hint: const client = new SendblueAPI ({ apiKey: 'API_KEY' , apiSecret: 'API_SECRET' });

16 subcommands seen, harvested 2026-09-15, all on the [tool page](../tools/sendblue.md).
