# xpay Lead Gen: products, MCP servers and connect URLs, one vendor page

> xpay Lead Gen (lead-gen.mcp.xpay.sh): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [lead-gen.mcp.xpay.sh](https://lead-gen.mcp.xpay.sh) · vendor page id lead-gen-mcp-xpay-sh
...
- **GitHub organisation**: none tied to lead-gen.mcp.xpay.sh with evidence on 2026-09-15
...
### [xpay Lead Gen](../tools/xpay-lead-gen.md) xpay official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/xpay-lead-gen.md).
