# Maintouch: products, MCP servers and connect URLs, one vendor page

> Maintouch (maintouch.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [maintouch.com](https://maintouch.com) · vendor page id maintouch-com
...
- **GitHub organisation**: none tied to maintouch.com with evidence on 2026-09-15
...
### [Maintouch](../tools/maintouch.md) maintouch official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/maintouch.md).
