# CUFinder: products, MCP servers and connect URLs, one vendor page

> CUFinder (cufinder.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [cufinder.io](https://cufinder.io) · vendor page id cufinder-io
...
- **Connect URL**: [https://mcp.cufinder.io/mcp](https://mcp.cufinder.io/mcp) (endpoint)
