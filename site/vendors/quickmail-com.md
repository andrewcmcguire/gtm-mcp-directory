# QuickMail: products, MCP servers and connect URLs, one vendor page

> QuickMail (quickmail.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [quickmail.com](https://quickmail.com) · vendor page id quickmail-com
...
- **GitHub organisation**: none tied to quickmail.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to quickmail.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: QuickMail, QuickmailAu, QuickMailServer, quickmails, quickmail-io. A name match alone is never accepted; the account has to point at the vendor domain.
