# Quantified: products, MCP servers and connect URLs, one vendor page

> Quantified (quantified.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [quantified.ai](https://quantified.ai) · vendor page id quantified-ai
...
- **GitHub organisation**: none tied to quantified.ai with evidence on 2026-09-08
...
AI roleplay and coaching platform aimed at regulated-industry (life sciences, pharma, financial services) sales teams, using photorealistic avatar personas for compliance-scored practice conversations.
...
No GitHub organisation could be tied to quantified.ai with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: quantified-uncertainty, quantifiedcode, QuantifiedSelfless, qcitizen, QuantifiedCarbon. A name match alone is never accepted; the account has to point at the vendor domain.
