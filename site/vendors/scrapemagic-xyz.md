# ScrapeMagic: products, MCP servers and connect URLs, one vendor page

> ScrapeMagic (scrapemagic.xyz): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [scrapemagic.xyz](https://scrapemagic.xyz) · vendor page id scrapemagic-xyz
...
- **GitHub organisation**: none tied to scrapemagic.xyz with evidence on 2026-09-15
...
Scrape any website or document just by describing what you want. Natural Language Scraping & Data Extraction.
...
No GitHub organisation could be tied to scrapemagic.xyz with evidence on 2026-09-15.
