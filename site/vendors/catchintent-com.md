# CatchIntent: products, MCP servers and connect URLs, one vendor page

> CatchIntent (catchintent.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 14 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [catchintent.com](https://catchintent.com) · vendor page id catchintent-com
...
- **GitHub organisation**: [github.com/CatchIntent](https://github.com/CatchIntent), tied to the domain with evidence 2026-09-08
