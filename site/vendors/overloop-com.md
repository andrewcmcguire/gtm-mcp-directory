# Overloop: products, MCP servers and connect URLs, one vendor page

> Overloop (overloop.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 54 tools catalogued. Data baked 2026-09-13.
...
Vendor domain: [overloop.com](https://overloop.com) · vendor page id overloop-com
...
- **Tools catalogued**: 54 named across 1 measured server, harvested 2026-09-13

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 1 community only, 0 none found, harvested 2026-09-13

- **GitHub organisation**: [github.com/overloop-crm](https://github.com/overloop-crm), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/sortlist/overloop-mcp](https://github.com/sortlist/overloop-mcp) (docs page)

- **Tools catalogued**: 54 named, harvested 2026-09-13, catalogue fixed
...
- [https://github.com/sortlist/overloop-mcp](https://github.com/sortlist/overloop-mcp) (Overloop, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Overloop](../tools/overloop.md) overloop community CLI
...
quoted from [https://www.npmjs.com/package/overloop-cli](https://www.npmjs.com/package/overloop-cli) on 2026-09-13, via npm, a third party source

harvested 2026-09-13, all on the [tool page](../tools/overloop.md).
