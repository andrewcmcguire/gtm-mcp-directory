# LinkMCP: products, MCP servers and connect URLs, one vendor page

> LinkMCP (app.linkmcp.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [app.linkmcp.io](https://app.linkmcp.io) · vendor page id app-linkmcp-io
...
- **GitHub organisation**: none tied to app.linkmcp.io with evidence on 2026-09-15
