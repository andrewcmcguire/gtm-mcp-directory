# Red String: products, MCP servers and connect URLs, one vendor page

> Red String (redstringapp.xyz): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [redstringapp.xyz](https://redstringapp.xyz) · vendor page id redstringapp-xyz
...
- **GitHub organisation**: none tied to redstringapp.xyz with evidence on 2026-09-15
