# Cirra AI Salesforce Admin MCP: products, MCP servers and connect URLs, one vendor page

> Cirra AI Salesforce Admin MCP (mcp.cirra.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.cirra.ai](https://mcp.cirra.ai) · vendor page id mcp-cirra-ai
...
- **GitHub organisation**: none tied to mcp.cirra.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to mcp.cirra.ai with evidence on 2026-09-15.
