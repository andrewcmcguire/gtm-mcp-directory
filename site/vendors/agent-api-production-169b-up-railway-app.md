# Agent Utility API: products, MCP servers and connect URLs, one vendor page

> Agent Utility API (agent-api-production-169b.up.railway.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [agent-api-production-169b.up.railway.app](https://agent-api-production-169b.up.railway.app) · vendor page id agent-api-production-169b-up-railway-app
...
- **GitHub organisation**: none tied to agent-api-production-169b.up.railway.app with evidence on 2026-09-15
...
### [Agent Utility API](../tools/agent-utility-api.md) railway official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/agent-utility-api.md).

A CLI being listed means the harvest found an install command or a package on a stated date. Nobody has run it. Every command is quoted verbatim from the URL beneath it.

**On GitHub**

No GitHub organisation could be tied to agent-api-production-169b.up.railway.app with evidence on 2026-09-15.
