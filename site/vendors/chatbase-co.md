...
> Chatbase (chatbase.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-13.
...
quoted from [https://www.chatbase.co/docs/cli/overview](https://www.chatbase.co/docs/cli/overview) on 2026-09-13, via npm

Login or key hint: chatbase auth

1 more install command, 4 subcommands seen, harvested 2026-09-13, all on the [tool page](../tools/chatbase.md).
