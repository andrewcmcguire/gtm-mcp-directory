# Chatbase: products, MCP servers and connect URLs, one vendor page

> Chatbase (chatbase.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [chatbase.co](https://chatbase.co) · vendor page id chatbase-co
...
quoted from [https://www.chatbase.co/docs/cli/overview](https://www.chatbase.co/docs/cli/overview) on 2026-09-15, via npm

Login or key hint: chatbase auth

1 more install command, 4 subcommands seen, harvested 2026-09-15, all on the [tool page](../tools/chatbase.md).
