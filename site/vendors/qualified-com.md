# Qualified: products, MCP servers and connect URLs, one vendor page

> Qualified (qualified.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [qualified.com](https://qualified.com) · vendor page id qualified-com
...
- **GitHub organisation**: none tied to qualified.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to qualified.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: qualified, ferrocene, Qualified-Health, qualifiedigital, isa-ulisboa. A name match alone is never accepted; the account has to point at the vendor domain.
