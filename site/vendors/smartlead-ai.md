# Smartlead: products, MCP servers and connect URLs, one vendor page

> Smartlead (smartlead.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 116 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [smartlead.ai](https://smartlead.ai) · vendor page id smartlead-ai
...
- **Tools catalogued**: 116 named across 1 measured server, harvested 2026-09-15
...
- **Connect URL**: [https://helpcenter.smartlead.ai/en/articles/300-smartlead-mcp-server](https://helpcenter.smartlead.ai/en/articles/300-smartlead-mcp-server) (docs page)

- **Tools catalogued**: 116 named, harvested 2026-09-15, catalogue fixed
...
quoted from [https://www.npmjs.com/package/@smartlead/cli](https://www.npmjs.com/package/@smartlead/cli) on 2026-09-15, via npm

harvested 2026-09-15, all on the [tool page](../tools/smartlead.md).
