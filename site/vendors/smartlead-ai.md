...
> Smartlead (smartlead.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 116 tools catalogued. Data baked 2026-09-14.
...
quoted from [https://www.npmjs.com/package/@smartlead/cli](https://www.npmjs.com/package/@smartlead/cli) on 2026-09-14, via npm

harvested 2026-09-14, all on the [tool page](../tools/smartlead.md).
