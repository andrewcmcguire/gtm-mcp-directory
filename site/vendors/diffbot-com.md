# Diffbot: products, MCP servers and connect URLs, one vendor page

> Diffbot (diffbot.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 7 tools catalogued. Data baked 2026-09-13.
...
Vendor domain: [diffbot.com](https://diffbot.com) · vendor page id diffbot-com
...
- **GitHub organisation**: [github.com/diffbot](https://github.com/diffbot), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/diffbot/diffbot-mcp](https://github.com/diffbot/diffbot-mcp) (docs page)
...
- [https://github.com/diffbot/diffbot-mcp](https://github.com/diffbot/diffbot-mcp) (Diffbot, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Diffbot](../tools/diffbot.md) diffbot community CLI
...
quoted from [https://pypi.org/project/diffbot/](https://pypi.org/project/diffbot/) on 2026-09-13, via pypi, a third party source

harvested 2026-09-13, all on the [tool page](../tools/diffbot.md).
