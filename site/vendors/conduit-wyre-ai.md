# SalesBuildr MCP by WYRE-AI: products, MCP servers and connect URLs, one vendor page

> SalesBuildr MCP by WYRE-AI (conduit.wyre.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [conduit.wyre.ai](https://conduit.wyre.ai) · vendor page id conduit-wyre-ai
...
- **GitHub organisation**: none tied to conduit.wyre.ai with evidence on 2026-09-15
