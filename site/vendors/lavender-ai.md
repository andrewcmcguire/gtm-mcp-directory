...
> Lavender (lavender.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-08.
...
### [Lavender](../tools/lavender.md) community CLI

This is a third party's CLI. It was published by somebody other than the vendor, so it is that author's surface for the vendor's API and not the vendor's published surface. The two must not be read as the same thing.

harvested 2026-09-08, all on the [tool page](../tools/lavender.md).
