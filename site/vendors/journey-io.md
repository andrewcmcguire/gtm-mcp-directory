# Journey: products, MCP servers and connect URLs, one vendor page

> Journey (journey.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [journey.io](https://journey.io) · vendor page id journey-io
...
- **GitHub organisation**: none tied to journey.io with evidence on 2026-09-15
...
Package your pitch deck, case studies, and follow-up docs into one branded page your buyer can forward to decision-makers. Track engagement and close faster.
...
No GitHub organisation could be tied to journey.io with evidence on 2026-09-15.
