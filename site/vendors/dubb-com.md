# Dubb: products, MCP servers and connect URLs, one vendor page

> Dubb (dubb.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [dubb.com](https://dubb.com) · vendor page id dubb-com
...
- **GitHub organisation**: none tied to dubb.com with evidence on 2026-09-08
...
Video sales-messaging platform with a built-in lightweight CRM - record/send personalized prospecting and follow-up videos via email, SMS, LinkedIn, iMessage, or QR code, with trackable video landing pages.
...
No GitHub organisation could be tied to dubb.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: dubbogo, dubbo, DubberSoftware, dubbo-go-pixiu, Dubbing-Voice-Engine. A name match alone is never accepted; the account has to point at the vendor domain.
