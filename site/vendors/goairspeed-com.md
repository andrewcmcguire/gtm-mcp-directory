# Airspeed (formerly Glyphic): products, MCP servers and connect URLs, one vendor page

> Airspeed (formerly Glyphic) (goairspeed.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [goairspeed.com](https://goairspeed.com) · vendor page id goairspeed-com
...
- **GitHub organisation**: none tied to goairspeed.com with evidence on 2026-09-08
...
- **Connect URL**: [https://api.glyphic.ai/mcp](https://api.glyphic.ai/mcp) (endpoint)
...
- [https://api.glyphic.ai/mcp](https://api.glyphic.ai/mcp) (Airspeed (formerly Glyphic), endpoint, probed 2026-09-04)
