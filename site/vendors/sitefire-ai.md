# Sitefire: products, MCP servers and connect URLs, one vendor page

> Sitefire (sitefire.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [sitefire.ai](https://sitefire.ai) · vendor page id sitefire-ai
...
- **GitHub organisation**: none tied to sitefire.ai with evidence on 2026-09-15
