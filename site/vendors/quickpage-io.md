# Quickpage: products, MCP servers and connect URLs, one vendor page

> Quickpage (quickpage.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-13.
...
Vendor domain: [quickpage.io](https://quickpage.io) · vendor page id quickpage-io
...
- **GitHub organisation**: [github.com/quickpagelabs](https://github.com/quickpagelabs), tied to the domain with evidence 2026-09-08
...
### [Quickpage](../tools/quickpage.md) qp community CLI
...
harvested 2026-09-13, all on the [tool page](../tools/quickpage.md).
