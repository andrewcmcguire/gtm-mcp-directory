# Copy.ai (GTM AI Platform): products, MCP servers and connect URLs, one vendor page

> Copy.ai (GTM AI Platform) (copy.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [copy.ai](https://copy.ai) · vendor page id copy-ai
...
- **GitHub organisation**: none tied to copy.ai with evidence on 2026-09-08
...
- **Connect URL**: [https://github.com/anhuaxiang/copy-ai-mcp](https://github.com/anhuaxiang/copy-ai-mcp) (docs page)
...
- [https://github.com/anhuaxiang/copy-ai-mcp](https://github.com/anhuaxiang/copy-ai-mcp) (Copy.ai (GTM AI Platform), docs page, probed 2026-09-04)
...
No GitHub organisation could be tied to copy.ai with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

9 candidate accounts seen and rejected by the evidence rules: anhuaxiang, Copy-AI-student-projecct, Copy-ai-Windows-Tool, Copy-ai-Pro-Windows, CopyTranslator. A name match alone is never accepted; the account has to point at the vendor domain.
