# Read AI: products, MCP servers and connect URLs, one vendor page

> Read AI (read.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [read.ai](https://read.ai) · vendor page id read-ai
...
- **GitHub organisation**: none tied to read.ai with evidence on 2026-09-15
