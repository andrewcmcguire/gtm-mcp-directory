# LeadSleuth MCP: products, MCP servers and connect URLs, one vendor page

> LeadSleuth MCP (leads.zalize.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [leads.zalize.com](https://leads.zalize.com) · vendor page id leads-zalize-com
...
- **GitHub organisation**: none tied to leads.zalize.com with evidence on 2026-09-15
