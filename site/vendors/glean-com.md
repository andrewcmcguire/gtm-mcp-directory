# Glean: products, MCP servers and connect URLs, one vendor page

> Glean (glean.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [glean.com](https://glean.com) · vendor page id glean-com
...
- **GitHub organisation**: none tied to glean.com with evidence on 2026-09-15
...
### [Glean](../tools/glean.md) glean-auth official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/glean.md).
