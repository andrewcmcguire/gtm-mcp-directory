# Rafiki: products, MCP servers and connect URLs, one vendor page

> Rafiki (getrafiki.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [getrafiki.ai](https://getrafiki.ai) · vendor page id getrafiki-ai
...
- **GitHub organisation**: none tied to getrafiki.ai with evidence on 2026-09-15
