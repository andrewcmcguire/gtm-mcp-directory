# CLODO: products, MCP servers and connect URLs, one vendor page

> CLODO (clodo.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [clodo.ai](https://clodo.ai) · vendor page id clodo-ai
...
- **GitHub organisation**: none tied to clodo.ai with evidence on 2026-09-15
