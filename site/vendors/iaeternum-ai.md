# Intelligence Aeternum: products, MCP servers and connect URLs, one vendor page

> Intelligence Aeternum (iaeternum.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [iaeternum.ai](https://iaeternum.ai) · vendor page id iaeternum-ai
...
- **GitHub organisation**: none tied to iaeternum.ai with evidence on 2026-09-15
