# Clara (Clara Labs): products, MCP servers and connect URLs, one vendor page

> Clara (Clara Labs) (claralabs.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [claralabs.com](https://claralabs.com) · vendor page id claralabs-com
...
- **GitHub organisation**: none tied to claralabs.com with evidence on 2026-09-08
