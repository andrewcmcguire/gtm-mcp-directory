# Clearbit Reveal (rebranded: HubSpot Breeze Intelligence): products, MCP servers and connect URLs, one vendor page

> Clearbit Reveal (rebranded: HubSpot Breeze Intelligence) (clearbit.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [clearbit.com](https://clearbit.com) · vendor page id clearbit-com
