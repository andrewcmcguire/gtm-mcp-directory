# Limadata: products, MCP servers and connect URLs, one vendor page

> Limadata (limadata.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [limadata.com](https://limadata.com) · vendor page id limadata-com
...
- **GitHub organisation**: none tied to limadata.com with evidence on 2026-09-15
...
Connect your AI agents to real-time web intelligence, B2B data, and live signals through one unified API.
...
No GitHub organisation could be tied to limadata.com with evidence on 2026-09-15.
