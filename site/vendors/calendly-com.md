# Calendly: products, MCP servers and connect URLs, one vendor page

> Calendly (calendly.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 36 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [calendly.com](https://calendly.com) · vendor page id calendly-com
...
- **Tools catalogued**: 36 named across 1 measured server, harvested 2026-09-26
...
- **Connect URL**: [https://developer.calendly.com/calendly-mcp-server](https://developer.calendly.com/calendly-mcp-server) (docs page)

- **Tools catalogued**: 36 named, harvested 2026-09-26, catalogue fixed
...
### [Calendly](../tools/calendly.md) calendly community CLI
...
quoted from [https://www.npmjs.com/package/calendly-cli](https://www.npmjs.com/package/calendly-cli) on 2026-09-26, via npm, a third party source

1 more install command, harvested 2026-09-26, all on the [tool page](../tools/calendly.md).
