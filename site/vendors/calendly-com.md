...
> Calendly (calendly.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 36 tools catalogued. Data baked 2026-09-21.
...
- **Tools catalogued**: 36 named across 1 measured server, harvested 2026-09-18
...
- **Tools catalogued**: 36 named, harvested 2026-09-18, catalogue fixed
...
quoted from [https://www.npmjs.com/package/calendly-axi](https://www.npmjs.com/package/calendly-axi) on 2026-09-18, via npm, a third party source

1 more install command, harvested 2026-09-18, all on the [tool page](../tools/calendly.md).
