# Salesken: products, MCP servers and connect URLs, one vendor page

> Salesken (salesken.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [salesken.ai](https://salesken.ai) · vendor page id salesken-ai
...
- **GitHub organisation**: none tied to salesken.ai with evidence on 2026-09-15
