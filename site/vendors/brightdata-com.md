...
> Bright Data (brightdata.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 17 tools catalogued. Data baked 2026-09-18.
...
harvested 2026-09-18, all on the [tool page](../tools/bright-data.md).
