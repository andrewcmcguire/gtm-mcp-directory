...
> Bright Data (brightdata.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 19 tools catalogued. Data baked 2026-09-13.
...
quoted from [https://www.npmjs.com/package/@brightdata/cli](https://www.npmjs.com/package/@brightdata/cli) on 2026-09-13, via npm

harvested 2026-09-13, all on the [tool page](../tools/bright-data.md).
