# SalesIntel: products, MCP servers and connect URLs, one vendor page

> SalesIntel (salesintel.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [salesintel.io](https://salesintel.io) · vendor page id salesintel-io
...
- **GitHub organisation**: none tied to salesintel.io with evidence on 2026-09-15
...
Turn B2B buying signals into pipeline with 200M AI + Human-verified contacts and AI-agents powering GTM workflows for sales, marketing, and RevOps teams.
...
No GitHub organisation could be tied to salesintel.io with evidence on 2026-09-15.
