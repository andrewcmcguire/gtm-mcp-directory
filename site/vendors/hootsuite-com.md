# Hootsuite (Social OS): products, MCP servers and connect URLs, one vendor page

> Hootsuite (Social OS) (hootsuite.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [hootsuite.com](https://hootsuite.com) · vendor page id hootsuite-com
