...
> Siftable (npmjs.com): 10 products in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
10 products in the directory
0 official MCP servers
0 live handshakes
Data baked 2026-09-17

Vendor domain: [npmjs.com](https://npmjs.com) · vendor page id npmjs-com

**The rollup**

- **Products**: 10, facts checked by hand 2026-09-12

- **Official MCP servers**: 0 of 10, as recorded on 2026-09-12

- **Community MCP servers**: 10 of 10

- **Live handshake**: 0 of 10 answered an MCP initialize, 0 probed, no date

- **Repo local**: 0 of 10: a server you install and run yourself

- **Docs only**: 0 of 10: the recorded URL is a page about the server, not the server

- **Tools catalogued**: not measured on any product of this vendor

- **Bench tested**: 0 of 10 here, 1 of 1,252 across the directory

- **Ships a CLI**: 0 of 10 official, 0 community only, 10 none found, harvested 2026-09-17

- **GitHub organisation**: none tied to npmjs.com with evidence on 2026-09-15
...
# ManyContacts MCP Server MCP (Model Context Protocol) server for [ManyContacts](https://manycontacts.com) - the WhatsApp Business CRM. Enables AI agents (Claude, Cursor, Windsurf, etc.) to manage contacts, send WhatsApp messages, run campaigns, configure AI...
...
A Salesforce connector MCP Server. Forked from @tsmztech/mcp-server-salesforce
...
10 of 10 gate unknown, not established from public sources and published as unknown.
