# Dex: products, MCP servers and connect URLs, one vendor page

> Dex (getdex.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [getdex.com](https://getdex.com) · vendor page id getdex-com
...
- **GitHub organisation**: none tied to getdex.com with evidence on 2026-09-15
...
### [Dex](../tools/dex.md) dex official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/dex.md).
