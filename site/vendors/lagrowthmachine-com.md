# La Growth Machine: products, MCP servers and connect URLs, one vendor page

> La Growth Machine (lagrowthmachine.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 34 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [lagrowthmachine.com](https://lagrowthmachine.com) · vendor page id lagrowthmachine-com
...
- **Connect URL**: [https://github.com/LaGrowthMachine/gtm-system](https://github.com/LaGrowthMachine/gtm-system) (docs page)
