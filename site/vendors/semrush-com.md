# Semrush: products, MCP servers and connect URLs, one vendor page

> Semrush (semrush.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [semrush.com](https://semrush.com) · vendor page id semrush-com
...
- **GitHub organisation**: none tied to semrush.com with evidence on 2026-09-15
...
### [Semrush](../tools/semrush.md) semrush-cli community CLI
...
harvested 2026-09-26, all on the [tool page](../tools/semrush.md).
