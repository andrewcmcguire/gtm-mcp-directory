# AstroFabric MCP: products, MCP servers and connect URLs, one vendor page

> AstroFabric MCP (astrofabric.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [astrofabric.ai](https://astrofabric.ai) · vendor page id astrofabric-ai
...
- **GitHub organisation**: none tied to astrofabric.ai with evidence on 2026-09-15
...
### [AstroFabric MCP](../tools/astrofabric-mcp.md) af official CLI
...
Login or key hint: astrofabric login --key ek_live_...

9 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/astrofabric-mcp.md).
