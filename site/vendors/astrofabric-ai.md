...
> AstroFabric MCP (astrofabric.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-21.
...
### [AstroFabric MCP](../tools/astrofabric-mcp.md) astrofabric official CLI
...
9 subcommands seen, harvested 2026-09-18, all on the [tool page](../tools/astrofabric-mcp.md).
