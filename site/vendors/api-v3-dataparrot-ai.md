# Data Parrot AI Revenue Analyst: products, MCP servers and connect URLs, one vendor page

> Data Parrot AI Revenue Analyst (api-v3.dataparrot.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Data Parrot AI Revenue Analyst
...
Vendor domain: [api-v3.dataparrot.ai](https://api-v3.dataparrot.ai) · vendor page id api-v3-dataparrot-ai
...
- **GitHub organisation**: none tied to api-v3.dataparrot.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to api-v3.dataparrot.ai with evidence on 2026-09-15.
