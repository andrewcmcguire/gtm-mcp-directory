# PitchIQ MCP: products, MCP servers and connect URLs, one vendor page

> PitchIQ MCP (chuhching.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [chuhching.com](https://chuhching.com) · vendor page id chuhching-com
...
- **GitHub organisation**: none tied to chuhching.com with evidence on 2026-09-15
