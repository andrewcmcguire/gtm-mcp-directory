# Enginy MCP: products, MCP servers and connect URLs, one vendor page

> Enginy MCP (openapi.enginy.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [openapi.enginy.ai](https://openapi.enginy.ai) · vendor page id openapi-enginy-ai
...
- **GitHub organisation**: none tied to openapi.enginy.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to openapi.enginy.ai with evidence on 2026-09-15.
