# Snov.io: products, MCP servers and connect URLs, one vendor page

> Snov.io (snov.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [snov.io](https://snov.io) · vendor page id snov-io
...
- **GitHub organisation**: none tied to snov.io with evidence on 2026-09-08
...
- **Connect URL**: [https://mcp.snov.io/mcp](https://mcp.snov.io/mcp) (endpoint)
...
- [https://mcp.snov.io/mcp](https://mcp.snov.io/mcp) (Snov.io, endpoint, probed 2026-09-04)
...
No GitHub organisation could be tied to snov.io with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: snovalleypa, snovvow, snova-labs, Snovibox, snovonetwork-hub. A name match alone is never accepted; the account has to point at the vendor domain.
