# UserGems: products, MCP servers and connect URLs, one vendor page

> UserGems (usergems.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [usergems.com](https://usergems.com) · vendor page id usergems-com
...
- **GitHub organisation**: [github.com/usergems](https://github.com/usergems), tied to the domain with evidence 2026-09-08
...
Tracks job changes of known contacts (past customers/champions moving to new companies) plus 30+ other native signals (new hires, promotions, funding, website visits, M&A) sourced from LinkedIn-style data providers and a customer's own CRM history, to surface...
...
- **Connect URL**: [https://www.usergems.com/product/mcp](https://www.usergems.com/product/mcp) (docs page)
...
- [https://www.usergems.com/product/mcp](https://www.usergems.com/product/mcp) (UserGems, docs page, probed 2026-09-04)
...
[github.com/usergems](https://github.com/usergems) tied to the vendor by rule 3, account website https://www.usergems.com has the vendor's domain, confidence strong
