# AnchoredIP: products, MCP servers and connect URLs, one vendor page

> AnchoredIP (api.anchoredip.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 8 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [api.anchoredip.com](https://api.anchoredip.com) · vendor page id api-anchoredip-com
...
- **GitHub organisation**: none tied to api.anchoredip.com with evidence on 2026-09-15
