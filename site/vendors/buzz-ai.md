# Buzz: products, MCP servers and connect URLs, one vendor page

> Buzz (buzz.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [buzz.ai](https://buzz.ai) · vendor page id buzz-ai
...
- **GitHub organisation**: none tied to buzz.ai with evidence on 2026-09-15
...
AI Employee for outbound - email, LinkedIn, call
...
No GitHub organisation could be tied to buzz.ai with evidence on 2026-09-15.
