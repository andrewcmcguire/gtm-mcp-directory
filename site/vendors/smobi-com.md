# Smobi: products, MCP servers and connect URLs, one vendor page

> Smobi (smobi.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [smobi.com](https://smobi.com) · vendor page id smobi-com
...
- **GitHub organisation**: none tied to smobi.com with evidence on 2026-09-15
...
Smobi is an AI-powered RCS & SMS marketing platform: branded, interactive texts with carousels, surveys, AI agents, built-in compliance, and SMS fallback.
...
No GitHub organisation could be tied to smobi.com with evidence on 2026-09-15.
