# Dealroom: products, MCP servers and connect URLs, one vendor page

> Dealroom (dealroom.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [dealroom.co](https://dealroom.co) · vendor page id dealroom-co
...
- **GitHub organisation**: none tied to dealroom.co with evidence on 2026-09-15
...
### [Dealroom](../tools/dealroom.md) ax-dealroom community CLI
...
harvested 2026-09-26, all on the [tool page](../tools/dealroom.md).
