# Derrick: products, MCP servers and connect URLs, one vendor page

> Derrick (derrick-app.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 5 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [derrick-app.com](https://derrick-app.com) · vendor page id derrick-app-com
...
- **GitHub organisation**: [github.com/DerrickAppOrg](https://github.com/DerrickAppOrg), tied to the domain with evidence 2026-09-08
...
A credit-metered B2B enrichment engine sold primarily as a Google Sheets add-on, plus a REST API and a hosted MCP server, covering email finding, mobile phone finding, LinkedIn profile lookup, company firmographics, website technology detection and the French...
...
### [Derrick](../tools/derrick.md) derrick community CLI
...
quoted from [https://www.npmjs.com/package/derrick-cli](https://www.npmjs.com/package/derrick-cli) on 2026-09-17, via npm, a third party source

harvested 2026-09-17, all on the [tool page](../tools/derrick.md).
