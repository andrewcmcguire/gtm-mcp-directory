# Consensus: products, MCP servers and connect URLs, one vendor page

> Consensus (goconsensus.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
Vendor domain: [goconsensus.com](https://goconsensus.com) · vendor page id goconsensus-com
...
- **GitHub organisation**: none tied to goconsensus.com with evidence on 2026-09-15
...
### [Consensus](../tools/consensus.md) consensus community CLI
...
1 more install command, harvested 2026-09-18, all on the [tool page](../tools/consensus.md).
