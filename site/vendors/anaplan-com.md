# Anaplan (PlanIQ / Anaplan Forecaster): products, MCP servers and connect URLs, one vendor page

> Anaplan (PlanIQ / Anaplan Forecaster) (anaplan.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 70 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [anaplan.com](https://anaplan.com) · vendor page id anaplan-com
...
- **Tools catalogued**: 70 named across 1 measured server, harvested 2026-09-14

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 0 community only, 1 none found, harvested 2026-09-14

- **GitHub organisation**: none tied to anaplan.com with evidence on 2026-09-08
...
Connected-planning platform whose AI forecasting engine - originally branded PlanIQ, now superseded by "Anaplan Forecaster" (launched October 2025) - generates time-series demand/sales/revenue forecasts that feed directly into a customer's broader Anaplan...
...
- **Connect URL**: [https://www.anaplan.com/platform/intelligence/](https://www.anaplan.com/platform/intelligence/) (docs page)

- **Tools catalogued**: 70 named, harvested 2026-09-14, catalogue fixed
...
- [https://www.anaplan.com/platform/intelligence/](https://www.anaplan.com/platform/intelligence/) (Anaplan (PlanIQ / Anaplan Forecaster), docs page, probed 2026-09-04)
