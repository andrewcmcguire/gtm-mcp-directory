...
> Anaplan (PlanIQ / Anaplan Forecaster) (anaplan.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 70 tools catalogued. Data baked 2026-09-08.
...
- **Tools catalogued**: 70 named across 1 measured server, harvested 2026-09-08
...
- **Tools catalogued**: 70 named, harvested 2026-09-08, catalogue fixed
...
### [Anaplan (PlanIQ / Anaplan Forecaster)](../tools/anaplan.md) community CLI

This is a third party's CLI. It was published by somebody other than the vendor, so it is that author's surface for the vendor's API and not the vendor's published surface. The two must not be read as the same thing.

harvested 2026-09-08, all on the [tool page](../tools/anaplan.md).
