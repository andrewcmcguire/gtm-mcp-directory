# Waalaxy: products, MCP servers and connect URLs, one vendor page

> Waalaxy (waalaxy.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 6 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [waalaxy.com](https://waalaxy.com) · vendor page id waalaxy-com
...
- **GitHub organisation**: none tied to waalaxy.com with evidence on 2026-09-08
...
- **Connect URL**: [https://docs.waalaxy.com/mcp-server](https://docs.waalaxy.com/mcp-server) (docs page)
...
- [https://docs.waalaxy.com/mcp-server](https://docs.waalaxy.com/mcp-server) (Waalaxy, docs page, probed 2026-09-04)
