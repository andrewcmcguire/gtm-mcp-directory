# Salesforce MCP by alfe: products, MCP servers and connect URLs, one vendor page

> Salesforce MCP by alfe (alfe.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [alfe.ai](https://alfe.ai) · vendor page id alfe-ai
...
- **GitHub organisation**: none tied to alfe.ai with evidence on 2026-09-15
...
### [Salesforce MCP by alfe](../tools/salesforce-mcp-by-alfe.md) alfe official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/salesforce-mcp-by-alfe.md).
