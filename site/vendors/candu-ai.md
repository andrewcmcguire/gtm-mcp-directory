# Candu: products, MCP servers and connect URLs, one vendor page

> Candu (candu.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [candu.ai](https://candu.ai) · vendor page id candu-ai
...
- **GitHub organisation**: none tied to candu.ai with evidence on 2026-09-15
