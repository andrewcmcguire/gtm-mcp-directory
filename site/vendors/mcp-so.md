# mcp.so: products, MCP servers and connect URLs, one vendor page

> mcp.so (mcp.so): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [mcp.so](https://mcp.so) · vendor page id mcp-so
...
- **GitHub organisation**: none tied to mcp.so with evidence on 2026-09-08
...
[MCP unknown](../mcp/unknown.md) · [Gate unknown](../gates/unknown.md)
...
No GitHub organisation could be tied to mcp.so with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: mcp-use, WebMCP-org, fastmcp-me, dcc-mcp, MCPI-Revival. A name match alone is never accepted; the account has to point at the vendor domain.
