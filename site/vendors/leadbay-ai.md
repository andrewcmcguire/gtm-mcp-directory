# Leadbay: products, MCP servers and connect URLs, one vendor page

> Leadbay (leadbay.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [leadbay.ai](https://leadbay.ai) · vendor page id leadbay-ai
...
- **GitHub organisation**: none tied to leadbay.ai with evidence on 2026-09-15
