# Reltio: products, MCP servers and connect URLs, one vendor page

> Reltio (reltio.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [reltio.com](https://reltio.com) · vendor page id reltio-com
...
- **GitHub organisation**: none tied to reltio.com with evidence on 2026-09-15
...
### [Reltio](../tools/reltio.md) app official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/reltio.md).
