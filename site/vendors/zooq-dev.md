# ZOOQ: products, MCP servers and connect URLs, one vendor page

> ZOOQ (zooq.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [zooq.dev](https://zooq.dev) · vendor page id zooq-dev
...
- **GitHub organisation**: none tied to zooq.dev with evidence on 2026-09-15
