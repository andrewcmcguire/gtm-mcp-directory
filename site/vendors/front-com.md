# Front: products, MCP servers and connect URLs, one vendor page

> Front (front.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [front.com](https://front.com) · vendor page id front-com
...
- **GitHub organisation**: none tied to front.com with evidence on 2026-09-08
...
A shared-inbox and customer-communication platform where email, SMS, social and chat land in team inboxes with assignment, internal comments and rules, and, since July 2026, an MCP server that lets an AI agent search and read conversations, draft and send...
