# Vibe Prospecting MCP: products, MCP servers and connect URLs, one vendor page

> Vibe Prospecting MCP (vibeprospecting.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [vibeprospecting.ai](https://vibeprospecting.ai) · vendor page id vibeprospecting-ai
...
- **GitHub organisation**: none tied to vibeprospecting.ai with evidence on 2026-09-15
