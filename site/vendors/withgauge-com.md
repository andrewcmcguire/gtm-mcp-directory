# Gauge: products, MCP servers and connect URLs, one vendor page

> Gauge (withgauge.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [withgauge.com](https://withgauge.com) · vendor page id withgauge-com
...
- **GitHub organisation**: none tied to withgauge.com with evidence on 2026-09-15
...
### [Gauge](../tools/gauge.md) gauge official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/gauge.md).
