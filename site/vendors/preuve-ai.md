# Preuve: products, MCP servers and connect URLs, one vendor page

> Preuve (preuve.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [preuve.ai](https://preuve.ai) · vendor page id preuve-ai
...
- **GitHub organisation**: none tied to preuve.ai with evidence on 2026-09-15
