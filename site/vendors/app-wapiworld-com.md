# Wapiworld: products, MCP servers and connect URLs, one vendor page

> Wapiworld (app.wapiworld.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [app.wapiworld.com](https://app.wapiworld.com) · vendor page id app-wapiworld-com
...
- **GitHub organisation**: none tied to app.wapiworld.com with evidence on 2026-09-15
...
### [Wapiworld](../tools/wapiworld.md) wapiworld official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/wapiworld.md).
