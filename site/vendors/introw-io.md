# Introw: products, MCP servers and connect URLs, one vendor page

> Introw (introw.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [introw.io](https://introw.io) · vendor page id introw-io
...
- **GitHub organisation**: none tied to introw.io with evidence on 2026-09-15
