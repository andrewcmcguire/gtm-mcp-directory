...
> Kairon (heykairon.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
quoted from [https://heykairon.com/cli](https://heykairon.com/cli) on 2026-09-17, via npm

Login or key hint: kairon login

3 more install commands, 40 subcommands seen, harvested 2026-09-17, all on the [tool page](../tools/kairon.md).
