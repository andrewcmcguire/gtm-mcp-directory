# Kairon: products, MCP servers and connect URLs, one vendor page

> Kairon (heykairon.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [heykairon.com](https://heykairon.com) · vendor page id heykairon-com
...
- **GitHub organisation**: none tied to heykairon.com with evidence on 2026-09-15
...
### [Kairon](../tools/kairon.md) kairon official CLI
...
Login or key hint: kairon login

3 more install commands, 40 subcommands seen, harvested 2026-09-15, all on the [tool page](../tools/kairon.md).
