# Accord: products, MCP servers and connect URLs, one vendor page

> Accord (inaccord.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-21.
...
Vendor domain: [inaccord.com](https://inaccord.com) · vendor page id inaccord-com
...
- **GitHub organisation**: none tied to inaccord.com with evidence on 2026-09-15
...
### [Accord](../tools/accord.md) accord-cms community CLI
...
2 more install commands, harvested 2026-09-18, all on the [tool page](../tools/accord.md).
