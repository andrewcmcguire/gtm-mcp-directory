# GetDialer: products, MCP servers and connect URLs, one vendor page

> GetDialer (getdialer.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [getdialer.app](https://getdialer.app) · vendor page id getdialer-app
...
- **GitHub organisation**: none tied to getdialer.app with evidence on 2026-09-15
...
No GitHub organisation could be tied to getdialer.app with evidence on 2026-09-15.
