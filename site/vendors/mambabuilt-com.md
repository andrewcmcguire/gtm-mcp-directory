# Mamba GTM Job Discovery MCP: products, MCP servers and connect URLs, one vendor page

> Mamba GTM Job Discovery MCP (mambabuilt.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mambabuilt.com](https://mambabuilt.com) · vendor page id mambabuilt-com
...
- **GitHub organisation**: none tied to mambabuilt.com with evidence on 2026-09-15
...
Developer tools for GTM data enrichment. Apify actors and MCP servers for hiring signals, tech stack detection, ICP scoring, firmographics, deliverability, and company intelligence. Pay per result, flat JSON output, built for Clay.
...
No GitHub organisation could be tied to mambabuilt.com with evidence on 2026-09-15.
