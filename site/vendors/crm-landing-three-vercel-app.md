# FounderStack CRM: products, MCP servers and connect URLs, one vendor page

> FounderStack CRM (crm-landing-three.vercel.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [crm-landing-three.vercel.app](https://crm-landing-three.vercel.app) · vendor page id crm-landing-three-vercel-app
...
- **GitHub organisation**: none tied to crm-landing-three.vercel.app with evidence on 2026-09-15
