# Alysio: products, MCP servers and connect URLs, one vendor page

> Alysio (alysio.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [alysio.ai](https://alysio.ai) · vendor page id alysio-ai
...
- **GitHub organisation**: none tied to alysio.ai with evidence on 2026-09-15
...
Alysio is the GTM AI Workspace powered by a Context Engine. Connect Salesforce, HubSpot and Gong using MCP and deploy revenue automation agents in plain English.
...
No GitHub organisation could be tied to alysio.ai with evidence on 2026-09-15.
