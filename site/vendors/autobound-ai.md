# Autobound: products, MCP servers and connect URLs, one vendor page

> Autobound (autobound.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 7 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [autobound.ai](https://autobound.ai) · vendor page id autobound-ai
...
- **GitHub organisation**: [github.com/autobound](https://github.com/autobound), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://www.autobound.ai/integrations/mcp](https://www.autobound.ai/integrations/mcp) (docs page)
...
- [https://www.autobound.ai/integrations/mcp](https://www.autobound.ai/integrations/mcp) (Autobound, docs page, probed 2026-09-04)
...
[github.com/autobound](https://github.com/autobound) tied to the vendor by rule 3, account website www.autobound.ai has the vendor's domain, confidence strong
