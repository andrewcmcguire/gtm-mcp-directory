# dbt (dbt platform remote MCP): products, MCP servers and connect URLs, one vendor page

> dbt (dbt platform remote MCP) (getdbt.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [getdbt.com](https://getdbt.com) · vendor page id getdbt-com
...
- **GitHub organisation**: [github.com/dbt-labs](https://github.com/dbt-labs), tied to the domain with evidence 2026-09-08
...
### [dbt (dbt platform remote MCP)](../tools/dbt.md) dbt official CLI

```
pip install dbt
```

quoted from [https://pypi.org/project/dbt/](https://pypi.org/project/dbt/) on 2026-09-15, via pypi

harvested 2026-09-15, all on the [tool page](../tools/dbt.md).
