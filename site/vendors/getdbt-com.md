...
> dbt (dbt platform remote MCP) (getdbt.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-08.
...
harvested 2026-09-08, all on the [tool page](../tools/dbt.md).
