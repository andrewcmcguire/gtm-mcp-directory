# Landbot: products, MCP servers and connect URLs, one vendor page

> Landbot (landbot.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 13 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [landbot.io](https://landbot.io) · vendor page id landbot-io
...
- **Tools catalogued**: 13 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: none tied to landbot.io with evidence on 2026-09-08
...
- **Connect URL**: [https://composio.dev/toolkits/landbot](https://composio.dev/toolkits/landbot) (docs page)

- **Tools catalogued**: 13 named, harvested 2026-09-17, catalogue fixed
...
- [https://composio.dev/toolkits/landbot](https://composio.dev/toolkits/landbot) (Landbot, docs page, probed 2026-09-04)
