# GTM Alpha MCP: products, MCP servers and connect URLs, one vendor page

> GTM Alpha MCP (gtmalpha.netlify.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [gtmalpha.netlify.app](https://gtmalpha.netlify.app) · vendor page id gtmalpha-netlify-app
...
- **GitHub organisation**: none tied to gtmalpha.netlify.app with evidence on 2026-09-15
...
Best AI GTM and Fractional CMO in India, APAC and US region. Professional MCP server by Shashwat Ghosh, Top 30 PLG Creator Worldwide. EPIC framework-powered AI consulting for B2B tech and ITES companies.
...
No GitHub organisation could be tied to gtmalpha.netlify.app with evidence on 2026-09-15.
