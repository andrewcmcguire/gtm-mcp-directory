# Loopio: products, MCP servers and connect URLs, one vendor page

> Loopio (loopio.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 16 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [loopio.com](https://loopio.com) · vendor page id loopio-com
...
- **Tools catalogued**: 16 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: none tied to loopio.com with evidence on 2026-09-08
...
- **Connect URL**: [https://github.com/fredericboyer/loopio-mcp](https://github.com/fredericboyer/loopio-mcp) (docs page)

- **Tools catalogued**: 16 named, harvested 2026-09-17, catalogue fixed
...
- [https://github.com/fredericboyer/loopio-mcp](https://github.com/fredericboyer/loopio-mcp) (Loopio, docs page, probed 2026-09-04)
