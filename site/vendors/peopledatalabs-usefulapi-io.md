# People Data Labs MCP by UsefulAPI: products, MCP servers and connect URLs, one vendor page

> People Data Labs MCP by UsefulAPI (peopledatalabs.usefulapi.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [peopledatalabs.usefulapi.io](https://peopledatalabs.usefulapi.io) · vendor page id peopledatalabs-usefulapi-io
...
- **GitHub organisation**: none tied to peopledatalabs.usefulapi.io with evidence on 2026-09-15
...
No GitHub organisation could be tied to peopledatalabs.usefulapi.io with evidence on 2026-09-15.
