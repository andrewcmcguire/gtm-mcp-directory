# Granola: products, MCP servers and connect URLs, one vendor page

> Granola (granola.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-12.
...
Vendor domain: [granola.ai](https://granola.ai) · vendor page id granola-ai
...
- **GitHub organisation**: none tied to granola.ai with evidence on 2026-09-08
...
### [Granola](../tools/granola.md) granola community CLI
...
quoted from [https://www.npmjs.com/package/granola-cli](https://www.npmjs.com/package/granola-cli) on 2026-09-12, via npm, a third party source

4 more install commands, harvested 2026-09-12, all on the [tool page](../tools/granola.md).
