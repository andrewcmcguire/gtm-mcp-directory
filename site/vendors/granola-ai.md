...
> Granola (granola.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-10.
...
4 more install commands, harvested 2026-09-10, all on the [tool page](../tools/granola.md).
