# SilkChart: products, MCP servers and connect URLs, one vendor page

> SilkChart (silkchart.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [silkchart.com](https://silkchart.com) · vendor page id silkchart-com
...
- **GitHub organisation**: none tied to silkchart.com with evidence on 2026-09-15
