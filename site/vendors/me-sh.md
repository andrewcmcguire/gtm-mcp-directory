# Mesh: products, MCP servers and connect URLs, one vendor page

> Mesh (me.sh): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [me.sh](https://me.sh) · vendor page id me-sh
...
- **GitHub organisation**: none tied to me.sh with evidence on 2026-09-15
...
No GitHub organisation could be tied to me.sh with evidence on 2026-09-15.
