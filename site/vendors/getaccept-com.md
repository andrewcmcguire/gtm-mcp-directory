# GetAccept: products, MCP servers and connect URLs, one vendor page

> GetAccept (getaccept.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [getaccept.com](https://getaccept.com) · vendor page id getaccept-com

**The rollup**

- **Products**: 1, facts checked by hand 2026-09-02

- **Official MCP servers**: 0 of 1, as recorded on 2026-09-02
...
- **GitHub organisation**: [github.com/getaccept](https://github.com/getaccept), tied to the domain with evidence 2026-09-08
