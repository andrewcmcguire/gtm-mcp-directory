# OpenHelm Email Outreach MCP: products, MCP servers and connect URLs, one vendor page

> OpenHelm Email Outreach MCP (mcp.openhelm.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.openhelm.ai](https://mcp.openhelm.ai) · vendor page id mcp-openhelm-ai
...
- **GitHub organisation**: none tied to mcp.openhelm.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to mcp.openhelm.ai with evidence on 2026-09-15.
