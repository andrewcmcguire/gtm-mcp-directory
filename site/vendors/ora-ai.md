# Ora: products, MCP servers and connect URLs, one vendor page

> Ora (ora.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [ora.ai](https://ora.ai) · vendor page id ora-ai
...
- **GitHub organisation**: none tied to ora.ai with evidence on 2026-09-15
...
### [Ora](../tools/ora.md) ora official CLI
...
Login or key hint: --api-key

3 more install commands, 1 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/ora.md).
