...
> Ora (ora.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
2 more install commands, 1 subcommands seen, harvested 2026-09-18, all on the [tool page](../tools/ora.md).
