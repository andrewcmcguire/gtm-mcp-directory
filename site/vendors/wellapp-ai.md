# Well: products, MCP servers and connect URLs, one vendor page

> Well (wellapp.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [wellapp.ai](https://wellapp.ai) · vendor page id wellapp-ai
...
- **GitHub organisation**: none tied to wellapp.ai with evidence on 2026-09-15
