# Talkwalker (rebranded: Lumen by Talkwalker): products, MCP servers and connect URLs, one vendor page

> Talkwalker (rebranded: Lumen by Talkwalker) (talkwalker.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [talkwalker.com](https://talkwalker.com) · vendor page id talkwalker-com
...
- **GitHub organisation**: none tied to talkwalker.com with evidence on 2026-09-08
...
- **Connect URL**: [https://www.hootsuite.com/integrations/mcp](https://www.hootsuite.com/integrations/mcp) (docs page)
...
- [https://www.hootsuite.com/integrations/mcp](https://www.hootsuite.com/integrations/mcp) (Talkwalker (rebranded: Lumen by Talkwalker), docs page, probed 2026-09-04)
...
No GitHub organisation could be tied to talkwalker.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

1 candidate account seen and rejected by the evidence rules: talkwalker. A name match alone is never accepted; the account has to point at the vendor domain.
