...
> Tally (tally.so): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-08.
...
### [Tally](../tools/tally.md) tally community CLI
...
Login or key hint: tally login --api-key tly_xxx

1 more install command, 7 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/tally.md).
