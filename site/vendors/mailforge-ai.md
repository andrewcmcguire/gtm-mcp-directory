# Mailforge: products, MCP servers and connect URLs, one vendor page

> Mailforge (mailforge.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [mailforge.ai](https://mailforge.ai) · vendor page id mailforge-ai
