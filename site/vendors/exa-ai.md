...
> Exa (exa.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 11 tools catalogued. Data baked 2026-09-10.
...
quoted from [https://pypi.org/project/exa-cli/](https://pypi.org/project/exa-cli/) on 2026-09-10, via pypi, a third party source

harvested 2026-09-10, all on the [tool page](../tools/exa.md).
