# Email Outreach by OpenHelm: products, MCP servers and connect URLs, one vendor page

> Email Outreach by OpenHelm (openhelm.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [openhelm.ai](https://openhelm.ai) · vendor page id openhelm-ai
...
- **GitHub organisation**: none tied to openhelm.ai with evidence on 2026-09-15
...
An email outreach MCP server for AI agents: research a recipient, draft and send a personalised email to accomplish an objective, then triage and reply to inbound responses automatically. Unlike an email inbox API, OpenHelm runs the whole conversation....
