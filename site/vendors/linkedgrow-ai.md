# LinkedGrow: products, MCP servers and connect URLs, one vendor page

> LinkedGrow (linkedgrow.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [linkedgrow.ai](https://linkedgrow.ai) · vendor page id linkedgrow-ai
...
- **GitHub organisation**: none tied to linkedgrow.ai with evidence on 2026-09-15
