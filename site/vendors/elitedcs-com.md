# GoHighLevel MCP by elitedcs: products, MCP servers and connect URLs, one vendor page

> GoHighLevel MCP by elitedcs (elitedcs.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [elitedcs.com](https://elitedcs.com) · vendor page id elitedcs-com
...
- **GitHub organisation**: none tied to elitedcs.com with evidence on 2026-09-15
...
GHL Command - run your entire GoHighLevel agency from Claude. 232 tools across 48 modules, the only tool that builds and audits GHL workflows by AI. $97/mo covers UNLIMITED sub-accounts on 3 machines - never billed per account. Save 5+ hours on your first...
...
No GitHub organisation could be tied to elitedcs.com with evidence on 2026-09-15.
