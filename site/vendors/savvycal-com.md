# SavvyCal: products, MCP servers and connect URLs, one vendor page

> SavvyCal (savvycal.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [savvycal.com](https://savvycal.com) · vendor page id savvycal-com
...
- **GitHub organisation**: [github.com/svycal](https://github.com/svycal), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/arturkoter/savvycal-mcp-server](https://github.com/arturkoter/savvycal-mcp-server) (docs page)
...
- [https://github.com/arturkoter/savvycal-mcp-server](https://github.com/arturkoter/savvycal-mcp-server) (SavvyCal, docs page, probed 2026-09-04)
