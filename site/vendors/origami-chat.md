# Origami: products, MCP servers and connect URLs, one vendor page

> Origami (origami.chat): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [origami.chat](https://origami.chat) · vendor page id origami-chat
...
- **GitHub organisation**: none tied to origami.chat with evidence on 2026-09-15
...
### [Origami](../tools/origami.md) ori community CLI
...
harvested 2026-09-17, all on the [tool page](../tools/origami.md).
