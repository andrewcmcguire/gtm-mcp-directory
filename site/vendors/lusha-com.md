# Lusha: products, MCP servers and connect URLs, one vendor page

> Lusha (lusha.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 8 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [lusha.com](https://lusha.com) · vendor page id lusha-com
...
- **Connect URL**: [https://github.com/lusha-oss/lusha-public-api-mcp](https://github.com/lusha-oss/lusha-public-api-mcp) (docs page)
