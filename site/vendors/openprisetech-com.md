# Openprise: products, MCP servers and connect URLs, one vendor page

> Openprise (openprisetech.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [openprisetech.com](https://openprisetech.com) · vendor page id openprisetech-com
...
- **GitHub organisation**: [github.com/Openprise](https://github.com/Openprise), tied to the domain with evidence 2026-09-08
