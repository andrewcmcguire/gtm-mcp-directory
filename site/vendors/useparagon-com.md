...
> Paragon (ActionKit MCP) (useparagon.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
quoted from [https://www.npmjs.com/package/@useparagon/cli](https://www.npmjs.com/package/@useparagon/cli) on 2026-09-18, via npm

1 more install command, harvested 2026-09-18, all on the [tool page](../tools/paragon.md).
