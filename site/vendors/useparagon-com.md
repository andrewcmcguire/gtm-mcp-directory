# Paragon (ActionKit MCP): products, MCP servers and connect URLs, one vendor page

> Paragon (ActionKit MCP) (useparagon.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [useparagon.com](https://useparagon.com) · vendor page id useparagon-com
...
An embedded integration platform for SaaS products, whose ActionKit product exposes a stated 1,000-plus actions across 130-plus third-party applications through one API and one MCP server, with Paragon handling the OAuth prompts inside the customer's own...
...
### [Paragon (ActionKit MCP)](../tools/paragon.md) para official CLI

```
npm install -g @useparagon/cli
```

quoted from [https://www.npmjs.com/package/@useparagon/cli](https://www.npmjs.com/package/@useparagon/cli) on 2026-09-15, via npm

1 more install command, harvested 2026-09-15, all on the [tool page](../tools/paragon.md).
