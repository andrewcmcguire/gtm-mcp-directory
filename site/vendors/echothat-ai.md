# Echo: products, MCP servers and connect URLs, one vendor page

> Echo (echothat.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [echothat.ai](https://echothat.ai) · vendor page id echothat-ai
...
- **GitHub organisation**: none tied to echothat.ai with evidence on 2026-09-15
