# Terrakotta: products, MCP servers and connect URLs, one vendor page

> Terrakotta (terrakotta.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [terrakotta.ai](https://terrakotta.ai) · vendor page id terrakotta-ai
...
- **GitHub organisation**: none tied to terrakotta.ai with evidence on 2026-09-15
