# Phonic: products, MCP servers and connect URLs, one vendor page

> Phonic (phonic.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [phonic.ai](https://phonic.ai) · vendor page id phonic-ai
...
- **GitHub organisation**: none tied to phonic.ai with evidence on 2026-09-15
...
### [Phonic](../tools/phonic.md) phonic official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/phonic.md).
