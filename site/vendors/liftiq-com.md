# LiftIQ: products, MCP servers and connect URLs, one vendor page

> LiftIQ (liftiq.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [liftiq.com](https://liftiq.com) · vendor page id liftiq-com
...
- **GitHub organisation**: none tied to liftiq.com with evidence on 2026-09-15
...
Qualified leads and calls with pay-per-performance pricing. Owned properties, in-house DSP, and strategic partnerships delivering $100M+ annually.
...
No GitHub organisation could be tied to liftiq.com with evidence on 2026-09-15.
