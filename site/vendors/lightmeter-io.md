# Lightmeter: products, MCP servers and connect URLs, one vendor page

> Lightmeter (lightmeter.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [lightmeter.io](https://lightmeter.io) · vendor page id lightmeter-io
...
- **GitHub organisation**: none tied to lightmeter.io with evidence on 2026-09-15
