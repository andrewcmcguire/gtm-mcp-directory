# Serpent Salesforce DevOps MCP: products, MCP servers and connect URLs, one vendor page

> Serpent Salesforce DevOps MCP (mcp.serpent.cloud): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.serpent.cloud](https://mcp.serpent.cloud) · vendor page id mcp-serpent-cloud
...
- **GitHub organisation**: none tied to mcp.serpent.cloud with evidence on 2026-09-15
...
No GitHub organisation could be tied to mcp.serpent.cloud with evidence on 2026-09-15.
