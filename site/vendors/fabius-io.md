# Fabius: products, MCP servers and connect URLs, one vendor page

> Fabius (fabius.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [fabius.io](https://fabius.io) · vendor page id fabius-io
...
- **GitHub organisation**: none tied to fabius.io with evidence on 2026-09-15
