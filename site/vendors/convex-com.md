# Convex: products, MCP servers and connect URLs, one vendor page

> Convex (convex.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [convex.com](https://convex.com) · vendor page id convex-com
...
- **GitHub organisation**: none tied to convex.com with evidence on 2026-09-15
...
The only sales intelligence platform built for commercial services teams to reach decision-makers and win more deals across 5.9 M+ properties.
...
No GitHub organisation could be tied to convex.com with evidence on 2026-09-15.
