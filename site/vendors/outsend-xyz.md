# OutSend: products, MCP servers and connect URLs, one vendor page

> OutSend (outsend.xyz): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [outsend.xyz](https://outsend.xyz) · vendor page id outsend-xyz
...
- **GitHub organisation**: none tied to outsend.xyz with evidence on 2026-09-15
