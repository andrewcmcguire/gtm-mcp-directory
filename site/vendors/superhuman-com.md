# Superhuman: products, MCP servers and connect URLs, one vendor page

> Superhuman (superhuman.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [superhuman.com](https://superhuman.com) · vendor page id superhuman-com
...
- **GitHub organisation**: none tied to superhuman.com with evidence on 2026-09-15
...
### [Superhuman](../tools/superhuman.md) superhuman community CLI
...
harvested 2026-09-17, all on the [tool page](../tools/superhuman.md).
