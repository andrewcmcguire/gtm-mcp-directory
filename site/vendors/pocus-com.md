# Pocus: products, MCP servers and connect URLs, one vendor page

> Pocus (pocus.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [pocus.com](https://pocus.com) · vendor page id pocus-com
...
- **GitHub organisation**: [github.com/pocus](https://github.com/pocus), tied to the domain with evidence 2026-09-08
...
Was a PLG/product-usage-signal platform - AI agents for account prioritization, an "intelligent inbox" for reps, and intent-signal enrichment aimed at turning free-trial/self-serve activity into sales-ready accounts.

[MCP not applicable](../mcp/n-a.md) · [Gate not applicable](../gates/n-a.md)
...
### [Pocus](../tools/pocus.md) pocus official CLI

```
npm install -g @pocus/cli
```

quoted from [https://www.npmjs.com/package/@pocus/cli](https://www.npmjs.com/package/@pocus/cli) on 2026-09-26, via npm

harvested 2026-09-26, all on the [tool page](../tools/pocus.md).
