# Motion: products, MCP servers and connect URLs, one vendor page

> Motion (usemotion.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 34 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [usemotion.com](https://usemotion.com) · vendor page id usemotion-com
...
- **GitHub organisation**: none tied to usemotion.com with evidence on 2026-09-08
...
- **Connect URL**: [https://github.com/RF-D/motion-mcp](https://github.com/RF-D/motion-mcp) (docs page)
...
- [https://github.com/RF-D/motion-mcp](https://github.com/RF-D/motion-mcp) (Motion, docs page, probed 2026-09-04)
