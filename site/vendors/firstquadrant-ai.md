# FirstQuadrant: products, MCP servers and connect URLs, one vendor page

> FirstQuadrant (firstquadrant.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [firstquadrant.ai](https://firstquadrant.ai) · vendor page id firstquadrant-ai
...
- **GitHub organisation**: none tied to firstquadrant.ai with evidence on 2026-09-15
