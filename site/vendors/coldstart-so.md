# Coldstart: products, MCP servers and connect URLs, one vendor page

> Coldstart (coldstart.so): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [coldstart.so](https://coldstart.so) · vendor page id coldstart-so
...
- **GitHub organisation**: none tied to coldstart.so with evidence on 2026-09-15
...
### [Coldstart](../tools/coldstart.md) coldstart community CLI
...
3 more install commands, harvested 2026-09-17, all on the [tool page](../tools/coldstart.md).
