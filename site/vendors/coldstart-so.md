...
> Coldstart (coldstart.so): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
quoted from [https://www.npmjs.com/package/@cstart/coldstart](https://www.npmjs.com/package/@cstart/coldstart) on 2026-09-26, via npm, a third party source

3 more install commands, harvested 2026-09-26, all on the [tool page](../tools/coldstart.md).
