# Twenty MCP by UsefulAPI: products, MCP servers and connect URLs, one vendor page

> Twenty MCP by UsefulAPI (twenty.usefulapi.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [twenty.usefulapi.io](https://twenty.usefulapi.io) · vendor page id twenty-usefulapi-io
...
- **GitHub organisation**: none tied to twenty.usefulapi.io with evidence on 2026-09-15
...
No GitHub organisation could be tied to twenty.usefulapi.io with evidence on 2026-09-15.
