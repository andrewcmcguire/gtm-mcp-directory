# Sprites: products, MCP servers and connect URLs, one vendor page

> Sprites (sprites.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [sprites.ai](https://sprites.ai) · vendor page id sprites-ai
...
- **GitHub organisation**: none tied to sprites.ai with evidence on 2026-09-15
