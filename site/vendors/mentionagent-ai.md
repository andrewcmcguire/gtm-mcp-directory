# MentionAgent: products, MCP servers and connect URLs, one vendor page

> MentionAgent (mentionagent.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mentionagent.ai](https://mentionagent.ai) · vendor page id mentionagent-ai
...
- **GitHub organisation**: none tied to mentionagent.ai with evidence on 2026-09-15
