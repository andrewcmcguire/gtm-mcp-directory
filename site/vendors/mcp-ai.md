# RD Station Marketing MCP: products, MCP servers and connect URLs, one vendor page

> RD Station Marketing MCP (mcp.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.ai](https://mcp.ai) · vendor page id mcp-ai
...
- **GitHub organisation**: none tied to mcp.ai with evidence on 2026-09-15
