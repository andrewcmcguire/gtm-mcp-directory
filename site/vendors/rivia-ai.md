# Rivia.AI: products, MCP servers and connect URLs, one vendor page

> Rivia.AI (rivia.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [rivia.ai](https://rivia.ai) · vendor page id rivia-ai
...
- **GitHub organisation**: none tied to rivia.ai with evidence on 2026-09-15
