# Nevent MCP: products, MCP servers and connect URLs, one vendor page

> Nevent MCP (nevent.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [nevent.ai](https://nevent.ai) · vendor page id nevent-ai
...
- **GitHub organisation**: none tied to nevent.ai with evidence on 2026-09-15
