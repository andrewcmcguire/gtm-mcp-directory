# FavCRM: products, MCP servers and connect URLs, one vendor page

> FavCRM (favcrm.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [favcrm.io](https://favcrm.io) · vendor page id favcrm-io
...
- **GitHub organisation**: none tied to favcrm.io with evidence on 2026-09-15
...
### [FavCRM](../tools/favcrm.md) favcrm official CLI

```
npm install -g @favcrm/cli
```

quoted from [https://www.npmjs.com/package/@favcrm/cli](https://www.npmjs.com/package/@favcrm/cli) on 2026-09-15, via npm

harvested 2026-09-15, all on the [tool page](../tools/favcrm.md).

A CLI being listed means the harvest found an install command or a package on a stated date. Nobody has run it. Every command is quoted verbatim from the URL beneath it.

**On GitHub**

No GitHub organisation could be tied to favcrm.io with evidence on 2026-09-15.
