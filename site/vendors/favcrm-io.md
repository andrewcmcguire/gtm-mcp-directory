...
> FavCRM (favcrm.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
quoted from [https://www.npmjs.com/package/@favcrm/cli](https://www.npmjs.com/package/@favcrm/cli) on 2026-09-17, via npm

harvested 2026-09-17, all on the [tool page](../tools/favcrm.md).
