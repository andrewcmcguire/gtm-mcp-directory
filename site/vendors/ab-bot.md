# Abbot: products, MCP servers and connect URLs, one vendor page

> Abbot (ab.bot): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [ab.bot](https://ab.bot) · vendor page id ab-bot
...
- **GitHub organisation**: none tied to ab.bot with evidence on 2026-09-15
