# Wokelo: products, MCP servers and connect URLs, one vendor page

> Wokelo (wokelo.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [wokelo.ai](https://wokelo.ai) · vendor page id wokelo-ai
...
- **GitHub organisation**: none tied to wokelo.ai with evidence on 2026-09-15
