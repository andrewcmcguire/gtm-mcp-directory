# CrispHive MCP: products, MCP servers and connect URLs, one vendor page

> CrispHive MCP (docs.crisphive.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [docs.crisphive.com](https://docs.crisphive.com) · vendor page id docs-crisphive-com
...
- **GitHub organisation**: none tied to docs.crisphive.com with evidence on 2026-09-15
