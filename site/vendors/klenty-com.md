# Klenty: products, MCP servers and connect URLs, one vendor page

> Klenty (klenty.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [klenty.com](https://klenty.com) · vendor page id klenty-com
...
- **GitHub organisation**: [github.com/klenty](https://github.com/klenty), tied to the domain with evidence 2026-09-08
