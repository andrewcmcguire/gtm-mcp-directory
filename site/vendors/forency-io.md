# Forency: products, MCP servers and connect URLs, one vendor page

> Forency (forency.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [forency.io](https://forency.io) · vendor page id forency-io
...
- **GitHub organisation**: none tied to forency.io with evidence on 2026-09-15
