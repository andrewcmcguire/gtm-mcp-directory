...
> MadKudu (madkudu.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 16 tools catalogued. Data baked 2026-09-17.
...
quoted from [https://www.npmjs.com/package/@madkudu-core-tools/vulnerator](https://www.npmjs.com/package/@madkudu-core-tools/vulnerator) on 2026-09-17, via npm

1 more install command, harvested 2026-09-17, all on the [tool page](../tools/madkudu.md).
