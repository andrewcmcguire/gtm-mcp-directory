# CloudFiles: products, MCP servers and connect URLs, one vendor page

> CloudFiles (cloudfiles.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
Vendor domain: [cloudfiles.io](https://cloudfiles.io) · vendor page id cloudfiles-io
...
- **GitHub organisation**: none tied to cloudfiles.io with evidence on 2026-09-15
...
### [CloudFiles](../tools/cloudfiles.md) cfmgr community CLI
...
1 more install command, harvested 2026-09-18, all on the [tool page](../tools/cloudfiles.md).
