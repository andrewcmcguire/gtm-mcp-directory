...
> CloudFiles (cloudfiles.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
1 more install command, harvested 2026-09-26, all on the [tool page](../tools/cloudfiles.md).
