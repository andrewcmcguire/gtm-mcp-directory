# myOPC: products, MCP servers and connect URLs, one vendor page

> myOPC (myopc.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
Vendor domain: [myopc.io](https://myopc.io) · vendor page id myopc-io
...
- **GitHub organisation**: none tied to myopc.io with evidence on 2026-09-15
...
All-in-one AI business platform with 28+ modules: CRM, inventory, accounting, sales orders, quotations, HR, payroll, tax compliance & e-invoicing. Bring your own AI key (BYOK) from 13 providers and connect AI assistants via MCP. From USD 8/month with a 7-day...
...
### [myOPC](../tools/myopc.md) myopc community CLI
...
harvested 2026-09-18, all on the [tool page](../tools/myopc.md).
