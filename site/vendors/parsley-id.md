# Parsley: products, MCP servers and connect URLs, one vendor page

> Parsley (parsley.id): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [parsley.id](https://parsley.id) · vendor page id parsley-id
...
- **GitHub organisation**: none tied to parsley.id with evidence on 2026-09-15
