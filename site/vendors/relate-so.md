# Relate: products, MCP servers and connect URLs, one vendor page

> Relate (relate.so): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [relate.so](https://relate.so) · vendor page id relate-so
...
- **GitHub organisation**: none tied to relate.so with evidence on 2026-09-15
