# LeadIQ: products, MCP servers and connect URLs, one vendor page

> LeadIQ (leadiq.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [leadiq.com](https://leadiq.com) · vendor page id leadiq-com
...
A B2B contact and company database with a Chrome extension for prospecting on LinkedIn and Sales Navigator, CRM enrichment, and champion-tracking (job-change) alerts, now also reachable as a verified Claude connector so prospect search and enrichment can be...
