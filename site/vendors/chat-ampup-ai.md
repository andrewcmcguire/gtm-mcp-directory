# AmpUp GTM Chat: products, MCP servers and connect URLs, one vendor page

> AmpUp GTM Chat (chat.ampup.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [chat.ampup.ai](https://chat.ampup.ai) · vendor page id chat-ampup-ai
...
- **GitHub organisation**: none tied to chat.ampup.ai with evidence on 2026-09-15
...
### [AmpUp GTM Chat](../tools/ampup-gtm-chat.md) ampup community CLI
...
harvested 2026-09-17, all on the [tool page](../tools/ampup-gtm-chat.md).
