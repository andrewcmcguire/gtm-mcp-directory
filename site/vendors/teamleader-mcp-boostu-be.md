# Teamleader MCP by BoostU: products, MCP servers and connect URLs, one vendor page

> Teamleader MCP by BoostU (teamleader-mcp.boostu.be): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [teamleader-mcp.boostu.be](https://teamleader-mcp.boostu.be) · vendor page id teamleader-mcp-boostu-be
...
- **GitHub organisation**: none tied to teamleader-mcp.boostu.be with evidence on 2026-09-15
...
De Teamleader MCP van BoostU brengt Teamleader Focus in Claude. Werk via je AI-assistent met de Teamleader Claude-koppeling op basis van het Model Context Protocol.
...
No GitHub organisation could be tied to teamleader-mcp.boostu.be with evidence on 2026-09-15.
