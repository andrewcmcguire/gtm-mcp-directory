# UpLead: products, MCP servers and connect URLs, one vendor page

> UpLead (uplead.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [uplead.com](https://uplead.com) · vendor page id uplead-com

**The rollup**

- **Products**: 1, facts checked by hand 2026-09-03

- **Official MCP servers**: 0 of 1, as recorded on 2026-09-03
...
- **GitHub organisation**: none tied to uplead.com with evidence on 2026-09-08
...
- **Connect URL**: [https://zapier.com/mcp/uplead](https://zapier.com/mcp/uplead) (docs page)
...
- [https://zapier.com/mcp/uplead](https://zapier.com/mcp/uplead) (UpLead, docs page, probed 2026-09-04)
...
No GitHub organisation could be tied to uplead.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

4 candidate accounts seen and rejected by the evidence rules: uplead, UpLeady, uplead-me, Uplead-Digital. A name match alone is never accepted; the account has to point at the vendor domain.
