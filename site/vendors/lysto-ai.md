# Lysto: products, MCP servers and connect URLs, one vendor page

> Lysto (lysto.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [lysto.ai](https://lysto.ai) · vendor page id lysto-ai
...
- **GitHub organisation**: none tied to lysto.ai with evidence on 2026-09-15
