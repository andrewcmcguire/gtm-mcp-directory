# Vidyard: products, MCP servers and connect URLs, one vendor page

> Vidyard (vidyard.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [vidyard.com](https://vidyard.com) · vendor page id vidyard-com
...
- **Ships a CLI**: 1 of 1 official, 0 community only, 0 none found, harvested 2026-09-15

- **GitHub organisation**: [github.com/Vidyard](https://github.com/Vidyard), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://viasocket.com/mcp/vidyard](https://viasocket.com/mcp/vidyard) (docs page)
...
- [https://viasocket.com/mcp/vidyard](https://viasocket.com/mcp/vidyard) (Vidyard, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Vidyard](../tools/vidyard.md) vy-cli official CLI

```
npm install -g @vidyard/vy-cli
```

quoted from [https://www.npmjs.com/package/@vidyard/vy-cli](https://www.npmjs.com/package/@vidyard/vy-cli) on 2026-09-15, via npm

harvested 2026-09-15, all on the [tool page](../tools/vidyard.md).

A CLI being listed means the harvest found an install command or a package on a stated date. Nobody has run it. Every command is quoted verbatim from the URL beneath it.

**On GitHub**

[github.com/Vidyard](https://github.com/Vidyard) tied to the vendor by rule 3, account website www.vidyard.com has the vendor's domain, confidence strong
...
|---|---|---|---|---|---|
| [DesktopAppReleases](https://github.com/Vidyard/DesktopAppReleases) | app | To house official releases of the Vidyard Desktop App | 0 | 2026-05-11 | 2.3.5 |
| [.github](https://github.com/Vidyard/.github) | other | Public org repo | 0 | 2026-02-03 | |
| [wordpress-plugin](https://github.com/Vidyard/wordpress-plugin) | plugin or integration | | 2 | 2019-09-30 | |
| [dsm](https://github.com/Vidyard/dsm) | other | Online MySQL data migrations gem | 2 | 2017-04-18 | |
