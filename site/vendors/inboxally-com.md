# InboxAlly: products, MCP servers and connect URLs, one vendor page

> InboxAlly (inboxally.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [inboxally.com](https://inboxally.com) · vendor page id inboxally-com
...
- **GitHub organisation**: [github.com/InboxAlly](https://github.com/InboxAlly), tied to the domain with evidence 2026-09-08
...
[github.com/InboxAlly](https://github.com/InboxAlly) tied to the vendor by rule 3, account website www.inboxally.com has the vendor's domain, confidence strong
...
|---|---|---|---|---|---|
| [ia-static-assets](https://github.com/InboxAlly/ia-static-assets) | other | public repo of misc static assets | 0 | 2026-06-03 | |
