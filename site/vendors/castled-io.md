# Castled.io: products, MCP servers and connect URLs, one vendor page

> Castled.io (castled.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [castled.io](https://castled.io) · vendor page id castled-io
...
- **GitHub organisation**: none tied to castled.io with evidence on 2026-09-15
