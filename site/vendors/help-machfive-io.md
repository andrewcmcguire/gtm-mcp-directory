# MachFive Cold Email MCP: products, MCP servers and connect URLs, one vendor page

> MachFive Cold Email MCP (help.machfive.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [help.machfive.io](https://help.machfive.io) · vendor page id help-machfive-io
...
- **GitHub organisation**: none tied to help.machfive.io with evidence on 2026-09-15
