# Icypeas: products, MCP servers and connect URLs, one vendor page

> Icypeas (icypeas.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [icypeas.com](https://icypeas.com) · vendor page id icypeas-com
...
- **GitHub organisation**: none tied to icypeas.com with evidence on 2026-09-15
...
Icypeas helps B2B teams find and verify professional email addresses, enrich leads with accurate data, and identify LinkedIn profiles at scale - via web app or fast API.
...
No GitHub organisation could be tied to icypeas.com with evidence on 2026-09-15.
