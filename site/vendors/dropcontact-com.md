# Dropcontact: products, MCP servers and connect URLs, one vendor page

> Dropcontact (dropcontact.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [dropcontact.com](https://dropcontact.com) · vendor page id dropcontact-com
...
- **GitHub organisation**: none tied to dropcontact.com with evidence on 2026-09-08
...
A France-based, GDPR-oriented contact enrichment and email-finding/verification service that takes a name plus company (name, domain, or LinkedIn URL) and returns a verified professional email plus cleaned company data, with batch processing of up to 250...
...
- **Connect URL**: [https://www.dropcontact.com/mcp-dropcontact](https://www.dropcontact.com/mcp-dropcontact) (docs page)
...
- [https://www.dropcontact.com/mcp-dropcontact](https://www.dropcontact.com/mcp-dropcontact) (Dropcontact, docs page, probed 2026-09-04)
...
No GitHub organisation could be tied to dropcontact.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

1 candidate account seen and rejected by the evidence rules: dropcontact-d. A name match alone is never accepted; the account has to point at the vendor domain.
