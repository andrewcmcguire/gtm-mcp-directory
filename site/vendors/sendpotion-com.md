# Potion: products, MCP servers and connect URLs, one vendor page

> Potion (sendpotion.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [sendpotion.com](https://sendpotion.com) · vendor page id sendpotion-com
...
- **GitHub organisation**: none tied to sendpotion.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to sendpotion.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: Potion, Potion-Studios, elixirator, PoTION-project, techpotion. A name match alone is never accepted; the account has to point at the vendor domain.
