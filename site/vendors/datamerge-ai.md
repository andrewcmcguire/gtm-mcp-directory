# DataMerge: products, MCP servers and connect URLs, one vendor page

> DataMerge (datamerge.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [datamerge.ai](https://datamerge.ai) · vendor page id datamerge-ai
...
- **GitHub organisation**: none tied to datamerge.ai with evidence on 2026-09-15
