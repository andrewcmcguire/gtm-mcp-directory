# AgentMail: products, MCP servers and connect URLs, one vendor page

> AgentMail (agentmail.to): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [agentmail.to](https://agentmail.to) · vendor page id agentmail-to
...
- **GitHub organisation**: none tied to agentmail.to with evidence on 2026-09-15
...
### [AgentMail](../tools/agentmail.md) agentmail official CLI
...
1 more install command, harvested 2026-09-26, all on the [tool page](../tools/agentmail.md).
