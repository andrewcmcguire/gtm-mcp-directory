# Salesroom: products, MCP servers and connect URLs, one vendor page

> Salesroom (salesroom.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [salesroom.com](https://salesroom.com) · vendor page id salesroom-com
...
- **GitHub organisation**: [github.com/SalesroomInc](https://github.com/SalesroomInc), tied to the domain with evidence 2026-09-08
...
Real-time AI video-conferencing platform for sales calls that coaches reps live against playbooks (MEDDIC, Challenger, BANT, Sandler) during the meeting.
...
[github.com/SalesroomInc](https://github.com/SalesroomInc) tied to the vendor by rule 3, account website https://www.salesroom.com has the vendor's domain, confidence strong
