# Crossbeam: products, MCP servers and connect URLs, one vendor page

> Crossbeam (crossbeam.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-12.
...
Vendor domain: [crossbeam.com](https://crossbeam.com) · vendor page id crossbeam-com
...
- **GitHub organisation**: [github.com/getcrossbeam](https://github.com/getcrossbeam), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://mcp.crossbeam.com/mcp](https://mcp.crossbeam.com/mcp) (endpoint)
...
- [https://mcp.crossbeam.com/mcp](https://mcp.crossbeam.com/mcp) (Crossbeam, endpoint, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Crossbeam](../tools/crossbeam.md) crossbeam community CLI

This is a third party's CLI. It was published by somebody other than the vendor, so it is that author's surface for the vendor's API and not the vendor's published surface. The two must not be read as the same thing.

```
npm install -g crossbeam-cli
```

quoted from [https://www.npmjs.com/package/crossbeam-cli](https://www.npmjs.com/package/crossbeam-cli) on 2026-09-12, via npm, a third party source

harvested 2026-09-12, all on the [tool page](../tools/crossbeam.md).

A CLI being listed means the harvest found an install command or a package on a stated date. Nobody has run it. Every command is quoted verbatim from the URL beneath it.

**On GitHub**

[github.com/getcrossbeam](https://github.com/getcrossbeam) tied to the vendor by rule 3, account website https://www.crossbeam.com/ has the vendor's domain, confidence strong
...
|---|---|---|---|---|---|
| [crossbeam-claude-skills](https://github.com/getcrossbeam/crossbeam-claude-skills) | other | Public bank of Crossbeam Claude AI skills | 0 | 2026-09-04 | crossbeam-skills--v1.0.0 |
| [crossbeam-plugin](https://github.com/getcrossbeam/crossbeam-plugin) | plugin or integration | Public Crossbeam plugin for Claude, scoped to skills that use the Crossbeam MCP | 0 | 2026-08-27 | v1.0.0 |
