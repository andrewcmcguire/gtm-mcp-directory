...
> Crossbeam (crossbeam.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-08.
...
quoted from [https://www.npmjs.com/package/crossbeam-cli](https://www.npmjs.com/package/crossbeam-cli) on 2026-09-08, via npm, a third party source

Login or key hint: Crossbeam login

1 more install command, 12 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/crossbeam.md).
