# Proposify: products, MCP servers and connect URLs, one vendor page

> Proposify (proposify.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [proposify.com](https://proposify.com) · vendor page id proposify-com
...
- **GitHub organisation**: [github.com/proposify](https://github.com/proposify), tied to the domain with evidence 2026-09-08
