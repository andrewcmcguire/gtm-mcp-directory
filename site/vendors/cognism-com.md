# Cognism: products, MCP servers and connect URLs, one vendor page

> Cognism (cognism.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [cognism.com](https://cognism.com) · vendor page id cognism-com
...
- **GitHub organisation**: [github.com/Cognism](https://github.com/Cognism), tied to the domain with evidence 2026-09-08
