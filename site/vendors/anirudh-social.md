# SuiteCRM MCP by Anirudhx7: products, MCP servers and connect URLs, one vendor page

> SuiteCRM MCP by Anirudhx7 (anirudh.social): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [anirudh.social](https://anirudh.social) · vendor page id anirudh-social
...
- **GitHub organisation**: none tied to anirudh.social with evidence on 2026-09-15
...
Open-source MCP server for SuiteCRM. Connect Claude, Cursor, or any AI agent to your CRM in 5 minutes. 24 tools, OAuth2, Prometheus. MIT licensed.
...
No GitHub organisation could be tied to anirudh.social with evidence on 2026-09-15.
