# Woodpecker: products, MCP servers and connect URLs, one vendor page

> Woodpecker (woodpecker.co): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 34 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [woodpecker.co](https://woodpecker.co) · vendor page id woodpecker-co
...
- **GitHub organisation**: [github.com/Woodpeckerco](https://github.com/Woodpeckerco), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://developers.woodpecker.co/docs/mcp/](https://developers.woodpecker.co/docs/mcp/) (docs page)
...
- [https://developers.woodpecker.co/docs/mcp/](https://developers.woodpecker.co/docs/mcp/) (Woodpecker, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Woodpecker](../tools/woodpecker.md) woodpecker official CLI

```
npm install -g @woodpecker.co/cli
```

quoted from [https://www.npmjs.com/package/@woodpecker.co/cli](https://www.npmjs.com/package/@woodpecker.co/cli) on 2026-09-14, via npm

harvested 2026-09-14, all on the [tool page](../tools/woodpecker.md).
