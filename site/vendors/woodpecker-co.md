...
> Woodpecker (woodpecker.co): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 34 tools catalogued. Data baked 2026-09-26.
...
- **Tools catalogued**: 34 named across 1 measured server, harvested 2026-09-26
...
- **Tools catalogued**: 34 named, harvested 2026-09-26, catalogue fixed
...
quoted from [https://www.npmjs.com/package/@woodpecker.co/cli](https://www.npmjs.com/package/@woodpecker.co/cli) on 2026-09-26, via npm

harvested 2026-09-26, all on the [tool page](../tools/woodpecker.md).
