# LinkedIn MCP by gtm-api: products, MCP servers and connect URLs, one vendor page

> LinkedIn MCP by gtm-api (gtm-api.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [gtm-api.com](https://gtm-api.com) · vendor page id gtm-api-com
...
- **GitHub organisation**: none tied to gtm-api.com with evidence on 2026-09-15
