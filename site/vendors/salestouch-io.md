# SalesTouch: products, MCP servers and connect URLs, one vendor page

> SalesTouch (salestouch.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [salestouch.io](https://salestouch.io) · vendor page id salestouch-io
...
- **GitHub organisation**: none tied to salestouch.io with evidence on 2026-09-15
...
### [SalesTouch](../tools/salestouch.md) salestouch official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/salestouch.md).
