...
> abm.dev (abm.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
### [abm.dev](../tools/abm-dev.md) abm-dev official CLI
...
5 subcommands seen, harvested 2026-09-15, all on the [tool page](../tools/abm-dev.md).
