# Kluster: products, MCP servers and connect URLs, one vendor page

> Kluster (kluster.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [kluster.com](https://kluster.com) · vendor page id kluster-com
...
- **GitHub organisation**: none tied to kluster.com with evidence on 2026-09-08
...
AI-native revenue forecasting and revenue-analytics platform for mid-market to enterprise SaaS companies - plugs into the CRM, ingests historical performance and activity data, and produces AI/statistical forecasts across new business, renewals, upsells, and...
