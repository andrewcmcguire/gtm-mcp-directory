# Retool: products, MCP servers and connect URLs, one vendor page

> Retool (retool.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 50 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [retool.com](https://retool.com) · vendor page id retool-com
...
- **Tools catalogued**: 50 named across 1 measured server, harvested 2026-09-26
...
- **GitHub organisation**: [github.com/tryretool](https://github.com/tryretool), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://retool.com/blog/retool-mcp-server](https://retool.com/blog/retool-mcp-server) (docs page)

- **Tools catalogued**: 50 named, harvested 2026-09-26, catalogue fixed
...
- [https://retool.com/blog/retool-mcp-server](https://retool.com/blog/retool-mcp-server) (Retool, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Retool](../tools/retool.md) retool official CLI

```
npm install -g @tryretool/cli
```

quoted from [https://www.npmjs.com/package/@tryretool/cli](https://www.npmjs.com/package/@tryretool/cli) on 2026-09-26, via npm

harvested 2026-09-26, all on the [tool page](../tools/retool.md).
