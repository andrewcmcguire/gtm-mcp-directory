# Resend: products, MCP servers and connect URLs, one vendor page

> Resend (resend.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [resend.com](https://resend.com) · vendor page id resend-com
...
- **GitHub organisation**: none tied to resend.com with evidence on 2026-09-15
...
### [Resend](../tools/resend.md) resend official CLI

```
npm install -g resend-cli
```

quoted from [https://resend.com/docs/cli](https://resend.com/docs/cli) on 2026-09-26, via npm

Login or key hint: resend login

2 more install commands, 22 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/resend.md).
