...
> Resend (resend.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
quoted from [https://resend.com/docs/cli](https://resend.com/docs/cli) on 2026-09-17, via npm

Login or key hint: resend login

2 more install commands, 22 subcommands seen, harvested 2026-09-17, all on the [tool page](../tools/resend.md).
