# Blackthorn Events: products, MCP servers and connect URLs, one vendor page

> Blackthorn Events (blackthorn.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [blackthorn.io](https://blackthorn.io) · vendor page id blackthorn-io
...
- **GitHub organisation**: none tied to blackthorn.io with evidence on 2026-09-15
