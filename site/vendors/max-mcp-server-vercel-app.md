# Max MCP by Digital Crew: products, MCP servers and connect URLs, one vendor page

> Max MCP by Digital Crew (max-mcp-server.vercel.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [max-mcp-server.vercel.app](https://max-mcp-server.vercel.app) · vendor page id max-mcp-server-vercel-app
...
- **GitHub organisation**: none tied to max-mcp-server.vercel.app with evidence on 2026-09-15
