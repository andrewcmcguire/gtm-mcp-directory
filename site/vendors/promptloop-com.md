# PromptLoop: products, MCP servers and connect URLs, one vendor page

> PromptLoop (promptloop.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [promptloop.com](https://promptloop.com) · vendor page id promptloop-com
...
- **GitHub organisation**: none tied to promptloop.com with evidence on 2026-09-15
...
### [PromptLoop](../tools/promptloop.md) promptloop official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/promptloop.md).
