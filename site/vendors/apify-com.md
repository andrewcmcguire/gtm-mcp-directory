...
> Apify (apify.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 23 tools catalogued. Data baked 2026-09-13.
...
- **Tools catalogued**: 23 named across 1 measured server, harvested 2026-09-13
...
- **Tools catalogued**: 23 named, harvested 2026-09-13, catalogue fixed
...
1 more install command, harvested 2026-09-13, all on the [tool page](../tools/apify.md).
