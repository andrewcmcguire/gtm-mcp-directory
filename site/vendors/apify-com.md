...
> Apify (apify.com): 3 products in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 30 tools catalogued. Data baked 2026-09-26.
...
- **Tools catalogued**: 30 named across 1 measured server, harvested 2026-09-26

- **Bench tested**: 0 of 3 here, 1 of 1,252 across the directory

- **Ships a CLI**: 3 of 3 official, 0 community only, 0 none found, harvested 2026-09-26
...
- **Tools catalogued**: 30 named, harvested 2026-09-26, catalogue fixed
...
harvested 2026-09-26, all on the [tool page](../tools/apify.md).
...
1 more install command, harvested 2026-09-26, all on the [tool page](../tools/google-maps-lead-mcp-by-nextgendata.md).
