...
> Apify (apify.com): 3 products in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 27 tools catalogued. Data baked 2026-09-20.
...
- **Tools catalogued**: 27 named across 1 measured server, harvested 2026-09-18

- **Bench tested**: 0 of 3 here, 1 of 1,252 across the directory

- **Ships a CLI**: 3 of 3 official, 0 community only, 0 none found, harvested 2026-09-18
...
- **Tools catalogued**: 27 named, harvested 2026-09-18, catalogue fixed
...
harvested 2026-09-18, all on the [tool page](../tools/apify.md).
...
quoted from [https://www.npmjs.com/package/apify-cli](https://www.npmjs.com/package/apify-cli) on 2026-09-18, via npm

1 more install command, harvested 2026-09-18, all on the [tool page](../tools/google-maps-lead-mcp-by-nextgendata.md).
