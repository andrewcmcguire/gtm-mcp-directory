# LeadSmarts: products, MCP servers and connect URLs, one vendor page

> LeadSmarts (bjmsxprjidjdyquiroxy.supabase.co): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [bjmsxprjidjdyquiroxy.supabase.co](https://bjmsxprjidjdyquiroxy.supabase.co) · vendor page id bjmsxprjidjdyquiroxy-supabase-co
...
- **GitHub organisation**: none tied to bjmsxprjidjdyquiroxy.supabase.co with evidence on 2026-09-15
...
No GitHub organisation could be tied to bjmsxprjidjdyquiroxy.supabase.co with evidence on 2026-09-15.
