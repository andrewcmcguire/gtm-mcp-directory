...
> Pipedream MCP (pipedream.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-18.
...
- **Tools catalogued**: 1 named, harvested 2026-09-18, catalogue dynamic, the server exposes the customer's own workspace
