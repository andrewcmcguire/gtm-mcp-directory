# Highspot: products, MCP servers and connect URLs, one vendor page

> Highspot (highspot.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-10.
...
Vendor domain: [highspot.com](https://highspot.com) · vendor page id highspot-com
...
- **Connect URL**: [https://www.highspot.com/product/mcp-server/](https://www.highspot.com/product/mcp-server/) (docs page)
...
quoted from [https://www.npmjs.com/package/highspot-cli](https://www.npmjs.com/package/highspot-cli) on 2026-09-10, via npm, a third party source

harvested 2026-09-10, all on the [tool page](../tools/highspot.md).
