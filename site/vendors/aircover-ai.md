# Aircover: products, MCP servers and connect URLs, one vendor page

> Aircover (aircover.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [aircover.ai](https://aircover.ai) · vendor page id aircover-ai
...
- **GitHub organisation**: none tied to aircover.ai with evidence on 2026-09-15
...
### [Aircover](../tools/aircover.md) aircover-pipeline official CLI
...
Login or key hint: endpoint auth

harvested 2026-09-26, all on the [tool page](../tools/aircover.md).
