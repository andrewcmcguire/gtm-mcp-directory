...
> Zapier (zapier.com): 2 products in The GTM MCP Directory, 2 with an official MCP server, 0 answering a live handshake, 15 tools catalogued. Data baked 2026-09-10.
...
- **Tools catalogued**: 15 named across 2 measured servers, harvested 2026-09-10
...
- **Tools catalogued**: 15 named, harvested 2026-09-10, catalogue dynamic, the server exposes the customer's own workspace
...
2 more install commands, harvested 2026-09-10, all on the [tool page](../tools/zapier.md).
