# Perspective AI: products, MCP servers and connect URLs, one vendor page

> Perspective AI (getperspective.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [getperspective.ai](https://getperspective.ai) · vendor page id getperspective-ai
...
- **GitHub organisation**: none tied to getperspective.ai with evidence on 2026-09-15
