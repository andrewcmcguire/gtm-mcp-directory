# Klarix Intelligence Engine: products, MCP servers and connect URLs, one vendor page

> Klarix Intelligence Engine (mcp.klarix.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 15 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.klarix.ai](https://mcp.klarix.ai) · vendor page id mcp-klarix-ai
...
- **Tools catalogued**: 15 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: none tied to mcp.klarix.ai with evidence on 2026-09-15
...
- **Tools catalogued**: 15 named, harvested 2026-09-17, catalogue fixed
