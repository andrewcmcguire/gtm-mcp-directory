# Birdie: products, MCP servers and connect URLs, one vendor page

> Birdie (getbirdie.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
Vendor domain: [getbirdie.io](https://getbirdie.io) · vendor page id getbirdie-io
...
- **GitHub organisation**: none tied to getbirdie.io with evidence on 2026-09-15
...
### [Birdie](../tools/birdie.md) butils community CLI

This is a third party's CLI. It was published by somebody other than the vendor, so it is that author's surface for the vendor's API and not the vendor's published surface. The two must not be read as the same thing.

```
npm install -g @birdiedata/butils
```

quoted from [https://www.npmjs.com/package/@birdiedata/butils](https://www.npmjs.com/package/@birdiedata/butils) on 2026-09-18, via npm, a third party source

harvested 2026-09-18, all on the [tool page](../tools/birdie.md).

A CLI being listed means the harvest found an install command or a package on a stated date. Nobody has run it. Every command is quoted verbatim from the URL beneath it.

**On GitHub**

No GitHub organisation could be tied to getbirdie.io with evidence on 2026-09-15.
