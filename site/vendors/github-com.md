...
> Model Context Protocol - official servers repo (github.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 24 tools catalogued. Data baked 2026-09-10.
...
- **Tools catalogued**: 24 named across 1 measured server, harvested 2026-09-10
...
- **Tools catalogued**: 24 named, harvested 2026-09-10, catalogue fixed
