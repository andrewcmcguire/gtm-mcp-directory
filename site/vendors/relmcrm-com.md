# Relm CRM: products, MCP servers and connect URLs, one vendor page

> Relm CRM (relmcrm.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [relmcrm.com](https://relmcrm.com) · vendor page id relmcrm-com
...
- **GitHub organisation**: none tied to relmcrm.com with evidence on 2026-09-15
...
### [Relm CRM](../tools/relm-crm.md) relmcrm official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/relm-crm.md).
