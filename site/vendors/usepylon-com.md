# Pylon: products, MCP servers and connect URLs, one vendor page

> Pylon (usepylon.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [usepylon.com](https://usepylon.com) · vendor page id usepylon-com
...
- **GitHub organisation**: none tied to usepylon.com with evidence on 2026-09-08
...
- **Connect URL**: [https://mcp.usepylon.com](https://mcp.usepylon.com) (endpoint)
...
- [https://mcp.usepylon.com](https://mcp.usepylon.com) (Pylon, endpoint, probed 2026-09-04)
...
No GitHub organisation could be tied to usepylon.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: pylon, Pylons, pylonmc, Pylons-tech, pylonbot. A name match alone is never accepted; the account has to point at the vendor domain.
