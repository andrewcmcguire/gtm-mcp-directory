# RecordX: products, MCP servers and connect URLs, one vendor page

> RecordX (recordx.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [recordx.io](https://recordx.io) · vendor page id recordx-io
...
- **GitHub organisation**: none tied to recordx.io with evidence on 2026-09-15
