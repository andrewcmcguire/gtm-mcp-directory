# Common Paper: products, MCP servers and connect URLs, one vendor page

> Common Paper (commonpaper.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [commonpaper.com](https://commonpaper.com) · vendor page id commonpaper-com
...
- **Connect URL**: [https://commonpaper.com/release-notes/common-paper-mcp-model-context-protocol-integration/](https://commonpaper.com/release-notes/common-paper-mcp-model-context-protocol-integration/) (docs page)
