# Vruum: products, MCP servers and connect URLs, one vendor page

> Vruum (vruum.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [vruum.ai](https://vruum.ai) · vendor page id vruum-ai
...
- **GitHub organisation**: none tied to vruum.ai with evidence on 2026-09-15
...
### [Vruum](../tools/vruum.md) vruum official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/vruum.md).
