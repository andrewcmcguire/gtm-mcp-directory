# Kordic CRM: products, MCP servers and connect URLs, one vendor page

> Kordic CRM (kordic.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [kordic.io](https://kordic.io) · vendor page id kordic-io
...
- **GitHub organisation**: none tied to kordic.io with evidence on 2026-09-15
