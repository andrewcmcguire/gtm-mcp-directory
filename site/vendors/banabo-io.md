# Banabo: products, MCP servers and connect URLs, one vendor page

> Banabo (banabo.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [banabo.io](https://banabo.io) · vendor page id banabo-io
...
- **GitHub organisation**: none tied to banabo.io with evidence on 2026-09-15
...
No GitHub organisation could be tied to banabo.io with evidence on 2026-09-15.
