# Intent Outreach: products, MCP servers and connect URLs, one vendor page

> Intent Outreach (demos.intentsolutions.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [demos.intentsolutions.io](https://demos.intentsolutions.io) · vendor page id demos-intentsolutions-io

**The rollup**

- **Products**: 1, facts checked by hand 2026-09-12

- **Official MCP servers**: 0 of 1, as recorded on 2026-09-12
...
- **GitHub organisation**: none tied to demos.intentsolutions.io with evidence on 2026-09-15
...
Intent Outreach runs outbound prospecting inside Claude Code: research, enrichment, and drafted outreach over your own provider accounts, with a typed validation gate in front of storage and a per-campaign cost meter. Includes a CFO one-pager with cited...
...
### [Intent Outreach](../tools/intent-outreach.md) j-rig official CLI
...
1 more install command, harvested 2026-09-15, all on the [tool page](../tools/intent-outreach.md).
