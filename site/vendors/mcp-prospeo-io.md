# Prospeo MCP: products, MCP servers and connect URLs, one vendor page

> Prospeo MCP (mcp.prospeo.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.prospeo.io](https://mcp.prospeo.io) · vendor page id mcp-prospeo-io
...
- **GitHub organisation**: none tied to mcp.prospeo.io with evidence on 2026-09-15
...
No GitHub organisation could be tied to mcp.prospeo.io with evidence on 2026-09-15.
