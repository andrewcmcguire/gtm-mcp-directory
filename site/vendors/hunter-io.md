# Hunter.io: products, MCP servers and connect URLs, one vendor page

> Hunter.io (hunter.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 6 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [hunter.io](https://hunter.io) · vendor page id hunter-io
...
- **Tools catalogued**: 6 named across 1 measured server, harvested 2026-09-14

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 0 community only, 1 none found, harvested 2026-09-14

- **GitHub organisation**: [github.com/hunter-io](https://github.com/hunter-io), tied to the domain with evidence 2026-09-08
...
An email-finding and verification tool - given a name, domain, or company, it locates likely professional email addresses (via domain pattern-matching and web-crawled data) and verifies deliverability; also offers bulk domain search and a separate...
...
- **Connect URL**: [https://hunter.io/api-documentation#mcp](https://hunter.io/api-documentation#mcp) (docs page)

- **Tools catalogued**: 6 named, harvested 2026-09-14, catalogue fixed
...
- [https://hunter.io/api-documentation#mcp](https://hunter.io/api-documentation#mcp) (Hunter.io, docs page, probed 2026-09-04)
