# Kubaru: products, MCP servers and connect URLs, one vendor page

> Kubaru (kubaru.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [kubaru.io](https://kubaru.io) · vendor page id kubaru-io
...
- **GitHub organisation**: none tied to kubaru.io with evidence on 2026-09-15
