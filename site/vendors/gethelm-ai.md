# Helm AI: products, MCP servers and connect URLs, one vendor page

> Helm AI (gethelm.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [gethelm.ai](https://gethelm.ai) · vendor page id gethelm-ai
...
- **GitHub organisation**: none tied to gethelm.ai with evidence on 2026-09-15
...
### [Helm AI](../tools/helm-ai.md) helm-ai official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/helm-ai.md).
