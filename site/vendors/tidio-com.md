# Tidio: products, MCP servers and connect URLs, one vendor page

> Tidio (tidio.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 4 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [tidio.com](https://tidio.com) · vendor page id tidio-com
...
- **GitHub organisation**: [github.com/TidioPoland](https://github.com/TidioPoland), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/TidioPoland/tidio-mcp-connector](https://github.com/TidioPoland/tidio-mcp-connector) (docs page)
...
- [https://github.com/TidioPoland/tidio-mcp-connector](https://github.com/TidioPoland/tidio-mcp-connector) (Tidio, docs page, probed 2026-09-04)
