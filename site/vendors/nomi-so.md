# Nomi: products, MCP servers and connect URLs, one vendor page

> Nomi (nomi.so): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [nomi.so](https://nomi.so) · vendor page id nomi-so
...
- **GitHub organisation**: none tied to nomi.so with evidence on 2026-09-15
