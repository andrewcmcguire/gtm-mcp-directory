# Champion: products, MCP servers and connect URLs, one vendor page

> Champion (championhq.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [championhq.com](https://championhq.com) · vendor page id championhq-com
...
- **GitHub organisation**: [github.com/championhq](https://github.com/championhq), tied to the domain with evidence 2026-09-08
...
Identifies and scores which existing customers are most engaged or most at risk, builds rich profiles of their expertise/preferences, and matches them to sales/CS deal contexts for reference requests, case studies, and expansion motions.
...
[github.com/championhq](https://github.com/championhq) tied to the vendor by rule 3, account website championhq.com has the vendor's domain, confidence strong
