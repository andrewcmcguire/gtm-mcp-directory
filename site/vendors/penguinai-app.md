# Penguin AI: products, MCP servers and connect URLs, one vendor page

> Penguin AI (penguinai.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [penguinai.app](https://penguinai.app) · vendor page id penguinai-app
...
- **GitHub organisation**: none tied to penguinai.app with evidence on 2026-09-15
