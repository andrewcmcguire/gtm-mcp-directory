# Emelia: products, MCP servers and connect URLs, one vendor page

> Emelia (emelia.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [emelia.io](https://emelia.io) · vendor page id emelia-io
...
- **GitHub organisation**: none tied to emelia.io with evidence on 2026-09-15
