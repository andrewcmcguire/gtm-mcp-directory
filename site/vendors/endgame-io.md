# Endgame: products, MCP servers and connect URLs, one vendor page

> Endgame (endgame.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 26 tools catalogued. Data baked 2026-09-20.
...
Vendor domain: [endgame.io](https://endgame.io) · vendor page id endgame-io
...
- **Tools catalogued**: 26 named across 1 measured server, harvested 2026-09-18
...
- **GitHub organisation**: none tied to endgame.io with evidence on 2026-09-08
...
- **Connect URL**: [https://docs.endgame.io/features/mcp-server](https://docs.endgame.io/features/mcp-server) (docs page)

- **Tools catalogued**: 26 named, harvested 2026-09-18, catalogue fixed
...
- [https://docs.endgame.io/features/mcp-server](https://docs.endgame.io/features/mcp-server) (Endgame, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Endgame](../tools/endgame.md) khub community CLI
...
quoted from [https://www.npmjs.com/package/@endgame-build/khub](https://www.npmjs.com/package/@endgame-build/khub) on 2026-09-18, via npm, a third party source

harvested 2026-09-18, all on the [tool page](../tools/endgame.md).
