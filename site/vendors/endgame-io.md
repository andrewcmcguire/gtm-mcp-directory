...
> Endgame (endgame.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 26 tools catalogued. Data baked 2026-09-17.
...
- **Tools catalogued**: 26 named across 1 measured server, harvested 2026-09-17
...
- **Tools catalogued**: 26 named, harvested 2026-09-17, catalogue fixed
...
quoted from [https://www.npmjs.com/package/@endgame-build/khub](https://www.npmjs.com/package/@endgame-build/khub) on 2026-09-17, via npm, a third party source

harvested 2026-09-17, all on the [tool page](../tools/endgame.md).
