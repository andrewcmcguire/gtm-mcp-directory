# Salesbot LinkedIn MCP: products, MCP servers and connect URLs, one vendor page

> Salesbot LinkedIn MCP (salesbot.cz): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [salesbot.cz](https://salesbot.cz) · vendor page id salesbot-cz
...
- **GitHub organisation**: none tied to salesbot.cz with evidence on 2026-09-15
