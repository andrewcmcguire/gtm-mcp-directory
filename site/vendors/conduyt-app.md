# Conduyt: products, MCP servers and connect URLs, one vendor page

> Conduyt (conduyt.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [conduyt.app](https://conduyt.app) · vendor page id conduyt-app
...
- **GitHub organisation**: none tied to conduyt.app with evidence on 2026-09-15
...
### [Conduyt](../tools/conduyt.md) conduyt official CLI

```
npx -y @mvanhorn/printing-press
```

quoted from [https://conduyt.app/docs](https://conduyt.app/docs) on 2026-09-15, via npx

Login or key hint: curl -H "Authorization: Bearer YOUR_API_KEY" \

1 more install command, 4 subcommands seen, harvested 2026-09-15, all on the [tool page](../tools/conduyt.md).
