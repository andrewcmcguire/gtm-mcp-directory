# Klavis AI: products, MCP servers and connect URLs, one vendor page

> Klavis AI (klavis.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 25 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [klavis.ai](https://klavis.ai) · vendor page id klavis-ai
...
- **Tools catalogued**: 25 named across 1 measured server, harvested 2026-09-17
...
- **GitHub organisation**: [github.com/Klavis-AI](https://github.com/Klavis-AI), tied to the domain with evidence 2026-09-08
...
Primarily an AI-agent training-data company - it builds "live environments for training AI agents" (long-horizon coding tasks and agentic tool-use scenarios), and separately mentions "production MCP servers" and "600+ real tools and SaaS apps" as part of that...

[Official MCP](../mcp/official.md) · [Gate unknown](../gates/unknown.md)
[MCP Layer](../categories/mcp-infrastructure.md)
RESEARCHED

- **Endpoint probe**: docs page, not an endpoint, 2026-09-04

- **Connect URL**: [https://www.klavis.ai/docs/concepts/strata.md](https://www.klavis.ai/docs/concepts/strata.md) (docs page)

- **Tools catalogued**: 25 named, harvested 2026-09-17, catalogue fixed

- **last_checked**: 2026-09-02

**The gates, in plain words**

1 of 1 gate unknown, not established from public sources and published as unknown.
...
- [https://www.klavis.ai/docs/concepts/strata.md](https://www.klavis.ai/docs/concepts/strata.md) (Klavis AI, docs page, probed 2026-09-04)
