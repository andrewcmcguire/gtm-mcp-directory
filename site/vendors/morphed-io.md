# Morphed: products, MCP servers and connect URLs, one vendor page

> Morphed (morphed.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [morphed.io](https://morphed.io) · vendor page id morphed-io
...
- **GitHub organisation**: none tied to morphed.io with evidence on 2026-09-15
...
### [Morphed](../tools/morphed.md) agent-hook official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/morphed.md).
