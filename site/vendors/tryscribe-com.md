# Scribe: products, MCP servers and connect URLs, one vendor page

> Scribe (tryscribe.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [tryscribe.com](https://tryscribe.com) · vendor page id tryscribe-com
...
- **GitHub organisation**: none tied to tryscribe.com with evidence on 2026-09-15
...
### [Scribe](../tools/scribe.md) scribe community CLI
...
quoted from [https://www.npmjs.com/package/@losthex/scribe](https://www.npmjs.com/package/@losthex/scribe) on 2026-09-17, via npm, a third party source

4 more install commands, harvested 2026-09-17, all on the [tool page](../tools/scribe.md).
