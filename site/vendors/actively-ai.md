# Actively: products, MCP servers and connect URLs, one vendor page

> Actively (actively.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [actively.ai](https://actively.ai) · vendor page id actively-ai
...
- **GitHub organisation**: [github.com/Actively](https://github.com/Actively), tied to the domain with evidence 2026-09-08
