# Orange Slice: products, MCP servers and connect URLs, one vendor page

> Orange Slice (orangeslice.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [orangeslice.ai](https://orangeslice.ai) · vendor page id orangeslice-ai
...
- **GitHub organisation**: none tied to orangeslice.ai with evidence on 2026-09-15
...
### [Orange Slice](../tools/orange-slice.md) orangeslice official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/orange-slice.md).
