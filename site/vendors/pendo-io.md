# Pendo: products, MCP servers and connect URLs, one vendor page

> Pendo (pendo.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [pendo.io](https://pendo.io) · vendor page id pendo-io
...
- **GitHub organisation**: none tied to pendo.io with evidence on 2026-09-15
...
### [Pendo](../tools/pendo.md) novus official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/pendo.md).
