# Loops: products, MCP servers and connect URLs, one vendor page

> Loops (loops.so): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [loops.so](https://loops.so) · vendor page id loops-so
...
- **GitHub organisation**: none tied to loops.so with evidence on 2026-09-15
...
### [Loops](../tools/loops.md) loops official CLI
...
Login or key hint: loops auth

3 more install commands, 5 subcommands seen, harvested 2026-09-15, all on the [tool page](../tools/loops.md).
