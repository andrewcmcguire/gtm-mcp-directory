# Jiminny: products, MCP servers and connect URLs, one vendor page

> Jiminny (jiminny.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 3 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [jiminny.com](https://jiminny.com) · vendor page id jiminny-com

**The rollup**

- **Products**: 1, facts checked by hand 2026-09-07

- **Official MCP servers**: 0 of 1, as recorded on 2026-09-07
...
- **GitHub organisation**: [github.com/jiminny](https://github.com/jiminny), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://glama.ai/mcp/servers/fzheng0222/jiminny-mcp](https://glama.ai/mcp/servers/fzheng0222/jiminny-mcp) (docs page)
...
- [https://glama.ai/mcp/servers/fzheng0222/jiminny-mcp](https://glama.ai/mcp/servers/fzheng0222/jiminny-mcp) (Jiminny, docs page, probed 2026-09-04)
