# Prospeo: products, MCP servers and connect URLs, one vendor page

> Prospeo (prospeo.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 8 tools catalogued. Data baked 2026-09-12.
...
Vendor domain: [prospeo.io](https://prospeo.io) · vendor page id prospeo-io
...
- **Connect URL**: [https://github.com/prospeo-v2/prospeo-mcp-server](https://github.com/prospeo-v2/prospeo-mcp-server) (docs page)
...
quoted from [https://www.npmjs.com/package/prospeo-cli](https://www.npmjs.com/package/prospeo-cli) on 2026-09-12, via npm, a third party source

harvested 2026-09-12, all on the [tool page](../tools/prospeo.md).
