# BuzzSumo: products, MCP servers and connect URLs, one vendor page

> BuzzSumo (buzzsumo.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [buzzsumo.com](https://buzzsumo.com) · vendor page id buzzsumo-com
...
- **GitHub organisation**: [github.com/BuzzSumo](https://github.com/BuzzSumo), tied to the domain with evidence 2026-09-08
...
[github.com/BuzzSumo](https://github.com/BuzzSumo) tied to the vendor by rule 3, account website http://buzzsumo.com has the vendor's domain, confidence strong
