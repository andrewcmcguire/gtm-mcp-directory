# Fellow: products, MCP servers and connect URLs, one vendor page

> Fellow (fellow.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-13.
...
Vendor domain: [fellow.ai](https://fellow.ai) · vendor page id fellow-ai
...
- **Connect URL**: [https://fellow.app/mcp](https://fellow.app/mcp) (endpoint)
...
### [Fellow](../tools/fellow.md) fellow community CLI
...
quoted from [https://pypi.org/project/fellow/](https://pypi.org/project/fellow/) on 2026-09-13, via pypi, a third party source

harvested 2026-09-13, all on the [tool page](../tools/fellow.md).
