# Correlated: products, MCP servers and connect URLs, one vendor page

> Correlated (correlated.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [correlated.ai](https://correlated.ai) · vendor page id correlated-ai
...
- **GitHub organisation**: none tied to correlated.ai with evidence on 2026-09-08
...
unknown in current form - per the seed list and general market classification, Correlated was a product-usage/PLG-signal tool for identifying product-qualified leads (PQLs); this description could not be re-verified against a live company source in this...

[No MCP found](../mcp/none-found.md) · [Gate not applicable](../gates/n-a.md)
