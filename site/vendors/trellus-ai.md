# Trellus AI: products, MCP servers and connect URLs, one vendor page

> Trellus AI (trellus.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [trellus.ai](https://trellus.ai) · vendor page id trellus-ai
...
- **GitHub organisation**: none tied to trellus.ai with evidence on 2026-09-08
...
A hybrid AI calling platform: a parallel dialer embedded in Salesloft/Outreach/HubSpot with real-time AI coaching for live reps, plus separate fully-autonomous voice agents for inbound call handling, appointment setting, and FAQ response.
...
No GitHub organisation could be tied to trellus.ai with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

2 candidate accounts seen and rejected by the evidence rules: TrellusHealth, Trellus-Health. A name match alone is never accepted; the account has to point at the vendor domain.
