# Memoir: products, MCP servers and connect URLs, one vendor page

> Memoir (trymemoir.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
Vendor domain: [trymemoir.ai](https://trymemoir.ai) · vendor page id trymemoir-ai
...
- **GitHub organisation**: none tied to trymemoir.ai with evidence on 2026-09-15
...
### [Memoir](../tools/memoir.md) memoir community CLI
...
1 more install command, harvested 2026-09-18, all on the [tool page](../tools/memoir.md).
