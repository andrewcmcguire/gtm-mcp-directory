# Linkly: products, MCP servers and connect URLs, one vendor page

> Linkly (linklyhq.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [linklyhq.com](https://linklyhq.com) · vendor page id linklyhq-com
...
- **GitHub organisation**: none tied to linklyhq.com with evidence on 2026-09-15
...
### [Linkly](../tools/linkly.md) linkly official CLI
...
harvested 2026-09-15, all on the [tool page](../tools/linkly.md).
