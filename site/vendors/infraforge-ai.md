# Infraforge: products, MCP servers and connect URLs, one vendor page

> Infraforge (infraforge.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [infraforge.ai](https://infraforge.ai) · vendor page id infraforge-ai
...
- **GitHub organisation**: none tied to infraforge.ai with evidence on 2026-09-08
...
- **Connect URL**: [https://mcp.salesforge.ai/mcp](https://mcp.salesforge.ai/mcp) (endpoint)
...
- [https://mcp.salesforge.ai/mcp](https://mcp.salesforge.ai/mcp) (Infraforge, endpoint, probed 2026-09-04)
...
No GitHub organisation could be tied to infraforge.ai with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: Infra-Forge, infraforge-agency, InfraForgeLabs, InfraForgeHQ, InfraForge-7X. A name match alone is never accepted; the account has to point at the vendor domain.
