# numbrU Client Compass: products, MCP servers and connect URLs, one vendor page

> numbrU Client Compass (numbru.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [numbru.com](https://numbru.com) · vendor page id numbru-com
...
- **GitHub organisation**: none tied to numbru.com with evidence on 2026-09-15
