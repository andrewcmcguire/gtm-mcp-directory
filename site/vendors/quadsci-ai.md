# QuadSci: products, MCP servers and connect URLs, one vendor page

> QuadSci (quadsci.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [quadsci.ai](https://quadsci.ai) · vendor page id quadsci-ai
...
- **GitHub organisation**: none tied to quadsci.ai with evidence on 2026-09-15
