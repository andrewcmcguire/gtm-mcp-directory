# TheirStack: products, MCP servers and connect URLs, one vendor page

> TheirStack (theirstack.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [theirstack.com](https://theirstack.com) · vendor page id theirstack-com
...
- **GitHub organisation**: none tied to theirstack.com with evidence on 2026-09-08
...
- **Connect URL**: [https://theirstack.com/en/job-posting-mcp](https://theirstack.com/en/job-posting-mcp) (docs page)
...
- [https://theirstack.com/en/job-posting-mcp](https://theirstack.com/en/job-posting-mcp) (TheirStack, docs page, probed 2026-09-04)
