...
> Instantly (instantly.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-08.
...
### [Instantly](../tools/instantly.md) instantly community CLI
...
Login or key hint: instantly login

2 more install commands, 40 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/instantly.md).
