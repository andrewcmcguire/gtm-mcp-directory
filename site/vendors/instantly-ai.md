# Instantly: products, MCP servers and connect URLs, one vendor page

> Instantly (instantly.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [instantly.ai](https://instantly.ai) · vendor page id instantly-ai
...
- **GitHub organisation**: none tied to instantly.ai with evidence on 2026-09-08
...
- **Connect URL**: [https://mcp.instantly.ai/mcp](https://mcp.instantly.ai/mcp) (endpoint)
...
- [https://mcp.instantly.ai/mcp](https://mcp.instantly.ai/mcp) (Instantly, endpoint, probed 2026-09-04)
