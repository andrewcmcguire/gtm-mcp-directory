# DealMachine: products, MCP servers and connect URLs, one vendor page

> DealMachine (mcp.dealmachine.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [mcp.dealmachine.com](https://mcp.dealmachine.com) · vendor page id mcp-dealmachine-com
...
- **GitHub organisation**: none tied to mcp.dealmachine.com with evidence on 2026-09-15
...
### [DealMachine](../tools/dealmachine.md) dm official CLI

```
npm install -g dealmachine
```

quoted from [https://www.npmjs.com/package/dealmachine](https://www.npmjs.com/package/dealmachine) on 2026-09-26, via npm

3 more install commands, harvested 2026-09-26, all on the [tool page](../tools/dealmachine.md).
