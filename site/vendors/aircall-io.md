...
> Aircall (aircall.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 81 tools catalogued. Data baked 2026-09-08.
...
- **Tools catalogued**: 81 named across 1 measured server, harvested 2026-09-08
...
- **Tools catalogued**: 81 named, harvested 2026-09-08, catalogue fixed
...
Login or key hint: aircall auth

4 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/aircall.md).
