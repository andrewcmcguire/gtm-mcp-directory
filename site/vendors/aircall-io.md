...
> Aircall (aircall.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 81 tools catalogued. Data baked 2026-09-14.
...
- **Tools catalogued**: 81 named across 1 measured server, harvested 2026-09-14
...
- **Tools catalogued**: 81 named, harvested 2026-09-14, catalogue fixed
...
quoted from [https://www.npmjs.com/package/aircall-cli](https://www.npmjs.com/package/aircall-cli) on 2026-09-14, via npm, a third party source

harvested 2026-09-14, all on the [tool page](../tools/aircall.md).
