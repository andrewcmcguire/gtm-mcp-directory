# Avoma: products, MCP servers and connect URLs, one vendor page

> Avoma (avoma.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [avoma.com](https://avoma.com) · vendor page id avoma-com
...
- **GitHub organisation**: none tied to avoma.com with evidence on 2026-09-08
...
- **Connect URL**: [https://help.avoma.com/admins-add-avoma-mcp-connector-in-claude](https://help.avoma.com/admins-add-avoma-mcp-connector-in-claude) (docs page)
...
- [https://help.avoma.com/admins-add-avoma-mcp-connector-in-claude](https://help.avoma.com/admins-add-avoma-mcp-connector-in-claude) (Avoma, docs page, probed 2026-09-04)
...
No GitHub organisation could be tied to avoma.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

2 candidate accounts seen and rejected by the evidence rules: Avoma, avomade. A name match alone is never accepted; the account has to point at the vendor domain.
