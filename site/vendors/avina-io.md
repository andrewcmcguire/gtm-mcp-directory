# Avina: products, MCP servers and connect URLs, one vendor page

> Avina (avina.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [avina.io](https://avina.io) · vendor page id avina-io
...
- **GitHub organisation**: none tied to avina.io with evidence on 2026-09-15
