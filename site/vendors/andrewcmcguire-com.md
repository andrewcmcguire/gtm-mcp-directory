# GTM Signals: products, MCP servers and connect URLs, one vendor page

> GTM Signals (andrewcmcguire.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [andrewcmcguire.com](https://andrewcmcguire.com) · vendor page id andrewcmcguire-com

**The rollup**

- **Products**: 1, facts checked by hand 2026-09-14

- **Official MCP servers**: 1 of 1, as recorded on 2026-09-14
...
- **GitHub organisation**: none tied to andrewcmcguire.com with evidence on 2026-09-15
...
Turns what public companies say about themselves into queryable buying signals, one row per dated public statement (earnings call, SEC filing, investor deck slide, IR statement, job posting), each carrying a verbatim quote and an https link to the source it...
