# Modus: products, MCP servers and connect URLs, one vendor page

> Modus (himodus.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [himodus.com](https://himodus.com) · vendor page id himodus-com
...
- **GitHub organisation**: none tied to himodus.com with evidence on 2026-09-15
...
### [Modus](../tools/modus.md) modus community CLI
...
1 more install command, harvested 2026-09-26, all on the [tool page](../tools/modus.md).
