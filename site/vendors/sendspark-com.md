# Sendspark: products, MCP servers and connect URLs, one vendor page

> Sendspark (sendspark.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 9 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [sendspark.com](https://sendspark.com) · vendor page id sendspark-com
...
- **GitHub organisation**: [github.com/sendspark](https://github.com/sendspark), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://composio.dev/toolkits/sendspark](https://composio.dev/toolkits/sendspark) (docs page)
...
- [https://composio.dev/toolkits/sendspark](https://composio.dev/toolkits/sendspark) (Sendspark, docs page, probed 2026-09-04)
