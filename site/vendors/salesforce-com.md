...
> Salesforce (salesforce.com): 2 products in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 17 tools catalogued. Data baked 2026-09-11.
...
- **Tools catalogued**: 17 named across 1 measured server, harvested 2026-09-11
...
harvested 2026-09-11, all on the [tool page](../tools/salesforce-agentforce.md).
