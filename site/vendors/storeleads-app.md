# Store Leads: products, MCP servers and connect URLs, one vendor page

> Store Leads (storeleads.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [storeleads.app](https://storeleads.app) · vendor page id storeleads-app
...
- **GitHub organisation**: none tied to storeleads.app with evidence on 2026-09-15
