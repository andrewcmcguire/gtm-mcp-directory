# Super Send: products, MCP servers and connect URLs, one vendor page

> Super Send (supersend.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 45 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [supersend.io](https://supersend.io) · vendor page id supersend-io
...
- **Tools catalogued**: 45 named across 1 measured server, harvested 2026-09-15
...
- **GitHub organisation**: none tied to supersend.io with evidence on 2026-09-08
...
- **Connect URL**: [https://docs.supersend.io/docs/mcp-server](https://docs.supersend.io/docs/mcp-server) (docs page)

- **Tools catalogued**: 45 named, harvested 2026-09-15, catalogue fixed
...
- [https://docs.supersend.io/docs/mcp-server](https://docs.supersend.io/docs/mcp-server) (Super Send, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Super Send](../tools/super-send.md) supersendtx official CLI

```
npm install -g supersendtx-cli
```

quoted from [https://www.npmjs.com/package/supersendtx-cli](https://www.npmjs.com/package/supersendtx-cli) on 2026-09-15, via npm

harvested 2026-09-15, all on the [tool page](../tools/super-send.md).
