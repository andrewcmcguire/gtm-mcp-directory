...
> Super Send (supersend.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 45 tools catalogued. Data baked 2026-09-13.
...
- **Tools catalogued**: 45 named across 1 measured server, harvested 2026-09-13
...
- **Tools catalogued**: 45 named, harvested 2026-09-13, catalogue fixed
...
quoted from [https://www.npmjs.com/package/supersendtx-cli](https://www.npmjs.com/package/supersendtx-cli) on 2026-09-13, via npm

harvested 2026-09-13, all on the [tool page](../tools/super-send.md).
