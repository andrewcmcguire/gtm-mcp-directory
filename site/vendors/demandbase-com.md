# Demandbase (Demandbase One): products, MCP servers and connect URLs, one vendor page

> Demandbase (Demandbase One) (demandbase.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [demandbase.com](https://demandbase.com) · vendor page id demandbase-com
...
- **GitHub organisation**: [github.com/Demandbase](https://github.com/Demandbase), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://developer.demandbase.com/docs/mcp](https://developer.demandbase.com/docs/mcp) (docs page)
...
- [https://developer.demandbase.com/docs/mcp](https://developer.demandbase.com/docs/mcp) (Demandbase (Demandbase One), docs page, probed 2026-09-04)
...
[github.com/Demandbase](https://github.com/Demandbase) tied to the vendor by rule 3, account website https://demandbase.com has the vendor's domain, confidence strong
