# AiSDR: products, MCP servers and connect URLs, one vendor page

> AiSDR (aisdr.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [aisdr.com](https://aisdr.com) · vendor page id aisdr-com
...
- **GitHub organisation**: [github.com/aisdrapp](https://github.com/aisdrapp), tied to the domain with evidence 2026-09-08
