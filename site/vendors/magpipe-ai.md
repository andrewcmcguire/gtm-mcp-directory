# Magpipe: products, MCP servers and connect URLs, one vendor page

> Magpipe (magpipe.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [magpipe.ai](https://magpipe.ai) · vendor page id magpipe-ai
...
- **GitHub organisation**: none tied to magpipe.ai with evidence on 2026-09-15
