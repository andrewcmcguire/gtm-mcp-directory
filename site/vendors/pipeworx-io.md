...
> Pipeworx (pipeworx.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
- **Tools catalogued**: 0 named across 1 measured server, harvested 2026-09-18. A further 6,361 sit behind a gateway server and are counted separately, because a gateway re-exposes other vendors
...
- **Tools catalogued**: 6361 named, harvested 2026-09-18, catalogue gateway, counted apart from the vendor total
...
quoted from [https://pipeworx.io/docs/getting-started/cli/](https://pipeworx.io/docs/getting-started/cli/) on 2026-09-18, via npx

Login or key hint: export PIPEWORX_API_KEY = your_key_here

1 subcommands seen, harvested 2026-09-18, all on the [tool page](../tools/pipeworx.md).
