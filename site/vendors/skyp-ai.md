# Skyp.ai: products, MCP servers and connect URLs, one vendor page

> Skyp.ai (skyp.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [skyp.ai](https://skyp.ai) · vendor page id skyp-ai
...
- **GitHub organisation**: [github.com/skyp-ai](https://github.com/skyp-ai), tied to the domain with evidence 2026-09-08
