...
> Firecrawl (firecrawl.dev): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 13 tools catalogued. Data baked 2026-09-09.
...
quoted from [https://docs.firecrawl.dev/sdks/cli](https://docs.firecrawl.dev/sdks/cli) on 2026-09-09, via npm

Login or key hint: firecrawl login

1 more install command, 16 subcommands seen, harvested 2026-09-09, all on the [tool page](../tools/firecrawl.md).
