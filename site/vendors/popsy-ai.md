# Popsy: products, MCP servers and connect URLs, one vendor page

> Popsy (popsy.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [popsy.ai](https://popsy.ai) · vendor page id popsy-ai
...
- **GitHub organisation**: none tied to popsy.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to popsy.ai with evidence on 2026-09-15.
