# Andru Revenue Intelligence: products, MCP servers and connect URLs, one vendor page

> Andru Revenue Intelligence (andru.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [andru.ai](https://andru.ai) · vendor page id andru-ai
...
- **GitHub organisation**: none tied to andru.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to andru.ai with evidence on 2026-09-15.
