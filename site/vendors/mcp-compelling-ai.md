# Compelling: products, MCP servers and connect URLs, one vendor page

> Compelling (mcp.compelling.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.compelling.ai](https://mcp.compelling.ai) · vendor page id mcp-compelling-ai
...
- **GitHub organisation**: none tied to mcp.compelling.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to mcp.compelling.ai with evidence on 2026-09-15.
