# SeldonFrame: products, MCP servers and connect URLs, one vendor page

> SeldonFrame (seldonframe.com): 2 products in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-20.
...
Vendor domain: [seldonframe.com](https://seldonframe.com) · vendor page id seldonframe-com
...
- **Ships a CLI**: 2 of 2 official, 0 community only, 0 none found, harvested 2026-09-18

- **GitHub organisation**: none tied to seldonframe.com with evidence on 2026-09-15
...
SeldonFrame is the agent-native, open-source alternative to GoHighLevel for agencies selling AI front offices to local businesses. Build a branded website, booking flow, CRM, intake, and AI agent for every client from one workspace-then operate it under your...
...
### [SeldonFrame](../tools/seldonframe.md) seldonframe official CLI
...
harvested 2026-09-18, all on the [tool page](../tools/seldonframe.md).
