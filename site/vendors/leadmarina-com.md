# LeadMarina: products, MCP servers and connect URLs, one vendor page

> LeadMarina (leadmarina.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [leadmarina.com](https://leadmarina.com) · vendor page id leadmarina-com
...
- **GitHub organisation**: none tied to leadmarina.com with evidence on 2026-09-15
...
Discover, enrich, and verify local-business leads - built for sales. A Raft Systems product.
...
No GitHub organisation could be tied to leadmarina.com with evidence on 2026-09-15.
