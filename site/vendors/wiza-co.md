# Wiza: products, MCP servers and connect URLs, one vendor page

> Wiza (wiza.co): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [wiza.co](https://wiza.co) · vendor page id wiza-co
...
- **Connect URL**: [https://mcp.wiza.co/mcp](https://mcp.wiza.co/mcp) (endpoint)
