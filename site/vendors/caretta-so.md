# Caretta: products, MCP servers and connect URLs, one vendor page

> Caretta (caretta.so): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-21.
...
Vendor domain: [caretta.so](https://caretta.so) · vendor page id caretta-so
...
- **GitHub organisation**: none tied to caretta.so with evidence on 2026-09-15
...
### [Caretta](../tools/caretta.md) caretta community CLI
...
harvested 2026-09-18, all on the [tool page](../tools/caretta.md).
