# Salesforce MCP Lib by Damecek: products, MCP servers and connect URLs, one vendor page

> Salesforce MCP Lib by Damecek (context7.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [context7.com](https://context7.com) · vendor page id context7-com
...
- **GitHub organisation**: none tied to context7.com with evidence on 2026-09-15
...
### [Salesforce MCP Lib by Damecek](../tools/salesforce-mcp-lib-by-damecek.md) ctx7 official CLI
...
Login or key hint: ctx7 setup

harvested 2026-09-15, all on the [tool page](../tools/salesforce-mcp-lib-by-damecek.md).
