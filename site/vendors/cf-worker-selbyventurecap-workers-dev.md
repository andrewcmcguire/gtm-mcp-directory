...
> Apollo-Salesforce Mapper MCP (cf-worker.selbyventurecap.workers.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-18.
