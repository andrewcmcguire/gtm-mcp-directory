# Apollo-Salesforce Mapper MCP: products, MCP servers and connect URLs, one vendor page

> Apollo-Salesforce Mapper MCP (cf-worker.selbyventurecap.workers.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [cf-worker.selbyventurecap.workers.dev](https://cf-worker.selbyventurecap.workers.dev) · vendor page id cf-worker-selbyventurecap-workers-dev
...
- **GitHub organisation**: none tied to cf-worker.selbyventurecap.workers.dev with evidence on 2026-09-15
...
No GitHub organisation could be tied to cf-worker.selbyventurecap.workers.dev with evidence on 2026-09-15.
