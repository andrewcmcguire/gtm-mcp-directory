# Manatee: products, MCP servers and connect URLs, one vendor page

> Manatee (trymanatee.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [trymanatee.com](https://trymanatee.com) · vendor page id trymanatee-com
...
- **GitHub organisation**: none tied to trymanatee.com with evidence on 2026-09-15
...
### [Manatee](../tools/manatee.md) manatee community CLI
...
harvested 2026-09-26, all on the [tool page](../tools/manatee.md).
