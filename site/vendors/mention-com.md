# Mention: products, MCP servers and connect URLs, one vendor page

> Mention (mention.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 13 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [mention.com](https://mention.com) · vendor page id mention-com
...
- **Connect URL**: [https://github.com/MaelitoP/mention-mcp-server](https://github.com/MaelitoP/mention-mcp-server) (docs page)
