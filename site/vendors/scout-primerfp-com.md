# PrimeRFP SCOUT: products, MCP servers and connect URLs, one vendor page

> PrimeRFP SCOUT (scout.primerfp.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [scout.primerfp.com](https://scout.primerfp.com) · vendor page id scout-primerfp-com
...
- **GitHub organisation**: none tied to scout.primerfp.com with evidence on 2026-09-15
