# DataLayer.sh MCP: products, MCP servers and connect URLs, one vendor page

> DataLayer.sh MCP (datalayer.sh): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [datalayer.sh](https://datalayer.sh) · vendor page id datalayer-sh
...
- **GitHub organisation**: none tied to datalayer.sh with evidence on 2026-09-15
