# Twenty MCP Suite: products, MCP servers and connect URLs, one vendor page

> Twenty MCP Suite (andrewmarconi.github.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [andrewmarconi.github.io](https://andrewmarconi.github.io) · vendor page id andrewmarconi-github-io
...
- **GitHub organisation**: none tied to andrewmarconi.github.io with evidence on 2026-09-15
...
Version-resilient MCP server suite for self-hosted Twenty CRM.
...
No GitHub organisation could be tied to andrewmarconi.github.io with evidence on 2026-09-15.
