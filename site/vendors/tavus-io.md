...
> Tavus (tavus.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 29 tools catalogued. Data baked 2026-09-10.
...
- **Tools catalogued**: 29 named across 1 measured server, harvested 2026-09-10
...
- **Tools catalogued**: 29 named, harvested 2026-09-10, catalogue fixed
...
1 more install command, harvested 2026-09-10, all on the [tool page](../tools/tavus.md).
