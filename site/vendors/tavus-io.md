...
> Tavus (tavus.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 29 tools catalogued. Data baked 2026-09-13.
...
- **Tools catalogued**: 29 named across 1 measured server, harvested 2026-09-13
...
- **Tools catalogued**: 29 named, harvested 2026-09-13, catalogue fixed
...
quoted from [https://pypi.org/project/tavus-cli/](https://pypi.org/project/tavus-cli/) on 2026-09-13, via pypi, a third party source

1 more install command, harvested 2026-09-13, all on the [tool page](../tools/tavus.md).
