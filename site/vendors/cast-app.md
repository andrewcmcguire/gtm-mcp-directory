# Cast.app: products, MCP servers and connect URLs, one vendor page

> Cast.app (cast.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [cast.app](https://cast.app) · vendor page id cast-app
...
- **GitHub organisation**: none tied to cast.app with evidence on 2026-09-15
