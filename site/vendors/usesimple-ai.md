# Simple AI: products, MCP servers and connect URLs, one vendor page

> Simple AI (usesimple.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [usesimple.ai](https://usesimple.ai) · vendor page id usesimple-ai
...
- **GitHub organisation**: none tied to usesimple.ai with evidence on 2026-09-15
