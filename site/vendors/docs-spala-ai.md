# Spala MCP: products, MCP servers and connect URLs, one vendor page

> Spala MCP (docs.spala.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [docs.spala.ai](https://docs.spala.ai) · vendor page id docs-spala-ai
...
- **GitHub organisation**: none tied to docs.spala.ai with evidence on 2026-09-15
