# Copyfactory: products, MCP servers and connect URLs, one vendor page

> Copyfactory (copyfactory.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [copyfactory.io](https://copyfactory.io) · vendor page id copyfactory-io
...
- **GitHub organisation**: none tied to copyfactory.io with evidence on 2026-09-15
...
AI copywriting platform for sales teams.
...
No GitHub organisation could be tied to copyfactory.io with evidence on 2026-09-15.
