# MuntuAI MCP: products, MCP servers and connect URLs, one vendor page

> MuntuAI MCP (api.muntuai.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [api.muntuai.com](https://api.muntuai.com) · vendor page id api-muntuai-com
...
- **GitHub organisation**: none tied to api.muntuai.com with evidence on 2026-09-15
