# Agent Cold Email MCP (Coldrig): products, MCP servers and connect URLs, one vendor page

> Agent Cold Email MCP (Coldrig) (coldrig.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [coldrig.dev](https://coldrig.dev) · vendor page id coldrig-dev
...
- **GitHub organisation**: none tied to coldrig.dev with evidence on 2026-09-15
...
### [Agent Cold Email MCP (Coldrig)](../tools/agent-cold-email-mcp.md) agent-cold-email official CLI
...
Login or key hint: MCP setup

harvested 2026-09-26, all on the [tool page](../tools/agent-cold-email-mcp.md).
