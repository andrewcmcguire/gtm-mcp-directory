...
> MeetGeek (meetgeek.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 6 tools catalogued. Data baked 2026-09-15.
...
quoted from [https://www.npmjs.com/package/meetgeek-cli](https://www.npmjs.com/package/meetgeek-cli) on 2026-09-15, via npm, a third party source

harvested 2026-09-15, all on the [tool page](../tools/meetgeek.md).
