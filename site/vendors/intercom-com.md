...
> Intercom (Fin) (intercom.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-15.
...
quoted from [https://www.npmjs.com/package/@intercom/cli](https://www.npmjs.com/package/@intercom/cli) on 2026-09-15, via npm

harvested 2026-09-15, all on the [tool page](../tools/intercom.md).
