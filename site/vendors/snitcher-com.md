# Snitcher: products, MCP servers and connect URLs, one vendor page

> Snitcher (snitcher.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 35 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [snitcher.com](https://snitcher.com) · vendor page id snitcher-com
...
- **Tools catalogued**: 35 named across 1 measured server, harvested 2026-09-14

- **Bench tested**: 0 of 1 here, 1 of 336 across the directory

- **Ships a CLI**: 0 of 1 official, 0 community only, 1 none found, harvested 2026-09-14

- **GitHub organisation**: none tied to snitcher.com with evidence on 2026-09-08
...
- **Connect URL**: [https://www.snitcher.com/changelog/point-claude-at-snitcher/](https://www.snitcher.com/changelog/point-claude-at-snitcher/) (docs page)

- **Tools catalogued**: 35 named, harvested 2026-09-14, catalogue fixed
...
- [https://www.snitcher.com/changelog/point-claude-at-snitcher/](https://www.snitcher.com/changelog/point-claude-at-snitcher/) (Snitcher, docs page, probed 2026-09-04)
