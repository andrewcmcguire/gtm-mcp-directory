...
> Apideck (apideck.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 22 tools catalogued. Data baked 2026-09-10.
...
- **Tools catalogued**: 22 named across 1 measured server, harvested 2026-09-10
...
- **Tools catalogued**: 22 named, harvested 2026-09-10, catalogue fixed
...
quoted from [https://www.apideck.com/cli](https://www.apideck.com/cli) on 2026-09-10, via brew

Login or key hint: apideck auth

2 more install commands, 6 subcommands seen, harvested 2026-09-10, all on the [tool page](../tools/apideck.md).
