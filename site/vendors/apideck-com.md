# Apideck: products, MCP servers and connect URLs, one vendor page

> Apideck (apideck.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 22 tools catalogued. Data baked 2026-09-12.
...
Vendor domain: [apideck.com](https://apideck.com) · vendor page id apideck-com
...
- **Tools catalogued**: 22 named across 1 measured server, harvested 2026-09-12
...
- **GitHub organisation**: [github.com/apideck-libraries](https://github.com/apideck-libraries), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/apideck-libraries/mcp](https://github.com/apideck-libraries/mcp) (docs page)

- **Tools catalogued**: 22 named, harvested 2026-09-12, catalogue fixed
...
- [https://github.com/apideck-libraries/mcp](https://github.com/apideck-libraries/mcp) (Apideck, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Apideck](../tools/apideck.md) apideck official CLI

```
brew install apideck-libraries/tap/apideck
```

quoted from [https://www.apideck.com/cli](https://www.apideck.com/cli) on 2026-09-12, via brew

Login or key hint: apideck auth

2 more install commands, 6 subcommands seen, harvested 2026-09-12, all on the [tool page](../tools/apideck.md).
