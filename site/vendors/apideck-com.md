...
> Apideck (apideck.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 25 tools catalogued. Data baked 2026-09-14.
...
quoted from [https://www.apideck.com/cli](https://www.apideck.com/cli) on 2026-09-14, via brew

Login or key hint: apideck auth

2 more install commands, 6 subcommands seen, harvested 2026-09-14, all on the [tool page](../tools/apideck.md).
