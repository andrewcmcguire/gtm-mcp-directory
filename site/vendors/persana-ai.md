# Persana AI: products, MCP servers and connect URLs, one vendor page

> Persana AI (persana.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [persana.ai](https://persana.ai) · vendor page id persana-ai
...
- **GitHub organisation**: none tied to persana.ai with evidence on 2026-09-15
...
Find, enrich, and personalize outbound at scale - all in seconds, and book more meetings. Find and target your ideal customer persona at scale.
...
No GitHub organisation could be tied to persana.ai with evidence on 2026-09-15.
