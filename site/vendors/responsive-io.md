# Responsive (formerly RFPIO): products, MCP servers and connect URLs, one vendor page

> Responsive (formerly RFPIO) (responsive.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [responsive.io](https://responsive.io) · vendor page id responsive-io
...
- **GitHub organisation**: none tied to responsive.io with evidence on 2026-09-08
...
- **Connect URL**: [https://www.responsive.io/capability/mcp-server](https://www.responsive.io/capability/mcp-server) (docs page)
...
- [https://www.responsive.io/capability/mcp-server](https://www.responsive.io/capability/mcp-server) (Responsive (formerly RFPIO), docs page, probed 2026-09-04)
...
No GitHub organisation could be tied to responsive.io with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: responsively-org, responsivedev, ResponsiveImagesCG, goresponsive, ResEnv. A name match alone is never accepted; the account has to point at the vendor domain.
