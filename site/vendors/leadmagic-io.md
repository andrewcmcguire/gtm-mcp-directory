...
> LeadMagic (leadmagic.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 19 tools catalogued. Data baked 2026-09-08.
...
- **Tools catalogued**: 19 named across 1 measured server, harvested 2026-09-08
...
- **Tools catalogued**: 19 named, harvested 2026-09-08, catalogue fixed
...
Login or key hint: leadmagic login

2 more install commands, 7 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/leadmagic.md).
