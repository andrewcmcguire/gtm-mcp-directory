...
> LeadMagic (leadmagic.io): 2 products in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 19 tools catalogued. Data baked 2026-09-26.
...
- **Tools catalogued**: 19 named across 1 measured server, harvested 2026-09-26

- **Bench tested**: 0 of 2 here, 1 of 1,252 across the directory

- **Ships a CLI**: 2 of 2 official, 0 community only, 0 none found, harvested 2026-09-26
...
- **Tools catalogued**: 19 named, harvested 2026-09-26, catalogue fixed
...
### [LeadMagic](../tools/leadmagic.md) lm official CLI
...
Login or key hint: lm login

29 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/leadmagic.md).
