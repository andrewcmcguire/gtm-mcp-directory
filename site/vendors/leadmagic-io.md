...
> LeadMagic (leadmagic.io): 2 products in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 19 tools catalogued. Data baked 2026-09-15.
...
- **Tools catalogued**: 19 named across 1 measured server, harvested 2026-09-15

- **Bench tested**: 0 of 2 here, 1 of 1,252 across the directory

- **Ships a CLI**: 0 of 2 official, 1 community only, 1 none found, harvested 2026-09-15

- **GitHub organisation**: [github.com/LeadMagic](https://github.com/LeadMagic), tied to the domain with evidence 2026-09-08, 2026-09-15
...
- **Tools catalogued**: 19 named, harvested 2026-09-15, catalogue fixed
...
quoted from [https://www.npmjs.com/package/leadmagic-agent-cli](https://www.npmjs.com/package/leadmagic-agent-cli) on 2026-09-15, via npm, a third party source

1 more install command, harvested 2026-09-15, all on the [tool page](../tools/leadmagic.md).
...
No organisation could be tied with evidence to the entry for [LeadMagic MCP](../tools/leadmagic-mcp.md) on 2026-09-08, 2026-09-15; the organisation above was tied through a sibling product.
