# Forethought (now "Forethought AI Agents by Zendesk"): products, MCP servers and connect URLs, one vendor page

> Forethought (now "Forethought AI Agents by Zendesk") (forethought.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [forethought.ai](https://forethought.ai) · vendor page id forethought-ai
