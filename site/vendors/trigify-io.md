...
> Trigify (Trigify.io) (trigify.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
quoted from [https://www.npmjs.com/package/@trigify/cli](https://www.npmjs.com/package/@trigify/cli) on 2026-09-14, via npm

harvested 2026-09-14, all on the [tool page](../tools/trigify.md).
