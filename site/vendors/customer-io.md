# Customer.io: products, MCP servers and connect URLs, one vendor page

> Customer.io (customer.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [customer.io](https://customer.io) · vendor page id customer-io
...
- **GitHub organisation**: none tied to customer.io with evidence on 2026-09-15
...
### [Customer.io](../tools/customer-io.md) customerio official CLI
...
Login or key hint: less setup

harvested 2026-09-26, all on the [tool page](../tools/customer-io.md).
