# Attention: products, MCP servers and connect URLs, one vendor page

> Attention (attention.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 7 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [attention.com](https://attention.com) · vendor page id attention-com
...
- **Connect URL**: [https://docs.attention.com/mcp/overview](https://docs.attention.com/mcp/overview) (docs page)
