# Hex: products, MCP servers and connect URLs, one vendor page

> Hex (hex.tech): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [hex.tech](https://hex.tech) · vendor page id hex-tech
