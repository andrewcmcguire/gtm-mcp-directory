...
> MailGenius (mailgenius.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-13.
...
quoted from [https://www.npmjs.com/package/mailgenius-cli](https://www.npmjs.com/package/mailgenius-cli) on 2026-09-13, via npm, a third party source

1 more install command, harvested 2026-09-13, all on the [tool page](../tools/mailgenius.md).
