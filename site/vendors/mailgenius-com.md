# MailGenius: products, MCP servers and connect URLs, one vendor page

> MailGenius (mailgenius.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-12.
...
Vendor domain: [mailgenius.com](https://mailgenius.com) · vendor page id mailgenius-com
...
- **GitHub organisation**: none tied to mailgenius.com with evidence on 2026-09-08
...
### [MailGenius](../tools/mailgenius.md) genius community CLI
...
quoted from [https://www.npmjs.com/package/mailgenius-cli](https://www.npmjs.com/package/mailgenius-cli) on 2026-09-12, via npm, a third party source

1 more install command, harvested 2026-09-12, all on the [tool page](../tools/mailgenius.md).
