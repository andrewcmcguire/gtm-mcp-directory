# Surfe: products, MCP servers and connect URLs, one vendor page

> Surfe (surfe.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [surfe.com](https://surfe.com) · vendor page id surfe-com
...
- **GitHub organisation**: [github.com/surfe](https://github.com/surfe), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://mcp.eu.surfe.com/mcp](https://mcp.eu.surfe.com/mcp) (endpoint)
...
- [https://mcp.eu.surfe.com/mcp](https://mcp.eu.surfe.com/mcp) (Surfe, endpoint, probed 2026-09-04)
...
[github.com/surfe](https://github.com/surfe) tied to the vendor by rule 3, account website https://www.surfe.com has the vendor's domain, confidence strong
...
|---|---|---|---|---|---|
| [surfer](https://github.com/surfe/surfer) | other | | 0 | 2026-08-26 | v0.1.2 |
| [homebrew-tap](https://github.com/surfe/homebrew-tap) | infrastructure | | 0 | 2026-07-01 | |
| [traefik-correlation-id](https://github.com/surfe/traefik-correlation-id) | other | Correlation id is a Traefik middleware that ensures every incoming HTTP request carries a unique Correlation-ID header.... | 0 | 2026-05-25 | v0.2.0 |
| [surfe-frontend-mock-interview](https://github.com/surfe/surfe-frontend-mock-interview) | app | | 1 | 2026-01-27 | |
| [live-coding-session](https://github.com/surfe/live-coding-session) | other | | 0 | 2026-01-20 | |
