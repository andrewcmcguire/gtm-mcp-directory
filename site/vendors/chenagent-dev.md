# LeadScout MCP: products, MCP servers and connect URLs, one vendor page

> LeadScout MCP (chenagent.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [chenagent.dev](https://chenagent.dev) · vendor page id chenagent-dev
...
- **GitHub organisation**: none tied to chenagent.dev with evidence on 2026-09-15
...
MCP server for LeadScout Spanish B2B lead generation for PyMEs.
...
No GitHub organisation could be tied to chenagent.dev with evidence on 2026-09-15.
