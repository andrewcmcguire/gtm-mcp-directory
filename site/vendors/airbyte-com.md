...
> Airbyte (airbyte.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 4 tools catalogued. Data baked 2026-09-09.
...
harvested 2026-09-09, all on the [tool page](../tools/airbyte.md).
