# Mailchimp: products, MCP servers and connect URLs, one vendor page

> Mailchimp (mailchimp.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [mailchimp.com](https://mailchimp.com) · vendor page id mailchimp-com
...
- **GitHub organisation**: none tied to mailchimp.com with evidence on 2026-09-15
...
### [Mailchimp](../tools/mailchimp.md) mailchimp community CLI
...
quoted from [https://pypi.org/project/mailchimp/](https://pypi.org/project/mailchimp/) on 2026-09-26, via pypi, a third party source

harvested 2026-09-26, all on the [tool page](../tools/mailchimp.md).
