# Cognis Enrichr MCP: products, MCP servers and connect URLs, one vendor page

> Cognis Enrichr MCP (cognis.digital): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [cognis.digital](https://cognis.digital) · vendor page id cognis-digital
...
- **GitHub organisation**: none tied to cognis.digital with evidence on 2026-09-15
...
Enrich a leads CSV with firmographic data via Cognis Digital tooling.
...
No GitHub organisation could be tied to cognis.digital with evidence on 2026-09-15.
