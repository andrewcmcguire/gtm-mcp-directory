# Plai: products, MCP servers and connect URLs, one vendor page

> Plai (plai.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [plai.io](https://plai.io) · vendor page id plai-io
...
- **GitHub organisation**: none tied to plai.io with evidence on 2026-09-15
...
Manage Facebook Ads and Google Ads across multiple clients with automation, templates, reporting, billing, and white-labeled access. Built for agencies.
...
No GitHub organisation could be tied to plai.io with evidence on 2026-09-15.
