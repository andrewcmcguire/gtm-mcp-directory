# Minoa: products, MCP servers and connect URLs, one vendor page

> Minoa (minoa.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [minoa.io](https://minoa.io) · vendor page id minoa-io
...
- **GitHub organisation**: none tied to minoa.io with evidence on 2026-09-15
