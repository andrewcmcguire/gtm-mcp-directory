...
> Findymail (findymail.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-08.
...
Login or key hint: - bearer auth from `FINDYMAIL_API_KEY`

3 more install commands, 5 subcommands seen, harvested 2026-09-08, all on the [tool page](../tools/findymail.md).
