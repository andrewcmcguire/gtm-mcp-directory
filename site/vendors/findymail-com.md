...
> Findymail (findymail.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
quoted from [https://www.npmjs.com/package/@paulelliot/findymail-cli](https://www.npmjs.com/package/@paulelliot/findymail-cli) on 2026-09-17, via npm, a third party source

1 more install command, harvested 2026-09-17, all on the [tool page](../tools/findymail.md).
