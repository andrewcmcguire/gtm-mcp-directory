# Findymail: products, MCP servers and connect URLs, one vendor page

> Findymail (findymail.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-12.
...
Vendor domain: [findymail.com](https://findymail.com) · vendor page id findymail-com
...
- **GitHub organisation**: none tied to findymail.com with evidence on 2026-09-08
...
### [Findymail](../tools/findymail.md) findymail community CLI
...
quoted from [https://www.npmjs.com/package/@paulelliot/findymail-cli](https://www.npmjs.com/package/@paulelliot/findymail-cli) on 2026-09-12, via npm, a third party source

1 more install command, harvested 2026-09-12, all on the [tool page](../tools/findymail.md).
