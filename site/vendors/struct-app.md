# Struct: products, MCP servers and connect URLs, one vendor page

> Struct (struct.app): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [struct.app](https://struct.app) · vendor page id struct-app
...
- **GitHub organisation**: none tied to struct.app with evidence on 2026-09-15
...
Multi-lingual AI voice agents for business workflows.
...
No GitHub organisation could be tied to struct.app with evidence on 2026-09-15.
