# Data Legion: products, MCP servers and connect URLs, one vendor page

> Data Legion (datalegion.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [datalegion.ai](https://datalegion.ai) · vendor page id datalegion-ai
...
- **GitHub organisation**: none tied to datalegion.ai with evidence on 2026-09-15
...
### [Data Legion](../tools/data-legion.md) datalegion-cli official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/data-legion.md).
