# Fintent Signals MCP: products, MCP servers and connect URLs, one vendor page

> Fintent Signals MCP (app.fintent.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [app.fintent.ai](https://app.fintent.ai) · vendor page id app-fintent-ai
...
- **GitHub organisation**: none tied to app.fintent.ai with evidence on 2026-09-15
...
No GitHub organisation could be tied to app.fintent.ai with evidence on 2026-09-15.
