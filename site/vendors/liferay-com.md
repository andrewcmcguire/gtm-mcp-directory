# Liferay: products, MCP servers and connect URLs, one vendor page

> Liferay (liferay.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [liferay.com](https://liferay.com) · vendor page id liferay-com
...
- **GitHub organisation**: none tied to liferay.com with evidence on 2026-09-15
...
### [Liferay](../tools/liferay.md) liferay-npm-bundler official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/liferay.md).
