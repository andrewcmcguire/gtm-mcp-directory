# Cal.com: products, MCP servers and connect URLs, one vendor page

> Cal.com (cal.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [cal.com](https://cal.com) · vendor page id cal-com
...
- **GitHub organisation**: [github.com/calcom](https://github.com/calcom), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/calcom/cal-mcp](https://github.com/calcom/cal-mcp) (docs page)
...
- [https://github.com/calcom/cal-mcp](https://github.com/calcom/cal-mcp) (Cal.com, docs page, probed 2026-09-04)
