...
> Metorial (metorial.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 9 tools catalogued. Data baked 2026-09-18.
...
- **Tools catalogued**: 9 named across 1 measured server, harvested 2026-09-18
...
quoted from [https://metorial.com/cli](https://metorial.com/cli) on 2026-09-18, via npm

Login or key hint: Easy setup

harvested 2026-09-18, all on the [tool page](../tools/metorial.md).
