# GoLinks: products, MCP servers and connect URLs, one vendor page

> GoLinks (golinks.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [golinks.io](https://golinks.io) · vendor page id golinks-io
...
- **GitHub organisation**: none tied to golinks.io with evidence on 2026-09-15
