# DataMerge MCP: products, MCP servers and connect URLs, one vendor page

> DataMerge MCP (mcp.datamerge.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 23 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [mcp.datamerge.ai](https://mcp.datamerge.ai) · vendor page id mcp-datamerge-ai
...
- **GitHub organisation**: none tied to mcp.datamerge.ai with evidence on 2026-09-15
