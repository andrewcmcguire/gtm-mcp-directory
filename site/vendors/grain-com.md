# Grain: products, MCP servers and connect URLs, one vendor page

> Grain (grain.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 15 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [grain.com](https://grain.com) · vendor page id grain-com
...
- **GitHub organisation**: [github.com/grain-team](https://github.com/grain-team), tied to the domain with evidence 2026-09-08
