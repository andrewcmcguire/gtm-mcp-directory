...
> Knit MCP (getknit.dev): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-12.
...
quoted from [https://pypi.org/project/knit-mcp/](https://pypi.org/project/knit-mcp/) on 2026-09-12, via pypi, a third party source

harvested 2026-09-12, all on the [tool page](../tools/knit-mcp.md).
