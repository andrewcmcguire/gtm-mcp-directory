# Knit MCP: products, MCP servers and connect URLs, one vendor page

> Knit MCP (getknit.dev): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-10.
...
Vendor domain: [getknit.dev](https://getknit.dev) · vendor page id getknit-dev
...
- **GitHub organisation**: none tied to getknit.dev with evidence on 2026-09-08
...
### [Knit MCP](../tools/knit-mcp.md) knit-mcp community CLI
...
quoted from [https://pypi.org/project/knit-mcp/](https://pypi.org/project/knit-mcp/) on 2026-09-10, via pypi, a third party source

harvested 2026-09-10, all on the [tool page](../tools/knit-mcp.md).
