# Toplyne: products, MCP servers and connect URLs, one vendor page

> Toplyne (toplyne.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [toplyne.io](https://toplyne.io) · vendor page id toplyne-io
...
- **GitHub organisation**: [github.com/Toplyne](https://github.com/Toplyne), tied to the domain with evidence 2026-09-08
