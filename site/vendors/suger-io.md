# Suger: products, MCP servers and connect URLs, one vendor page

> Suger (suger.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
Vendor domain: [suger.io](https://suger.io) · vendor page id suger-io
...
- **GitHub organisation**: none tied to suger.io with evidence on 2026-09-15
...
### [Suger](../tools/suger.md) suger community CLI
...
harvested 2026-09-18, all on the [tool page](../tools/suger.md).
