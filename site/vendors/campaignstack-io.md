# CampaignStack: products, MCP servers and connect URLs, one vendor page

> CampaignStack (campaignstack.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [campaignstack.io](https://campaignstack.io) · vendor page id campaignstack-io
...
- **GitHub organisation**: none tied to campaignstack.io with evidence on 2026-09-15
