# Ada: products, MCP servers and connect URLs, one vendor page

> Ada (ada.cx): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 1 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [ada.cx](https://ada.cx) · vendor page id ada-cx
...
- **GitHub organisation**: none tied to ada.cx with evidence on 2026-09-08
...
- **Connect URL**: [https://docs.ada.cx/_mcp/server](https://docs.ada.cx/_mcp/server) (docs page)
...
- [https://docs.ada.cx/_mcp/server](https://docs.ada.cx/_mcp/server) (Ada, docs page, probed 2026-09-04)
