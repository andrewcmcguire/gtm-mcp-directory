...
> HubSpot (hubspot.com): 3 products in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 25 tools catalogued. Data baked 2026-09-13.
...
- **Ships a CLI**: 2 of 3 official, 0 community only, 1 none found, harvested 2026-09-13
...
quoted from [https://www.npmjs.com/package/@hubspot/cli](https://www.npmjs.com/package/@hubspot/cli) on 2026-09-13, via npm

harvested 2026-09-13, all on the [tool page](../tools/hubspot.md).
