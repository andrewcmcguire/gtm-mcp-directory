...
> HubSpot (hubspot.com): 3 products in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 25 tools catalogued. Data baked 2026-09-12.
...
- **Bench tested**: 0 of 3 here, 1 of 784 across the directory

- **Ships a CLI**: 2 of 3 official, 0 community only, 1 none found, harvested 2026-09-12
...
harvested 2026-09-12, all on the [tool page](../tools/hubspot.md).
