# Hatch: products, MCP servers and connect URLs, one vendor page

> Hatch (usehatch.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [usehatch.ai](https://usehatch.ai) · vendor page id usehatch-ai
...
- **GitHub organisation**: none tied to usehatch.ai with evidence on 2026-09-15
...
### [Hatch](../tools/hatch.md) hatch-cli community CLI
...
2 more install commands, harvested 2026-09-17, all on the [tool page](../tools/hatch.md).
