# Gradient Works: products, MCP servers and connect URLs, one vendor page

> Gradient Works (gradient.works): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [gradient.works](https://gradient.works) · vendor page id gradient-works
...
- **GitHub organisation**: none tied to gradient.works with evidence on 2026-09-15
