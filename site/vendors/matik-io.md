# Matik: products, MCP servers and connect URLs, one vendor page

> Matik (matik.io): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [matik.io](https://matik.io) · vendor page id matik-io
...
- **GitHub organisation**: none tied to matik.io with evidence on 2026-09-15
