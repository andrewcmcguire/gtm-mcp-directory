# Inventive AI: products, MCP servers and connect URLs, one vendor page

> Inventive AI (inventive.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [inventive.ai](https://inventive.ai) · vendor page id inventive-ai
...
- **GitHub organisation**: none tied to inventive.ai with evidence on 2026-09-15
