# Vessel: products, MCP servers and connect URLs, one vendor page

> Vessel (vessel.dev): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [vessel.dev](https://vessel.dev) · vendor page id vessel-dev
...
- **GitHub organisation**: none tied to vessel.dev with evidence on 2026-09-15
