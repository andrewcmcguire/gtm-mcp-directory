# Karumi: products, MCP servers and connect URLs, one vendor page

> Karumi (karumi.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [karumi.ai](https://karumi.ai) · vendor page id karumi-ai
...
- **GitHub organisation**: none tied to karumi.ai with evidence on 2026-09-15
