# Zoho CRM: products, MCP servers and connect URLs, one vendor page

> Zoho CRM (zoho.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [zoho.com](https://zoho.com) · vendor page id zoho-com
...
- **GitHub organisation**: [github.com/catalystbyzoho](https://github.com/catalystbyzoho), tied to the domain with evidence 2026-09-08
