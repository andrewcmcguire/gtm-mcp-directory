# Truva: products, MCP servers and connect URLs, one vendor page

> Truva (truva.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [truva.ai](https://truva.ai) · vendor page id truva-ai
...
- **GitHub organisation**: none tied to truva.ai with evidence on 2026-09-15
...
### [Truva](../tools/truva.md) truva community CLI
...
harvested 2026-09-26, all on the [tool page](../tools/truva.md).
