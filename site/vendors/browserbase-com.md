...
> Browserbase (browserbase.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 6 tools catalogued. Data baked 2026-09-11.
...
1 more install command, 13 subcommands seen, harvested 2026-09-11, all on the [tool page](../tools/browserbase.md).
