...
> Browserbase (browserbase.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 6 tools catalogued. Data baked 2026-09-09.
...
quoted from [https://docs.browserbase.com/integrations/skills/browse-cli](https://docs.browserbase.com/integrations/skills/browse-cli) on 2026-09-09, via npm

Login or key hint: export BROWSERBASE_API_KEY = "your_api_key"

1 more install command, 13 subcommands seen, harvested 2026-09-09, all on the [tool page](../tools/browserbase.md).
