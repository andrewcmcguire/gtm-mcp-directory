# PitchPilot Outreach: products, MCP servers and connect URLs, one vendor page

> PitchPilot Outreach (aioutreachkit.surge.sh): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [aioutreachkit.surge.sh](https://aioutreachkit.surge.sh) · vendor page id aioutreachkit-surge-sh
...
- **GitHub organisation**: none tied to aioutreachkit.surge.sh with evidence on 2026-09-15
...
### [PitchPilot Outreach](../tools/pitchpilot-outreach.md) surge official CLI
...
Login or key hint: surge login

12 subcommands seen, harvested 2026-09-26, all on the [tool page](../tools/pitchpilot-outreach.md).
