# Kronologic: products, MCP servers and connect URLs, one vendor page

> Kronologic (kronologic.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [kronologic.com](https://kronologic.com) · vendor page id kronologic-com
...
- **GitHub organisation**: none tied to kronologic.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to kronologic.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

2 candidate accounts seen and rejected by the evidence rules: kronologic, kronologic-engineering. A name match alone is never accepted; the account has to point at the vendor domain.
