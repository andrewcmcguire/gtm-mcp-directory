...
> Superblocks (superblocks.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-18.
...
quoted from [https://www.npmjs.com/package/@superblocksteam/cli](https://www.npmjs.com/package/@superblocksteam/cli) on 2026-09-18, via npm

2 more install commands, harvested 2026-09-18, all on the [tool page](../tools/superblocks.md).
