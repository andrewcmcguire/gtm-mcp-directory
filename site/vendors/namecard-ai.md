# Namecard.ai: products, MCP servers and connect URLs, one vendor page

> Namecard.ai (namecard.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [namecard.ai](https://namecard.ai) · vendor page id namecard-ai
...
- **GitHub organisation**: none tied to namecard.ai with evidence on 2026-09-15
