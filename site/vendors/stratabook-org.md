# StrataBook MCP: products, MCP servers and connect URLs, one vendor page

> StrataBook MCP (stratabook.org): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [stratabook.org](https://stratabook.org) · vendor page id stratabook-org
...
- **GitHub organisation**: none tied to stratabook.org with evidence on 2026-09-15
