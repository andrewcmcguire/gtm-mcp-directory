# JustAI: products, MCP servers and connect URLs, one vendor page

> JustAI (getjust.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [getjust.ai](https://getjust.ai) · vendor page id getjust-ai
...
- **GitHub organisation**: none tied to getjust.ai with evidence on 2026-09-15
...
An AI-first modern enterprise marketing stack that sets you in an always-on, set-and-forget motion. Increase your experimentation velocity and keep your team lean! Say goodbye to manual campaign management.
...
No GitHub organisation could be tied to getjust.ai with evidence on 2026-09-15.
