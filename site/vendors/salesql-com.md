# SalesQL: products, MCP servers and connect URLs, one vendor page

> SalesQL (salesql.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [salesql.com](https://salesql.com) · vendor page id salesql-com
...
- **GitHub organisation**: [github.com/salesql](https://github.com/salesql), tied to the domain with evidence 2026-09-08
