# Fiber AI: products, MCP servers and connect URLs, one vendor page

> Fiber AI (fiber.ai): 1 product in The GTM MCP Directory, 1 with an official MCP server, 1 answering a live handshake, 3 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [fiber.ai](https://fiber.ai) · vendor page id fiber-ai
...
- **GitHub organisation**: [github.com/fiber-ai](https://github.com/fiber-ai), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://mcp.fiber.ai/mcp/v3](https://mcp.fiber.ai/mcp/v3) (endpoint)
...
- [https://mcp.fiber.ai/mcp/v3](https://mcp.fiber.ai/mcp/v3) (Fiber AI, endpoint, probed 2026-09-04)
