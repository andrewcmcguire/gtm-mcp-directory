# SMARTe: products, MCP servers and connect URLs, one vendor page

> SMARTe (smarte.pro): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [smarte.pro](https://smarte.pro) · vendor page id smarte-pro
...
- **GitHub organisation**: none tied to smarte.pro with evidence on 2026-09-15
