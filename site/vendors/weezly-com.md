# Weezly: products, MCP servers and connect URLs, one vendor page

> Weezly (weezly.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [weezly.com](https://weezly.com) · vendor page id weezly-com
...
- **GitHub organisation**: none tied to weezly.com with evidence on 2026-09-08
...
- **Connect URL**: [https://zapier.com/mcp/weezly](https://zapier.com/mcp/weezly) (docs page)
...
- [https://zapier.com/mcp/weezly](https://zapier.com/mcp/weezly) (Weezly, docs page, probed 2026-09-04)
...
No GitHub organisation could be tied to weezly.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

1 candidate account seen and rejected by the evidence rules: Weezly-GmbH. A name match alone is never accepted; the account has to point at the vendor domain.
