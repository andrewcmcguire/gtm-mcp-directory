# usefulapi.io: products, MCP servers and connect URLs, one vendor page

> usefulapi.io (usefulapi.io): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 20 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [usefulapi.io](https://usefulapi.io) · vendor page id usefulapi-io
...
- **GitHub organisation**: none tied to usefulapi.io with evidence on 2026-09-08
...
A hosted catalogue of 146 single-application MCP servers, one per SaaS product, each on its own subdomain, wrapping that product's public REST API as a named tool list with per-tool read and write labels and the underlying REST call documented against each...
...
- **Tools catalogued**: 20 named, harvested 2026-09-14, catalogue dynamic, the server exposes the customer's own workspace
