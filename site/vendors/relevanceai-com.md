...
> Relevance AI (relevanceai.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
quoted from [https://pypi.org/project/relevanceai/](https://pypi.org/project/relevanceai/) on 2026-09-17, via pypi

harvested 2026-09-17, all on the [tool page](../tools/relevance-ai.md).
