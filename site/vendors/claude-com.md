# Claude / Anthropic MCP Connector Directory: products, MCP servers and connect URLs, one vendor page

> Claude / Anthropic MCP Connector Directory (claude.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-17.
...
Vendor domain: [claude.com](https://claude.com) · vendor page id claude-com
...
- **GitHub organisation**: none tied to claude.com with evidence on 2026-09-08
...
No GitHub organisation could be tied to claude.com with evidence on 2026-09-08.

Recorded by the harvest: github candidates were seen but none passed the evidence rules.

5 candidate accounts seen and rejected by the evidence rules: claude-code-expert, claudekit, claudeskills, SuperClaude-Org, claude-world. A name match alone is never accepted; the account has to point at the vendor domain.
