# Brandwatch: products, MCP servers and connect URLs, one vendor page

> Brandwatch (brandwatch.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 7 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [brandwatch.com](https://brandwatch.com) · vendor page id brandwatch-com
...
- **GitHub organisation**: [github.com/brandwatch](https://github.com/brandwatch), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://github.com/ambo-sk/mcp-brandwatch](https://github.com/ambo-sk/mcp-brandwatch) (docs page)
...
- [https://github.com/ambo-sk/mcp-brandwatch](https://github.com/ambo-sk/mcp-brandwatch) (Brandwatch, docs page, probed 2026-09-04)
