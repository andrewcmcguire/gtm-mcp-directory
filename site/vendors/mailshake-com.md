# Mailshake: products, MCP servers and connect URLs, one vendor page

> Mailshake (mailshake.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [mailshake.com](https://mailshake.com) · vendor page id mailshake-com
...
- **GitHub organisation**: [github.com/mailshake](https://github.com/mailshake), tied to the domain with evidence 2026-09-08
