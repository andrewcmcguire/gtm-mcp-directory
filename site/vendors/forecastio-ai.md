# Forecastio: products, MCP servers and connect URLs, one vendor page

> Forecastio (forecastio.ai): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-14.
...
Vendor domain: [forecastio.ai](https://forecastio.ai) · vendor page id forecastio-ai
...
- **GitHub organisation**: none tied to forecastio.ai with evidence on 2026-09-08
...
AI sales-forecasting and pipeline-intelligence platform built for HubSpot and Salesforce users, applying machine learning, time-series models, and weighted-pipeline methods to predict a forecast range (best case/commit/worst case) and support what-if scenario...
