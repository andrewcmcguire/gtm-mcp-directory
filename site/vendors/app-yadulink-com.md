# Yadulink: products, MCP servers and connect URLs, one vendor page

> Yadulink (app.yadulink.com): 1 product in The GTM MCP Directory, 0 with an official MCP server, 0 answering a live handshake, 0 tools catalogued. Data baked 2026-09-26.
...
Vendor domain: [app.yadulink.com](https://app.yadulink.com) · vendor page id app-yadulink-com
...
- **GitHub organisation**: none tied to app.yadulink.com with evidence on 2026-09-15
...
### [Yadulink](../tools/yadulink.md) yadulink official CLI
...
harvested 2026-09-26, all on the [tool page](../tools/yadulink.md).
