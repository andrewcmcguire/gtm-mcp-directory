# Attio: products, MCP servers and connect URLs, one vendor page

> Attio (attio.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 41 tools catalogued. Data baked 2026-09-15.
...
Vendor domain: [attio.com](https://attio.com) · vendor page id attio-com
...
- **Tools catalogued**: 41 named across 1 measured server, harvested 2026-09-15
...
- **GitHub organisation**: [github.com/attio](https://github.com/attio), tied to the domain with evidence 2026-09-08
...
- **Connect URL**: [https://docs.attio.com/mcp/overview](https://docs.attio.com/mcp/overview) (docs page)

- **Tools catalogued**: 41 named, harvested 2026-09-15, catalogue fixed
...
- [https://docs.attio.com/mcp/overview](https://docs.attio.com/mcp/overview) (Attio, docs page, probed 2026-09-04)

An endpoint is where an agent connects. A docs page is where a person reads about connecting. Both are published because both are what the probe found; an agent needs the first.

**Command line**

### [Attio](../tools/attio.md) attio official CLI

```
npm install -g attio
```

quoted from [https://www.npmjs.com/package/attio](https://www.npmjs.com/package/attio) on 2026-09-15, via npm

harvested 2026-09-15, all on the [tool page](../tools/attio.md).
