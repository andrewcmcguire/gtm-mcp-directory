...
> Attio (attio.com): 1 product in The GTM MCP Directory, 1 with an official MCP server, 0 answering a live handshake, 41 tools catalogued. Data baked 2026-09-09.
...
- **Tools catalogued**: 41 named across 1 measured server, harvested 2026-09-09
...
- **Tools catalogued**: 41 named, harvested 2026-09-09, catalogue fixed
...
quoted from [https://www.npmjs.com/package/attio](https://www.npmjs.com/package/attio) on 2026-09-09, via npm

harvested 2026-09-09, all on the [tool page](../tools/attio.md).
