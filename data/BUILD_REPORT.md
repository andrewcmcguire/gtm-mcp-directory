...
|---|---|---|---|
| 01-data-enrichment.md | 149 | 149 | OK |
| 02-engagement-outbound.md | 127 | 127 | OK |
| 03-conversation-intel.md | 47 | 47 | OK |
| 04-ai-sdr-agents.md | 57 | 57 | OK |
| 05-signals-intent-abm.md | 65 | 65 | OK |
| 06-revops-infra.md | 89 | 89 | OK |
| 07-mcp-infrastructure.md | 201 | 201 | OK |
| 08-video-prospecting.md | 24 | 24 | OK |
| 09-email-deliverability.md | 24 | 24 | OK |
| 10-scheduling-routing.md | 18 | 18 | OK |
| 11-enablement-coaching.md | 58 | 58 | OK |
| 12-forecasting-revenue.md | 24 | 24 | OK |
| 13-proposals-deals.md | 27 | 27 | OK |
| 14-inbound-plg-chat.md | 51 | 51 | OK |
| 15-community-dark-social.md | 21 | 21 | OK |
| **Total** | **982** | **982** | **OK** |

mcp_status, build: `{"community": 271, "n-a": 9, "none-found": 487, "official": 200, "unknown": 15}`
mcp_status, recount: `{"community": 271, "n-a": 9, "none-found": 487, "official": 200, "unknown": 15}`

api_gate, build: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 679}`
api_gate, recount: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 679}`

## Field coverage, all 982 entries
...
- mcp_url non-empty: **565 of 982** (489 parse to at least one URL, 280 point at github.com)
- mcp_auth non-empty: **331 of 982**
- docs_url present: **353 of 982**
- api_gate `unknown`: **679 of 982**
- entries with at least one github.com URL anywhere (phase 6 seed): **316**
- sources: 3310 URLs total; 925 entries with 2+, 57 with exactly 1, 0 with none
...
mcp_status: `{"community": 271, "n-a": 9, "none-found": 487, "official": 200, "unknown": 15}`
api_gate: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 679}`
tier: `{"BENCH-TESTED": 1, "RESEARCHED": 981}`
last_checked: `{"2026-08-24": 71, "2026-08-25": 22, "2026-09-02": 121, "2026-09-03": 15, "2026-09-07": 107, "2026-09-12": 646}`

### Capability layer (what each server exposes, from merge_capabilities.py)

null
- servers with a recorded tool list: **119** of 471 that claim a server
...
- endpoint_status: `{"live": 1, "live-auth-gated": 26, "auth-wall": 8, "repo-local": 34, "docs-only": 97, "unreachable": 15, "not-probed": 290, "not-applicable": 511}`
...
- `github_url`: null or empty on all 982 entries
- `github_stars`: null or empty on all 982 entries
- `github_last_commit`: null or empty on all 982 entries
- `github_archived`: null or empty on all 982 entries
- `github_fetched_on`: null or empty on all 982 entries
- `docs_digest`: null or empty on all 982 entries
- `docs_last_crawled`: null or empty on all 982 entries
- `submission`: null or empty on all 982 entries
...
- entries tagged: **271 of 982**; untagged: **711**
- canonical products tagged: **255**; untagged: **711**
- total tag assignments: **849**, mean **3.13** per tagged entry, max **9**
- flagged needs-review in tags.yaml: **49**

Tags per entry: `{"0": 711, "1": 71, "2": 54, "3": 52, "4": 26, "5": 30, "6": 18, "7": 10, "8": 8, "9": 2}`
...
- Thin sourcing (fewer than 2 source URLs): **57**
- api_gate unknown: **679**
- docs_url missing: **629**
...
- content sha256: `47874948b18cc96a992b17d6ef9c27836266a90c5023043a656ebf20890f290b`
- source sha256: `b44204cec8c8baf544ac43fe35fdde72c46b10aaec8b4f76f1feb7570dc1967c`
