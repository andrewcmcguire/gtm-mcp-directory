...
Generated 2026-09-21 by `build_directory.py`. Zero network calls.
...
|---|---|---|---|
| 01-data-enrichment.md | 235 | 235 | OK |
| 02-engagement-outbound.md | 173 | 173 | OK |
| 03-conversation-intel.md | 51 | 51 | OK |
| 04-ai-sdr-agents.md | 65 | 65 | OK |
| 05-signals-intent-abm.md | 86 | 86 | OK |
| 06-revops-infra.md | 102 | 102 | OK |
| 07-mcp-infrastructure.md | 266 | 266 | OK |
| 08-video-prospecting.md | 24 | 24 | OK |
| 09-email-deliverability.md | 28 | 28 | OK |
| 10-scheduling-routing.md | 19 | 19 | OK |
| 11-enablement-coaching.md | 62 | 62 | OK |
| 12-forecasting-revenue.md | 33 | 33 | OK |
| 13-proposals-deals.md | 30 | 30 | OK |
| 14-inbound-plg-chat.md | 57 | 57 | OK |
| 15-community-dark-social.md | 21 | 21 | OK |
| **Total** | **1252** | **1252** | **OK** |

mcp_status, build: `{"community": 540, "n-a": 9, "none-found": 487, "official": 201, "unknown": 15}`
mcp_status, recount: `{"community": 540, "n-a": 9, "none-found": 487, "official": 201, "unknown": 15}`

api_gate, build: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 949}`
api_gate, recount: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 949}`

## Field coverage, all 1252 entries
...
- mcp_url non-empty: **835 of 1252** (759 parse to at least one URL, 431 point at github.com)
- mcp_auth non-empty: **332 of 1252**
- docs_url present: **525 of 1252**
- api_gate `unknown`: **949 of 1252**
- entries with at least one github.com URL anywhere (phase 6 seed): **469**
- sources: 4092 URLs total; 1152 entries with 2+, 100 with exactly 1, 0 with none
...
mcp_status: `{"community": 540, "n-a": 9, "none-found": 487, "official": 201, "unknown": 15}`
api_gate: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 949}`
tier: `{"BENCH-TESTED": 1, "RESEARCHED": 1251}`
last_checked: `{"2026-08-24": 71, "2026-08-25": 22, "2026-09-02": 121, "2026-09-03": 15, "2026-09-07": 107, "2026-09-12": 915, "2026-09-14": 1}`

### Capability layer (what each server exposes, from merge_capabilities.py)

null
- servers with a recorded tool list: **140** of 741 that claim a server
- tools recorded in total: **9417**, of which **None** belong to gateway servers that re-expose other vendors. The number that describes what GTM tools themselves expose is **None**.
- by evidence: `{"live-list": 6655, "source": 1375, "docs": 983, "readme": 404}`
...
- `github_url`: null or empty on all 1252 entries
- `github_stars`: null or empty on all 1252 entries
- `github_last_commit`: null or empty on all 1252 entries
- `github_archived`: null or empty on all 1252 entries
- `github_fetched_on`: null or empty on all 1252 entries
- `docs_digest`: null or empty on all 1252 entries
- `docs_last_crawled`: null or empty on all 1252 entries
- `submission`: null or empty on all 1252 entries
...
- entries tagged: **271 of 1252**; untagged: **981**
- canonical products tagged: **255**; untagged: **981**
- total tag assignments: **849**, mean **3.13** per tagged entry, max **9**
- flagged needs-review in tags.yaml: **49**

Tags per entry: `{"0": 981, "1": 71, "2": 54, "3": 52, "4": 26, "5": 30, "6": 18, "7": 10, "8": 8, "9": 2}`
...
- Thin sourcing (fewer than 2 source URLs): **100**
- api_gate unknown: **949**
- docs_url missing: **727**
...
- content sha256: `ac528ab40b4b28e1840ce9bf404581721b951154c60667dc56cebb88e1a4a010`
