...
|---|---|---|---|
| 01-data-enrichment.md | 94 | 94 | OK |
| 02-engagement-outbound.md | 77 | 77 | OK |
| 03-conversation-intel.md | 34 | 34 | OK |
| 04-ai-sdr-agents.md | 36 | 36 | OK |
| 05-signals-intent-abm.md | 49 | 49 | OK |
| 06-revops-infra.md | 55 | 55 | OK |
| 07-mcp-infrastructure.md | 77 | 77 | OK |
| 08-video-prospecting.md | 18 | 18 | OK |
| 09-email-deliverability.md | 15 | 15 | OK |
| 10-scheduling-routing.md | 16 | 16 | OK |
| 11-enablement-coaching.md | 36 | 36 | OK |
| 12-forecasting-revenue.md | 20 | 20 | OK |
| 13-proposals-deals.md | 20 | 20 | OK |
| 14-inbound-plg-chat.md | 37 | 37 | OK |
| 15-community-dark-social.md | 20 | 20 | OK |
| **Total** | **604** | **604** | **OK** |

mcp_status, build: `{"community": 103, "n-a": 9, "none-found": 277, "official": 200, "unknown": 15}`
mcp_status, recount: `{"community": 103, "n-a": 9, "none-found": 277, "official": 200, "unknown": 15}`

api_gate, build: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 301}`
api_gate, recount: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 301}`

## Field coverage, all 604 entries
...
- mcp_url non-empty: **397 of 604** (321 parse to at least one URL, 146 point at github.com)
- mcp_auth non-empty: **331 of 604**
- docs_url present: **155 of 604**
- api_gate `unknown`: **301 of 604**
- entries with at least one github.com URL anywhere (phase 6 seed): **172**
- sources: 2252 URLs total; 584 entries with 2+, 20 with exactly 1, 0 with none
...
mcp_status: `{"community": 103, "n-a": 9, "none-found": 277, "official": 200, "unknown": 15}`
api_gate: `{"enterprise-leaning": 8, "enterprise-only": 79, "free": 78, "n-a": 6, "paid": 132, "unknown": 301}`
tier: `{"BENCH-TESTED": 1, "RESEARCHED": 603}`
last_checked: `{"2026-08-24": 71, "2026-08-25": 22, "2026-09-02": 121, "2026-09-03": 15, "2026-09-07": 107, "2026-09-12": 268}`

### Capability layer (what each server exposes, from merge_capabilities.py)

null
- servers with a recorded tool list: **119** of 303 that claim a server
...
- endpoint_status: `{"live": 1, "live-auth-gated": 26, "auth-wall": 8, "repo-local": 34, "docs-only": 97, "unreachable": 15, "not-probed": 122, "not-applicable": 301}`
...
- `github_url`: null or empty on all 604 entries
- `github_stars`: null or empty on all 604 entries
- `github_last_commit`: null or empty on all 604 entries
- `github_archived`: null or empty on all 604 entries
- `github_fetched_on`: null or empty on all 604 entries
- `docs_digest`: null or empty on all 604 entries
- `docs_last_crawled`: null or empty on all 604 entries
- `submission`: null or empty on all 604 entries
...
- entries tagged: **271 of 604**; untagged: **333**
- canonical products tagged: **255**; untagged: **333**
- total tag assignments: **849**, mean **3.13** per tagged entry, max **9**
- flagged needs-review in tags.yaml: **49**

Tags per entry: `{"0": 333, "1": 71, "2": 54, "3": 52, "4": 26, "5": 30, "6": 18, "7": 10, "8": 8, "9": 2}`
...
- Thin sourcing (fewer than 2 source URLs): **20**
- api_gate unknown: **301**
- docs_url missing: **449**
...
- content sha256: `de39de7f6d63369ae8907f32a16eedaa5ebc3356a8665e0d098ec444acbedcac`
- source sha256: `b60c991232659b7f4c46279d470b8a2b5d45dec4dafd9f708c63b8e1844b43fb`
